...
oOoO = "%MEM" . ljust ( 8 )
i11iiII = "Process"
print "{}{}{}{}" . format ( iIiiI1 , OoOooOOOO , oOoO , i11iiII )
if 68 - 68: oOo0O0Ooo . ii1IiI1i . i11iIiiIii
for I1iiiiI1iII in oo00o0Oo0oo :
 IiIi11i = I1iiiiI1iII . split ( )
 iIiiI1 = IiIi11i [ 1 ] . ljust ( 8 )
 OoOooOOOO = IiIi11i [ 2 ] . ljust ( 8 )
 oOoO = IiIi11i [ 3 ] . ljust ( 8 )
 if 40 - 40: ii1IiI1i . oOo0O0Ooo . IIiI1I11i11 . i1IIi
 if ( I1iiiiI1iII . find ( "lisp-core.py" ) != - 1 ) :
  i11iiII = IiIi11i [ - 2 ] + " " + IiIi11i [ - 1 ]
 elif ( I1iiiiI1iII . find ( "lisp-join.py" ) != - 1 ) :
  I11iii = IiIi11i [ - 1 ]
  if ( I11iii . count ( "." ) != 3 ) : I11iii = IiIi11i [ - 2 ] + " " + I11iii
  i11iiII = "lisp-join.py " + I11iii
 else :
  i11iiII = IiIi11i [ - 1 ]
  if 54 - 54: OOooOOo + OOooOOo % I1Ii111 % i11iIiiIii / iIii1I11I1II1 . OOooOOo
  if 57 - 57: Ii1I % OoooooooOO
 print "{}{}{}{}" . format ( iIiiI1 , OoOooOOOO , oOoO , i11iiII )
 if 61 - 61: iII111i . iIii1I11I1II1 * oOooOoO0Oo0O . ooOoO0o % IIiI1I11i11
exit ( 0 )
