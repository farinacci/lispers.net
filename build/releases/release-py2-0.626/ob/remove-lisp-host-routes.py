...
try :
 Oooo0000 = getoutput ( r"ip route | egrep 'via'" )
 if 22 - 22: Ii1I . IiII
 if ( Oooo0000 == "" ) :
 ...
 for i1iII1I1i1i1 in Oooo0000 . split ( "\n" ) :
  ...
  i1iIIi1 = i1iIIII [ 0 ]
  try :
   ii11iIi1I = ipaddress . ip_address ( unicode ( i1iIIi1 ) )
   if ( ii11iIi1I . is_private or ii11iIi1I . is_loopback or
 ii11iIi1I . is_link_local or ii11iIi1I . is_multicast ) :
    continue
    if 6 - 6: OoOoOO00 * iII111i
    if 67 - 67: ooOoO0o - oO0o * o0oOOo0O0Ooo % o0oOOo0O0Ooo % I11i * OoOoOO00
   os . system ( "sudo ip route delete {}/32" . format ( i1iIIi1 ) )
   oo00o0Oo0oo . append ( i1iIIi1 )
  except :
   pass
