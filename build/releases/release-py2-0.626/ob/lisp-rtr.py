...
def O0oooo00o0Oo ( lisp_packet , thread_name ) :
 ...
 lisp_socket = O00OOooo0Ooo ) == False ) : return
  ...
  if ( len ( O0iIi1IiII . packet ) <= 1500 ) :
   OO0 = "Send {}" . format ( oO0O00OoOO0 . rloc_next_hop [ 0 ] )
   O0iIi1IiII . print_packet ( OO0 , True )
  ...
  o0Oo = Ii1IIii11 if I1Iii1iI1 == 6 else OOo
  O0iIi1IiII . send_packet ( o0Oo , O0iIi1IiII . outer_dest )
  ...
  oO0OO = len ( O0iIi1IiII . packet )
  for OO0o0OO0 in O0oOOo0o . rle_forwarding_list :
   if ( OO0o0OO0 . rloc . up_state ( ) == False ) : continue
   if 56 - 56: i11iIiiIii - Oo0Ooo / iII111i / OoOoOO00
   O0iIi1IiII . outer_dest . copy_address ( OO0o0OO0 . rloc . rloc )
   O0iIi1IiII . encap_port = lisp . LISP_DATA_PORT if OO0o0OO0 . rloc . translated_port == 0 else OO0o0OO0 . rloc . translated_port
   ...
   OO0o0OO0 . rloc . stats . increment ( len ( O0iIi1IiII . packet ) )
   if 49 - 49: ooOoO0o * oO0o / o0oOOo0O0Ooo / Oo0Ooo * iIii1I11I1II1
   O0iIi1IiII . print_packet ( "Replicate-to-L{}" . format ( OO0o0OO0 . level ) , True )
   ...
   OO0OO0O = len ( O0iIi1IiII . packet ) - oO0OO
   O0iIi1IiII . packet = O0iIi1IiII . packet [ OO0OO0O : : ]
...
def oo0 ( thread ) :
 iIiI = ( time . time ( ) % thread . number_of_pcap_threads )
 return ( int ( iIiI ) == thread . thread_number )
...
def iiO0O0o0oO0O00 ( parms , not_used , packet ) :
 if ( oo0 ( parms [ 1 ] ) == False ) : return
 if 70 - 70: I1Ii111 + oO0o
 o00ooo0 = parms [ 0 ]
 i1i1IiIi1 = parms [ 1 ]
 I1iiIiI1iI1I = i1i1IiIi1 . number_of_worker_threads
 if 27 - 27: I1ii11iIi11i * I1Ii111 - OoO0O00 + Ii1I * Ii1I
 i1i1IiIi1 . input_stats . increment ( len ( packet ) )
 if 55 - 55: ooOoO0o
 ...
 if 100 - 100: O0
 o00 = 4 if o00ooo0 == "lo0" else ( 14 if lisp . lisp_is_macos ( ) else 16 )
 packet = packet [ o00 : : ]
 ...
 if ( I1iiIiI1iI1I ) :
  i1II1i = i1i1IiIi1 . input_stats . packet_count % I1iiIiI1iI1I
  i1II1i = i1II1i + ( len ( I11 ) - I1iiIiI1iI1I )
  I1iIiiiI1 = I11 [ i1II1i ]
  I1iIiiiI1 . input_queue . put ( packet )
 else :
  i1i1IiIi1 . lisp_packet . packet = packet
  O0oooo00o0Oo ( i1i1IiIi1 . lisp_packet , i1i1IiIi1 . thread_name )
...
def oOO0 ( lisp_thread ) :
 ...
 IIiIi11iiIi = getoutput ( "egrep 'lisp-nat = yes' ./lisp.config" )
 IIiIi11iiIi = ( IIiIi11iiIi != "" and IIiIi11iiIi [ 0 ] == " " )
 if 48 - 48: IiII % I11i
 i1I1III1i1i = "(dst host "
 i1I11 = ""
 for OOOOOoo0 in lisp . lisp_get_all_addresses ( ) :
  i1I1III1i1i += "{} or " . format ( OOOOOoo0 )
  i1I11 += "{} or " . format ( OOOOOoo0 )
  if 9 - 9: O0 % OOooOOo * iIii1I11I1II1 * oO0o + OoooooooOO + I1ii11iIi11i
 i1I1III1i1i = i1I1III1i1i [ 0 : - 4 ]
 i1I1III1i1i += ") and ((udp dst port 4341 or 8472 or 4789) or "
 i1I1III1i1i += "(proto 17 and (ip[6]&0xe0 == 0x20 or " + "(ip[6]&0xe0 == 0 and ip[7] != 0))))"
 ...
 i1I11 = i1I11 [ 0 : - 4 ]
 i1I1III1i1i += ( " or (not (src host {}) and " + "((udp src port 4342 and ip[28] == 0x28) or " + "(udp dst port 4342 and ip[28] == 0x12)))" ) . format ( i1I11 )
 if 45 - 45: O0 / i1IIi * oO0o * OoO0O00
 if 35 - 35: I1ii11iIi11i / iII111i % I1IiiI + iIii1I11I1II1
 if 79 - 79: OoOoOO00 / ooOoO0o
 if ( IIiIi11iiIi ) :
  i1I1III1i1i += ( " or (dst net 0.0.0.0/0 and " + "not (host {} or src net 127.0.0.0/8))" ) . format ( i1I11 )
  if 77 - 77: Oo0Ooo
  if 46 - 46: I1Ii111
  if 72 - 72: iII111i * OOooOOo
 lisp . lprint ( "Capturing packets for: '{}'" . format ( i1I1III1i1i ) )
 if 67 - 67: i1IIi
 ...
 if ( lisp . lisp_is_python2 ( ) ) :
  import pcappy
  iii11i1 = pcappy . open_live ( o00ooo0 , 9000 , 0 , 100 )
  iii11i1 . filter = i1I1III1i1i
  iii11i1 . loop ( - 1 , iiO0O0o0oO0O00 , [ o00ooo0 , lisp_thread ] )
  if 48 - 48: ooOoO0o * I1ii11iIi11i
 if ( lisp . lisp_is_python3 ( ) ) :
  import pcapy
  iii11i1 = pcapy . open_live ( o00ooo0 , 9000 , 0 , 100 )
  iii11i1 . setfilter ( i1I1III1i1i )
  while ( True ) :
   Ii1Iii111IiI1 , O0iIi1IiII = iii11i1 . next ( )
   if ( len ( O0iIi1IiII ) == 0 ) : continue
   iiO0O0o0oO0O00 ( [ o00ooo0 , lisp_thread ] , None , O0iIi1IiII )
...
def O0oOO0o ( lisp_raw_socket , eid , geid , igmp ) :
 ...
 for iiIIiiIi1Ii11 in OoOo . rloc_set [ 0 ] . rle . rle_nodes :
  if ( iiIIiiIi1Ii11 . rloc . rloc_name == i1i11ii1Ii ) :
 ...
 ii1I = lisp . lisp_myrlocs [ 0 ]
 if ( iIiiI1 ) : ii1I = iIiiI1
 O0iIi1IiII . outer_source . copy_address ( ii1I )
 ...
 OOO0oO = lisp . bold ( "IGMP Query" , False )
 if 38 - 38: iIii1I11I1II1 / ooOoO0o
 lisp . lprint ( "Data encapsulate {} to gleaned EID {}, RLOC {}" . format ( OOO0oO , OO0oOoOO0oOO0 , i1oO ) )
...
def IIii ( lisp_raw_socket ) :
 ...
 O0Oo000OO000 = b"\x46\xc0\x00\x24\x00\x00\x40\x00\x01\x02\x00\x00"
 OOOO00OooO = lisp . lisp_myrlocs [ 0 ]
 oO0o0OOOO = OOOO00OooO . address
 O0Oo000OO000 += OooO0OO ( ( oO0o0OOOO >> 24 ) & 0xff )
 O0Oo000OO000 += OooO0OO ( ( oO0o0OOOO >> 16 ) & 0xff )
 O0Oo000OO000 += OooO0OO ( ( oO0o0OOOO >> 8 ) & 0xff )
 O0Oo000OO000 += OooO0OO ( oO0o0OOOO & 0xff )
 O0Oo000OO000 += b"\xe0\x00\x00\x01"
 O0Oo000OO000 += b"\x94\x04\x00\x00"
 O0Oo000OO000 = lisp . lisp_ip_checksum ( O0Oo000OO000 , 24 )
 ...
 for Oo0O in lisp . lisp_gleaned_groups :
  ...
  for iiiii111 in lisp . lisp_gleaned_groups [ Oo0O ] :
   Oo0oOOo . store_address ( iiiii111 )
   II1i , Ii1IIIIi1ii1I , oO0oo0o00o0O = lisp . lisp_allow_gleaning ( i1i , Oo0oOOo , None )
   if ( oO0oo0o00o0O == False ) : continue
   O0oOO0o ( lisp_raw_socket , i1i , Oo0oOOo , O0Oo000OO000 + oO0 )
...
def oo00o0 ( ) :
 ...
 for Oo0O in lisp . lisp_gleaned_groups :
  for iiiii111 in lisp . lisp_gleaned_groups [ Oo0O ] :
   iIi1iI = lisp . lisp_gleaned_groups [ Oo0O ] [ iiiii111 ]
   OO0Oo = time . time ( ) - iIi1iI
   if ( OO0Oo < lisp . LISP_IGMP_TIMEOUT_INTERVAL ) : continue
   III1III11II . append ( [ Oo0O , iiiii111 ] )
 ...
 for Oo0O , iiiii111 in III1III11II :
  i1i . store_address ( Oo0O )
  Oo0oOOo . store_address ( iiiii111 )
  OO0oOoOO0oOO0 = lisp . green ( Oo0O , False )
  i1I1IiI1ii = lisp . green ( iiiii111 , False )
...
def iI111II1ii ( lisp_raw_socket ) :
 ...
 for O0OO0O in list ( lisp . lisp_crypto_keys_by_nonce . values ( ) ) :
  for i1o0oo0 in O0OO0O : del ( i1o0oo0 )
...
def iIi1i11 ( ) :
 ...
 if ( lisp . lisp_on_gcp ( ) == False and lisp . lisp_on_aws ( ) ) :
  ...
  oO0o0OOOO = None
  for o00ooo0 in [ "eth0" , "ens5" ] :
   oO0o0OOOO = lisp . lisp_get_interface_address ( o00ooo0 )
   if ( oO0o0OOOO != None ) : break
   if 28 - 28: Oo0Ooo + IiII % II111iiii / OoO0O00 + i11iIiiIii
  if ( oO0o0OOOO != None ) :
   iIiiI1 = oO0o0OOOO
   OOOOOoo0 = oO0o0OOOO . print_address_no_iid ( )
   lisp . lprint ( "{} using RLOC {} on {}" . format ( I1IiII1I1i1I1 , OOOOOoo0 , o00ooo0 ) )
  else :
 ...
 for iiI in range ( ooOOO00oOOooO ) :
  ...
  threading . Thread ( target = oOO0 , args = [ O0OO0o0O00oO ] ) . start ( )
  if 81 - 81: IiII / I11i
 ...
 for iiI in range ( IiI ) :
  ...
  I11 . append ( O0OO0o0O00oO )
  threading . Thread ( target = i1II11Iii1I , args = [ O0OO0o0O00oO ] ) . start ( )
