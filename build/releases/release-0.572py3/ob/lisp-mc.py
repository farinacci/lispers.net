...
for oo0 in i1iiI11I :
 o00 = oo0 [ "eid-prefix" ]
 if ( "group-prefix" in oo0 ) : o00 = "({}, {})" . format ( o00 , oo0 [ "group-prefix" ] )
 o00 = IiII1IiiIiI1 ( "[{}]{}" . format ( oo0 [ "instance-id" ] , o00 ) )
 o00 = "EID {}," . format ( o00 )
 OooOooo = oo0 [ "ttl" ]
 OooOooo = "never" if ( OooOooo == "--" ) else OooOooo . split ( "." ) [ 0 ] + "m"
 O000oo0O = "uptime {}, ttl {}" . format ( oo0 [ "uptime" ] , OooOooo )
 OOOO = oo0 [ "action" ]
 O000oo0O += ", action {}" . format ( ooO0oooOoO0 ( OOOO ) ) if OOOO != "no-action" else ""
 print ( o00 , O000oo0O )
 ...
 for i11 in oo0 [ "rloc-set" ] :
  ...
  i1I1iI = i11 [ "address" ]
  if ( "encap-port" in i11 ) : i1I1iI += ":{}" . format ( i11 [ "encap-port" ] )
  if 93 - 93: iIii1I11I1II1 % iiiiIi11i * i1IIi
  i1I1iI = "  RLOC {}, state {} since {}" . format ( Ii1I ( i1I1iI ) , IIIii1II1II ,
 i11 [ "uptime" ] )
  if ( "encap-crypto" in i11 ) : i1I1iI += ", {}" . format ( i11 [ "encap-crypto" ] )
  if ( "rloc-name" in i11 ) : i1I1iI += ", {}" . format ( II1i ( i11 [ "rloc-name" ] ) )
  if 16 - 16: O0 - oO0o0ooO0 * iIii1I11I1II1 + ooOoO0o
  print ( i1I1iI )
  print ( "    {}" . format ( i11 [ "stats" ] ) )
