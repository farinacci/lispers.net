...
for OOoO00o in range ( i1iII1IiiIiI1 ) :
 ...
 print "Configure {} on interface {} ..." . format ( OOoo0O0 , iII11i ) ,
 os . system ( ii1 . format ( ii1I1i1I ) )
 if ( o0OoOoOO00 ) : print commands . getoutput ( iiiIi1i1I )
 print "succeeded"
 ...
 print "Deconfigure {} on interface {} ..." . format ( OOoo0O0 , iII11i ) ,
