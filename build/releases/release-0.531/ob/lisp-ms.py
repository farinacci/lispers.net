...
def i11i ( eid_key , group_key ) :
 ...
 if ( ii1 . last_registerer . afi == lisp . LISP_AFI_NONE ) :
  ...
  OOoOoOo = ii1 . last_registerer . print_address ( )
  if 98 - 98: iII111i
 ...
 for ii1 in ii1 . individual_registrations . values ( ) :
  ...
  O0I11Iiii1I = ii1 . print_flags ( False )
  O0I11Iiii1I = lisp . lisp_print_cour ( O0I11Iiii1I )
  I1ii1 = lisp . lisp_print_cour ( ii1 . last_registerer . print_address ( ) )
  o0o00OOo0 = lisp . lisp_print_elapsed ( ii1 . first_registered )
 ...
 ( ii1 . register_ttl / 2 ) and I1IIii1 != "never" ) :
  ...
  o0O0OOOOoOO0 += '''
        ...
        ''' . format ( o0ooooO0o0O , I1ii1 , ooO , oOooo0 , iI1 , o0ooooO0o0O , o0o00OOo0 , I1IIii1 , oo00O0oO0O0 ,
 O0I11Iiii1I )
...
def o00 ( ddt_entry , output ) :
 ...
 for oo0o0O0Oooooo in ddt_entry . delegation_set :
  ...
  output += lispconfig . lisp_table_row ( oO , OoO000 . print_address ( ) ,
...
def ii111Iiii ( ) :
 ...
 hashlib . sha256 ) . hexdigest ( )
  ...
  I1Ii11II1I1 = copy . deepcopy ( IIiiIiI1 )
  IiI1iI1IiiIi1 = "{" + OOOoo0ooOo00O . format ( ii1111Ii1i ) + "}"
  I1Ii11II1I1 . json = lisp . lisp_json ( ii1 . eid . address , IiI1iI1IiiIi1 )
  OoO0oo = copy . deepcopy ( IIiiIiI1 )
  IiI1iI1IiiIi1 = "{" + OoO0oO00o . format ( ii1111Ii1i ) + "}"
  OoO0oo . json = lisp . lisp_json ( ii1 . eid . address , IiI1iI1IiiIi1 )
  ii1 . registered_rlocs = [ I1Ii11II1I1 , OoO0oo ]
 ...
 if ( Ooo0O < 60 ) :
  lisp . fprint ( "Finished in {} secs" . format ( round ( Ooo0O , 3 ) ) )
 else :
  Ooo0O = Ooo0O / 60
  lisp . fprint ( "Finished in {} mins" . format ( round ( Ooo0O , 1 ) ) )
...
def i1I1II ( ) :
 ...
 Ii1IIii11 = threading . Timer ( lisp . LISP_PUBSUB_TIMEOUT_CHECK_INTERVAL , i1I1II , [ ] )
...
def oOOO0ooo ( ) :
 ...
 Ii1IIii11 = threading . Timer ( o0o0Oo0OOOOO , i1I1II , [ ] )
 Ii1IIii11 . start ( )
 return ( True )
