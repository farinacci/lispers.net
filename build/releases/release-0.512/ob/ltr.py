...
def oO0OOOO0 ( match_iid , match_eid , user , pw , http , port , v4v6 ) :
 ...
 ii = commands . getoutput ( iI1I11iiI1i )
 ...
 for o00oO0oo0OO in I1I1II1I11 :
  if ( o00oO0oo0OO . has_key ( "eid-prefix" ) == False ) : continue
  ...
  o00oOOooOOo0o = o00oO0oo0OO [ "rlocs" ] [ 0 ] . has_key ( "translated-rloc" )
...
def Oo ( user , pw , http , port ) :
 ...
 I1ii1I1 = [ ]
 for o00oO0oo0OO in I1I1II1I11 :
  if ( o00oO0oo0OO . has_key ( "group-prefix" ) ) : continue
  if ( o00oO0oo0OO . has_key ( "eid-prefix" ) == False ) : continue
