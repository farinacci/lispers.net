...
def lisp_database_mapping_command ( kv_pair , ephem_port = None , replace = True ) :
 ...
 for O00oO0 in kv_pair . keys ( ) :
  ...
  if ( O00oO0 == "register-ttl" ) :
   for i11Ii1 in range ( len ( IIo0oo0OO ) ) :
    ...
    iiIii = IIo0oo0OO [ i11Ii1 ]
    iiIii . register_ttl = int ( oo00oO0O0 [ i11Ii1 ] )
 ...
 for iiIii in IIo0oo0OO :
  ...
  iiIii . sort_rloc_set ( )
  iiIii . add_db ( )
  if ( replace and lisp_replace_db_list ( iiIii ) ) : continue
 ...
 oo00O0OO0oo0O = ( lisp . lisp_myrlocs [ 0 ] != None )
 lisp . lisp_get_local_addresses ( )
 if 1 - 1: Oo0Ooo * O0 . I1IiiI + ooOoO0o / OoOoOO00 + I11i
 if ( lisp . lisp_myrlocs [ 0 ] == None and oo00O0OO0oo0O ) :
 ...
 for iiIii in IIo0oo0OO :
  if ( iiIii . dynamic_eids == None ) : continue
  iIIIIi = iiIii . eid . print_prefix_no_iid ( )
  iIi1I1 = lisp . lisp_i_am_itr
  os . system ( "ip route add {} dev ma1" . format ( iIIIIi ) )
...
def lisp_show_db_list ( itr_or_etr , output ) :
 ...
 for iiIii in lisp . lisp_db_list :
  oO000OO0 = lisp . lisp_print_elapsed ( iiIii . uptime )
  ooOOoOoo0OO = iiIii . map_replies_sent
  ...
  if ( iiIii . dynamic_eid_configured ( ) ) :
   iiii11i1 = iiIii . eid . print_prefix_url ( )
   Oo00o = len ( iiIii . dynamic_eids )
   OoiIIIiIi1I1i = itr_or_etr . lower ( )
   oOo0 = ( "<br><a href='/lisp/show/{}/dynamic-eid/{}'>" + "{} dynamic-eids</a>" ) . format ( OoiIIIiIi1I1i , iiii11i1 , Oo00o )
  ...
  for i1iIIiiIiII in iiIii . rloc_set :
   if ( II1I11iIIIii1 ) :
    I11iIIiIIiIi = iiIii . print_eid_tuple ( )
    I11iIIiIIiIi = iiIii . star_secondary_iid ( I11iIIiIIiIi )
    I11iIIiIIiIi += oOo0
    Oo000o = oO000OO0
    II1I11iIIIii1 = False
   else :
    I11iIIiIIiIi , Oo000o , ooOOoOoo0OO = ( "" , "" , "" )
    if 45 - 45: I1IiiI
   ...
   iii1I = i1iIIiiIiII . print_rloc_name ( True )
   if ( iii1I != "" ) : II1iiiiI1 += iii1I + "<br>"
   ...
   if ( i1iIIiiIiII . json_name != None ) :
    ...
    if 3 - 3: I1ii11iIi11i
   if ( itr_or_etr == "ITR" ) :
    output += lisp_table_row ( I11iIIiIIiIi , Oo000o , II1iiiiI1 ,
 ...
 "Geo-Prefix or Geo-Point" )
  iiI = sorted ( lisp . lisp_geo_list )
  for IIiI1I11ii1i in iiI :
...
def lisp_interface_command ( kv_pair ) :
 ...
 for O00oO0 in kv_pair . keys ( ) :
  oo00oO0O0 = kv_pair [ O00oO0 ]
  if ( O00oO0 == "interface-name" ) : iII1I1 = oo00oO0O0
  if ( O00oO0 == "device" ) : OoO0O = oo00oO0O0
  if ( O00oO0 == "instance-id" ) : II1i1iI1 = oo00oO0O0
  if ( O00oO0 == "dynamic-eid" ) : i1iI1i11II = oo00oO0O0
  if ( O00oO0 == "multi-tenant-eid" ) : oO0 = oo00oO0O0
  if ( O00oO0 == "dynamic-eid-device" ) : I1iii1iIi1i11 = oo00oO0O0
  if ( O00oO0 == "dynamic-eid-timeout" ) : Ii111iiIIi = oo00oO0O0
  if ( O00oO0 == "lisp-nat" ) : I11i1I1 = ( oo00oO0O0 == "yes" )
 ...
 if ( lisp . lisp_myinterfaces . has_key ( OoO0O ) and oO0 == None ) :
  i1Iii1ii = lisp . lisp_myinterfaces [ OoO0O ]
 else :
  i1Iii1ii = lisp . lisp_interface ( OoO0O )
  lisp . lisp_myinterfaces [ OoO0O ] = i1Iii1ii
 ...
 i1Iii1ii . interface_name = iII1I1
 if ( II1i1iI1 != None ) :
  if ( II1i1iI1 . isdigit ( ) == False ) : II1i1iI1 = "0"
  i1Iii1ii . instance_id = int ( II1i1iI1 )
  if 87 - 87: OoO0O00 * Oo0Ooo
 if ( i1iI1i11II != None ) :
  i1Iii1ii . dynamic_eid . store_prefix ( i1iI1i11II )
  i1Iii1ii . dynamic_eid . instance_id = i1Iii1ii . instance_id
  if 83 - 83: i1IIi * I1Ii111 - IiII / Ii1I
 if ( I1iii1iIi1i11 != None ) :
  i1Iii1ii . dynamic_eid_device = I1iii1iIi1i11
  if 48 - 48: oO0o . II111iiii - OoOoOO00 % i1IIi . OoOoOO00
 if ( Ii111iiIIi != None ) :
  i1Iii1ii . dynamic_eid_timeout = int ( Ii111iiIIi )
  if 32 - 32: Ii1I * I1IiiI - OOooOOo . Oo0Ooo / O0 + Ii1I
 if ( oO0 != None ) :
  i1Iii1ii . multi_tenant_eid . store_prefix ( oO0 )
  i1Iii1ii . multi_tenant_eid . instance_id = int ( i1Iii1ii . instance_id )
  lisp . lisp_multi_tenant_interfaces . append ( i1Iii1ii )
  if 67 - 67: OoOoOO00 % Oo0Ooo
 if ( I11i1I1 ) :
  IiiI11III1i = "sudo iptables -t nat -C POSTROUTING -o {} -j MASQUERADE"
  IiiI11III1i = commands . getoutput ( IiiI11III1i . format ( OoO0O ) )
  if ( IiiI11III1i != "" ) :
   OOo0o0 = lisp . lisp_get_loopback_address ( )
   if ( OOo0o0 ) :
    oOOoO = "sudo iptables -t nat -A POSTROUTING -s {} -j ACCEPT"
    os . system ( oOOoO . format ( OOo0o0 ) )
    if 1 - 1: II111iiii
   oOOoO = "sudo iptables -t nat -A POSTROUTING -o {} -j MASQUERADE"
   os . system ( oOOoO . format ( OoO0O ) )
   os . system ( "sudo sysctl net.ipv4.ip_forward=1" )
   if 44 - 44: i11iIiiIii
   if 63 - 63: I11i . I1IiiI . I1ii11iIi11i * Ii1I
   if 43 - 43: o0oOOo0O0Ooo + OoO0O00 - o0oOOo0O0Ooo - OoooooooOO / OoOoOO00 + O0
 lisp . lisp_iid_to_interface [ II1i1iI1 ] = i1Iii1ii
 ...
 if ( "SO_BINDTODEVICE" in dir ( socket ) ) : i1Iii1ii . set_socket ( OoO0O )
 if ( "PF_PACKET" in dir ( socket ) ) : i1Iii1ii . set_bridge_socket ( OoO0O )
 ...
 if 31 - 31: IiII . oO0o
 if ( i1iI1i11II != None and lisp . lisp_program_hardware ) :
  O0O0Ooooo000 = "ip verify unicast source reachable-via rx"
  lisp . lisp_send_to_arista ( O0O0Ooooo000 , OoO0O )
  O0O0Ooooo000 = 'sysctl -w "net.ipv4.conf.{}.rp_filter=0"' . format ( OoO0O )
...
def lisp_show_dynamic_eid_command ( parm ) :
 ...
 for iIIIIi in iiIii . dynamic_eids . values ( ) :
  Oo0o0OOo0Oo0 = iIIIIi . dynamic_eid . print_address ( )
  Oo0OOOOOOOo0O = lisp . lisp_print_elapsed ( iIIIIi . uptime )
  I1III = str ( iIIIIi . timeout ) + " secs"
  if ( OoiIIIiIi1I1i == "ITR" ) :
   ii1I1IIi = lisp . lisp_print_elapsed ( iIIIIi . last_packet )
   i1iiI11I += lisp_table_row ( Oo0o0OOo0Oo0 , iIIIIi . interface , Oo0OOOOOOOo0O , ii1I1IIi , I1III )
  else :
   i1iiI11I += lisp_table_row ( Oo0o0OOo0Oo0 , iIIIIi . interface , Oo0OOOOOOOo0O , I1III )
   if 67 - 67: ooOoO0o % iII111i
...
def lisp_clear_decap_stats ( command ) :
 o00oo00oo = command . split ( "%" ) [ 1 ]
 lisp . lisp_decap_stats [ o00oo00oo ] = lisp . lisp_stats ( )
...
def lisp_show_decap_stats ( output , etr_or_rtr ) :
 OOOOO0ooOOOoo = etr_or_rtr . upper ( )
 I11IiI1I11i1i = etr_or_rtr . lower ( )
 if 76 - 76: iIii1I11I1II1 * I1Ii111 / I1IiiI
 iIIi11 = [ ]
 for I1I111iIi in lisp . lisp_decap_stats :
  ooOO0O00O = "<a href='/lisp/clear/{}/stats/{}'>{}</a>" . format ( I11IiI1I11i1i , I1I111iIi , I1I111iIi )
  iIIi11 . append ( ooOO0O00O )
  if 31 - 31: iIii1I11I1II1
  if 78 - 78: I1Ii111
 ooOo0oO = "LISP-{} Decapsulation Stats:" . format ( OOOOO0ooOOOoo )
 output += lisp_table_header ( ooOo0oO , * iIIi11 )
 if 34 - 34: OOooOOo - OoO0O00
 iIIi11 = [ ]
 for iII1iII in lisp . lisp_decap_stats . values ( ) :
  iIIi11 . append ( iII1iII . get_stats ( False , True ) )
  if 33 - 33: iII111i
...
def lisp_show_crypto_list ( xtr ) :
 i1iiI11I = ""
 i11i1IIi = len ( lisp . lisp_crypto_keys_by_nonce ) != 0
 if 81 - 81: II111iiii / i1IIi * OoOoOO00 + o0oOOo0O0Ooo
 ...
 "Key Material" )
   for I1I111iIi in lisp . lisp_crypto_keys_by_nonce :
    ...
    for ii11I1IiIIi1i1IIi in oo00oO0O0 :
     if ( ii11I1IiIIi1i1IIi == None ) : continue
     oooOo = lisp . lisp_print_elapsed ( ii11I1IiIIi1i1IIi . uptime )
     o0Oo = ii11I1IiIIi1i1IIi . print_keys ( False )
     i1iiI11I += lisp_table_row ( i1ii1i1i1 , oooOo , ii11I1IiIIi1i1IIi . key_id , o0Oo )
     i1ii1i1i1 = ""
     if 33 - 33: I11i * iII111i + iIii1I11I1II1 - I1ii11iIi11i
     if 11 - 11: II111iiii + OoOoOO00 * I11i
   i1iiI11I += lisp_table_footer ( )
   if 45 - 45: iII111i . O0 - I1IiiI
 ...
 "Rekey Count" , "Use Count" , "Key-ID" , "Key Material" )
  for I1I111iIi in lisp . lisp_crypto_keys_by_rloc_encap :
   ...
   for ii11I1IiIIi1i1IIi in oo00oO0O0 :
    if ( ii11I1IiIIi1i1IIi == None ) : continue
    oooOo = lisp . lisp_print_elapsed ( ii11I1IiIIi1i1IIi . uptime )
    oO00oOOOO = lisp . lisp_print_elapsed ( ii11I1IiIIi1i1IIi . last_rekey )
    o0Oo = ii11I1IiIIi1i1IIi . print_keys ( False )
    i1iiI11I += lisp_table_row ( i1ii1i1i1 , oooOo , oO00oOOOO , ii11I1IiIIi1i1IIi . rekey_count ,
 ii11I1IiIIi1i1IIi . use_count , ii11I1IiIIi1i1IIi . key_id , o0Oo )
    i1ii1i1i1 = ""
    if 54 - 54: I11i * OoooooooOO
