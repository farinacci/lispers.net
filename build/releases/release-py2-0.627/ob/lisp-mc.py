...
for iiI111I1iIiI in i1 :
 ...
 for IIooooo in oOOo0oOo0 :
  ...
  oooO0 = IIooooo [ "nh-interface" ] [ 0 ] if ( "nh-interface" in IIooooo ) else ""
  iIiIiiIIiIIi = IIooooo [ "nh-interface-state" ] if ( "nh-interface-state" in IIooooo ) else ""
  if ( iIiIiiIIiIIi == "up-state" or iIiIiiIIiIIi == "" ) :
   if ( oooO0 != "" ) : oO0OOOO0 = o000o0o00o0Oo ( oooO0 ) + ": "
  else :
   if ( oooO0 != "" ) : oO0OOOO0 = Oooo0000 ( oooO0 ) + ": "
   if 26 - 26: OoOO0ooOOoo0O
  if ( "is-active" in IIooooo and IIooooo [ "is-active" ] == True ) : oO0OOOO0 = "*" + oO0OOOO0
  if 35 - 35: OoOO0ooOOoo0O - I1IiiI % o0oOOo0O0Ooo . OoooooooOO % OoOO0ooOOoo0O
  print ( "    {}{}" . format ( oO0OOOO0 , OO ( IIooooo ) ) )
