...
for iiI111I1iIiI in i1 :
 ...
 for IIooooo in oOOo0oOo0 :
  IIIII11I1IiI = "RLOC"
  if ( "mrloc" in IIooooo ) : IIIII11I1IiI = "mRLOC"
  if ( "rle-node" in IIooooo ) : IIIII11I1IiI = "RLE"
  ...
  if ( "nh-node" not in IIooooo ) :
   oO00OOoO00 = IIooooo [ "address" ]
   if ( "encap-port" in IIooooo ) : oO00OOoO00 += ":{}" . format ( IIooooo [ "encap-port" ] )
   IiI111111IIII = IIooooo [ "state" ]
   IiI111111IIII = II1i ( IiI111111IIII ) if IiI111111IIII == "up-state" else Oooo0000 ( IiI111111IIII )
   i1Ii = Oooo0000 ( oO00OOoO00 )
   if 14 - 14: o0000oOoOoO0o
   oO00OOoO00 = "  {} {}, state {} since {}" . format ( IIIII11I1IiI , i1Ii , IiI111111IIII , IIooooo [ "uptime" ] )
   if ( "encap-crypto" in IIooooo ) :
    oO00OOoO00 += ", {}" . format ( IIooooo [ "encap-crypto" ] )
    if 11 - 11: o00O0oo * I1IiiI . iIii1I11I1II1 % OoooooooOO + o0000oOoOoO0o
   if ( "rloc-name" in IIooooo ) :
    oO00OOoO00 += ", {}" . format ( o000o0o00o0Oo ( IIooooo [ "rloc-name" ] ) )
    if 78 - 78: OoO0O00 . ii11ii1ii + OoO0O00 / OoOO / OoO0O00
   if ( I1IiI and "rloc-memory" in IIooooo ) : oO00OOoO00 += ", " + IIooooo [ "rloc-memory" ]
   print ( oO00OOoO00 )
   if 54 - 54: OoOoOO00 % o0000oOoOoO0o
  IIiII111iiI1I = o000o0o00o0Oo ( IIooooo [ "nh-interface" ] [ 0 ] ) + ": " if ( "nh-interface" in IIooooo ) else ""
  if ( "is-active" in IIooooo and IIooooo [ "is-active" ] == True ) : IIiII111iiI1I = "*" + IIiII111iiI1I
  if 11 - 11: II111iiii * II111iiii % iIii1I11I1II1 * oO0o0ooO0 + OoOoOO00 / I1IiiI
  print ( "    {}{}" . format ( IIiII111iiI1I , OO ( IIooooo ) ) )
  i1iiIII111ii , ii1Ii11I , o00o0 = i11IiIiiIIIII ( IIooooo )
  print ( "    rtts {}, hops {}, latencies {}" . format ( i1iiIII111ii , ii1Ii11I , o00o0 ) )
  if 45 - 45: O0
 print ( )
 if 26 - 26: OoOO - iIii1I11I1II1 - I1IiiI / OoO0O00 . OoOoOO00 % iIii1I11I1II1
...
if ( o00oOO0 and i1i == False ) :
 ...
 if 47 - 47: o0000oOoOoO0o - OoOO0ooOOoo0O . II111iiii + OoooooooOO . i11iIiiIii
 if 94 - 94: o0oOOo0O0Ooo * OoOO0ooOOoo0O / Oo0Ooo / OoOO0ooOOoo0O
exit ( 0 )
if 87 - 87: Oo0Ooo . o00O0oo
if 75 - 75: IIII + OoOoOO00 + o0oOOo0O0Ooo * OoOO % OOooOOo . o0000oOoOoO0o
if 55 - 55: ii11ii1ii . I1IiiI
if 61 - 61: Oo0Ooo % o00O0oo . Oo0Ooo
