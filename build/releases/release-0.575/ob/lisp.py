...
def lisp_process_map_reply ( lisp_sockets , packet , source , ttl , itr_in_ts ) :
 ...
 for iIi1iIIIiIiI in range ( iIII1111IiIII . record_count ) :
  ...
  if ( iII1iii1iII1iI1II ) :
   o0ooo0oOO0o = lisp_map_cache . lookup_cache ( IiIo0oo0O . group , True )
   if ( o0ooo0oOO0o ) :
    o0ooo0oOO0o = o0ooo0oOO0o . lookup_source_cache ( IiIo0oo0O . eid , False )
  ...
  if ( o0ooo0oOO0o == None ) :
   OOOi11i , iIiiiI1 , II11iiiII1Ii = lisp_allow_gleaning ( IiIo0oo0O . eid , IiIo0oo0O . group ,
 None )
   if ( OOOi11i ) : continue
  else :
  ...
  OOOo0O00OO00O = [ ]
  OOO0 = None
  for I11ii1IiI1Ii in range ( IiIo0oo0O . rloc_count ) :
   IiiI1 = lisp_rloc_record ( )
   ...
   iIi111I1i1Ii1 = None
   if ( o0ooo0oOO0o ) : iIi111I1i1Ii1 = o0ooo0oOO0o . get_rloc ( IiiI1 . rloc )
   if ( iIi111I1i1Ii1 ) :
...
def lisp_send_merged_map_notify ( lisp_sockets , parent , map_register ,
 ...
 for oOOOoO0 in parent . registered_rlocs :
  IiiI1 = lisp_rloc_record ( )
  IiiI1 . store_rloc_entry ( oOOOoO0 )
  IiiI1 . local_bit = True
  IiiI1 . probe_bit = False
  IiiI1 . reach_bit = True
  Ii1IIIi1 += IiiI1 . encode ( )
  IiiI1 . print_record ( "  " )
  del ( IiiI1 )
...
def lisp_process_map_register ( lisp_sockets , packet , source , sport ) :
 ...
 IiIo0oo0O . rloc_count - I11ii1IiI1Ii - 1 )
     break
...
def lisp_process_rloc_probe_timer ( lisp_sockets ) :
 ...
 for I1i1IIIi1iii in list ( lisp_rloc_probe_list . values ( ) ) :
  ...
  for o0oOO00 , i1I1I1IIIi11 , o0o0Oo0o0oOo in I1i1IIIi1iii :
   ...
   if 11 - 11: OoooooooOO
   if 85 - 85: O0 * i1IIi
   OOOi11i , iIi11I , II11iiiII1Ii = lisp_allow_gleaning ( i1I1I1IIIi11 , None , o0oOO00 )
   if ( OOOi11i and iIi11I == False ) :
 ...
 red ( O0O0 , False ) , II1iIi1ii1IIi ) )
    ...
    if ( I1Ii1i111I . rloc_name != None ) :
     ...
     if 14 - 14: OOooOOo
    lprint ( "Send {}{} {}, last rtt: {}{}" . format ( iii1IIi11 , ii1oO00o ,
...
def lisp_process_rloc_probe_reply ( rloc_entry , source , port , map_reply , ttl , mrloc ) :
 ...
 if ( IiI not in oOoOOoO0o ) :
  ...
  if ( IiI not in oOoOOoO0o ) :
   ...
   if ( IiI not in oOoOOoO0o ) :
    IiI += ":" + str ( port )
    lprint ( "    Received unsolicited {} from {}/{}, port {}" . format ( iii1IIi11 , red ( O0o , False ) , red ( I1IIi1Iiii11I ,
    # i1IIi / O0
 False ) , port ) )
    return
...
def lisp_encapsulate_rloc_probe ( lisp_sockets , rloc , nat_info , packet ) :
 ...
 lprint ( ( "Data encapsulate {} to {}{} port {} for " + "NAT-traversal" ) . format ( iii1IIi11 , IIi11IiiiI11i , iiI1I , packet . encap_port ) )
...
def lisp_process_igmp_packet ( packet ) :
 ...
 bold ( IIiI11I1I1i1i , False ) ) )
  ...
  for I11ii1IiI1Ii in range ( OOOO0OOO ) :
