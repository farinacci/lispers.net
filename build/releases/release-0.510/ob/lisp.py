...
class lisp_dynamic_eid ( ) :
 ...
 def get_timeout ( self , interface ) :
  try :
   i1Iiooo00ooOO0 = lisp_myinterfaces [ interface ]
   self . timeout = i1Iiooo00ooOO0 . dynamic_eid_timeout
  except :
   self . timeout = LISP_DEFAULT_DYN_EID_TIMEOUT
...
def lisp_lookup_group ( group ) :
 Oo0000oo0O = None
 for o0oO in lisp_group_mapping_list . values ( ) :
  iIi1iii1 = lisp_is_group_more_specific ( group , o0oO )
  if ( iIi1iii1 == - 1 ) : continue
  if ( Oo0000oo0O == None or iIi1iii1 > Oo0000oo0O . group_prefix . mask_len ) : Oo0000oo0O = o0oO
  if 69 - 69: ooOoO0o
 return ( Oo0000oo0O )
...
class lisp_site_eid ( ) :
 ...
 def print_flags ( self , html ) :
  if ( html == False ) :
   ...
   # ooOoO0o + I1ii11iIi11i * I1IiiI / OoO0O00 / OoooooooOO
 "S" if self . lisp_sec_present else "s" ,
 "I" if self . xtr_id_present else "i" ,
 ...
 "N" if self . map_notify_requested else "n" )
   ...
   Oo0Ooo0O0 = ""
   for i1i111Ii1iII1 in I11ii1i1I :
    OoiI1iII1Ii111I = lisp_site_flags [ i1i111Ii1iII1 . upper ( ) ]
    OoiI1iII1Ii111I = OoiI1iII1Ii111I . format ( "" if i1i111Ii1iII1 . isupper ( ) else "not " )
    Oo0Ooo0O0 += lisp_span ( i1i111Ii1iII1 , OoiI1iII1Ii111I )
    if ( i1i111Ii1iII1 . lower ( ) != "n" ) : Oo0Ooo0O0 += "-"
 ...
 def build_sort_key ( self ) :
  OO0O0O = lisp_cache ( )
  o00O0Oo , ii1i1I1111ii = OO0O0O . build_key ( self . eid )
  oOOOo0 = ""
  if ( self . group . is_null ( ) == False ) :
   o0o0oOo00Oo , oOOOo0 = OO0O0O . build_key ( self . group )
   oOOOo0 = "-" + oOOOo0 [ 0 : 12 ] + "-" + str ( o0o0oOo00Oo ) + "-" + oOOOo0 [ 12 : : ]
   if 90 - 90: I1Ii111 * OoooooooOO . iIii1I11I1II1 % OoO0O00 / I11i + iII111i
  ii1i1I1111ii = ii1i1I1111ii [ 0 : 12 ] + "-" + str ( o00O0Oo ) + "-" + ii1i1I1111ii [ 12 : : ] + oOOOo0
  del ( OO0O0O )
  return ( ii1i1I1111ii )
 ...
 def merge_in_site_eid ( self , child ) :
  ...
  if ( self . group . is_null ( ) ) :
   ...
   iiIIiIiiII = self . merge_rles_in_site_eid ( )
   if 23 - 23: II111iiii / iII111i
 ...
 def copy_rloc_records ( self ) :
  ...
  for iIII in self . registered_rlocs :
   oOOo0O000O0O . append ( copy . deepcopy ( iIII ) )
 ...
 def merge_rlocs_in_site_eid ( self ) :
  ...
  oOOo0O000O0O = [ ]
  for iIII in self . registered_rlocs :
   if ( iIII . rloc . is_null ( ) or len ( oOOo0O000O0O ) == 0 ) :
    oOOo0O000O0O . append ( iIII )
    continue
    if 95 - 95: II111iiii + II111iiii + iII111i
   for II11iiI11III1 in oOOo0O000O0O :
    if ( II11iiI11III1 . rloc . is_null ( ) ) : continue
    if ( iIII . rloc . is_exact_match ( II11iiI11III1 . rloc ) ) : break
    if 38 - 38: I1Ii111 + Ii1I * OOooOOo + O0
   if ( II11iiI11III1 == oOOo0O000O0O [ - 1 ] ) : oOOo0O000O0O . append ( iIII )
   if 44 - 44: OoooooooOO + OoO0O00 % OoOoOO00 * I1Ii111 . I1Ii111
  self . registered_rlocs = oOOo0O000O0O
 ...
 def merge_rles_in_site_eid ( self ) :
  ...
  for iIII in self . registered_rlocs :
   ...
   for iIIII1iiIII in iIII . rle . rle_nodes :
    ...
    oOoOOo00O0O [ IiiIIi1 ] = iIIII1iiIII . address
  ...
  for iIII in self . registered_rlocs :
   ...
   if ( iIII . rle == None ) : Ooo . append ( iIII )
   if 88 - 88: o0oOOo0O0Ooo % I1Ii111
  self . registered_rlocs = Ooo
  ...
  for oO00Oooo0o0o0 in self . individual_registrations . values ( ) :
   if ( oO00Oooo0o0o0 . registered == False ) : continue
   IiIi1iiI1i = oO00Oooo0o0o0 . registered_rlocs [ 0 ] . rle
   if ( IiIi1iiI1i == None ) : continue
   if 82 - 82: OoO0O00
   IiIi1I1i1iII = oO00Oooo0o0o0 . registered_rlocs [ 0 ] . rloc_name
   for o00OoO0O00 in IiIi1iiI1i . rle_nodes :
    IiiIIi1 = o00OoO0O00 . address . print_address_no_iid ( )
    if ( IiII1I1I1i1 . has_key ( IiiIIi1 ) ) : break
    if 97 - 97: I1Ii111 % i11iIiiIii / O0
    iIIII1iiIII = lisp_rle_node ( )
    iIIII1iiIII . address . copy_address ( o00OoO0O00 . address )
    iIIII1iiIII . level = o00OoO0O00 . level
    iIIII1iiIII . rloc_name = IiIi1I1i1iII
    i1I1Ii11II1i . rle_nodes . append ( iIIII1iiIII )
    IiII1I1I1i1 [ IiiIIi1 ] = o00OoO0O00 . address
    if 67 - 67: oO0o . ooOoO0o % iIii1I11I1II1 * O0 % Oo0Ooo
    if 75 - 75: I1Ii111
  ...
  if ( len ( self . registered_rlocs ) != 0 ) :
   ...
   if 10 - 10: OOooOOo
  if ( oOoOOo00O0O . keys ( ) == IiII1I1I1i1 . keys ( ) ) : return ( False )
  ...
  # I11i
 oOoOOo00O0O . keys ( ) , IiII1I1I1i1 . keys ( ) ) )
  if 73 - 73: OoOoOO00
  return ( True )
...
class lisp_mr ( ) :
 ...
 time . time ( ) - self . last_dns_resolve < 30 ) : return
  ...
  for O0o00000o0O in lisp_map_resolvers_list . values ( ) :
   ...
   if ( OO0o in IIi1111111 ) : continue
...
class lisp_ms ( ) :
 ...
 time . time ( ) - self . last_dns_resolve < 30 ) : return
  ...
  for IiiIIi1 in IIi1111111 [ 1 : : ] :
   ...
   if ( OooOoOoo0OOoo != None and OooOoOoo0OOoo . a_record_index == IIi1111111 . index ( IiiIIi1 ) ) :
    continue
    if 11 - 11: OOooOOo
   OooOoOoo0OOoo = copy . deepcopy ( self )
   OooOoOoo0OOoo . map_server . store_address ( IiiIIi1 )
   OooOoOoo0OOoo . a_record_index = IIi1111111 . index ( IiiIIi1 )
