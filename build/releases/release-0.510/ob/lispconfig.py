...
def lisp_show_db_list ( itr_or_etr , output ) :
 ...
 for OOOooOO0oO in lisp . lisp_db_list :
  ...
  if ( OOOooOO0oO . dynamic_eid_configured ( ) ) :
   ...
   Iii1Iii = ( "<br><a href='/lisp/show/{}/dynamic-eid/{}'>" + "{} dynamic-eids</a>" ) . format ( OoiIIIiIi1I1i , o0ooO00o00 , iiIIIII )
   if 25 - 25: OoO0O00
  ...
  for i1iIIiiIiII in OOOooOO0oO . rloc_set :
   ...
   if ( itr_or_etr == "ITR" ) :
    output += lisp_table_row ( oo , Oo000o , Ii ,
