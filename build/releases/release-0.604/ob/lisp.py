...
def lisp_is_group_more_specific ( group_str , group_mapping ) :
 oO0O = group_mapping . group_prefix . instance_id
 i111iii1i1 = group_mapping . group_prefix . mask_len
 iII1I1i = lisp_address ( LISP_AFI_IPV4 , group_str , 32 , oO0O )
 if ( iII1I1i . is_more_specific ( group_mapping . group_prefix ) ) : return ( i111iii1i1 )
 return ( - 1 )
...
def lisp_lookup_group ( group ) :
 ...
 for i1iI1IIIi1iIii1 in list ( lisp_group_mapping_list . values ( ) ) :
  i111iii1i1 = lisp_is_group_more_specific ( group , i1iI1IIIi1iIii1 )
  if ( i111iii1i1 == - 1 ) : continue
  if ( Ooo0i11II1IIIIi == None or i111iii1i1 > Ooo0i11II1IIIIi . group_prefix . mask_len ) : Ooo0i11II1IIIIi = i1iI1IIIi1iIii1
  if 64 - 64: OoOoOO00
