...
def ii ( packet , device , input_interface , macs , my_sa ) :
 ...
 if ( IIiIiiiIIIIi1 ) :
  ...
  oOOO = i11 if III1ii == 6 else Oooo0000
  ...
  ooo0O0OO = i1iiIIi11I . rle_nodes [ 0 ] . level
  O0Oooo = len ( packet . packet )
  for oO000 in i1iiIIi11I . rle_forwarding_list :
   if ( oO000 . rloc . up_state ( ) == False ) : continue
   if ( oO000 . level != ooo0O0OO ) : return
   if 7 - 7: IiII * I1IiiI + i1IIi + i11iIiiIii + Oo0Ooo % I1IiiI
   packet . outer_dest . copy_address ( oO000 . rloc . rloc )
   ...
   oO000 . rloc . stats . increment ( len ( packet . packet ) )
   if 45 - 45: Oo0Ooo - o0oOOo0O0Ooo % I1Ii111
   if 38 - 38: I1Ii111 % OOooOOo - OoooooooOO
   if 87 - 87: OoO0O00 % I1IiiI
   if 77 - 77: iIii1I11I1II1 - i1IIi . oO0o
   packet . print_packet ( "Replicate-to-L{}" . format ( oO000 . level ) , True )
   ...
   iiIIii = len ( packet . packet ) - O0Oooo
 ...
 if 31 - 31: Ii1I
def OoOOo00 ( device , not_used , packet ) :
 O00 = 4 if device == "lo0" else 0 if device == "lispers.net" else 14
 if 94 - 94: I11i . I11i + i11iIiiIii - OOooOOo * I1ii11iIi11i
 if ( lisp . lisp_frame_logging ) :
  iIoo0ooooO = lisp . bold ( "Received frame on interface '{}'" . format ( device ) ,
 False )
  iiIIi = lisp . lisp_format_packet ( packet [ 0 : 64 ] )
  lisp . lprint ( "{}: {}" . format ( iIoo0ooooO , iiIIi ) )
 ...
 if ( O00 == 14 ) :
  oOO00O , Oo0 , o0OOOOO0O , oO00OoOOOo = lisp . lisp_get_input_interface ( packet )
  OoOOoOooooOOo = device if ( device in oOO00O ) else oOO00O [ 0 ]
  i1II11Iii1I = lisp . lisp_format_macs ( Oo0 , o0OOOOO0O )
  if ( OoOOoOooooOOo . find ( "vlan" ) != - 1 ) : O00 += 4
  ...
  if ( int ( o0OOOOO0O [ 1 ] , 16 ) & 1 ) : oO00OoOOOo = True
 ...
 if ( O00 != 0 ) :
  ooOO0o = struct . unpack ( "H" , packet [ O00 - 2 : O00 ] ) [ 0 ]
  ooOO0o = socket . ntohs ( ooOO0o )
  if ( ooOO0o == 0x8100 ) :
   oO0O0oO0 = struct . unpack ( "I" , packet [ O00 : O00 + 4 ] ) [ 0 ]
   oO0O0oO0 = socket . ntohl ( oO0O0oO0 )
   OoOOoOooooOOo = "vlan" + str ( oO0O0oO0 >> 16 )
   O00 += 4
  elif ( ooOO0o == 0x806 ) :
 ...
 if ( lisp . lisp_l2_overlay ) : O00 = 0
 if 47 - 47: I11i + ooOoO0o + II111iiii % i11iIiiIii
 ii ( packet [ O00 : : ] , device , OoOOoOooooOOo , i1II11Iii1I , oO00OoOOOo )
 return
...
def OOo00OoO ( sources , dyn_eids ) :
 ...
 if 21 - 21: OOooOOo
 iIiI1I1IIi11 = "sudo ip{}tables -t raw -A lisp -j ACCEPT -d {}"
 I1I1i11 = [ "127.0.0.1" , "::1" , "224.0.0.0/4 -p igmp" , "ff00::/8" ,
 "fe80::/16" ]
 I1I1i11 += sources + lisp . lisp_get_all_addresses ( )
 for i1IiIi1i in I1I1i11 :
  if ( lisp . lisp_is_mac_string ( i1IiIi1i ) ) : continue
  II = "" if i1IiIi1i . find ( ":" ) == - 1 else "6"
  os . system ( iIiI1I1IIi11 . format ( II , i1IiIi1i ) )
 ...
 if ( lisp . lisp_pitr == False ) :
  iIiI1I1IIi11 = "sudo ip{}tables -t raw -A lisp -j ACCEPT -s {} -d {}"
  I11o0000o0Oo = "sudo ip{}tables -t raw -C lisp -j ACCEPT -s {} -d {}"
  for ooOooo000OO00 in sources :
   if ( lisp . lisp_is_mac_string ( ooOooo000OO00 ) ) : continue
   if ( ooOooo000OO00 in dyn_eids ) : continue
   II = "" if ooOooo000OO00 . find ( ":" ) == - 1 else "6"
   for iii11 in sources :
    ...
    if ( iii11 . find ( ":" ) != - 1 and ooOooo000OO00 . find ( ":" ) == - 1 ) : continue
    if ( getoutput ( I11o0000o0Oo . format ( II , ooOooo000OO00 , iii11 ) ) == "" ) :
     continue
     if 90 - 90: iIii1I11I1II1 * II111iiii
    os . system ( iIiI1I1IIi11 . format ( II , ooOooo000OO00 , iii11 ) )
    ...
    if 77 - 77: Oo0Ooo
    if 46 - 46: I1Ii111
 o00OoooooooOo = "sudo ip{}tables -t raw -A lisp -j DROP -s {}"
 for ooOooo000OO00 in sources :
  if ( lisp . lisp_is_mac_string ( ooOooo000OO00 ) ) : continue
  II = "" if ooOooo000OO00 . find ( ":" ) == - 1 else "6"
  os . system ( o00OoooooooOo . format ( II , ooOooo000OO00 ) )
 ...
 oooO00Oo = getoutput ( "sudo iptables -t raw -S lisp" ) . split ( "\n" )
 oooO00Oo += getoutput ( "sudo ip6tables -t raw -S lisp" ) . split ( "\n" )
 lisp . lprint ( "Using kernel filters: {}" . format ( oooO00Oo ) )
 ...
 if ( os . getenv ( "LISP_VIRTIO_BUG" ) != None ) :
  O0o00oO0oOO = ( "sudo iptables -A POSTROUTING -t mangle -p tcp -j " + "CHECKSUM --checksum-fill; " )
  if 49 - 49: iIii1I11I1II1 * i1IIi . OoooooooOO
  O0o00oO0oOO += ( "sudo iptables -A POSTROUTING -t mangle -p udp -j " + "CHECKSUM --checksum-fill; " )
  if 90 - 90: o0oOOo0O0Ooo % I1ii11iIi11i - iIii1I11I1II1 % OoOoOO00
  O0o00oO0oOO += ( "sudo ip6tables -A POSTROUTING -t mangle -p tcp -j " + "CHECKSUM --checksum-fill; " )
  if 8 - 8: OoOoOO00 * Oo0Ooo / IiII % Ii1I - I1IiiI
  O0o00oO0oOO += ( "sudo ip6tables -A POSTROUTING -t mangle -p udp -j " + "CHECKSUM --checksum-fill" )
  if 71 - 71: iII111i
  os . system ( O0o00oO0oOO )
  Iii = lisp . bold ( "virtio" , False )
  lisp . lprint ( "{} bug workaround, configure '{}'" . format ( Iii , O0o00oO0oOO ) )
  if 14 - 14: OOooOOo
 return
 if 79 - 79: Ii1I
...
def o0o0o0o0 ( sources , dyn_eids , l2_overlay , pitr ) :
 ...
 IIi1ii1 = "(not ether proto 0x806)"
 Oo = " or (udp src port 4342 and ip[28] == 0x28)"
 I1Ii = " or (ip[16] >= 224 and ip[16] < 240 and (ip[28] & 0xf0) == 0x30)"
 ...
 for ooOooo000OO00 in sources :
  ...
  if ( lisp . lisp_is_mac_string ( ooOooo000OO00 ) ) :
   Ii1 = ooOooo000OO00 . split ( "/" ) [ 0 ]
   Ii1 = Ii1 . replace ( "-" , "" )
   OOOo = [ ]
   for o0OO0O0Oo in range ( 0 , 12 , 2 ) : OOOo . append ( Ii1 [ o0OO0O0Oo : o0OO0O0Oo + 2 ] )
   Ii1 = "ether host " + ":" . join ( OOOo )
   if 35 - 35: ooOoO0o - OoO0O00 . Oo0Ooo * Oo0Ooo / i11iIiiIii + I1ii11iIi11i
   if 87 - 87: OoOoOO00 % iIii1I11I1II1
  oOOOo0o += "{}" . format ( Ii1 )
  if ( ooOooo000OO00 not in dyn_eids ) : iiiii11I1 += "{}" . format ( Ii1 )
  if ( sources [ - 1 ] == ooOooo000OO00 ) : break
  oOOOo0o += " or "
  if ( ooOooo000OO00 not in dyn_eids ) : iiiii11I1 += " or "
  if 72 - 72: OOooOOo . OOooOOo - I1ii11iIi11i
 if ( iiiii11I1 [ - 4 : : ] == " or " ) : iiiii11I1 = iiiii11I1 [ 0 : - 4 ]
 ...
 for i1IiIi1i in iIiIIiii1II :
  if ( i1IiIi1i == i1Ii11I1II ) : continue
  IIi1i += "{}" . format ( i1IiIi1i )
  if ( iIiIIiii1II [ - 1 ] == i1IiIi1i ) : break
  IIi1i += " or "
  if 44 - 44: OoooooooOO . II111iiii . OOooOOo % OoooooooOO
  if 86 - 86: i11iIiiIii + O0 * IiII - OoO0O00 * OOooOOo + O0
 if ( oOOOo0o != "" ) :
  oOOOo0o = " and (src net {})" . format ( oOOOo0o )
  if 95 - 95: iIii1I11I1II1 . I1Ii111 % iII111i - I1Ii111 * II111iiii
 if ( iiiii11I1 != "" ) :
  iiiii11I1 = " and not (dst net {})" . format ( iiiii11I1 )
 ...
 O00oO0 = IIi1ii1 + oOOOo0o + iiiii11I1 + IIi1i
 O00oO0 += Oo
 O00oO0 += I1Ii
...
def OooOo00o ( device , pfilter , pcap_lock ) :
 ...
 if ( lisp . lisp_is_python2 ( ) ) :
  ...
  iiiii111 . loop ( - 1 , OoOOo00 , device )
  if 93 - 93: oO0o * Ii1I
...
def iIIi1Ii1III ( kv_pair ) :
 ...
 for o0OO0O0Oo in range ( len ( kv_pair [ "eid-prefix" ] ) ) :
  o0 = kv_pair [ "eid-prefix" ] [ o0OO0O0Oo ]
  iIIIIi = kv_pair [ "lookup-length" ] [ o0OO0O0Oo ]
  iIIIIi = int ( iIIIIi )
  ...
  ii1IIiII111I = 0
  if ( "instance-id" in kv_pair and len ( kv_pair [ "instance-id" ] ) > o0OO0O0Oo ) :
   if ( kv_pair [ "instance-id" ] [ o0OO0O0Oo ] != "" ) :
    try :
     ii1IIiII111I = int ( kv_pair [ "instance-id" ] [ o0OO0O0Oo ] )
    except :
     ii1IIiII111I = 0
  ...
  iIi1i11 = lisp . lisp_address ( lisp . LISP_AFI_NONE , "" , 0 , 0 )
  iIi1i11 . store_prefix ( o0 )
  iIi1i11 . instance_id = ii1IIiII111I
  if 25 - 25: I1IiiI % O0 + i1IIi - ooOoO0o
  if 38 - 38: o0oOOo0O0Ooo % I1Ii111 + i11iIiiIii + iII111i + ooOoO0o / i11iIiiIii
  if 94 - 94: iII111i - Oo0Ooo + oO0o
  if 59 - 59: I11i . I1IiiI - iIii1I11I1II1 + iIii1I11I1II1
  if ( iIIIIi < iIi1i11 . mask_len ) :
   lisp . lprint ( "decent-lookup error, EID-prefix {} length > than lookup-length {}" . format ( iIi1i11 . print_prefix ( ) , iIIIIi ) )
  ...
  iIiI1I1IIi11 = True
  for ooO0oooOO0 , i11ii in lisp . lisp_decent_lookup_prefixes . items ( ) :
   if ( iIi1i11 . is_exact_match ( ooO0oooOO0 ) and i11ii == iIIIIi ) : iIiI1I1IIi11 = False
   if 83 - 83: I1ii11iIi11i * I1ii11iIi11i + OOooOOo
   if 57 - 57: O0 - O0 . I1ii11iIi11i / o0oOOo0O0Ooo / Ii1I
  if ( iIiI1I1IIi11 ) :
   lisp . lisp_decent_lookup_prefixes [ iIi1i11 ] = iIIIIi
   lisp . lprint ( "decent-prefix configured, EID-prefix {} -> lookup-length {}" . format ( iIi1i11 . print_prefix ( ) , iIIIIi ) )
...
def I1i ( kv_pair ) :
 ...
 Ii11iiI = lisp . lisp_nat_traversal
 o0OO0oooo = lisp . lisp_rloc_probing
 ...
 oo = ( Ii11iiI == False and lisp . lisp_nat_traversal and lisp . lisp_rloc_probing )
 if 30 - 30: O0 + OOooOOo % Oo0Ooo . i1IIi
 I111 = ( o0OO0oooo == False and lisp . lisp_rloc_probing )
 ...
 if ( i1Ii1i1 != 0 ) :
  oOoO = [ iiI1iIiI , i111I ,
 oO0oIIII , Oooo0000 ]
  lisp . lisp_start_rloc_probe_timer ( i1Ii1i1 , oOoO )
 ...
 if ( lisp . lisp_crypto_ephem_port == None and lisp . lisp_data_plane_security ) :
  ...
  i1Ii11II = { "type" : "itr-crypto-port" , "port" : IiIiI1I1I1 }
  lisp . lisp_write_to_dp_socket ( i1Ii11II )
 ...
 if 35 - 35: I11i
def o00oo ( ipc ) :
 O0oO0oo0O , oooOOO0ooOoOOO , o0IiIiI111IIII1 , O00O0 = ipc . split ( "%" )
 O00O0 = int ( O00O0 , 16 )
 if 100 - 100: OOooOOo * O0 + I1IiiI + OoOoOO00 . OOooOOo
 OO0 = lisp . lisp_get_echo_nonce ( None , o0IiIiI111IIII1 )
 if ( OO0 == None ) : OO0 = lisp . lisp_echo_nonce ( o0IiIiI111IIII1 )
 ...
 if ( oooOOO0ooOoOOO == "R" ) :
  OO0 . request_nonce_rcvd = O00O0
  OO0 . last_request_nonce_rcvd = lisp . lisp_get_timestamp ( )
  OO0 . echo_nonce_sent = O00O0
  OO0 . last_new_echo_nonce_sent = lisp . lisp_get_timestamp ( )
  lisp . lprint ( "Start echo-nonce mode for {}, nonce 0x{}" . format ( lisp . red ( OO0 . rloc_str , False ) , lisp . lisp_hex_string ( O00O0 ) ) )
  if 66 - 66: OoO0O00
  if 72 - 72: I1Ii111
  if 91 - 91: II111iiii / IiII + iIii1I11I1II1 . I11i - O0
 if ( oooOOO0ooOoOOO == "E" ) :
  OO0 . echo_nonce_rcvd = O00O0
  OO0 . last_echo_nonce_rcvd = lisp . lisp_get_timestamp ( )
  if 70 - 70: Ii1I * oO0o - I11i + Oo0Ooo % I1ii11iIi11i - IiII
  if ( OO0 . request_nonce_sent == O00O0 ) :
   ooo = lisp . bold ( "echoed nonce" , False )
   lisp . lprint ( "Received {} {} from {}" . format ( ooo ,
 lisp . lisp_hex_string ( O00O0 ) ,
 lisp . red ( OO0 . rloc_str , False ) ) )
   if 75 - 75: iIii1I11I1II1 % IiII + I1ii11iIi11i * O0 . iII111i - ooOoO0o
   OO0 . request_nonce_sent = None
   lisp . lprint ( "Stop request-nonce mode for {}" . format ( lisp . red ( OO0 . rloc_str , False ) ) )
   if 32 - 32: Ii1I % oO0o - i1IIi
   OO0 . last_good_echo_nonce_rcvd = lisp . lisp_get_timestamp ( )
  else :
   Ii11III = "none"
   if ( OO0 . request_nonce_sent ) :
    Ii11III = lisp . lisp_hex_string ( OO0 . request_nonce_sent )
   ...
   # iII111i + I11i + ooOoO0o + iII111i / i1IIi
 lisp . red ( OO0 . rloc_str , False ) , Ii11III ) )
...
iII1IIiiI11II = {
 ...
 "lisp decent-prefix" : [ iIIi1Ii1III , {
 "instance-id" : [ False , 0 , 0xffffffff ] ,
 "eid-prefix" : [ True ] ,
 "lookup-length" : [ True , 0 , 128 ] } ] ,

 "lisp database-mapping" : [ OOooOO , {
 "prefix" : [ ] ,
 "mr-name" : [ True ] ,
 "ms-name" : [ True ] ,
 "instance-id" : [ True , 0 , 0xffffffff ] ,
...
oO = True
iIi = [ i111I ] * 3
oo0ooO = [ II1Ii1iI1i , II1Ii1iI1i ,
 oO0oIIII ]
if 97 - 97: I1Ii111 . I11i / I1IiiI
while ( True ) :
 try : o00OO0o0 , i1II1IiiIi , O0oO0oo0O = select . select ( OOOO0O0OOoo , [ ] , [ ] )
 except : break
 ...
 if ( lisp . lisp_ipc_data_plane and Oo0oO0oo0oO00 in o00OO0o0 ) :
 ...
 if ( i111I in o00OO0o0 ) :
  oooOOO0ooOoOOO , ooOooo000OO00 , IiIiI1I1I1 , I11iI1I = lisp . lisp_receive ( iIi [ 0 ] ,
 False )
  ...
  lisp . lisp_parse_packet ( iIi , I11iI1I , ooOooo000OO00 , IiIiI1I1I1 )
 ...
 if ( II1Ii1iI1i in o00OO0o0 ) :
  oooOOO0ooOoOOO , ooOooo000OO00 , IiIiI1I1I1 , I11iI1I = lisp . lisp_receive ( oo0ooO [ 0 ] ,
 False )
  if ( ooOooo000OO00 == "" ) : break
  ...
  o00o0o000Oo = lisp . lisp_parse_packet ( oo0ooO , I11iI1I , ooOooo000OO00 , IiIiI1I1I1 )
  ...
  if ( o00o0o000Oo ) :
   oOoO = [ iiI1iIiI , i111I ,
 oO0oIIII , Oooo0000 ]
   lisp . lisp_start_rloc_probe_timer ( 0 , oOoO )
 ...
 if ( oO0oIIII in o00OO0o0 ) :
  oooOOO0ooOoOOO , ooOooo000OO00 , IiIiI1I1I1 , I11iI1I = lisp . lisp_receive ( oO0oIIII , True )
  if 5 - 5: OOooOOo % Oo0Ooo % IiII % ooOoO0o
  if ( ooOooo000OO00 == "" ) : break
  if 17 - 17: Ii1I + II111iiii + OoooooooOO / OOooOOo / IiII
  if ( oooOOO0ooOoOOO == "command" ) :
   ...
   lispconfig . lisp_process_command ( oO0oIIII , oooOOO0ooOoOOO ,
 I11iI1I , "lisp-itr" , [ iII1IIiiI11II ] )
  elif ( oooOOO0ooOoOOO == "api" ) :
   I11iI1I = I11iI1I . decode ( )
   lisp . lisp_process_api ( "lisp-itr" , oO0oIIII , I11iI1I )
  elif ( oooOOO0ooOoOOO == "data-packet" ) :
   ii ( I11iI1I , "ipc" )
  else :
