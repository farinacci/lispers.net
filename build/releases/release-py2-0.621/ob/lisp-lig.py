...
def iIIi1i1 ( record_count , nonce , packet ) :
 ...
 for OOooOO000 in range ( record_count ) :
  ...
  for iiIi1I1iIIi in range ( OOoOoo . rloc_count ) :
   ...
   print ( "  RLOC: {}, up/uw/mp/mw: {}/{}/{}/{}, flags: {}{}{}" . format ( iii . rloc . print_address_no_iid ( ) , II1I , iii .
   # iII111i
 ...
 ", RTR" if II1I == 254 and O0i1II1Iiii1I11 == 255 else "" ) )
   ...
   if ( iii . elp ) :
    IIi1I11I1II = iii . elp . print_elp ( False )
    print ( "        elp: {}" . format ( IIi1I11I1II ) )
    if 63 - 63: OoooooooOO - OoO0O00 . II111iiii / o0oOOo0O0Ooo . OoOoOO00 / O0
   if ( iii . rle ) :
    o0OOOO00O0Oo = iii . rle . print_rle ( False , True )
    print ( "        rle: {}" . format ( o0OOOO00O0Oo ) )
    if 48 - 48: O0
   if ( iii . json ) :
    I1IiiIIIi = iii . json . print_json ( False )
    print ( "        json: {}" . format ( I1IiiIIIi ) )
    if 41 - 41: Ii1I - O0 - O0
   iii . print_record ( "  " )
