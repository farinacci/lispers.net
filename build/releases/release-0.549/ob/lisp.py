...
def lisp_store_pubsub_state ( reply_eid , itr_rloc , mr_sport , nonce , ttl , xtr_id ) :
 ...
 OOo . add ( reply_eid )
 return ( OOo )
 if 47 - 47: ooOoO0o / i11iIiiIii - I1Ii111 % Ii1I / OoO0O00
 if 93 - 93: iII111i + I11i / OoOoOO00
...
def lisp_convert_reply_to_notify ( packet ) :
 ...
 O0o0Ooo00OOO = struct . unpack ( "I" , packet [ 0 : 4 ] ) [ 0 ]
 O0o0Ooo00OOO = socket . ntohl ( O0o0Ooo00OOO ) & 0xff
 O0oo00o000 = packet [ 4 : 12 ]
 packet = packet [ 12 : : ]
 if 90 - 90: iII111i + I11i % OoooooooOO + Oo0Ooo . OoO0O00
 if 22 - 22: ooOoO0o - o0oOOo0O0Ooo + I11i / I1IiiI + OOooOOo
 if 10 - 10: oO0o / I1IiiI
 if 95 - 95: II111iiii - IiII % IiII . o0oOOo0O0Ooo
 i1IIi1ii1i1ii = ( LISP_MAP_NOTIFY << 28 ) | O0o0Ooo00OOO
...
def lisp_notify_subscribers ( lisp_sockets , eid_record , rloc_records ,
 ...
 for Iiii11 in lisp_pubsub_cache :
  for OOo in lisp_pubsub_cache [ Iiii11 ] . values ( ) :
   I1i = OOo . eid_prefix
   ...
   OoO0o00O0oOOo = "0x" + lisp_hex_string ( OOo . xtr_id )
   O0oo00o000 = "0x" + lisp_hex_string ( OOo . nonce )
   if 5 - 5: I1Ii111 * I1IiiI * O0 + I1Ii111
   lprint ( "    Notify {} {}:{} xtr-id {} for {}, nonce {}" . format ( OOOo00OOoO , iiI , IiO0o , OoO0o00O0oOOo , green ( Iiii11 , False ) , O0oo00o000 ) )
   ...
   lisp_build_map_notify ( lisp_sockets , IIi11 , [ Iiii11 ] , 1 , OO ,
 IiO0o , OOo . nonce , 0 , 0 , 0 , site , False )
...
def lisp_process_pubsub ( lisp_sockets , packet , reply_eid , itr_rloc , port , nonce ,
 ...
 OOo = lisp_store_pubsub_state ( reply_eid , itr_rloc , port , nonce , ttl ,
 xtr_id )
...
def lisp_ms_process_map_request ( lisp_sockets , packet , map_request , mr_source ,
 ...
 iIIii = True
 oOoO = ( lisp_get_eid_hash ( oOooOOo000o0o ) != None )
 if ( oOoO ) :
  ...
  if ( IIIiiiIi1I1 == None ) :
   ...
   IIi1i1IIi11 , ii1 , iIIii = lisp_lookup_public_key ( O00 )
   if ( iIIii ) :
    iIIii = map_request . verify_map_request_sig ( ii1 )
   else :
    lprint ( "Public-key lookup failed for sig-eid {}, hash-eid {}" . format ( O00 . print_address ( ) , IIi1i1IIi11 . print_address ( ) ) )
 ...
 iIiiii1iIi11 = oO0o0o00O if ( oO0o0o00O . afi == ecm_source . afi ) else ecm_source
 if 18 - 18: OoooooooOO / I1ii11iIi11i * i1IIi / i11iIiiIii + Oo0Ooo / Ii1I
 IiiiiiIiI = lisp_site_eid_lookup ( oOooOOo000o0o , iiIoOOOOoo0O00o , False )
 ...
 iiiiiiiiII1i = IiiiiiIiI . print_eid_tuple ( )
 ...
 if ( iIIii and IiiiiiIiI . registered == False ) :
  lprint ( "Site '{}' with EID-prefix {} is not registered for EID {}" . format ( O00O0o , green ( iiiiiiiiII1i , False ) , green ( iIiI1I1ii1I1 , False ) ) )
  ...
  if ( IiiiiiIiI . accept_more_specifics == False ) :
   oOooOOo000o0o = IiiiiiIiI . eid
   iiIoOOOOoo0O00o = IiiiiiIiI . group
  ...
  if ( IiiiiiIiI . force_ttl != None ) :
   O0OOo = IiiiiiIiI . force_ttl | 0x80000000
   if 57 - 57: O0
   ...
   if 8 - 8: OoO0O00
  lisp_send_negative_map_reply ( lisp_sockets , oOooOOo000o0o , iiIoOOOOoo0O00o , O0oo00o000 , oO0o0o00O ,
 mr_sport , O0OOo , OoO0o00O0oOOo , OOo )
 ...
 if ( IiiiiiIiI . force_nat_proxy_reply ) :
  ...
  iiIIiI = IiiiiiIiI . proxy_reply_action
  Iio0oO0 = ", forced, action {}" . format ( iiIIiI )
 ...
 O000oO0O0 = False
 oOo0Oooooo = None
 if ( IIIiI and lisp_policies . has_key ( IiiiiiIiI . policy ) ) :
  IIIiIIi111 = lisp_policies [ IiiiiiIiI . policy ]
  if ( IIIiIIi111 . match_policy_map_request ( map_request , mr_source ) ) : oOo0Oooooo = IIIiIIi111
  if 59 - 59: O0
  if ( oOo0Oooooo ) :
 ...
 if ( Iio0oO0 != "" ) :
  lprint ( "Proxy-replying for EID {}, found site '{}' EID-prefix {}{}" . format ( green ( iIiI1I1ii1I1 , False ) , O00O0o , green ( iiiiiiiiII1i , False ) ,
  # oO0o % OoO0O00 % oO0o . i11iIiiIii + o0oOOo0O0Ooo . i11iIiiIii
 Iio0oO0 ) )
  if 80 - 80: OoOoOO00 . I11i
  oOO000OOO = IiiiiiIiI . registered_rlocs
  O0OOo = 1440
  if ( IiII11I1I1II ) :
   if ( IiiiiiIiI . site_id != 0 ) :
    o0ooO = map_request . source_eid
    oOO000OOO = lisp_get_private_rloc_set ( IiiiiiIiI , o0ooO , iiIoOOOOoo0O00o )
    if 23 - 23: I1ii11iIi11i % iIii1I11I1II1
   if ( oOO000OOO == IiiiiiIiI . registered_rlocs ) :
    oOooOO00OooO = ( IiiiiiIiI . group . is_null ( ) == False )
    iii1 = lisp_get_partial_rloc_set ( oOO000OOO , iIiiii1iIi11 , oOooOO00OooO )
    if ( iii1 != oOO000OOO ) :
     O0OOo = 15
     oOO000OOO = iii1
  ...
  if ( oOo0Oooooo ) :
   if ( oOo0Oooooo . set_record_ttl ) :
    O0OOo = oOo0Oooooo . set_record_ttl
  ...
  if ( O000oO0O0 ) :
   ...
   if 72 - 72: I1Ii111
   if 51 - 51: OoOoOO00
  i1iIii1 = IiiiiiIiI . echo_nonce_capable
  ...
  if ( iIIii ) :
   ...
   ii11iIIII = oOooOOo000o0o
   Iii1iIiI1II = iiIoOOOOoo0O00o
  ...
  packet = lisp_build_map_reply ( ii11iIIII , Iii1iIiI1II , oOO000OOO ,
 O0oo00o000 , iiIIiI , O0OOo , map_request , None , i1iIii1 , False )
  if 66 - 66: iII111i % iII111i
  if ( OOo ) :
   lisp_process_pubsub ( lisp_sockets , packet , ii11iIIII , oO0o0o00O ,
 ...
 Iii1I11Iiii1 = len ( IiiiiiIiI . registered_rlocs )
 if ( Iii1I11Iiii1 == 0 ) :
 ...
 iIIi111I1i1i = map_request . target_eid . hash_address ( O0oO )
 iIIi111I1i1i %= Iii1I11Iiii1
 O00000ooO0OOo = IiiiiiIiI . registered_rlocs [ iIIi111I1i1i ]
 ...
 O00O0o , green ( iiiiiiiiII1i , False ) ) )
 else :
...
def lisp_ddt_process_map_request ( lisp_sockets , map_request , ecm_source , port ) :
 ...
 if ( lisp_i_am_ms ) :
  ...
  O0ooO0oOoOo = lisp_ddt_cache_lookup ( oOooOOo000o0o , iiIoOOOOoo0O00o , False )
  if ( O0ooO0oOoOo == None ) :
 ...
 green ( iIiI1I1ii1I1 , False ) ) )
   ...
   if ( iiIoOOOOoo0O00o . is_null ( ) ) :
    oOooOOo000o0o = lisp_ddt_compute_neg_prefix ( oOooOOo000o0o , O0ooO0oOoOo ,
 lisp_ddt_cache )
   else :
    iiIoOOOOoo0O00o = lisp_ddt_compute_neg_prefix ( iiIoOOOOoo0O00o , O0ooO0oOoOo ,
 lisp_ddt_cache )
    oOooOOo000o0o = lisp_ddt_compute_neg_prefix ( oOooOOo000o0o , O0ooO0oOoOo ,
 ...
 o0o0ooOOo0oO = lisp_build_map_referral ( oOooOOo000o0o , iiIoOOOOoo0O00o , O0ooO0oOoOo , iiIIiI , O0OOo , O0oo00o000 )
...
def lisp_find_negative_mask_len ( eid , entry_prefix , neg_prefix ) :
 ...
 for o00O00 in range ( OOooO0Ooo ) :
  i1111i = 1 << ( OOooO0Ooo - o00O00 - 1 )
...
def lisp_neg_prefix_walk ( entry , parms ) :
 ...
 if ( o00 == None ) :
  ...
  if ( entry . eid . is_more_specific ( o00 ) == False ) :
   ...
   if 72 - 72: Ii1I
 lisp_find_negative_mask_len ( oOooOOo000o0o , entry . eid , IiI1i )
 return ( [ True , parms ] )
...
def lisp_ddt_compute_neg_prefix ( eid , ddt_entry , cache ) :
 ...
 iiiI1Ii1iI1II = ddt_entry . print_eid_tuple ( )
 o00 = ddt_entry . eid
 if 90 - 90: OOooOOo
 ...
 # IiII + IiII / I1IiiI / ooOoO0o . OoOoOO00
 iiiI1Ii1iI1II , IiI1i . print_prefix ( ) ) )
 return ( IiI1i )
...
def lisp_ms_compute_neg_prefix ( eid , group ) :
 ...
 IiI1i . copy_address ( eid )
 IiI1i . mask_len = 0
 iiiiIi = lisp_address ( group . afi , "" , 0 , 0 )
 iiiiIi . copy_address ( group )
 iiiiIi . mask_len = 0
 o00 = None
 if 96 - 96: OoO0O00 + OoO0O00
 ...
 if ( group . is_null ( ) ) :
  ...
  if ( O0ooO0oOoOo == None ) :
   ...
   iiiiIi . mask_len = iiiiIi . host_mask_len ( )
   return ( [ IiI1i , iiiiIi , LISP_DDT_ACTION_NOT_AUTH ] )
   if 10 - 10: ooOoO0o
  ...
  # iIii1I11I1II1 * OoO0O00 / Oo0Ooo + OoooooooOO
  # OoO0O00 * OoOoOO00 . OOooOOo
  # OoO0O00
 iiiiIi . print_prefix ( ) ) )
  if 24 - 24: i1IIi + o0oOOo0O0Ooo / oO0o - I1IiiI % I1IiiI
  O0O0o = O0ooO0oOoOo . source_cache
 ...
 iiIIiI = LISP_DDT_ACTION_DELEGATION_HOLE if ( o00 != None ) else LISP_DDT_ACTION_NOT_AUTH
 ...
 if 88 - 88: Ii1I % Ii1I
 eid , o00 , IiI1i = O0O0o . walk_cache ( lisp_neg_prefix_walk ,
 ( eid , o00 , IiI1i ) )
 ...
 if 62 - 62: I1ii11iIi11i + OOooOOo . o0oOOo0O0Ooo
 if 79 - 79: II111iiii % I1Ii111 * IiII
 return ( [ IiI1i , iiiiIi , iiIIiI ] )
...
def lisp_ms_send_map_referral ( lisp_sockets , map_request , ecm_source , port ,
 ...
 O0ooO0oOoOo = lisp_ddt_cache_lookup ( oOooOOo000o0o , iiIoOOOOoo0O00o , False )
 if ( O0ooO0oOoOo != None ) :
  Iii1I11Iiii1 = len ( O0ooO0oOoOo . delegation_set )
  o00OOOOoOOO = O0ooO0oOoOo . is_ms_peer_entry ( )
 ...
 if ( Iii1I11Iiii1 != 0 ) :
  for I111IiiII in O0ooO0oOoOo . delegation_set :
   iIIi = lisp_rloc_record ( )
   iIIi . rloc = I111IiiII . delegate_address
   iIIi . priority = I111IiiII . priority
   iIIi . weight = I111IiiII . weight
...
def lisp_retransmit_ddt_map_request ( mr ) :
 IiI1iiIi1I1i = mr . mr_source . print_address ( )
 iIii1I = mr . print_eid_tuple ( )
 O0oo00o000 = mr . nonce
 if 66 - 66: i11iIiiIii
 ...
 if ( mr . last_request_sent_to ) :
  iiIiiI1I1Ii = mr . last_request_sent_to . print_address ( )
  Ooo00o0000 = lisp_referral_cache_lookup ( mr . last_cached_prefix [ 0 ] ,
 mr . last_cached_prefix [ 1 ] , True )
  if ( Ooo00o0000 and Ooo00o0000 . referral_set . has_key ( iiIiiI1I1Ii ) ) :
   Ooo00o0000 . referral_set [ iiIiiI1I1Ii ] . no_responses += 1
 ...
 if ( mr . retry_count == LISP_MAX_MAP_NOTIFY_RETRIES ) :
  lprint ( "DDT Map-Request retry limit reached for EID {}, nonce 0x{}" . format ( green ( iIii1I , False ) , lisp_hex_string ( O0oo00o000 ) ) )
 ...
 I1iiIi111I = green ( IiI1iiIi1I1i , False )
 IiI11I111 = green ( iIii1I , False )
...
def lisp_get_referral_node ( referral , source_eid , dest_eid ) :
 ...
 oOIII = [ ]
 for OO00 in referral . referral_set . values ( ) :
  if ( OO00 . updown == False ) : continue
  if ( len ( oOIII ) == 0 or oOIII [ 0 ] . priority == OO00 . priority ) :
   oOIII . append ( OO00 )
  elif ( oOIII [ 0 ] . priority > OO00 . priority ) :
   oOIII = [ ]
   oOIII . append ( OO00 )
 ...
 I1ii1I = len ( oOIII )
 if ( I1ii1I == 0 ) : return ( None )
 if 64 - 64: I1Ii111
 iIIi111I1i1i = dest_eid . hash_address ( source_eid )
 iIIi111I1i1i = iIIi111I1i1i % I1ii1I
 return ( oOIII [ iIIi111I1i1i ] )
 if 96 - 96: Ii1I
 if 100 - 100: ooOoO0o
...
def lisp_send_ddt_map_request ( mr , send_to_root ) :
 ooooOo = mr . lisp_sockets
 O0oo00o000 = mr . nonce
 OO = mr . itr
 IIIIIiiII11i = mr . mr_source
 ...
 if ( send_to_root ) :
  oo00oO0ooo = lisp_address ( LISP_AFI_NONE , "" , 0 , 0 )
  IiiiIi1iIiII = lisp_address ( LISP_AFI_NONE , "" , 0 , 0 )
  mr . tried_root = True
  lprint ( "Jumping up to root for EID {}" . format ( green ( iIiI1I1ii1I1 , False ) ) )
 else :
  oo00oO0ooo = mr . eid
  IiiiIi1iIiII = mr . group
  if 3 - 3: IiII
 ...
 OO00o0oO0O00 = lisp_referral_cache_lookup ( oo00oO0ooo , IiiiIi1iIiII , False )
 if ( OO00o0oO0O00 == None ) :
  lprint ( "No referral cache entry found" )
  lisp_send_negative_map_reply ( ooooOo , oo00oO0ooo , IiiiIi1iIiII ,
 O0oo00o000 , OO , mr . sport , 15 , None , False )
  return
  if 60 - 60: I11i + O0 * I1IiiI * O0 * II111iiii
  if 73 - 73: II111iiii
 ooOo00 = OO00o0oO0O00 . print_eid_tuple ( )
 lprint ( "Found referral cache entry {}, referral-type: {}" . format ( ooOo00 ,
 OO00o0oO0O00 . print_referral_type ( ) ) )
 if 45 - 45: iII111i + O0 % i11iIiiIii * I1ii11iIi11i + I1Ii111 / OOooOOo
 OO00 = lisp_get_referral_node ( OO00o0oO0O00 , IIIIIiiII11i , mr . eid )
 if ( OO00 == None ) :
  lprint ( "No reachable referral-nodes found" )
  mr . dequeue_map_request ( )
  lisp_send_negative_map_reply ( ooooOo , OO00o0oO0O00 . eid ,
 OO00o0oO0O00 . group , O0oo00o000 , OO , mr . sport , 1 , None , False )
  return
  if 55 - 55: OoooooooOO % iIii1I11I1II1 . ooOoO0o
  if 10 - 10: O0 * iIii1I11I1II1 . OOooOOo
 lprint ( "Send DDT Map-Request to {} {} for EID {}, nonce 0x{}" . format ( OO00 . referral_address . print_address ( ) ,
 # iIii1I11I1II1
 OO00o0oO0O00 . print_referral_type ( ) , green ( iIiI1I1ii1I1 , False ) ,
 lisp_hex_string ( O0oo00o000 ) ) )
 if 13 - 13: O0 / ooOoO0o
 if 64 - 64: i11iIiiIii + I1IiiI / Oo0Ooo - iII111i
 if 26 - 26: I1ii11iIi11i
 if 67 - 67: I1Ii111 * iIii1I11I1II1 / O0 + OoO0O00 * iIii1I11I1II1 % II111iiii
 I1i1 = ( OO00o0oO0O00 . referral_type == LISP_DDT_ACTION_MS_REFERRAL or
 OO00o0oO0O00 . referral_type == LISP_DDT_ACTION_MS_ACK )
 lisp_send_ecm ( ooooOo , mr . packet , IIIIIiiII11i , mr . sport , mr . eid ,
 OO00 . referral_address , to_ms = I1i1 , ddt = True )
 ...
 mr . last_request_sent_to = OO00 . referral_address
 mr . last_sent = lisp_get_timestamp ( )
 mr . send_count += 1
 OO00 . map_requests_sent += 1
 return
...
def lisp_mr_process_map_request ( lisp_sockets , packet , map_request , ecm_source ,
 ...
 oOooOOo000o0o = map_request . target_eid
 iiIoOOOOoo0O00o = map_request . target_group
 iIii1I = map_request . print_eid_tuple ( )
 IiI1iiIi1I1i = mr_source . print_address ( )
 O0oo00o000 = map_request . nonce
 ...
 oooO = lisp_ddt_map_request ( lisp_sockets , packet , oOooOOo000o0o , iiIoOOOOoo0O00o , O0oo00o000 )
 oooO . packet = packet
 oooO . itr = ecm_source
...
def lisp_process_map_request ( lisp_sockets , packet , ecm_source , ecm_port ,
 ...
 packet = i1i . decode ( packet , mr_source , mr_port )
 if ( packet == None ) :
 ...
 if ( i1i . rloc_probe ) :
  lisp_process_rloc_probe_request ( lisp_sockets , i1i , mr_source ,
 ...
 if ( i1i . smr_invoked_bit ) :
  lisp_process_smr_invoked_request ( i1i )
 ...
 if ( lisp_i_am_etr ) :
  lisp_etr_process_map_request ( lisp_sockets , i1i , mr_source ,
 mr_port , ttl , timestamp )
 ...
 if ( lisp_i_am_ms ) :
  packet = iII111I
  oOooOOo000o0o , iiIoOOOOoo0O00o , O00OO0oOooOOo = lisp_ms_process_map_request ( lisp_sockets ,
 iII111I , i1i , mr_source , mr_port , ecm_source )
  if ( ddt_request ) :
   lisp_ms_send_map_referral ( lisp_sockets , i1i , ecm_source ,
 ecm_port , O00OO0oOooOOo , oOooOOo000o0o , iiIoOOOOoo0O00o )
 ...
 if ( lisp_i_am_mr and not ddt_request ) :
  lisp_mr_process_map_request ( lisp_sockets , iII111I , i1i ,
 ...
 if ( lisp_i_am_ddt or ddt_request ) :
  packet = iII111I
  lisp_ddt_process_map_request ( lisp_sockets , i1i , ecm_source ,
 ecm_port )
...
def lisp_process_map_reply ( lisp_sockets , packet , source , ttl , itr_in_ts ) :
 ...
 for OoOOoO0oOo in range ( iIO0OOoOOO0OO . record_count ) :
  ...
  if 62 - 62: IiII
  if ( o0OooO ) :
   O0OoO = lisp_map_cache_lookup ( oOO0O0o0oOooO . eid , oOO0O0o0oOooO . group )
  else :
   O0OoO = lisp_map_cache . lookup_cache ( oOO0O0o0oOooO . eid , True )
   if 27 - 27: OoO0O00 + OOooOOo / ooOoO0o * I1IiiI / I11i
  O00IIiiiii1I111I = ( O0OoO == None )
  if 84 - 84: OoO0O00
  ...
  if 74 - 74: Ii1I
  if ( O0OoO == None ) :
   i1ii1iiI , Ii1i1I1Ii , I1iI1 = lisp_allow_gleaning ( oOO0O0o0oOooO . eid , oOO0O0o0oOooO . group ,
 None )
   if ( i1ii1iiI ) : continue
  else :
   if ( O0OoO . gleaned ) : continue
  ...
  oOO000OOO = [ ]
  O0I11IiI1ii = None
  for Iii1i1IiI in range ( oOO0O0o0oOooO . rloc_count ) :
   iIIi = lisp_rloc_record ( )
   ...
   iIi1I1i11iI = None
   if ( O0OoO ) : iIi1I1i11iI = O0OoO . get_rloc ( iIIi . rloc )
   if ( iIi1I1i11iI ) :
    IIIi1iI1 = iIi1I1i11iI
   else :
    IIIi1iI1 = lisp_rloc ( )
    if 48 - 48: ooOoO0o - Oo0Ooo
    if 44 - 44: OoOoOO00 + OoO0O00 % OOooOOo + oO0o
 ...
 iIO0OOoOOO0OO , ttl , O0I11IiI1ii )
     if 47 - 47: OoO0O00
    if ( IIIi1iI1 . rloc . is_multicast_address ( ) ) : O0I11IiI1ii = IIIi1iI1
  ...
  if ( iIO0OOoOOO0OO . rloc_probe == False and lisp_nat_traversal ) :
   ...
   for IIIi1iI1 in oOO000OOO :
    if 66 - 66: OoO0O00 * ooOoO0o - oO0o / OoO0O00 . Oo0Ooo * i11iIiiIii
    ...
    if ( IIIi1iI1 . rloc . is_private_address ( ) ) :
     ...
     iIi1IiII1 . append ( IIIi1iI1 . rloc . print_address_no_iid ( ) )
     continue
   ...
   if ( iIi1IiII1 != [ ] ) :
    oOO000OOO = iii1
    lprint ( "NAT-traversal optimized RLOC-set: {}" . format ( iIi1IiII1 ) )
  ...
  if ( iii1 != [ ] ) :
   ...
   if 82 - 82: OOooOOo
  if ( iIO0OOoOOO0OO . rloc_probe and O0OoO != None ) : oOO000OOO = O0OoO . rloc_set
  ...
  i1111 = O00IIiiiii1I111I
  if ( O0OoO and oOO000OOO != O0OoO . rloc_set ) :
   O0OoO . delete_rlocs_from_rloc_probe_list ( )
   i1111 = True
   if 17 - 17: O0 % I1Ii111
  ...
  IIIiIiI1Ii = O0OoO . uptime if ( O0OoO ) else None
  if ( O0OoO == None ) :
   O0OoO = lisp_mapping ( oOO0O0o0oOooO . eid , oOO0O0o0oOooO . group , oOO000OOO )
   O0OoO . mapping_source = source
   ...
   if ( lisp_i_am_rtr and oOO0O0o0oOooO . group . is_null ( ) == False ) :
    O0OoO . map_cache_ttl = LISP_MCAST_TTL
   else :
    O0OoO . map_cache_ttl = oOO0O0o0oOooO . store_ttl ( )
    if 78 - 78: II111iiii * I11i
   O0OoO . action = oOO0O0o0oOooO . action
   O0OoO . add_cache ( i1111 )
   if 47 - 47: Ii1I
   if 42 - 42: I11i . oO0o - I1IiiI / OoO0O00
  OooO0 = "Add"
  if ( IIIiIiI1Ii ) :
   O0OoO . uptime = IIIiIiI1Ii
   O0OoO . refresh_time = lisp_get_timestamp ( )
   OooO0 = "Replace"
   if 73 - 73: o0oOOo0O0Ooo
   if 8 - 8: O0
  lprint ( "{} {} map-cache with {} RLOCs" . format ( OooO0 ,
 green ( O0OoO . print_eid_tuple ( ) , False ) , len ( oOO000OOO ) ) )
  ...
  if ( lisp_ipc_dp_socket and i1II != None ) :
   lisp_write_ipc_keys ( i1II )
   ...
   if 34 - 34: O0 * oO0o
  if ( O00IIiiiii1I111I ) :
   OOOOo00 = bold ( "RLOC-probe" , False )
   for IIIi1iI1 in O0OoO . best_rloc_set :
    O0O0 = red ( IIIi1iI1 . rloc . print_address_no_iid ( ) , False )
    lprint ( "Trigger {} to {}" . format ( OOOOo00 , O0O0 ) )
    lisp_send_map_request ( lisp_sockets , 0 , O0OoO . eid , O0OoO . group , IIIi1iI1 )
...
def lisp_hash_me ( packet , alg_id , password , do_hex ) :
 ...
 if ( do_hex ) :
  iIIi111I1i1i = hmac . new ( password , packet , I1I ) . hexdigest ( )
 else :
  iIIi111I1i1i = hmac . new ( password , packet , I1I ) . digest ( )
  if 6 - 6: iII111i
 return ( iIIi111I1i1i )
 if 44 - 44: oO0o
...
def lisp_send_merged_map_notify ( lisp_sockets , parent , map_register ,
 ...
 for ii11i1IiI in parent . registered_rlocs :
  iIIi = lisp_rloc_record ( )
  iIIi . store_rloc_entry ( ii11i1IiI )
  ooO00 += iIIi . encode ( )
  iIIi . print_record ( "  " )
  del ( iIIi )
 ...
 for ii11i1IiI in parent . registered_rlocs :
  OO0oooOO = ii11i1IiI . rloc
  I1iii1 = lisp_map_notify ( lisp_sockets )
  I1iii1 . record_count = 1
  I1IIiiiiI1iIi = map_register . key_id
  I1iii1 . key_id = I1IIiiiiI1iIi
  I1iii1 . alg_id = map_register . alg_id
  I1iii1 . auth_len = map_register . auth_len
  I1iii1 . nonce = map_register . nonce
  I1iii1 . nonce_key = lisp_hex_string ( I1iii1 . nonce )
  I1iii1 . etr . copy_address ( OO0oooOO )
  I1iii1 . etr_port = map_register . sport
  I1iii1 . site = parent . site
  o0o0ooOOo0oO = I1iii1 . encode ( ooO00 , parent . site . auth_key [ I1IIiiiiI1iIi ] )
  I1iii1 . print_notify ( )
  if 11 - 11: o0oOOo0O0Ooo
  if 45 - 45: I11i / OoOoOO00 * o0oOOo0O0Ooo / O0 . I1IiiI
  if 82 - 82: i1IIi
  if 86 - 86: I1IiiI
  OO0Oo00o0o0 = I1iii1 . nonce_key
  if ( lisp_map_notify_queue . has_key ( OO0Oo00o0o0 ) ) :
   oOOoOo = lisp_map_notify_queue [ OO0Oo00o0o0 ]
   oOOoOo . retransmit_timer . cancel ( )
   del ( oOOoOo )
   if 5 - 5: OoOoOO00 % OoooooooOO - i1IIi / OoooooooOO * OOooOOo / O0
  lisp_map_notify_queue [ OO0Oo00o0o0 ] = I1iii1
  ...
  I1iii1 . retransmit_timer = threading . Timer ( LISP_MAP_NOTIFY_INTERVAL ,
 lisp_retransmit_map_notify , [ I1iii1 ] )
  I1iii1 . retransmit_timer . start ( )
...
def lisp_build_map_notify ( lisp_sockets , eid_records , eid_list , record_count ,
 ...
 if ( lisp_map_notify_queue . has_key ( OO0Oo00o0o0 ) ) :
  I1iii1 = lisp_map_notify_queue [ OO0Oo00o0o0 ]
  I1iiIi111I = red ( source . print_address_no_iid ( ) , False )
  lprint ( "Map-Notify with nonce 0x{} pending for xTR {}" . format ( lisp_hex_string ( I1iii1 . nonce ) , I1iiIi111I ) )
  if 19 - 19: OoooooooOO + i11iIiiIii / II111iiii - Oo0Ooo . OOooOOo
  return
  if 10 - 10: oO0o * Oo0Ooo
  if 55 - 55: OoO0O00 - i1IIi - I11i * oO0o
 I1iii1 = lisp_map_notify ( lisp_sockets )
 I1iii1 . record_count = record_count
 key_id = key_id
 I1iii1 . key_id = key_id
 I1iii1 . alg_id = alg_id
 I1iii1 . auth_len = auth_len
 I1iii1 . nonce = nonce
 I1iii1 . nonce_key = lisp_hex_string ( nonce )
 I1iii1 . etr . copy_address ( source )
 I1iii1 . etr_port = port
 I1iii1 . site = site
 I1iii1 . eid_list = eid_list
 if 91 - 91: I1Ii111
 ...
 if ( map_register_ack ) :
  ...
  if 69 - 69: IiII
  if 13 - 13: i11iIiiIii
 o0o0ooOOo0oO = I1iii1 . encode ( eid_records , site . auth_key [ key_id ] )
 I1iii1 . print_notify ( )
 if 49 - 49: OoOoOO00
 if ( map_register_ack == False ) :
  oOO0O0o0oOooO = lisp_eid_record ( )
 ...
 lisp_send_map_notify ( lisp_sockets , o0o0ooOOo0oO , I1iii1 . etr , port )
...
def lisp_send_multicast_map_notify ( lisp_sockets , site_eid , eid_list , xtr ) :
 ...
 I1iii1 = lisp_map_notify ( lisp_sockets )
 I1iii1 . record_count = 1
 I1iii1 . nonce = lisp_get_control_nonce ( )
 I1iii1 . nonce_key = lisp_hex_string ( I1iii1 . nonce )
 I1iii1 . etr . copy_address ( xtr )
 I1iii1 . etr_port = LISP_CTRL_PORT
 I1iii1 . eid_list = eid_list
 OO0Oo00o0o0 = I1iii1 . nonce_key
 ...
 if 42 - 42: IiII
 lisp_remove_eid_from_map_notify_queue ( I1iii1 . eid_list )
 if ( lisp_map_notify_queue . has_key ( OO0Oo00o0o0 ) ) :
  I1iii1 = lisp_map_notify_queue [ OO0Oo00o0o0 ]
  lprint ( "Map-Notify with nonce 0x{} pending for ITR {}" . format ( I1iii1 . nonce , red ( xtr . print_address_no_iid ( ) , False ) ) )
 ...
 i1iIIiii = site_eid . rtrs_in_rloc_set ( )
 if ( i1iIIiii ) :
  if ( site_eid . is_rtr_in_rloc_set ( xtr ) ) : i1iIIiii = False
 ...
 for O0O0OOo0O in site_eid . registered_rlocs :
  if ( i1iIIiii ^ O0O0OOo0O . is_rtr ( ) ) : continue
 ...
 o0o0ooOOo0oO = I1iii1 . encode ( o0o0ooOOo0oO , "" )
 if ( o0o0ooOOo0oO == None ) : return
...
def lisp_queue_multicast_map_notify ( lisp_sockets , rle_list ) :
 ...
 for I1IIiIiIIiIiI in rle_list :
  iIIIi1I1i = lisp_site_eid_lookup ( I1IIiIiIIiIiI [ 0 ] , I1IIiIiIIiIiI [ 1 ] , True )
  ...
  if ( len ( oO0O0Ooo000 ) == 0 ) :
   OO0000O0 = { }
   for i1I1I11II in iIIIi1I1i . individual_registrations . values ( ) :
  ...
  if ( iIIIi1I1i . eid . address == 0 and iIIIi1I1i . eid . mask_len == 0 ) :
   ...
   for o0Ii11I in iIi1iiIiiII1I :
    Oo0Oooo0 . append ( o0Ii11I . address )
    I1II1111iI . append ( o0Ii11I . address . print_address_no_iid ( ) )
   ...
   OoO0 = ( len ( Oo0Oooo0 ) != 0 )
   if ( OoO0 == False ) :
    IiiiiiIiI = lisp_site_eid_lookup ( I1IIiIiIIiIiI [ 0 ] , iI111I11iii1 , False )
  ...
  for ii11i1IiI in Oo0Oooo0 :
   lprint ( "Build Map-Notify to {}TR {} for {}" . format ( "R" if OoO0 else "x" , red ( ii11i1IiI . print_address_no_iid ( ) , False ) ,
   # i11iIiiIii
 green ( iIIIi1I1i . print_eid_tuple ( ) , False ) ) )
   if 32 - 32: i1IIi / II111iiii
   o0oo0OOOo0O = [ iIIIi1I1i . print_eid_tuple ( ) ]
   lisp_send_multicast_map_notify ( lisp_sockets , iIIIi1I1i , o0oo0OOOo0O , ii11i1IiI )
   time . sleep ( .001 )
...
def lisp_find_sig_in_rloc_set ( packet , rloc_count ) :
 for OoOOoO0oOo in range ( rloc_count ) :
  ...
  try :
   ...
   if 65 - 65: OoO0O00
   if 65 - 65: oO0o
  if ( O00o0OO0o0 . has_key ( "signature" ) == False ) : continue
  return ( iIIi )
...
def lisp_get_eid_hash ( eid ) :
 ...
 for i1IIiiIiiI1ii in lisp_eid_hashes :
  ...
  i1 = i1IIiiIiiI1ii . instance_id
  if ( i1 == - 1 ) : i1IIiiIiiI1ii . instance_id = eid . instance_id
  if 14 - 14: iIii1I11I1II1 + oO0o / ooOoO0o
  IIo0o0oo0 = eid . is_more_specific ( i1IIiiIiiI1ii )
  i1IIiiIiiI1ii . instance_id = i1
  if ( IIo0o0oo0 ) :
 ...
 iIIiiiI = eid . address
 O0oo = ""
 for OoOOoO0oOo in range ( 0 , iIii111 / 16 ) :
  IiIIiiI = iIIiiiI & 0xffff
  IiIIiiI = hex ( IiIIiiI ) [ 2 : - 1 ]
  O0oo = IiIIiiI . zfill ( 4 ) + ":" + O0oo
  iIIiiiI >>= 16
  if 42 - 42: Oo0Ooo - OOooOOo - o0oOOo0O0Ooo . i11iIiiIii - i11iIiiIii % I1IiiI
 if ( iIii111 % 16 != 0 ) :
  IiIIiiI = iIIiiiI & 0xff
  IiIIiiI = hex ( IiIIiiI ) [ 2 : - 1 ]
  O0oo = IiIIiiI . zfill ( 2 ) + ":" + O0oo
...
def lisp_lookup_public_key ( eid ) :
 ...
 IIi1i1IIi11 = lisp_address ( LISP_AFI_NAME , O0OOo00 , len ( O0OOo00 ) , i1 )
 ...
 IiiiiiIiI = lisp_site_eid_lookup ( IIi1i1IIi11 , iiIoOOOOoo0O00o , True )
 ...
 for IIIi1iI1 in IiiiiiIiI . registered_rlocs :
  ...
  if ( III1IiI . has_key ( "public-key" ) == False ) : continue
...
def lisp_verify_cga_sig ( eid , rloc_record ) :
 ...
 if ( lisp_get_eid_hash ( eid ) ) :
  ...
  O00OO0OO = IIIiiiIi1I1 [ "signature-eid" ]
  O00 = lisp_address ( LISP_AFI_IPV6 , O00OO0OO , 0 , 0 )
 else :
 ...
 IIi1i1IIi11 , ii1 , II1ii1iI111i = lisp_lookup_public_key ( O00 )
 if ( IIi1i1IIi11 == None ) :
 ...
 ooooI111I11i = IIIiiiIi1I1 [ "signature" ]
 if 76 - 76: OOooOOo . iII111i % ooOoO0o
 try :
  IIIiiiIi1I1 = binascii . a2b_base64 ( ooooI111I11i )
 except :
  lprint ( "  Incorrect padding in signature string" )
  return ( False )
  if 15 - 15: iII111i
  if 55 - 55: iII111i
 I11i1iiiii = len ( IIIiiiIi1I1 )
 if ( I11i1iiiii & 1 ) :
  lprint ( "  Signature length is odd, length {}" . format ( I11i1iiiii ) )
  return ( False )
 ...
 try :
  OO0Oo00o0o0 = ecdsa . VerifyingKey . from_pem ( ii1 )
 except :
  Ii1 = bold ( "Bad public-key" , False )
  lprint ( "  {}, not in PEM format" . format ( Ii1 ) )
  return ( False )
 ...
 try :
  ...
  lprint ( "  Signature used '{}'" . format ( ooooI111I11i ) )
  return ( False )
...
def lisp_remove_eid_from_map_notify_queue ( eid_list ) :
 ...
 oo = [ ]
 for i11 in eid_list :
  for oO0o0O in lisp_map_notify_queue :
   I1iii1 = lisp_map_notify_queue [ oO0o0O ]
   if ( i11 not in I1iii1 . eid_list ) : continue
   if 72 - 72: II111iiii . O0 . I11i * OoO0O00
   oo . append ( oO0o0O )
   O00ooOo0Oo = I1iii1 . retransmit_timer
   if ( O00ooOo0Oo ) : O00ooOo0Oo . cancel ( )
   if 27 - 27: O0
   lprint ( "Remove from Map-Notify queue nonce 0x{} for EID {}" . format ( I1iii1 . nonce_key , green ( i11 , False ) ) )
 ...
 for oO0o0O in oo : lisp_map_notify_queue . pop ( oO0o0O )
 return
...
def lisp_decrypt_map_register ( packet ) :
 ...
 OO0oo0O00O0o = ( OoOOoo0o00O0oO >> 13 ) & 0x1
 if ( OO0oo0O00O0o == 0 ) : return ( packet )
 if 74 - 74: o0oOOo0O0Ooo + OoOoOO00 - o0oOOo0O0Ooo
 ii1I1Ii11i = ( OoOOoo0o00O0oO >> 14 ) & 0x7
 ...
 try :
  IIi1IIii1 = lisp_ms_encryption_keys [ ii1I1Ii11i ]
  IIi1IIii1 = IIi1IIii1 . zfill ( 32 )
  OoOooO = "0" * 8
 except :
  lprint ( "Cannot decrypt Map-Register with key-id {}" . format ( ii1I1Ii11i ) )
  return ( None )
  if 5 - 5: i11iIiiIii - OoooooooOO - I11i . Ii1I
  if 83 - 83: Oo0Ooo * II111iiii + Ii1I
 IiI11I111 = bold ( "Decrypt" , False )
 lprint ( "{} Map-Register with key-id {}" . format ( IiI11I111 , ii1I1Ii11i ) )
 if 59 - 59: iII111i % OoO0O00 / Oo0Ooo + I1ii11iIi11i % Ii1I
 if 59 - 59: O0 + oO0o . IiII . IiII / OoOoOO00 / II111iiii
 if 2 - 2: I1Ii111
 if 45 - 45: OOooOOo * ooOoO0o
 o0oO = chacha . ChaCha ( IIi1IIii1 , OoOooO , 20 ) . decrypt ( packet [ 4 : : ] )
...
def lisp_process_map_register ( lisp_sockets , packet , source , sport ) :
 ...
 O0OII = packet
 OOoOo0oOoo = [ ]
 O0o0Ooo00OOO = iiIio0o0 . record_count
 for OoOOoO0oOo in range ( O0o0Ooo00OOO ) :
  oOO0O0o0oOooO = lisp_eid_record ( )
  iIIi = lisp_rloc_record ( )
  packet = oOO0O0o0oOooO . decode ( packet )
  if ( packet == None ) :
 ...
 False )
  ...
  oO0O0o = IiiiiiIiI . print_eid_tuple ( ) if IiiiiiIiI else None
  ...
  if ( IiiiiiIiI and IiiiiiIiI . accept_more_specifics == False ) :
   if ( IiiiiiIiI . eid_record_matches ( oOO0O0o0oOooO ) == False ) :
    Ooo0 = IiiiiiIiI . parent_for_more_specifics
    if ( Ooo0 ) : IiiiiiIiI = Ooo0
    if 81 - 81: oO0o
  ...
  IiII1II1I = ( IiiiiiIiI and IiiiiiIiI . accept_more_specifics )
  if ( IiII1II1I ) :
   iIIIiIIi1 = lisp_site_eid ( IiiiiiIiI . site )
   iIIIiIIi1 . dynamic = True
   iIIIiIIi1 . eid . copy_address ( oOO0O0o0oOooO . eid )
   iIIIiIIi1 . group . copy_address ( oOO0O0o0oOooO . group )
   iIIIiIIi1 . parent_for_more_specifics = IiiiiiIiI
   iIIIiIIi1 . add_cache ( )
   iIIIiIIi1 . inherit_from_ams_parent ( )
   IiiiiiIiI . more_specific_registrations . append ( iIIIiIIi1 )
   IiiiiiIiI = iIIIiIIi1
  else :
   IiiiiiIiI = lisp_site_eid_lookup ( oOO0O0o0oOooO . eid , oOO0O0o0oOooO . group ,
 True )
 ...
 iiIio0o0 . auth_data , i1ii1IIii )
  i1II11iiIiii = "dynamic " if IiiiiiIiI . dynamic else ""
  ...
  if ( i11Ii or IiiiiiIiI . require_signature ) :
   i1I11 = "Required " if IiiiiiIiI . require_signature else ""
 ...
 bold ( "failed" , False ) , iIiI1I1ii1I1 ) )
  ...
  if ( iiIio0o0 . merge_register_requested ) :
   ...
   if ( IiiiiiIiI . individual_registrations . has_key ( OO0Oo00o0o0 ) ) :
    IiiiiiIiI = IiiiiiIiI . individual_registrations [ OO0Oo00o0o0 ]
   else :
    IiiiiiIiI = lisp_site_eid ( ooo0ooOO0OO )
    IiiiiiIiI . eid . copy_address ( Ooo0 . eid )
    IiiiiiIiI . group . copy_address ( Ooo0 . group )
    IiiiiiIiI . encrypt_json = Ooo0 . encrypt_json
    Ooo0 . individual_registrations [ OO0Oo00o0o0 ] = IiiiiiIiI
  ...
  Ii1 = ( IiiiiiIiI . is_rloc_in_rloc_set ( source ) == False )
  if ( oOO0O0o0oOooO . record_ttl == 0 and Ii1 ) :
  ...
  O0Ooo000Ooo = IiiiiiIiI . registered_rlocs
 ...
 oOO0O0o0oOooO . rloc_count - Iii1i1IiI - 1 )
     break
  ...
  i11iI1iIi11 = ( IiiiiiIiI . do_rloc_sets_match ( O0Ooo000Ooo ) == False )
  if 49 - 49: iIii1I11I1II1
 ...
 IiiiiiIiI . registered ) :
   ...
   IiiiiiIiI . registered_rlocs = O0Ooo000Ooo
   continue
  ...
  if 35 - 35: O0
  IiiiiiIiI . auth_sha1_or_sha2 = i1IiIIi11I
  IiiiiiIiI . proxy_reply_requested = iiIio0o0 . proxy_reply_requested
  IiiiiiIiI . lisp_sec_present = iiIio0o0 . lisp_sec_present
  IiiiiiIiI . map_notify_requested = iiIio0o0 . map_notify_requested
  IiiiiiIiI . mobile_node_requested = iiIio0o0 . mobile_node
  IiiiiiIiI . merge_register_requested = iiIio0o0 . merge_register_requested
  if 10 - 10: Ii1I - I1Ii111 / Oo0Ooo + O0
  IiiiiiIiI . use_register_ttl_requested = iiIio0o0 . use_ttl_for_timeout
  ...
  IiiiiiIiI . xtr_id_present = iiIio0o0 . xtr_id_present
  if ( IiiiiiIiI . xtr_id_present ) :
   IiiiiiIiI . xtr_id = iiIio0o0 . xtr_id
   IiiiiiIiI . site_id = iiIio0o0 . site_id
  ...
  if ( iiIio0o0 . merge_register_requested ) :
   if ( Ooo0 . merge_in_site_eid ( IiiiiiIiI ) ) :
 ...
 oOO0O0o0oOooO )
  ...
  OOoOo0oOoo . append ( IiiiiiIiI . print_eid_tuple ( ) )
  if 19 - 19: OoooooooOO
...
def lisp_process_unicast_map_notify ( lisp_sockets , packet , source ) :
 I1iii1 = lisp_map_notify ( "" )
 packet = I1iii1 . decode ( packet )
 if ( packet == None ) :
 ...
 I1iii1 . print_notify ( )
 if ( I1iii1 . record_count == 0 ) : return
 if 73 - 73: O0 % i11iIiiIii
 iiIii1 = I1iii1 . eid_records
 if 5 - 5: OoO0O00 . iII111i * oO0o + I1IiiI . Oo0Ooo
 for OoOOoO0oOo in range ( I1iii1 . record_count ) :
  oOO0O0o0oOooO = lisp_eid_record ( )
  ...
  if 9 - 9: OoO0O00
  O0OoO = lisp_map_cache_lookup ( oOO0O0o0oOooO . eid , oOO0O0o0oOooO . eid )
  if ( O0OoO == None ) :
   ...
   if 78 - 78: iII111i
  if ( O0OoO . action != LISP_SEND_PUBSUB_ACTION ) :
   if ( O0OoO . subscribed_eid == None ) :
    I1i = green ( iIiI1I1ii1I1 , False )
  ...
  O0000oo0Oo = [ ]
  if ( O0OoO . action == LISP_SEND_PUBSUB_ACTION ) :
   O0OoO = lisp_mapping ( oOO0O0o0oOooO . eid , oOO0O0o0oOooO . group , [ ] )
   O0OoO . add_cache ( )
   i11o0o0OoOo00O0O = copy . deepcopy ( oOO0O0o0oOooO . eid )
   oo0ooOo0oo0Oo = copy . deepcopy ( oOO0O0o0oOooO . group )
  else :
   i11o0o0OoOo00O0O = O0OoO . subscribed_eid
   oo0ooOo0oo0Oo = O0OoO . subscribed_group
   O0000oo0Oo = O0OoO . rloc_set
   O0OoO . delete_rlocs_from_rloc_probe_list ( )
   O0OoO . rloc_set = [ ]
  ...
  O0OoO . mapping_source = None if source == "lisp-itr" else source
  O0OoO . map_cache_ttl = oOO0O0o0oOooO . store_ttl ( )
  O0OoO . subscribed_eid = i11o0o0OoOo00O0O
  O0OoO . subscribed_group = oo0ooOo0oo0Oo
  ...
  if ( len ( O0000oo0Oo ) != 0 and oOO0O0o0oOooO . rloc_count == 0 ) :
   O0OoO . build_best_rloc_set ( )
   lisp_write_ipc_map_cache ( True , O0OoO )
  ...
  for Iii1i1IiI in range ( oOO0O0o0oOooO . rloc_count ) :
   ...
   IIIi1iI1 . store_rloc_from_record ( iIIi , None , O0OoO . mapping_source )
   O0OoO . rloc_set . append ( IIIi1iI1 )
 ...
 lisp_send_map_notify_ack ( lisp_sockets , iiIii1 , I1iii1 , IIo0o0oo0 )
...
def lisp_process_multicast_map_notify ( packet , source ) :
 ...
 None )
  ...
  if ( O0OoO . gleaned ) :
   lprint ( "Ignore Map-Notify for gleaned {}" . format ( green ( O0OoO . print_eid_tuple ( ) , False ) ) )
   if 59 - 59: I1IiiI * OoooooooOO % OOooOOo / I11i
   continue
   if 77 - 77: II111iiii - IiII % OOooOOo
   if 22 - 22: OoooooooOO / oO0o
  O0OoO . mapping_source = None if source == "lisp-etr" else source
  O0OoO . map_cache_ttl = oOO0O0o0oOooO . store_ttl ( )
  ...
  if ( len ( O0OoO . rloc_set ) != 0 and oOO0O0o0oOooO . rloc_count == 0 ) :
   O0OoO . rloc_set = [ ]
   O0OoO . build_best_rloc_set ( )
   lisp_write_ipc_map_cache ( True , O0OoO )
   lprint ( "Update {} map-cache entry with no RLOC-set" . format ( green ( O0OoO . print_eid_tuple ( ) , False ) ) )
  ...
  iIiI1III = O0OoO . rtrs_in_rloc_set ( )
  ...
  for Iii1i1IiI in range ( oOO0O0o0oOooO . rloc_count ) :
   ...
   OO000 = O0OoO . rloc_set [ 0 ] . stats if len ( O0OoO . rloc_set ) != 0 else None
   ...
   O0OoO . rloc_set = [ IIIi1iI1 ]
   O0OoO . build_best_rloc_set ( )
   lisp_write_ipc_map_cache ( True , O0OoO )
   if 99 - 99: OoO0O00 * oO0o / Ii1I + OoO0O00
   lprint ( "Update {} map-cache entry with RLE {}" . format ( green ( O0OoO . print_eid_tuple ( ) , False ) ,
...
def lisp_process_map_notify ( lisp_sockets , orig_packet , source ) :
 I1iii1 = lisp_map_notify ( "" )
 o0o0ooOOo0oO = I1iii1 . decode ( orig_packet )
 ...
 if ( I1iii1 . alg_id != 0 or I1iii1 . auth_len != 0 ) :
  IIo0o0oo0 = None
  for OO0Oo00o0o0 in lisp_map_servers_list :
   if ( OO0Oo00o0o0 . find ( I1iiIi111I ) == - 1 ) : continue
   IIo0o0oo0 = lisp_map_servers_list [ OO0Oo00o0o0 ]
   if 75 - 75: ooOoO0o
  if ( IIo0o0oo0 == None ) :
  ...
  O0oO0 = lisp_verify_auth ( o0o0ooOOo0oO , I1iii1 . alg_id ,
 I1iii1 . auth_data , IIo0o0oo0 . password )
  if 45 - 45: IiII
...
def lisp_process_map_notify_ack ( packet , source ) :
 ...
 if ( oOO0O0o0oOooO . decode ( I1iii1 . eid_records ) == None ) :
 ...
 if ( I1iii1 . alg_id != LISP_NONE_ALG_ID and I1iii1 . auth_len != 0 ) :
  ...
  O0oO0 = lisp_verify_auth ( packet , I1iii1 . alg_id ,
 I1iii1 . auth_data , i1ii1IIii )
  if 13 - 13: iII111i * Ii1I % o0oOOo0O0Ooo * i1IIi . IiII % i1IIi
  I1IIiiiiI1iIi = "key-id {}" . format ( I1IIiiiiI1iIi ) if I1IIiiiiI1iIi == I1iii1 . key_id else "bad key-id {}" . format ( I1iii1 . key_id )
 ...
 if ( I1iii1 . retransmit_timer ) : I1iii1 . retransmit_timer . cancel ( )
 if 7 - 7: I1Ii111 . Oo0Ooo + IiII / iIii1I11I1II1
 O00000ooO0OOo = source . print_address ( )
 OO0Oo00o0o0 = I1iii1 . nonce_key
 if 22 - 22: iIii1I11I1II1 - O0 . iII111i - IiII - ooOoO0o
 if ( lisp_map_notify_queue . has_key ( OO0Oo00o0o0 ) ) :
  I1iii1 = lisp_map_notify_queue . pop ( OO0Oo00o0o0 )
  if ( I1iii1 . retransmit_timer ) : I1iii1 . retransmit_timer . cancel ( )
  lprint ( "Dequeue Map-Notify from retransmit queue, key is: {}" . format ( OO0Oo00o0o0 ) )
  if 54 - 54: OoO0O00 . iII111i . OoOoOO00 * OoO0O00 + o0oOOo0O0Ooo . ooOoO0o
 else :
  lprint ( "Map-Notify with nonce 0x{} queue entry not found for {}" . format ( I1iii1 . nonce_key , red ( O00000ooO0OOo , False ) ) )
...
def lisp_process_map_referral ( lisp_sockets , packet , source ) :
 ...
 for OoOOoO0oOo in range ( I1IIIiIiii1i . record_count ) :
  ...
  oooO = lisp_ddt_map_requestQ [ OO0Oo00o0o0 ]
  if ( oooO == None ) :
 ...
 oOO0O0o0oOooO . action , I1iiIi111I ) ) :
  ...
  OooO0 = False
  OO00o0oO0O00 = lisp_referral_cache_lookup ( oOO0O0o0oOooO . eid , oOO0O0o0oOooO . group ,
 True )
  if ( OO00o0oO0O00 == None ) :
   OooO0 = True
   OO00o0oO0O00 = lisp_referral ( )
   OO00o0oO0O00 . eid = oOO0O0o0oOooO . eid
   OO00o0oO0O00 . group = oOO0O0o0oOooO . group
   if ( oOO0O0o0oOooO . ddt_incomplete == False ) : OO00o0oO0O00 . add_cache ( )
  elif ( OO00o0oO0O00 . referral_source . not_set ( ) ) :
   lprint ( "Do not replace static referral entry {}" . format ( green ( OO00o0oO0O00 . print_eid_tuple ( ) , False ) ) )
   if 33 - 33: iIii1I11I1II1
   oooO . dequeue_map_request ( )
   continue
  ...
  iiIIiI = oOO0O0o0oOooO . action
  OO00o0oO0O00 . referral_source = source
  OO00o0oO0O00 . referral_type = iiIIiI
  O0OOo = oOO0O0o0oOooO . store_ttl ( )
  OO00o0oO0O00 . referral_ttl = O0OOo
  OO00o0oO0O00 . expires = lisp_set_timestamp ( O0OOo )
  ...
  OOOoO = OO00o0oO0O00 . is_referral_negative ( )
  if ( OO00o0oO0O00 . referral_set . has_key ( I1iiIi111I ) ) :
   OO00 = OO00o0oO0O00 . referral_set [ I1iiIi111I ]
   if 39 - 39: IiII / oO0o % Ii1I
   if ( OO00 . updown == False and OOOoO == False ) :
    OO00 . updown = True
    lprint ( "Change up/down status for referral-node {} to up" . format ( I1iiIi111I ) )
    if 62 - 62: I11i - o0oOOo0O0Ooo
   elif ( OO00 . updown == True and OOOoO == True ) :
    OO00 . updown = False
  ...
  o0o0oo = { }
  for OO0Oo00o0o0 in OO00o0oO0O00 . referral_set : o0o0oo [ OO0Oo00o0o0 ] = None
  if 39 - 39: i1IIi
  ...
  for OoOOoO0oOo in range ( oOO0O0o0oOooO . rloc_count ) :
   ...
   O0O0 = iIIi . rloc . print_address ( )
   if ( OO00o0oO0O00 . referral_set . has_key ( O0O0 ) == False ) :
    OO00 = lisp_referral_node ( )
    OO00 . referral_address . copy_address ( iIIi . rloc )
    OO00o0oO0O00 . referral_set [ O0O0 ] = OO00
    if ( I1iiIi111I == O0O0 and OOOoO ) : OO00 . updown = False
   else :
    OO00 = OO00o0oO0O00 . referral_set [ O0O0 ]
    if ( o0o0oo . has_key ( O0O0 ) ) : o0o0oo . pop ( O0O0 )
    if 85 - 85: I11i + I11i + oO0o - OoOoOO00
   OO00 . priority = iIIi . priority
   OO00 . weight = iIIi . weight
   if 15 - 15: OoO0O00
  ...
  for OO0Oo00o0o0 in o0o0oo : OO00o0oO0O00 . referral_set . pop ( OO0Oo00o0o0 )
  if 35 - 35: i11iIiiIii
  iIiI1I1ii1I1 = OO00o0oO0O00 . print_eid_tuple ( )
  ...
  if ( iiIIiI == LISP_DDT_ACTION_DELEGATION_HOLE ) :
   lisp_send_negative_map_reply ( oooO . lisp_sockets , OO00o0oO0O00 . eid ,
 OO00o0oO0O00 . group , oooO . nonce , oooO . itr , oooO . sport , 15 , None , False )
   oooO . dequeue_map_request ( )
  ...
  if ( iiIIiI == LISP_DDT_ACTION_NOT_AUTH ) :
   if ( oooO . tried_root ) :
    lisp_send_negative_map_reply ( oooO . lisp_sockets , OO00o0oO0O00 . eid ,
 OO00o0oO0O00 . group , oooO . nonce , oooO . itr , oooO . sport , 0 , None , False )
    oooO . dequeue_map_request ( )
   else :
  ...
  if ( iiIIiI == LISP_DDT_ACTION_MS_NOT_REG ) :
   ...
   if ( len ( OO00o0oO0O00 . referral_set ) == 0 ) :
    oooO . dequeue_map_request ( )
   else :
    lisp_send_ddt_map_request ( oooO , False )
 ...
 OO00o0oO0O00 . eid , OO00o0oO0O00 . group , oooO . nonce , oooO . itr ,
 oooO . sport , 15 , None , False )
  ...
  if ( iiIIiI == LISP_DDT_ACTION_MS_ACK ) : oooO . dequeue_map_request ( )
...
def lisp_send_map_register ( lisp_sockets , packet , map_register , ms ) :
 ...
 if ( ms . ekey != None ) :
  IIi1IIii1 = ms . ekey . zfill ( 32 )
  OoOooO = "0" * 8
  iiIi = chacha . ChaCha ( IIi1IIii1 , OoOooO , 20 ) . encrypt ( packet [ 4 : : ] )
...
def lisp_send_ecm ( lisp_sockets , packet , inner_source , inner_sport , inner_dest ,
 ...
 ooO0 = I11IIi11Iii1 . encode ( packet , inner_source , inner_dest )
 if ( ooO0 == None ) :
...
class lisp_cache ( ) :
 ...
 def lookup_cache ( self , prefix , exact ) :
  ...
  for Iii1iii1II in self . cache_sorted :
   if ( IIIIi11IiiI < Iii1iii1II ) : return ( iIIiOOOO0 )
 ...
 oOOoO0oO0oo0O . eid . is_more_specific ( iIIiOOOO0 . eid ) ) : iIIiOOOO0 = oOOoO0oO0oo0O
     if 95 - 95: I11i
...
def lisp_map_cache_lookup ( source , dest ) :
 ...
 O0OoO = lisp_map_cache . lookup_cache ( dest , False )
 if ( O0OoO == None ) :
 ...
 if ( o0OooO == False ) :
  oOooOO00OooO = green ( O0OoO . eid . print_prefix ( ) , False )
 ...
 O0OoO = O0OoO . lookup_source_cache ( source , False )
 if ( O0OoO == None ) :
 ...
 oOooOO00OooO = green ( O0OoO . print_eid_tuple ( ) , False )
...
def lisp_referral_cache_lookup ( eid , group , exact ) :
 if ( group and group . is_null ( ) ) :
  Ooo00o0000 = lisp_referral_cache . lookup_cache ( eid , exact )
  return ( Ooo00o0000 )
  if 33 - 33: OoO0O00
 ...
 if 42 - 42: i11iIiiIii / O0
 if 8 - 8: I1Ii111
 Ooo00o0000 = lisp_referral_cache . lookup_cache ( group , exact )
 if ( Ooo00o0000 == None ) : return ( None )
 if 51 - 51: i11iIiiIii
 IiiII = Ooo00o0000 . lookup_source_cache ( eid , exact )
 if ( IiiII ) : return ( IiiII )
 if 58 - 58: i11iIiiIii * i11iIiiIii - OoO0O00
 if ( exact ) : Ooo00o0000 = None
 return ( Ooo00o0000 )
...
def lisp_site_eid_lookup ( eid , group , exact ) :
 ...
 if ( exact ) :
  ...
  if ( Ooo0 and Ooo0 . accept_more_specifics ) :
   if ( group . is_more_specific ( Ooo0 . group ) ) : IiiiiiIiI = Ooo0
   if 59 - 59: OOooOOo
...
class lisp_address ( ) :
 ...
 def store_address ( self , addr_str ) :
  ...
  Iii1i1IiI = addr_str . find ( "]" )
  if ( OoOOoO0oOo != - 1 and Iii1i1IiI != - 1 ) :
   self . instance_id = int ( addr_str [ OoOOoO0oOo + 1 : Iii1i1IiI ] )
   addr_str = addr_str [ Iii1i1IiI + 1 : : ]
...
class lisp_json ( ) :
 ...
 def print_json ( self , html ) :
  ...
  Ii1 = "***"
  if ( html ) : Ii1 = red ( Ii1 , html )
  O00O0oo0O0OOo = Ii1 + self . json_string + Ii1
 ...
 def encrypt_json ( self ) :
  IIi1IIii1 = self . json_key . zfill ( 32 )
  OoOooO = "0" * 8
  ...
  for OO0Oo00o0o0 in oO0oOo :
   ...
   iiIiII11i1 = chacha . ChaCha ( IIi1IIii1 , OoOooO ) . encrypt ( iiIiII11i1 )
 ...
 def decrypt_json ( self ) :
  ...
  for OO0Oo00o0o0 in oO0oOo :
   ...
   oO0oOo [ OO0Oo00o0o0 ] = chacha . ChaCha ( IIi1IIii1 , OoOooO ) . encrypt ( iiIiII11i1 )
...
class lisp_rloc ( ) :
 ...
 def print_recent_rloc_probe_rtts ( self ) :
  i1iiOO0O0O = str ( self . recent_rloc_probe_rtts )
  i1iiOO0O0O = i1iiOO0O0O . replace ( "-1" , "?" )
  return ( i1iiOO0O0O )
 ...
 def print_recent_rloc_probe_latencies ( self ) :
  ooOo0OO = str ( self . recent_rloc_probe_latencies )
  return ( ooOo0OO )
 ...
 def process_rloc_probe_reply ( self , ts , nonce , eid , group , hc , ttl , jt ) :
  ...
  if ( IIIi1iI1 . state != LISP_RLOC_UP_STATE ) :
   ...
   O0OoO = lisp_map_cache . lookup_cache ( eid , True )
   if ( O0OoO ) : lisp_write_ipc_map_cache ( True , O0OoO )
  ...
  OOOOo00 = bold ( "RLOC-probe reply" , False )
  O0O0 = IIIi1iI1 . rloc . print_address_no_iid ( )
  ...
  if ( IIIi1iI1 . rloc_next_hop != None ) :
   ...
   Oo00 = ", nh {}({})" . format ( IiI1iI , IiI11I111 )
  ...
  if 80 - 80: Oo0Ooo
  lprint ( ( "    Received {} from {}{} for {}, {}, rtt {}{}, " + "to-ttl/from-ttl {}{}" ) . format ( OOOOo00 , red ( O0O0 , False ) , IIIiIIi111 , I1i ,
  # I1ii11iIi11i / I1Ii111 . OoOoOO00
 IiIiiII1I , iIIiiIii11I1i , Oo00 , str ( hc ) + "/" + str ( ttl ) , ooOO00o ) )
  if 97 - 97: i1IIi / Ii1I
  ...
  if ( Ii1II11 != None ) :
   ...
   Oo00 = bold ( "nh {}({})" . format ( IiI1iI , IiI11I111 ) , False )
 ...
 def print_rloc_probe_state ( self , trailing_linefeed ) :
  ...
  while ( True ) :
   ...
   OoiIIIiIi1I1i += ( "{}RLOC-probe request sent: {}\n{}RLOC-probe reply " + "received: {}, rtt {}" ) . format ( I1iiIi111I , lisp_print_elapsed ( ooo0oOOOooOoO ) ,
   # oO0o + Oo0Ooo * I1Ii111 % OOooOOo . Oo0Ooo . I1IiiI
 I1iiIi111I , lisp_print_elapsed ( ooO0oO ) , iIIiiIii11I1i )
...
class lisp_mapping ( ) :
 ...
 def has_ttl_elapsed ( self ) :
  ...
  iI1o00Ooo = self . map_cache_ttl - ( self . map_cache_ttl / 10 )
 ...
 def select_rloc ( self , lisp_packet , ipc_socket ) :
  ...
  if ( ooO0oOoO0O0 == 4 ) :
   ...
   for OoOOoO0oOo in range ( 0 , 12 + O00oIi11I11iIi1i1 , 4 ) :
  ...
  if ( lisp_data_plane_logging ) :
   ...
   for iiiI1I in self . best_rloc_set :
    ...
    if 33 - 33: Ii1I
   dprint ( "Packet hash {}, index {}, best-rloc-list: {}" . format ( hex ( iIIi111I1i1i ) , iIIi111I1i1i % i1iIii , red ( str ( O0ooo ) , False ) ) )
  ...
  if ( IIIi1iI1 . up_state ( ) == False ) :
   OOO0OOO0O00 = iIIi111I1i1i % i1iIii
   I1i11II = ( OOO0OOO0O00 + 1 ) % i1iIii
   while ( I1i11II != OOO0OOO0O00 ) :
 ...
 None ] )
  ...
  iiIIiI = self . action if ( OoOooO00 == None ) else None
  ...
  if ( OO0Ooo0O00ooOo0o and OO0Ooo0O00ooOo0o . request_nonce_timeout ( ) == False ) :
   O0oo00o000 = OO0Ooo0O00ooOo0o . get_request_or_echo_nonce ( ipc_socket , OoOooO00 )
  ...
  return ( [ OoOooO00 , IiO0o , O0oo00o000 , iiIIiI , None , IIIi1iI1 ] )
  if 79 - 79: oO0o + IiII
 ...
 def add_cache ( self , do_ipc = True ) :
  if ( self . group . is_null ( ) ) :
   ...
   O0OoO = lisp_map_cache . lookup_cache ( self . group , True )
   if ( O0OoO == None ) :
    O0OoO = lisp_mapping ( self . group , self . group , [ ] )
    O0OoO . eid . copy_address ( self . group )
    O0OoO . group . copy_address ( self . group )
    lisp_map_cache . add_cache ( self . group , O0OoO )
    if 58 - 58: OoooooooOO - OOooOOo * oO0o / Ii1I . IiII
   if ( self . eid . is_null ( ) ) : self . eid . make_default_route ( O0OoO . group )
   O0OoO . add_source_entry ( self )
 ...
 def delete_cache ( self ) :
  ...
  if ( self . group . is_null ( ) ) :
   ...
   iI1III1111I1 = O0OoO . lookup_source_cache ( self . eid , True )
   if ( iI1III1111I1 == None ) : return
   if 32 - 32: I1IiiI % oO0o
   O0OoO . source_cache . delete_cache ( self . eid )
   if ( O0OoO . source_cache . cache_size ( ) == 0 ) :
...
def lisp_lookup_group ( group ) :
 O0ooo = None
 for oO0O000Oo in lisp_group_mapping_list . values ( ) :
  o00O00 = lisp_is_group_more_specific ( group , oO0O000Oo )
  if ( o00O00 == - 1 ) : continue
  if ( O0ooo == None or o00O00 > O0ooo . group_prefix . mask_len ) : O0ooo = oO0O000Oo
...
class lisp_site_eid ( ) :
 ...
 "N" if self . map_notify_requested else "n" )
   ...
   IIi1 = IIi1 . split ( "-" )
   OoiIIIiIi1I1i = ""
   for oOOO00Ooo0oo0 in IIi1 :
    o0Oo = lisp_site_flags [ oOOO00Ooo0oo0 . upper ( ) ]
    o0Oo = o0Oo . format ( "" if oOOO00Ooo0oo0 . isupper ( ) else "not " )
    OoiIIIiIi1I1i += lisp_span ( oOOO00Ooo0oo0 , o0Oo )
    if ( oOOO00Ooo0oo0 . lower ( ) != "n" ) : OoiIIIiIi1I1i += "-"
 ...
 def merge_rlocs_in_site_eid ( self ) :
  self . registered_rlocs = [ ]
  for IiiiiiIiI in self . individual_registrations . values ( ) :
 ...
 def merge_rles_in_site_eid ( self ) :
  ...
  for IiiiiiIiI in self . individual_registrations . values ( ) :
   if ( IiiiiiIiI . registered == False ) : continue
   O0oI1Iii = IiiiiiIiI . registered_rlocs [ 0 ] . rle
   if ( O0oI1Iii == None ) : continue
   if 5 - 5: II111iiii
   oOoOoO0Oo0oo = IiiiiiIiI . registered_rlocs [ 0 ] . rloc_name
 ...
 def do_rloc_sets_match ( self , prev_rloc_set ) :
  ...
  for O0O0OOo0O in prev_rloc_set :
   iIi1I1i11iI = O0O0OOo0O . rloc
   if ( self . is_rloc_in_rloc_set ( iIi1I1i11iI ) == False ) : return ( False )
...
class lisp_mr ( ) :
 ...
 time . time ( ) - self . last_dns_resolve < 30 ) : return
  ...
  for IiIIiiI in IiIIii1I [ 1 : : ] :
   ...
   if ( oooO != None and oooO . a_record_index == IiIIii1I . index ( IiIIiiI ) ) :
    continue
    if 24 - 24: I11i / Oo0Ooo / i1IIi + IiII
   oooO = lisp_mr ( IiIIiiI , None , None )
   oooO . a_record_index = IiIIii1I . index ( IiIIiiI )
...
class lisp_referral ( ) :
 ...
 oOOOOOO0oO , len ( self . referral_set ) ) )
  if 35 - 35: OoOoOO00
  for OO00 in self . referral_set . values ( ) :
   OO00 . print_ref_node ( referral_indent )
 ...
 def add_cache ( self ) :
  if ( self . group . is_null ( ) ) :
   ...
   Ooo00o0000 = lisp_referral_cache . lookup_cache ( self . group , True )
   if ( Ooo00o0000 == None ) :
    Ooo00o0000 = lisp_referral ( )
    Ooo00o0000 . eid . copy_address ( self . group )
    Ooo00o0000 . group . copy_address ( self . group )
    lisp_referral_cache . add_cache ( self . group , Ooo00o0000 )
    if 48 - 48: OoooooooOO + II111iiii
   if ( self . eid . is_null ( ) ) : self . eid . make_default_route ( Ooo00o0000 . group )
   Ooo00o0000 . add_source_entry ( self )
 ...
 def delete_cache ( self ) :
  if ( self . group . is_null ( ) ) :
   ...
   Ooo00o0000 = lisp_referral_cache . lookup_cache ( self . group , True )
   if ( Ooo00o0000 == None ) : return
   if 2 - 2: ooOoO0o % ooOoO0o
   IiiII = Ooo00o0000 . lookup_source_cache ( self . eid , True )
   if ( IiiII == None ) : return
   if 94 - 94: ooOoO0o / OoooooooOO * i1IIi . Oo0Ooo * i11iIiiIii
   Ooo00o0000 . source_cache . delete_cache ( self . eid )
   if ( Ooo00o0000 . source_cache . cache_size ( ) == 0 ) :
...
class lisp_ms ( ) :
 ...
 time . time ( ) - self . last_dns_resolve < 30 ) : return
  ...
  for IiIIiiI in IiIIii1I [ 1 : : ] :
   ...
   if ( IIo0o0oo0 != None and IIo0o0oo0 . a_record_index == IiIIii1I . index ( IiIIiiI ) ) :
    continue
    if 20 - 20: OOooOOo . iIii1I11I1II1 - I1Ii111 . i1IIi
   IIo0o0oo0 = copy . deepcopy ( self )
   IIo0o0oo0 . map_server . store_address ( IiIIiiI )
   IIo0o0oo0 . a_record_index = IiIIii1I . index ( IiIIiiI )
  ...
  oo0Oo00OO0000 = [ ]
  for IIo0o0oo0 in lisp_map_servers_list . values ( ) :
   if ( self . dns_name != IIo0o0oo0 . dns_name ) : continue
   OoOOOO = IIo0o0oo0 . map_server . print_address_no_iid ( )
   if ( OoOOOO in IiIIii1I ) : continue
   oo0Oo00OO0000 . append ( IIo0o0oo0 )
   if 69 - 69: OOooOOo
  for IIo0o0oo0 in oo0Oo00OO0000 : IIo0o0oo0 . delete_ms ( )
...
class lisp_policy ( ) :
 ...
 def match_policy_map_request ( self , mr , srloc ) :
  for oOooOO00OooO in self . match_clauses :
   IIIiIIi111 = oOooOO00OooO . source_eid
   ...
   IIIiIIi111 = oOooOO00OooO . dest_eid
   I11iI1I = mr . target_eid
   if ( IIIiIIi111 and I11iI1I and I11iI1I . is_more_specific ( IIIiIIi111 ) == False ) : continue
   if 65 - 65: I1Ii111 + OOooOOo
   IIIiIIi111 = oOooOO00OooO . source_rloc
   I11iI1I = srloc
   if ( IIIiIIi111 and I11iI1I and I11iI1I . is_more_specific ( IIIiIIi111 ) == False ) : continue
   OOoOo0O0 = oOooOO00OooO . datetime_lower
   OO0O0OOooo = oOooOO00OooO . datetime_upper
...
class lisp_pubsub ( ) :
 ...
 def add ( self , eid_prefix ) :
  ...
  OOo = lisp_pubsub_cache [ oOooOOo000o0o ]
  if 82 - 82: Oo0Ooo
  I11IiI1i11i1 = "Add"
...
def lisp_get_any_map_server ( ) :
 for IIo0o0oo0 in lisp_map_servers_list . values ( ) : return ( IIo0o0oo0 )
 return ( None )
...
def lisp_get_map_resolver ( address , eid ) :
 if ( address != None ) :
  ...
  for OO0Oo00o0o0 in lisp_map_resolvers_list :
   ...
   oooO = lisp_map_resolvers_list [ OO0Oo00o0o0 ]
 ...
 if ( eid == "" ) :
  ...
  I111 = "all" if oooOOoO0oo0 == None else oooOOoO0oo0 . use_mr_name
  if 64 - 64: Oo0Ooo
  if 33 - 33: I1Ii111
 i11iiiIII = None
 for oooO in lisp_map_resolvers_list . values ( ) :
  if ( I111 == "" ) : return ( oooO )
  if ( oooO . mr_name != I111 ) : continue
  if ( i11iiiIII == None or oooO . last_used < i11iiiIII . last_used ) : i11iiiIII = oooO
  if 39 - 39: I11i
 return ( i11iiiIII )
...
def lisp_get_decent_map_resolver ( eid ) :
 ...
 i11iiiIII = None
 for oooO in lisp_map_resolvers_list . values ( ) :
  if ( iiI1IIII1Ii1 != oooO . dns_name ) : continue
  if ( i11iiiIII == None or oooO . last_used < i11iiiIII . last_used ) : i11iiiIII = oooO
...
def lisp_send_info_request ( lisp_sockets , dest , port , device_name ) :
 ...
 O0oii1III1II1 = lisp_info ( )
 O0oii1III1II1 . nonce = lisp_get_control_nonce ( )
 if ( device_name ) : O0oii1III1II1 . hostname += "-" + device_name
 ...
 II111i1i = False
 if ( device_name ) :
  OoOOoOOoOoO = lisp_get_host_route_next_hop ( O0O0 )
  ...
  if 3 - 3: I1Ii111
  if ( port == LISP_CTRL_PORT and OoOOoOOoOoO != None ) :
   while ( True ) :
    time . sleep ( .01 )
    OoOOoOOoOoO = lisp_get_host_route_next_hop ( O0O0 )
    if ( OoOOoOOoOoO == None ) : break
  ...
  for OoO , Oo00 in o0O0oo :
   ...
   if ( OoOOoOOoOoO != Oo00 ) :
    if ( OoOOoOOoOoO != None ) :
     lisp_install_host_route ( O0O0 , OoOOoOOoOoO , False )
 ...
 o0o0ooOOo0oO = O0oii1III1II1 . encode ( )
 O0oii1III1II1 . print_info ( )
 ...
 if 1 - 1: OOooOOo
 Ii1iiI = "(for control)" if port == LISP_CTRL_PORT else "(for data)"
 Ii1iiI = bold ( Ii1iiI , False )
 IIIiIIi111 = bold ( "{}" . format ( port ) , False )
 OoOOOO = red ( O0O0 , False )
 IiIi1I1i1iIiI = "RTR " if port == LISP_DATA_PORT else "MS "
 lprint ( "Send Info-Request to {}{}, port {} {}" . format ( IiIi1I1i1iIiI , OoOOOO , IIIiIIi111 , Ii1iiI ) )
 ...
 if ( II111i1i ) :
  lisp_install_host_route ( O0O0 , None , False )
  if ( OoOOoOOoOoO != None ) : lisp_install_host_route ( O0O0 , OoOOoOOoOoO , True )
...
def lisp_process_info_request ( lisp_sockets , packet , addr_str , sport , rtr_list ) :
 ...
 O0oii1III1II1 = lisp_info ( )
 packet = O0oii1III1II1 . decode ( packet )
 if ( packet == None ) : return
 O0oii1III1II1 . print_info ( )
 ...
 O0oii1III1II1 . info_reply = True
 O0oii1III1II1 . global_etr_rloc . store_address ( addr_str )
 O0oii1III1II1 . etr_port = sport
 if 37 - 37: ooOoO0o
 ...
 if ( O0oii1III1II1 . hostname != None ) :
  O0oii1III1II1 . private_etr_rloc . afi = LISP_AFI_NAME
  O0oii1III1II1 . private_etr_rloc . store_address ( O0oii1III1II1 . hostname )
  if 82 - 82: iII111i - I1Ii111 - OoOoOO00
  if 96 - 96: Oo0Ooo . Oo0Ooo % o0oOOo0O0Ooo - I1IiiI * iIii1I11I1II1
 if ( rtr_list != None ) : O0oii1III1II1 . rtr_list = rtr_list
 packet = O0oii1III1II1 . encode ( )
 O0oii1III1II1 . print_info ( )
 ...
 if 32 - 32: O0 + IiII
 OOo0O0Oo = lisp_info_source ( O0oii1III1II1 . hostname , addr_str , sport )
 OOo0O0Oo . cache_address_for_info_source ( )
 return
 if 82 - 82: i1IIi - II111iiii + OoOoOO00 % o0oOOo0O0Ooo . OoooooooOO
 if 9 - 9: I1ii11iIi11i % Ii1I / i1IIi % i11iIiiIii
 if 57 - 57: OoooooooOO + II111iiii * Ii1I + I1Ii111 / ooOoO0o
 if 73 - 73: IiII * o0oOOo0O0Ooo + II111iiii * o0oOOo0O0Ooo . OoOoOO00 . i1IIi
 if 76 - 76: IiII / OoooooooOO % oO0o + II111iiii - OoOoOO00
 if 69 - 69: OoOoOO00 / O0 - i11iIiiIii
...
def lisp_get_all_translated_rlocs ( ) :
 ...
 for oooOOoO0oo0 in lisp_db_list :
  for O0O0OOo0O in oooOOoO0oo0 . rloc_set :
   ...
   I1IiiII1iI . append ( IiIIiiI )
   if 40 - 40: iII111i * ooOoO0o + IiII / IiII * ooOoO0o
   if 93 - 93: I1ii11iIi11i - I1IiiI * IiII
 return ( I1IiiII1iI )
 if 90 - 90: OoooooooOO + OoOoOO00 . OOooOOo - I1Ii111 - OOooOOo
...
def lisp_update_default_routes ( map_resolver , iid , rtr_list ) :
 ...
 for i1I1iiiI in [ LISP_AFI_IPV4 , LISP_AFI_IPV6 , LISP_AFI_MAC ] :
  ...
  O0OoO = lisp_map_cache . lookup_cache ( o00oO0ooO000 , True )
  if ( O0OoO ) :
   if ( O0OoO . checkpoint_entry ) :
    lprint ( "Updating checkpoint entry for {}" . format ( green ( O0OoO . print_eid_tuple ( ) , False ) ) )
    if 89 - 89: I11i % II111iiii
   elif ( O0OoO . do_rloc_sets_match ( rtr_list . values ( ) ) ) :
    continue
    if 35 - 35: oO0o
   O0OoO . delete_cache ( )
   if 65 - 65: II111iiii
   if 87 - 87: oO0o / OoO0O00 - oO0o
  o0OoOOooO000O . append ( [ o00oO0ooO000 , "" ] )
  if 69 - 69: i11iIiiIii
  ...
  II1IiIi111I = lisp_map_cache . lookup_cache ( iiIoOOOOoo0O00o , True )
  if ( II1IiIi111I ) : II1IiIi111I = II1IiIi111I . source_cache . lookup_cache ( o00oO0ooO000 , True )
  if ( II1IiIi111I ) : II1IiIi111I . delete_cache ( )
  if 92 - 92: i1IIi + IiII - iIii1I11I1II1 + i1IIi * ooOoO0o - i11iIiiIii
  o0OoOOooO000O . append ( [ o00oO0ooO000 , iiIoOOOOoo0O00o ] )
  if 68 - 68: o0oOOo0O0Ooo + IiII / iII111i - i11iIiiIii / OOooOOo
 if ( len ( o0OoOOooO000O ) == 0 ) : return
 if 62 - 62: I1IiiI
 if 42 - 42: II111iiii
 if 49 - 49: OoooooooOO
 ...
 for IiIi1I1i1iIiI in rtr_list :
  I1IIiI1I1iiiI = rtr_list [ IiIi1I1i1iIiI ]
  O0O0OOo0O = lisp_rloc ( )
  O0O0OOo0O . rloc . copy_address ( I1IIiI1I1iiiI )
 ...
 for o00oO0ooO000 in o0OoOOooO000O :
  O0OoO = lisp_mapping ( o00oO0ooO000 [ 0 ] , o00oO0ooO000 [ 1 ] , oOO000OOO )
  O0OoO . mapping_source = map_resolver
  O0OoO . map_cache_ttl = LISP_MR_TTL * 60
  O0OoO . add_cache ( )
  lprint ( "Add {} to map-cache with RTR RLOC-set: {}" . format ( green ( O0OoO . print_eid_tuple ( ) , False ) , rtr_list . keys ( ) ) )
  if 65 - 65: OoooooooOO
...
def lisp_process_info_reply ( source , packet , store ) :
 ...
 if 46 - 46: i11iIiiIii
 ooOOOo = False
 for IiIi1I1i1iIiI in O0oii1III1II1 . rtr_list :
 ...
 if ( store == False ) :
  return ( [ O0oii1III1II1 . global_etr_rloc , O0oii1III1II1 . etr_port , ooOOOo ] )
 ...
 for oooOOoO0oo0 in lisp_db_list :
  for O0O0OOo0O in oooOOoO0oo0 . rloc_set :
   ...
   if ( iI1ii1iI1 == None ) :
    ...
    if ( O0oii1III1II1 . private_etr_rloc . is_null ( ) == False and
 IIIi1iI1 . is_exact_match ( O0oii1III1II1 . private_etr_rloc ) == False ) :
     continue
     if 10 - 10: O0 / I11i
   elif ( O0oii1III1II1 . private_etr_rloc . is_dist_name ( ) ) :
    oOoOoO0Oo0oo = O0oii1III1II1 . private_etr_rloc . address
   ...
   OOoIiI1IIIIi1I = O0oii1III1II1 . global_etr_rloc . is_exact_match ( IIIi1iI1 )
   if ( O0O0OOo0O . translated_port == 0 and OOoIiI1IIIIi1I ) :
    lprint ( "No NAT for {} ({}), EID-prefix {}" . format ( iI ,
 iI1ii1iI1 , iIiI1I1ii1I1 ) )
    continue
    if 85 - 85: o0oOOo0O0Ooo
    if 55 - 55: I1Ii111 + O0 / II111iiii . I11i
    if 97 - 97: O0 * O0 % OoooooooOO % I11i
    if 48 - 48: Ii1I
    if 32 - 32: O0
   ii1IIII1I1Ii = O0oii1III1II1 . global_etr_rloc
   OOOOo0oO0 = O0O0OOo0O . translated_rloc
   if ( OOOOo0oO0 . is_exact_match ( ii1IIII1I1Ii ) and
 O0oii1III1II1 . etr_port == O0O0OOo0O . translated_port ) : continue
   if 70 - 70: iIii1I11I1II1 - I11i
   lprint ( "Store translation {}:{} for {} ({}), EID-prefix {}" . format ( red ( O0oii1III1II1 . global_etr_rloc . print_address_no_iid ( ) , False ) ,
   # OoO0O00
 O0oii1III1II1 . etr_port , iI , iI1ii1iI1 , iIiI1I1ii1I1 ) )
   if 22 - 22: II111iiii * I11i + OoO0O00 % i1IIi
   O0O0OOo0O . store_translated_rloc ( O0oii1III1II1 . global_etr_rloc ,
 O0oii1III1II1 . etr_port )
   if 84 - 84: OoO0O00 . OOooOOo + Oo0Ooo - OOooOOo . iIii1I11I1II1
   if 70 - 70: OOooOOo / iII111i . I1IiiI . ooOoO0o
 return ( [ O0oii1III1II1 . global_etr_rloc , O0oii1III1II1 . etr_port , ooOOOo ] )
 if 99 - 99: OoooooooOO - iII111i
...
def lisp_test_mr ( lisp_sockets , port ) :
 ...
 OooOo0OOo00O0 = lisp_address ( LISP_AFI_IPV6 , "" , 0 , 0 )
 ...
 OooOo0OOo00O0 . store_address ( "0100::1" )
 lisp_send_map_request ( lisp_sockets , port , None , OooOo0OOo00O0 , None )
 OooOo0OOo00O0 . store_address ( "8000::1" )
 lisp_send_map_request ( lisp_sockets , port , None , OooOo0OOo00O0 , None )
 ...
 oOii1I = threading . Timer ( LISP_TEST_MR_INTERVAL , lisp_test_mr ,
 [ lisp_sockets , port ] )
 oOii1I . start ( )
 return
 if 43 - 43: ooOoO0o . I11i + i11iIiiIii + I1ii11iIi11i / i1IIi
 if 99 - 99: o0oOOo0O0Ooo % OOooOOo
 if 11 - 11: ooOoO0o / i1IIi
 if 77 - 77: I1IiiI * I11i - Oo0Ooo % i1IIi . o0oOOo0O0Ooo / O0
 if 85 - 85: oO0o + i11iIiiIii - i1IIi * I1Ii111 % i11iIiiIii
 if 22 - 22: I1Ii111
...
def lisp_update_local_rloc ( rloc ) :
 ...
 OooO0OO = rloc . rloc . print_address_no_iid ( )
 O00o0OoO0OOOo = IiIIiiI . print_address_no_iid ( )
 if 14 - 14: OoO0O00 + I1IiiI . o0oOOo0O0Ooo - OoO0O00 + Ii1I - Ii1I
 if ( OooO0OO == O00o0OoO0OOOo ) : return
 if 98 - 98: oO0o * O0 + I11i
 lprint ( "Local interface address changed on {} from {} to {}" . format ( rloc . interface , OooO0OO , O00o0OoO0OOOo ) )
...
def lisp_update_encap_port ( mc ) :
 for IIIi1iI1 in mc . rloc_set :
  ...
  # I1ii11iIi11i / OoooooooOO . Oo0Ooo % i11iIiiIii * Ii1I
...
def lisp_timeout_map_cache_walk ( mc , parms ) :
 ...
 if ( mc . group . is_null ( ) ) :
  ...
  if ( oo0Oo00OO0000 == [ ] or mc != oo0Oo00OO0000 [ - 1 ] ) :
   IiI1iooOOoo0oooo0 = lisp_write_checkpoint_entry ( IiI1iooOOoo0oooo0 , mc )
   if 8 - 8: i11iIiiIii
...
def lisp_timeout_map_cache ( lisp_map_cache ) :
 ...
 for O0OoO in oo0Oo00OO0000 : O0OoO . delete_cache ( )
 if 99 - 99: I1ii11iIi11i
 if 78 - 78: I1Ii111 . IiII - OOooOOo
 if 93 - 93: iIii1I11I1II1
 if 33 - 33: OOooOOo . i1IIi
 IiI1iooOOoo0oooo0 = iiii11IiIiI [ 1 ]
 lisp_checkpoint ( IiI1iooOOoo0oooo0 )
 return
...
def lisp_store_nat_info ( hostname , rloc , port ) :
 ...
 if ( I1OOoO0OoOOo0 . address == O0O0 and I1OOoO0OoOOo0 . port == port ) :
  ...
  lprint ( I11Ii1i . format ( "Refresh existing" ) )
  return ( False )
 ...
 for I1OOoO0OoOOo0 in lisp_nat_state_info [ hostname ] :
  if ( I1OOoO0OoOOo0 . address == O0O0 and I1OOoO0OoOOo0 . port == port ) :
   Ii1I1i = I1OOoO0OoOOo0
   break
   if 83 - 83: Ii1I - I11i . OoOoOO00 / OoOoOO00 * OoooooooOO * i11iIiiIii
   if 88 - 88: ooOoO0o + ooOoO0o / I1Ii111
   if 69 - 69: O0 * o0oOOo0O0Ooo + i1IIi * ooOoO0o . o0oOOo0O0Ooo
 if ( Ii1I1i == None ) :
  lprint ( I11Ii1i . format ( "Store new" ) )
 else :
  lisp_nat_state_info [ hostname ] . remove ( Ii1I1i )
  lprint ( I11Ii1i . format ( "Use previous" ) )
  if 46 - 46: Oo0Ooo / Oo0Ooo * IiII
  if 65 - 65: iIii1I11I1II1 * o0oOOo0O0Ooo - iII111i % II111iiii - I1ii11iIi11i
 o0Oo0O00oo = lisp_nat_state_info [ hostname ]
 lisp_nat_state_info [ hostname ] = [ Ii1II1 ] + o0Oo0O00oo
 return ( True )
...
def lisp_build_info_requests ( lisp_sockets , dest , port ) :
 ...
 if ( dest == None ) :
  for oooO in lisp_map_resolvers_list . values ( ) :
   O0Ooo0OO0 . append ( oooO . map_resolver )
   if 19 - 19: i1IIi
  oO000OO0oOO0 = O0Ooo0OO0
  if ( oO000OO0oOO0 == [ ] ) :
   for IIo0o0oo0 in lisp_map_servers_list . values ( ) :
    oO000OO0oOO0 . append ( IIo0o0oo0 . map_server )
    if 32 - 32: I1IiiI
    if 97 - 97: iII111i
  if ( oO000OO0oOO0 == [ ] ) : return
 else :
  oO000OO0oOO0 . append ( dest )
 ...
 for oooOOoO0oo0 in lisp_db_list :
  for O0O0OOo0O in oooOOoO0oo0 . rloc_set :
   ...
   if ( IiIIiiI in I1IiiII1iI ) : continue
   I1IiiII1iI [ IiIIiiI ] = O0O0OOo0O . interface
   if 51 - 51: I1IiiI
   if 52 - 52: I1Ii111
 if ( I1IiiII1iI == { } ) :
 ...
 for IiIIiiI in I1IiiII1iI :
  iI1ii1iI1 = I1IiiII1iI [ IiIIiiI ]
  OoOOOO = red ( IiIIiiI , False )
  lprint ( "Build Info-Request for private address {} ({})" . format ( OoOOOO ,
 iI1ii1iI1 ) )
  OoO = iI1ii1iI1 if len ( I1IiiII1iI ) > 1 else None
  for dest in oO000OO0oOO0 :
...
def lisp_valid_address_format ( kw , value ) :
 ...
 if ( value . find ( "." ) != - 1 ) :
  ...
  for OOoo0oOoO in IiIIiiI :
   if ( OOoo0oOoO . isdigit ( ) == False ) : return ( False )
   if ( int ( OOoo0oOoO ) > 255 ) : return ( False )
   if 73 - 73: OoooooooOO
  return ( True )
 ...
 if ( value [ 0 ] == "+" ) :
  IiIIiiI = value [ 1 : : ]
  for O0OooOo0o in IiIIiiI :
   if ( O0OooOo0o . isdigit ( ) == False ) : return ( False )
   if 67 - 67: OoO0O00 + I11i / Oo0Ooo + II111iiii - OOooOOo . Ii1I
  return ( True )
...
def lisp_process_api ( process , lisp_socket , data_structure ) :
 iIi1i1I1I1 , iiii11IiIiI = data_structure . split ( "%" )
 if 97 - 97: OOooOOo % I1ii11iIi11i + I1Ii111 + I1IiiI + iIii1I11I1II1
 lprint ( "Process API request '{}', parameters: '{}'" . format ( iIi1i1I1I1 ,
 iiii11IiIiI ) )
 if 77 - 77: O0
 iiii1II = [ ]
 if ( iIi1i1I1I1 == "map-cache" ) :
  if ( iiii11IiIiI == "" ) :
...
def lisp_gather_map_cache_data ( mc , data ) :
 ...
 for IIIi1iI1 in mc . rloc_set :
  ...
  if ( IIIi1iI1 . rloc . is_multicast_address ( ) ) :
   ...
   for O0I11IiI1ii in IIIi1iI1 . multicast_rloc_probe_list . values ( ) :
    oooO = lisp_fill_rloc_in_json ( O0I11IiI1ii )
    iiiI1I [ "multicast-rloc-set" ] . append ( oooO )
...
def lisp_fill_rloc_in_json ( rloc ) :
 ...
 I111iIiI1IIIi = rloc . last_rloc_probe_reply
 if ( I111iIiI1IIIi ) :
  iiiI1I [ "last-rloc-probe-reply" ] = lisp_print_elapsed ( I111iIiI1IIIi )
 ...
 if 76 - 76: OOooOOo
 oo0o0OooOoOOo = [ ]
 for iIIiiIii11I1i in rloc . recent_rloc_probe_rtts : oo0o0OooOoOOo . append ( str ( iIIiiIii11I1i ) )
 iiiI1I [ "recent-rloc-probe-rtts" ] = oo0o0OooOoOOo
 return ( iiiI1I )
 if 95 - 95: Oo0Ooo % ooOoO0o . OoO0O00 . OoooooooOO + I1ii11iIi11i
 if 84 - 84: o0oOOo0O0Ooo * OOooOOo / i11iIiiIii - Ii1I + I1ii11iIi11i
 if 7 - 7: I1ii11iIi11i
...
def lisp_process_api_map_cache_entry ( parms ) :
 ...
 iiii1II = [ ]
 O0OoO = lisp_map_cache_lookup ( iIiI111ii1Ii , OO0oooOO )
 if ( O0OoO ) : I11i11I1i1i , iiii1II = lisp_process_api_map_cache ( O0OoO , iiii1II )
 return ( iiii1II )
...
def lisp_process_api_site_cache_summary ( site_cache ) :
 ...
 for Iii1iii1II in site_cache . cache_sorted :
  for i1I1I11II in site_cache . cache [ Iii1iii1II ] . entries . values ( ) :
   if ( i1I1I11II . accept_more_specifics == False ) : continue
   if ( I1IIiII11I1 . has_key ( i1I1I11II . site . site_name ) == False ) :
    I1IIiII11I1 [ i1I1I11II . site . site_name ] = [ ]
   ...
   for iiII1ii in i1I1I11II . more_specific_registrations :
    if ( iiII1ii . registered ) : I1i [ "registered-count" ] += 1
    if 94 - 94: o0oOOo0O0Ooo - OoO0O00
   I1IIiII11I1 [ i1I1I11II . site . site_name ] . append ( I1i )
 ...
 iiii1II = [ ]
 for O00O0o in I1IIiII11I1 :
  I1iiIi111I = copy . deepcopy ( ooo0ooOO0OO )
  I1iiIi111I [ "site" ] = O00O0o
  I1iiIi111I [ "registrations" ] = I1IIiII11I1 [ O00O0o ]
...
def lisp_process_api_ms_or_mr ( ms_or_mr , data ) :
 ...
 if ( ms_or_mr ) :
  for IIo0o0oo0 in lisp_map_servers_list . values ( ) :
   if ( iiI1IIII1Ii1 ) :
    if ( iiI1IIII1Ii1 != IIo0o0oo0 . dns_name ) : continue
   else :
    if ( iIIiiiI . is_exact_match ( IIo0o0oo0 . map_server ) == False ) : continue
    if 64 - 64: Ii1I
    if 4 - 4: OoOoOO00
  ...
  for oooO in lisp_map_resolvers_list . values ( ) :
   if ( iiI1IIII1Ii1 ) :
    ...
    if ( iIIiiiI . is_exact_match ( oooO . map_resolver ) == False ) : continue
...
def lisp_process_api_database_mapping ( ) :
 ...
 for oooOOoO0oo0 in lisp_db_list :
  ...
  for iiiI1I in oooOOoO0oo0 . rloc_set :
   ...
   ii1iiOOoOOOo = iiiI1I . translated_rloc
   if ( ii1iiOOoOOOo . is_null ( ) == False ) :
    IIIi1iI1 [ "translated-rloc" ] = ii1iiOOoOOOo . print_address_no_iid ( )
...
def lisp_process_api_site_cache_entry ( parms ) :
 ...
 iiii1II = [ ]
 i1I1I11II = lisp_site_eid_lookup ( oOooOOo000o0o , iiIoOOOOoo0O00o , False )
 if ( i1I1I11II ) : lisp_gather_site_cache_data ( i1I1I11II , iiii1II )
 return ( iiii1II )
...
def lisp_get_interface_instance_id ( device , source_eid ) :
 ...
 source_eid . instance_id = O00Oo000
 if 69 - 69: Ii1I . II111iiii + o0oOOo0O0Ooo * iII111i
 if ( O0ooo == None ) : return ( i1 )
...
def lisp_allow_dynamic_eid ( device , eid ) :
 ...
 iI1ii1iI1 = lisp_myinterfaces [ device ]
 iIiiII1Ii = device if iI1ii1iI1 . dynamic_eid_device == None else iI1ii1iI1 . dynamic_eid_device
 if 15 - 15: I1Ii111 + i1IIi - OoooooooOO % ooOoO0o % IiII
 if 66 - 66: I11i . O0 * i1IIi % OoooooooOO - ooOoO0o
 if ( iI1ii1iI1 . does_dynamic_eid_match ( eid ) ) : return ( iIiiII1Ii )
 return ( None )
 if 54 - 54: O0 + I11i
 if 71 - 71: OoOoOO00
...
def lisp_start_rloc_probe_timer ( interval , lisp_sockets ) :
 ...
 O0ooOoO0Oo0oOo00o = lisp_process_rloc_probe_timer
 O00ooOo0Oo = threading . Timer ( interval , O0ooOoO0Oo0oOo00o , [ lisp_sockets ] )
 lisp_rloc_probe_timer = O00ooOo0Oo
 O00ooOo0Oo . start ( )
 return
...
def lisp_show_rloc_probe_list ( ) :
 ...
 for OO0Oo00o0o0 in lisp_rloc_probe_list :
  iIIiIIII11iii = lisp_rloc_probe_list [ OO0Oo00o0o0 ]
  lprint ( "RLOC {}:" . format ( OO0Oo00o0o0 ) )
  for iiiI1I , I1i , OoIi1I1I in iIIiIIII11iii :
...
def lisp_mark_rlocs_for_other_eids ( eid_list ) :
 ...
 for IIIi1iI1 , I1i , OoIi1I1I in eid_list :
  O0OoO = lisp_map_cache . lookup_cache ( I1i , True )
  if ( O0OoO ) : lisp_write_ipc_map_cache ( True , O0OoO )
  if 33 - 33: iII111i
 return
...
def lisp_process_rloc_probe_timer ( lisp_sockets ) :
 ...
 iIIi11i = lisp_get_default_route_next_hops ( )
 ...
 for oOO in lisp_rloc_probe_list . values ( ) :
  ...
  III1IIii1 = None
  for O0OO0o0OoO , oOooOOo000o0o , iiIoOOOOoo0O00o in oOO :
   O0O0 = O0OO0o0OoO . rloc . print_address_no_iid ( )
   if 40 - 40: OoooooooOO
   if 100 - 100: IiII - I11i
   if 79 - 79: iII111i % O0
   if 73 - 73: Oo0Ooo
   i1ii1iiI , iI1ii11I , I1iI1 = lisp_allow_gleaning ( oOooOOo000o0o , None , O0OO0o0OoO )
   if ( i1ii1iiI and iI1ii11I == False ) :
    I1i = green ( oOooOOo000o0o . print_address ( ) , False )
    O0O0 += ":{}" . format ( O0OO0o0OoO . translated_port )
    ...
    if 70 - 70: O0
   if ( O0OO0o0OoO . down_state ( ) ) : continue
   ...
   if ( III1IIii1 ) :
    O0OO0o0OoO . last_rloc_probe_nonce = III1IIii1 . last_rloc_probe_nonce
    if 25 - 25: iIii1I11I1II1 - I1IiiI . i11iIiiIii + ooOoO0o
    if ( III1IIii1 . translated_port == O0OO0o0OoO . translated_port and III1IIii1 . rloc_name == O0OO0o0OoO . rloc_name ) :
     ...
     O0OO0o0OoO . last_rloc_probe = III1IIii1 . last_rloc_probe
     continue
   ...
   IIIi1iI1 = None
   while ( True ) :
    IIIi1iI1 = O0OO0o0OoO if IIIi1iI1 == None else IIIi1iI1 . next_rloc
    if ( IIIi1iI1 == None ) : break
    ...
    if ( IIIi1iI1 . rloc_next_hop != None ) :
     if ( IIIi1iI1 . rloc_next_hop not in iIIi11i ) :
 ...
 red ( O0O0 , False ) , O0O0oO0O0 ) )
    ...
    ii11ii1 = 0 if i11iII11I1III == None else time . time ( ) - i11iII11I1III
    if ( IIIi1iI1 . unreach_state ( ) and ii11ii1 < LISP_RLOC_PROBE_INTERVAL ) :
    ...
    if ( OO0Ooo0O00ooOo0o and OO0Ooo0O00ooOo0o . request_nonce_timeout ( ) ) :
     ...
     IIIi1iI1 . last_state_change = lisp_get_timestamp ( )
     O0O0oO0O0 = bold ( "unreachable" , False )
     lprint ( "RLOC {} went {}, nonce-echo failed" . format ( red ( O0O0 , False ) , O0O0oO0O0 ) )
    ...
    if ( IIIi1iI1 . last_rloc_probe != None ) :
     ...
     ii11ii1 = time . time ( ) - i11iII11I1III
     if ( IIIi1iI1 . up_state ( ) and ii11ii1 >= LISP_RLOC_PROBE_REPLY_WAIT ) :
      if 60 - 60: i1IIi / iIii1I11I1II1 + I11i % iII111i
      IIIi1iI1 . state = LISP_RLOC_UNREACH_STATE
      IIIi1iI1 . last_state_change = lisp_get_timestamp ( )
      lisp_update_rtr_updown ( IIIi1iI1 . rloc , False )
      O0O0oO0O0 = bold ( "unreachable" , False )
      lprint ( "RLOC {} went {}, probe it" . format ( red ( O0O0 , False ) , O0O0oO0O0 ) )
    ...
    i1iiI = "" if IIIi1iI1 . unreach_state ( ) == False else " unreachable"
    ...
    if ( IIIi1iI1 . rloc_next_hop != None ) :
     IiI11I111 , IiI1iI = IIIi1iI1 . rloc_next_hop
     lisp_install_host_route ( O0O0 , IiI1iI , True )
     o0oo = ", send on nh {}({})" . format ( IiI1iI , IiI11I111 )
    ...
    if ( IIIi1iI1 . translated_port != 0 ) :
     I1III1iIIIi1i += ":{}" . format ( IIIi1iI1 . translated_port )
     if 22 - 22: IiII % II111iiii * II111iiii . OOooOOo % O0
    I1III1iIIIi1i = red ( I1III1iIIIi1i , False )
    if ( IIIi1iI1 . rloc_name != None ) :
     I1III1iIIIi1i += " (" + blue ( IIIi1iI1 . rloc_name , False ) + ")"
     if 21 - 21: Ii1I % oO0o / OOooOOo - I11i
    lprint ( "Send {}{} {}, last rtt: {}{}" . format ( OOOOo00 , i1iiI ,
 I1III1iIIIi1i , iIIiiIii11I1i , o0oo ) )
    ...
    if ( IIIi1iI1 . rloc . is_null ( ) ) :
     IIIi1iI1 . rloc . copy_address ( O0OO0o0OoO . rloc )
     if 4 - 4: iII111i
    ...
    o0ooO = None if ( iiIoOOOOoo0O00o . is_null ( ) ) else oOooOOo000o0o
    i11iO0000o0OO0OOo = oOooOOo000o0o if ( iiIoOOOOoo0O00o . is_null ( ) ) else iiIoOOOOoo0O00o
    lisp_send_map_request ( lisp_sockets , 0 , o0ooO , i11iO0000o0OO0OOo , IIIi1iI1 )
    III1IIii1 = O0OO0o0OoO
    if 70 - 70: I1Ii111 * Ii1I
...
def lisp_update_rtr_updown ( rtr , updown ) :
 ...
 I1i1I1IIiI111 = rtr . print_address_no_iid ( )
 ...
 if ( lisp_rtr_list . has_key ( I1i1I1IIiI111 ) == False ) : return
 if 96 - 96: IiII - I1IiiI . I1ii11iIi11i . O0
 updown = "up" if updown else "down"
 lprint ( "Send ETR IPC message, RTR {} has done {}" . format (
 red ( I1i1I1IIiI111 , False ) , bold ( updown , False ) ) )
 ...
 Oo0O = "rtr%{}%{}" . format ( I1i1I1IIiI111 , updown )
...
def lisp_process_rloc_probe_reply ( rloc_entry , source , port , map_reply , ttl ,
 ...
 OoOo0 = map_reply . hop_count
 OOOOo00 = bold ( "RLOC-probe reply" , False )
 OoO0O00o00 = IIIi1iI1 . print_address_no_iid ( )
 II1IIii = source . print_address_no_iid ( )
 oOooOO00O0o = lisp_rloc_probe_list
 ...
 if ( mrloc != None ) :
  ii1oO00o = mrloc . rloc . print_address_no_iid ( )
  if ( mrloc . multicast_rloc_probe_list . has_key ( OoO0O00o00 ) == False ) :
   IIIiii = lisp_rloc ( )
   IIIiii = copy . deepcopy ( mrloc )
   IIIiii . rloc . copy_address ( IIIi1iI1 )
   IIIiii . multicast_rloc_probe_list = { }
   mrloc . multicast_rloc_probe_list [ OoO0O00o00 ] = IIIiii
   if 52 - 52: o0oOOo0O0Ooo * I1ii11iIi11i % OoOoOO00 . Ii1I . OoO0O00 * I1Ii111
  IIIiii = mrloc . multicast_rloc_probe_list [ OoO0O00o00 ]
  IIIiii . last_rloc_probe_nonce = mrloc . last_rloc_probe_nonce
  IIIiii . last_rloc_probe = mrloc . last_rloc_probe
  iiiI1I , oOooOOo000o0o , iiIoOOOOoo0O00o = lisp_rloc_probe_list [ ii1oO00o ] [ 0 ]
  IIIiii . process_rloc_probe_reply ( ii1III11 , O0oo00o000 , oOooOOo000o0o , iiIoOOOOoo0O00o , OoOo0 , ttl , ooo0 )
  mrloc . process_rloc_probe_reply ( ii1III11 , O0oo00o000 , oOooOOo000o0o , iiIoOOOOoo0O00o , OoOo0 , ttl , ooo0 )
  return
 ...
 IiIIiiI = OoO0O00o00
 if ( oOooOO00O0o . has_key ( IiIIiiI ) == False ) :
  IiIIiiI += ":" + str ( port )
  if ( oOooOO00O0o . has_key ( IiIIiiI ) == False ) :
   IiIIiiI = II1IIii
   if ( oOooOO00O0o . has_key ( IiIIiiI ) == False ) :
    IiIIiiI += ":" + str ( port )
    lprint ( "    Received unsolicited {} from {}/{}, port {}" . format ( OOOOo00 , red ( OoO0O00o00 , False ) , red ( II1IIii ,
    # O0 + II111iiii * o0oOOo0O0Ooo / i1IIi / i11iIiiIii
 False ) , port ) )
    return
    if 4 - 4: OoO0O00 . II111iiii
    if 80 - 80: iIii1I11I1II1 . I1ii11iIi11i / O0
    if 96 - 96: iII111i * OoOoOO00 % OoOoOO00 - OoOoOO00 . oO0o - OoOoOO00
    if 79 - 79: iII111i
 ...
 for IIIi1iI1 , oOooOOo000o0o , iiIoOOOOoo0O00o in lisp_rloc_probe_list [ IiIIiiI ] :
  ...
  IIIi1iI1 . process_rloc_probe_reply ( ii1III11 , O0oo00o000 , oOooOOo000o0o , iiIoOOOOoo0O00o , OoOo0 , ttl , ooo0 )
...
def lisp_write_flow_log ( flow_log ) :
 ...
 for o00OO000 in flow_log :
  ...
  I11iII = o0o0ooOOo0oO . print_flow ( o00OO000 [ 0 ] , o00OO000 [ 1 ] , o00OO000 [ 2 ] )
  III1I . write ( I11iII )
  ooOoOoO0 += 1
...
def lisp_program_vxlan_hardware ( mc ) :
 ...
 iII = getoutput ( "ip route get {} | egrep vlan4094" . format ( i1IIiiIiiI1ii ) )
 if 63 - 63: OoOoOO00 / Oo0Ooo * OOooOOo - i11iIiiIii + OoO0O00
 if ( iII != "" ) :
  lprint ( "Route {} already in hardware: '{}'" . format ( green ( i1IIiiIiiI1ii , False ) , iII ) )
 ...
 for OoOOoO0oOo in range ( 1 , 255 ) :
  oOOo0O000ooO [ 3 ] = str ( OoOOoO0oOo )
  IiIIiiI = "." . join ( oOOo0O000ooO )
  if ( IiIIiiI in O00O00OOo0oo0 ) : continue
 ...
 iI1II1i = "arp -i vlan4094 -s {} {}" . format ( Oo00 , iiiI1IiIIii )
 os . system ( iI1II1i )
 ...
 ooOOOOo0oOOOO0 = "ip route add {} via {}" . format ( i1IIiiIiiI1ii , Oo00 )
 os . system ( ooOOOOo0oOOOO0 )
 if 23 - 23: I1IiiI - O0 - iII111i . II111iiii / oO0o
 lprint ( "Hardware programmed with commands:" )
 ooOOOOo0oOOOO0 = ooOOOOo0oOOOO0 . replace ( i1IIiiIiiI1ii , green ( i1IIiiIiiI1ii , False ) )
...
def lisp_clear_map_cache ( ) :
 ...
 lprint ( "{} map-cache with {} entries" . format ( ooO0I11i11i , ooOoOoO0 ) )
...
def lisp_encapsulate_rloc_probe ( lisp_sockets , rloc , nat_info , packet ) :
 ...
 if ( nat_info ) :
  ...
  OOOOo00 = bold ( "RLOC-probe request" , False )
 else :
  III11iI1 = ""
  OOOOo00 = bold ( "RLOC-probe reply" , False )
  if 65 - 65: oO0o / I11i + iII111i - I1ii11iIi11i
  if 80 - 80: II111iiii . i11iIiiIii
 lprint ( ( "Data encapsulate {} to {}{} port {} for " + "NAT-traversal" ) . format ( OOOOo00 , iI , III11iI1 , packet . encap_port ) )
...
def lisp_get_default_route_next_hops ( ) :
 ...
 if ( lisp_is_macos ( ) ) :
  ...
  II11Ii1II = getoutput ( ii1iI1i ) . split ( "\n" )
  I1iiI11ii = iI1ii1iI1 = None
  for III1I in II11Ii1II :
   if ( III1I . find ( "gateway: " ) != - 1 ) : I1iiI11ii = III1I . split ( ": " ) [ 1 ]
   if ( III1I . find ( "interface: " ) != - 1 ) : iI1ii1iI1 = III1I . split ( ": " ) [ 1 ]
   if 56 - 56: I11i % I1ii11iIi11i / i11iIiiIii
  return ( [ [ iI1ii1iI1 , I1iiI11ii ] ] )
 ...
 o0O0oo = getoutput ( ii1iI1i ) . split ( "\n" )
 if 60 - 60: OoO0O00
 iI1I111 = [ ]
 for iII in o0O0oo :
  ...
  try :
   ...
   if 85 - 85: OoO0O00
  iI1I111 . append ( [ iiiI1I [ I1II ] , iiiI1I [ Ii1i1iI1I1I ] ] )
  if 29 - 29: IiII
 return ( iI1I111 )
...
def lisp_get_host_route_next_hop ( rloc ) :
 ...
 try : I1i11II = iII . index ( "via" ) + 1
 except : return ( None )
 if 14 - 14: oO0o
 if ( I1i11II >= len ( iII ) ) : return ( None )
 return ( iII [ I1i11II ] )
...
def lisp_install_host_route ( dest , nh , install ) :
 ...
 o0oo = "none" if nh == None else nh
 if 26 - 26: I1IiiI + OoooooooOO % OoOoOO00 . IiII - II111iiii . OoOoOO00
 lprint ( "{} host-route {}, nh {}" . format ( install . title ( ) , dest , o0oo ) )
...
def lisp_load_checkpoint ( ) :
 ...
 for oOOoO0oO0oo0O in III1I :
  ...
  O0OoO = lisp_mapping ( "" , "" , oOO000OOO )
  if ( O0OoO != None ) :
   O0OoO . eid . store_prefix ( I1i [ 0 ] )
   O0OoO . checkpoint_entry = True
   O0OoO . map_cache_ttl = LISP_NMR_TTL * 60
   if ( oOO000OOO == [ ] ) : O0OoO . action = LISP_NATIVE_FORWARD_ACTION
   O0OoO . add_cache ( )
   continue
...
def lisp_write_to_dp_socket ( entry ) :
 try :
  o0oo00o0o0O0o0 = json . dumps ( entry )
  iI11I1II = bold ( "Write IPC" , False )
  lprint ( "{} record to named socket: '{}'" . format ( iI11I1II , o0oo00o0o0O0o0 ) )
  lisp_ipc_dp_socket . sendto ( o0oo00o0o0O0o0 , lisp_ipc_dp_socket_name )
 except :
  lprint ( "Failed to write IPC record to named socket: '{}'" . format ( o0oo00o0o0O0o0 ) )
...
def lisp_write_ipc_map_cache ( add_or_delete , mc , dont_send = False ) :
 ...
 if ( o0OooO ) :
  if ( len ( mc . rloc_set ) >= 1 and mc . rloc_set [ 0 ] . rle ) :
   for o0Ii11I in mc . rloc_set [ 0 ] . rle . rle_forwarding_list :
    ...
    IIi1IIii1 , iIiII1I1I1 = o0Ii11I . get_encap_keys ( )
    iiiI1I = lisp_build_json_keys ( iiiI1I , IIi1IIii1 , iIiII1I1I1 , "encrypt-key" )
 ...
 IiO0o }
   IIi1IIii1 , iIiII1I1I1 = IIIi1iI1 . get_encap_keys ( )
   iiiI1I = lisp_build_json_keys ( iiiI1I , IIi1IIii1 , iIiII1I1I1 , "encrypt-key" )
...
def lisp_write_ipc_decap_key ( rloc_addr , keys ) :
 ...
 IIi1IIii1 = keys [ 1 ] . encrypt_key
 iIiII1I1I1 = keys [ 1 ] . icv_key
 ...
 o0IiIiIi1I1 = rloc_addr . split ( ":" )
 if ( len ( o0IiIiIi1I1 ) == 1 ) :
  oOOoO0oO0oo0O = { "type" : "decap-keys" , "rloc" : o0IiIiIi1I1 [ 0 ] }
 else :
  oOOoO0oO0oo0O = { "type" : "decap-keys" , "rloc" : o0IiIiIi1I1 [ 0 ] , "port" : o0IiIiIi1I1 [ 1 ] }
  if 67 - 67: i11iIiiIii % OoooooooOO - o0oOOo0O0Ooo + OoOoOO00 + OoooooooOO
 oOOoO0oO0oo0O = lisp_build_json_keys ( oOOoO0oO0oo0O , IIi1IIii1 , iIiII1I1I1 , "decrypt-key" )
...
def lisp_write_ipc_database_mappings ( ephem_port ) :
 ...
 for oooOOoO0oo0 in lisp_db_list :
  ...
  iiOOo0O = { "instance-id" : str ( oooOOoO0oo0 . eid . instance_id ) ,
 "eid-prefix" : oooOOoO0oo0 . eid . print_prefix_no_iid ( ) }
  oOOoO0oO0oo0O [ "database-mappings" ] . append ( iiOOo0O )
  if 22 - 22: O0 + OOooOOo % iIii1I11I1II1 * Oo0Ooo - OoooooooOO
 lisp_write_to_dp_socket ( oOOoO0oO0oo0O )
 if 35 - 35: OoOoOO00 + oO0o * OoOoOO00
...
def lisp_write_ipc_interfaces ( ) :
 ...
 for iI1ii1iI1 in lisp_myinterfaces . values ( ) :
  ...
  iiOOo0O = { "interface" : iI1ii1iI1 . device ,
 "instance-id" : str ( iI1ii1iI1 . instance_id ) }
  oOOoO0oO0oo0O [ "interfaces" ] . append ( iiOOo0O )
...
def lisp_parse_auth_key ( value ) :
 ...
 for i1i11i in oOO :
  ...
  oOoooOoOOOO [ I1IIiiiiI1iIi ] = i1i11i [ I1i11II + 1 : : ]
...
def lisp_reassemble ( packet ) :
 ...
 O0OO0 = ( OoooOO0 & 0x2000 == 0 and ( OoooOO0 & 0x1fff ) != 0 )
 oOOoO0oO0oo0O = [ ( OoooOO0 & 0x1fff ) * 8 , IIiii1iii1II - 20 , packet , O0OO0 ]
 ...
 IiO00 = IiIIiiI . print_address_no_iid ( )
 IiIIiiI . address = socket . ntohl ( struct . unpack ( "I" , packet [ 16 : 20 ] ) [ 0 ] )
 I1Ii11iIii1i = IiIIiiI . print_address_no_iid ( )
 IiIIiiI = red ( "{} -> {}" . format ( IiO00 , I1Ii11iIii1i ) , False )
 if 60 - 60: OoO0O00 % oO0o - I1ii11iIi11i % i11iIiiIii % I11i * I1IiiI
 ...
 # iIii1I11I1II1 - oO0o * i11iIiiIii * o0oOOo0O0Ooo
 # O0
 lisp_hex_string ( OoooOO0 ) . zfill ( 4 ) ) )
 if 95 - 95: ooOoO0o / I1ii11iIi11i
 if 8 - 8: O0
 if 2 - 2: I1IiiI - I1IiiI * O0 / i11iIiiIii % OoO0O00 / I1ii11iIi11i
 if 82 - 82: oO0o * OOooOOo - Oo0Ooo % II111iiii
 if 36 - 36: O0 / Ii1I - I11i . I1ii11iIi11i / II111iiii / OoO0O00
 if ( queue [ 0 ] [ 0 ] != 0 or queue [ - 1 ] [ 3 ] == False ) : return ( None )
 iii1IiIi = queue [ 0 ]
 for oOOo00O0O0 in queue [ 1 : : ] :
  OoooOO0 = oOOo00O0O0 [ 0 ]
  oO00o00OO , Ooo00oo00oo = iii1IiIi [ 0 ] , iii1IiIi [ 1 ]
  if ( oO00o00OO + Ooo00oo00oo != OoooOO0 ) : return ( None )
  iii1IiIi = oOOo00O0O0
...
def lisp_get_crypto_decap_lookup_key ( addr , port ) :
 ...
 if 81 - 81: IiII
 for oO0OOoOoo0o in lisp_crypto_keys_by_rloc_decap :
  OoOOOO = oO0OOoOoo0o . split ( ":" )
  if ( len ( OoOOOO ) == 1 ) : continue
  OoOOOO = OoOOOO [ 0 ] if len ( OoOOOO ) == 2 else ":" . join ( OoOOOO [ 0 : - 1 ] )
  if ( OoOOOO == O0O0 ) :
   IiI11I1iiii1 = lisp_crypto_keys_by_rloc_decap [ oO0OOoOoo0o ]
...
def lisp_build_crypto_decap_lookup_key ( addr , port ) :
 ...
 if ( lisp_i_am_rtr ) :
  ...
  for I1OOoO0OoOOo0 in lisp_nat_state_info . values ( ) :
   for IiII11I1I1II in I1OOoO0OoOOo0 :
    if ( addr == IiII11I1I1II . address ) : return ( oOoooo )
...
def lisp_is_rloc_probe ( packet , rr ) :
 ...
 oo0O0O00o00O = ( socket . htons ( LISP_CTRL_PORT ) in [ IiIi , IiiI1iii1iIiiI ] )
 if ( oo0O0O00o00O == False ) : return ( [ packet , None , None , None ] )
 if 5 - 5: OoOoOO00 + Ii1I - OoO0O00
 if ( rr == 0 ) :
  OOOOo00 = lisp_is_rloc_probe_request ( packet [ 28 ] )
  if ( OOOOo00 == False ) : return ( [ packet , None , None , None ] )
 elif ( rr == 1 ) :
  OOOOo00 = lisp_is_rloc_probe_reply ( packet [ 28 ] )
  if ( OOOOo00 == False ) : return ( [ packet , None , None , None ] )
 elif ( rr == - 1 ) :
  OOOOo00 = lisp_is_rloc_probe_request ( packet [ 28 ] )
  if ( OOOOo00 == False ) :
...
def lisp_process_data_plane_restart ( do_clear = False ) :
 ...
 Oo00oo = { "type" : "entire-map-cache" , "entries" : [ ] }
 if 54 - 54: Oo0Ooo
 if ( do_clear == False ) :
  iii1i = Oo00oo [ "entries" ]
  lisp_map_cache . walk_cache ( lisp_ipc_walk_map_cache , iii1i )
  if 62 - 62: ooOoO0o % I1IiiI + I1IiiI / Oo0Ooo
...
def lisp_process_data_plane_stats ( msg , lisp_sockets , lisp_port ) :
 ...
 for msg in msg [ "entries" ] :
  ...
  O0OoO = lisp_map_cache_lookup ( None , oOooOOo000o0o )
  if ( O0OoO == None ) :
  ...
  for O0oO0oO in O00o0ooOooO0 :
   ...
   O0O0OOo0O = O0OoO . get_rloc ( IIIi1iI1 )
   ...
   Ooi11I1 = 0 if O0oO0oO . has_key ( "packet-count" ) == False else O0oO0oO [ "packet-count" ]
   if 96 - 96: I11i % o0oOOo0O0Ooo + i1IIi % II111iiii
   iIIiI11 = 0 if O0oO0oO . has_key ( "byte-count" ) == False else O0oO0oO [ "byte-count" ]
   if 85 - 85: OoO0O00 + IiII . OOooOOo % i1IIi * o0oOOo0O0Ooo / i1IIi
   ii1III11 = 0 if O0oO0oO . has_key ( "seconds-last-packet" ) == False else O0oO0oO [ "seconds-last-packet" ]
   if 42 - 42: Oo0Ooo - Oo0Ooo % O0 - OoO0O00
   if 42 - 42: OoooooooOO * OOooOOo
   O0O0OOo0O . stats . packet_count += Ooi11I1
   ...
   lprint ( "Update stats {}/{}/{}s for {} RLOC {}" . format ( Ooi11I1 , iIIiI11 ,
 ii1III11 , iIiI1I1ii1I1 , iI ) )
  ...
  if ( O0OoO . group . is_null ( ) and O0OoO . has_ttl_elapsed ( ) ) :
   iIiI1I1ii1I1 = green ( O0OoO . print_eid_tuple ( ) , False )
   lprint ( "Refresh map-cache entry {}" . format ( iIiI1I1ii1I1 ) )
   lisp_send_map_request ( lisp_sockets , lisp_port , None , O0OoO . eid , None )
...
def lisp_process_data_plane_decap_stats ( msg , lisp_ipc_socket ) :
 ...
 IIi1i1i1111II = [ "good-packets" , "ICV-error" , "checksum-error" ,
 "lisp-header-error" , "no-decrypt-key" , "bad-inner-version" ,
 "outer-header-error" ]
 if 40 - 40: iIii1I11I1II1 / OoooooooOO % IiII . Ii1I
 for OoOOo0 in IIi1i1i1111II :
  Ooi11I1 = 0 if msg . has_key ( OoOOo0 ) == False else msg [ OoOOo0 ] [ "packet-count" ]
  if 4 - 4: i11iIiiIii % i1IIi + i1IIi + I1IiiI
  lisp_decap_stats [ OoOOo0 ] . packet_count += Ooi11I1
  if 56 - 56: OOooOOo * iIii1I11I1II1
  iIIiI11 = 0 if msg . has_key ( OoOOo0 ) == False else msg [ OoOOo0 ] [ "byte-count" ]
  if 31 - 31: OoOoOO00 + OoooooooOO % OoO0O00 - Oo0Ooo * i11iIiiIii % Oo0Ooo
  lisp_decap_stats [ OoOOo0 ] . byte_count += iIIiI11
  if 14 - 14: II111iiii * II111iiii
  ii1III11 = 0 if msg . has_key ( OoOOo0 ) == False else msg [ OoOOo0 ] [ "seconds-last-packet" ]
  if 66 - 66: II111iiii / Oo0Ooo
  lisp_decap_stats [ OoOOo0 ] . last_increment = lisp_get_timestamp ( ) - ii1III11
  if 16 - 16: i11iIiiIii / Oo0Ooo
 return
...
def lisp_process_punt ( punt_socket , lisp_send_sockets , lisp_ephem_port ) :
 OoOOOo00O0 , iIiI111ii1Ii = punt_socket . recvfrom ( 4000 )
 if 17 - 17: Ii1I + iII111i - O0 - iIii1I11I1II1
 I11Ii1i = json . loads ( OoOOOo00O0 )
 if ( type ( I11Ii1i ) != dict ) :
 ...
 oOOOOo00ooOo = bold ( "Punt" , False )
 lprint ( "{} message from '{}': '{}'" . format ( oOOOOo00ooOo , iIiI111ii1Ii , I11Ii1i ) )
 if 86 - 86: I11i
 if ( I11Ii1i . has_key ( "type" ) == False ) :
  lprint ( "Punt IPC message has no 'type' key" )
  return
  if 75 - 75: iIii1I11I1II1 % O0 * i11iIiiIii / OoOoOO00 * II111iiii
  if 88 - 88: o0oOOo0O0Ooo - I1Ii111 + i11iIiiIii / OOooOOo . Ii1I % OOooOOo
  if 88 - 88: O0 * OoO0O00 % OoooooooOO * iII111i
  if 60 - 60: Ii1I
  if 30 - 30: i1IIi * OoO0O00
 if ( I11Ii1i [ "type" ] == "statistics" ) :
  lisp_process_data_plane_stats ( I11Ii1i , lisp_send_sockets , lisp_ephem_port )
  return
  if 80 - 80: I11i
 if ( I11Ii1i [ "type" ] == "decap-statistics" ) :
  lisp_process_data_plane_decap_stats ( I11Ii1i , punt_socket )
  return
 ...
 if ( I11Ii1i . has_key ( "interface" ) == False ) :
  ...
  if 72 - 72: Ii1I
 OoO = I11Ii1i [ "interface" ]
 if ( OoO == "" ) :
  i1 = int ( I11Ii1i [ "instance-id" ] )
  if ( i1 == - 1 ) : return
 else :
 ...
 o0ooO = None
 if ( I11Ii1i . has_key ( "source-eid" ) ) :
  O00Oo = I11Ii1i [ "source-eid" ]
  o0ooO = lisp_address ( LISP_AFI_NONE , O00Oo , 0 , i1 )
  if ( o0ooO . is_null ( ) ) :
 ...
 i11iO0000o0OO0OOo = None
 if ( I11Ii1i . has_key ( "dest-eid" ) ) :
  ooOoOO00o = I11Ii1i [ "dest-eid" ]
  i11iO0000o0OO0OOo = lisp_address ( LISP_AFI_NONE , ooOoOO00o , 0 , i1 )
  if ( i11iO0000o0OO0OOo . is_null ( ) ) :
   lprint ( "Invalid dest-EID format '{}'" . format ( ooOoOO00o ) )
   return
   if 99 - 99: Oo0Ooo / IiII * iII111i - I1Ii111
 ...
 if ( o0ooO ) :
  ...
  oooOOoO0oo0 = lisp_db_for_lookups . lookup_cache ( o0ooO , False )
  if ( oooOOoO0oo0 != None ) :
   ...
   if ( oooOOoO0oo0 . dynamic_eid_configured ( ) ) :
    iI1ii1iI1 = lisp_allow_dynamic_eid ( OoO , o0ooO )
    if ( iI1ii1iI1 != None and lisp_i_am_itr ) :
     lisp_itr_discover_eid ( oooOOoO0oo0 , o0ooO , OoO , iI1ii1iI1 )
    else :
 ...
 if ( i11iO0000o0OO0OOo ) :
  O0OoO = lisp_map_cache_lookup ( o0ooO , i11iO0000o0OO0OOo )
  if ( O0OoO == None or lisp_mr_or_pubsub ( O0OoO . action ) ) :
   ...
   if ( lisp_rate_limit_map_request ( i11iO0000o0OO0OOo ) ) : return
   if 66 - 66: I1IiiI . Oo0Ooo - oO0o
   OOo = ( O0OoO and O0OoO . action == LISP_SEND_PUBSUB_ACTION )
   lisp_send_map_request ( lisp_send_sockets , lisp_ephem_port ,
 o0ooO , i11iO0000o0OO0OOo , None , OOo )
  else :
   I1i = green ( i11iO0000o0OO0OOo . print_address ( ) , False )
...
def lisp_itr_discover_eid ( db , eid , input_interface , routed_interface ,
 ...
 if ( input_interface != routed_interface ) :
  o0o0oo0O0 = ", routed-interface " + routed_interface
  if 51 - 51: i1IIi * II111iiii
  if 15 - 15: II111iiii / Ii1I % iIii1I11I1II1
 Ii11ii = green ( iIiI1I1ii1I1 , False ) + bold ( " discovered" , False )
 lprint ( "Dynamic-EID {} on interface {}{}, timeout {}" . format ( Ii11ii , input_interface , o0o0oo0O0 , ooOoo000 . timeout ) )
 if 23 - 23: IiII + OoooooooOO + o0oOOo0O0Ooo * Ii1I % I1ii11iIi11i - Ii1I
 if 2 - 2: iII111i
 if 97 - 97: II111iiii - iII111i
 if 45 - 45: i11iIiiIii . I11i + o0oOOo0O0Ooo - o0oOOo0O0Ooo + OOooOOo
 if 55 - 55: II111iiii . ooOoO0o . iII111i / o0oOOo0O0Ooo / IiII - I1IiiI
 Oo0O = "learn%{}%{}" . format ( iIiI1I1ii1I1 , routed_interface )
 Oo0O = lisp_command_ipc ( Oo0O , "lisp-itr" )
 lisp_ipc ( Oo0O , lisp_ipc_listen_socket , "lisp-etr" )
 return
 if 65 - 65: ooOoO0o + i1IIi * I11i + OoOoOO00 + iII111i % oO0o
 if 11 - 11: OOooOOo * IiII - Ii1I / Oo0Ooo / I1ii11iIi11i . iII111i
...
def lisp_retry_decap_keys ( addr_str , packet , iv , packet_icv ) :
 ...
 for OO0Oo00o0o0 in lisp_crypto_keys_by_rloc_decap :
  ...
  oOoI11 = oOOoO0oO0oo0O [ 1 ]
  if ( packet_icv != oOoI11 . do_icv ( packet , iv ) ) :
...
def lisp_get_decent_index ( eid ) :
 iIiI1I1ii1I1 = eid . print_prefix ( )
 iIii = hmac . new ( "lisp-decent" , iIiI1I1ii1I1 , hashlib . sha256 ) . hexdigest ( )
 if 41 - 41: Oo0Ooo + Ii1I
 if 79 - 79: IiII
 if 64 - 64: i11iIiiIii + OoooooooOO . oO0o * Ii1I
 if 49 - 49: O0
 o0Ooo0OooOoO = os . getenv ( "LISP_DECENT_HASH_WIDTH" )
 if ( o0Ooo0OooOoO in [ "" , None ] ) :
  o0Ooo0OooOoO = 12
 else :
  o0Ooo0OooOoO = int ( o0Ooo0OooOoO )
  if ( o0Ooo0OooOoO > 32 ) :
   o0Ooo0OooOoO = 12
  else :
   o0Ooo0OooOoO *= 2
 ...
 OoOOO0o0OOO00O = iIii [ 0 : o0Ooo0OooOoO ]
 I1i11II = int ( OoOOO0o0OOO00O , 16 ) % lisp_decent_modulus
 if 17 - 17: I1Ii111 % I1Ii111 * o0oOOo0O0Ooo
 lprint ( "LISP-Decent modulus {}, hash-width {}, mod-value {}, index {}" . format ( lisp_decent_modulus , o0Ooo0OooOoO / 2 , OoOOO0o0OOO00O , I1i11II ) )
...
def lisp_trace_append ( packet , reason = None , ed = "encap" , lisp_socket = None ,
 ...
 O0Oo0O00O = packet . packet [ IiI1ii1Ii : : ]
 ...
 oOOoO0oO0oo0O [ "srloc" ] = i1i1I1II1Ii . print_address_no_iid ( )
 ...
 if ( oOo0OOoOO == "?" and oOOoO0oO0oo0O [ "node" ] == "ETR" ) :
 ...
 i11iO0000o0OO0OOo = packet . inner_dest . print_address ( )
 if ( I11III1i111 . packet_json == [ ] ) :
  o0oo00o0o0O0o0 = { }
  o0oo00o0o0O0o0 [ "seid" ] = o0ooO
  o0oo00o0o0O0o0 [ "deid" ] = i11iO0000o0OO0OOo
  o0oo00o0o0O0o0 [ "paths" ] = [ ]
  I11III1i111 . packet_json . append ( o0oo00o0o0O0o0 )
 ...
 for o0oo00o0o0O0o0 in I11III1i111 . packet_json :
  if ( o0oo00o0o0O0o0 [ "deid" ] != i11iO0000o0OO0OOo ) : continue
  o0oo00o0o0O0o0 [ "paths" ] . append ( oOOoO0oO0oo0O )
  break
 ...
 IiI = False
 if ( len ( I11III1i111 . packet_json ) == 1 and oOOoO0oO0oo0O [ "node" ] == "ETR" and
 I11III1i111 . myeid ( packet . inner_dest ) ) :
  o0oo00o0o0O0o0 = { }
  o0oo00o0o0O0o0 [ "seid" ] = i11iO0000o0OO0OOo
  o0oo00o0o0O0o0 [ "deid" ] = o0ooO
  o0oo00o0o0O0o0 [ "paths" ] = [ ]
  I11III1i111 . packet_json . append ( o0oo00o0o0O0o0 )
  IiI = True
  if 15 - 15: O0 % IiII
 ...
 if 66 - 66: OoO0O00
 if 94 - 94: O0
 Oo000oOo = I11III1i111 . packet_json [ 0 ] [ "paths" ] [ 0 ] [ "srloc" ]
 if ( oOo0OOoOO == "?" ) :
  lprint ( "LISP-Trace return to sender RLOC {}" . format ( Oo000oOo ) )
  I11III1i111 . return_to_sender ( lisp_socket , Oo000oOo , O0Oo0O00O )
  return ( False )
 ...
 o0OoO00OOoO0 = packet . packet [ 0 : IiI1ii1Ii ]
 IIIiIIi111 = struct . pack ( "HH" , socket . htons ( Ooo000O00 ) , 0 )
 o0OoO00OOoO0 = o0OoO00OOoO0 [ 0 : IiI1ii1Ii - 4 ] + IIIiIIi111
 if ( packet . inner_version == 6 and oOOoO0oO0oo0O [ "node" ] == "ETR" and
 len ( I11III1i111 . packet_json ) == 2 ) :
  O0I1II1 = o0OoO00OOoO0 [ IiI1ii1Ii - 8 : : ] + O0Oo0O00O
  O0I1II1 = lisp_udp_checksum ( o0ooO , i11iO0000o0OO0OOo , O0I1II1 )
  o0OoO00OOoO0 = o0OoO00OOoO0 [ 0 : IiI1ii1Ii - 8 ] + O0I1II1 [ 0 : 8 ]
 ...
 if ( IiI ) :
  if ( packet . inner_version == 4 ) :
   o0OoO00OOoO0 = o0OoO00OOoO0 [ 0 : 12 ] + o0OoO00OOoO0 [ 16 : 20 ] + o0OoO00OOoO0 [ 12 : 16 ] + o0OoO00OOoO0 [ 22 : 24 ] + o0OoO00OOoO0 [ 20 : 22 ] + o0OoO00OOoO0 [ 24 : : ]
   if 49 - 49: oO0o . oO0o % oO0o / Oo0Ooo
  else :
   o0OoO00OOoO0 = o0OoO00OOoO0 [ 0 : 8 ] + o0OoO00OOoO0 [ 24 : 40 ] + o0OoO00OOoO0 [ 8 : 24 ] + o0OoO00OOoO0 [ 42 : 44 ] + o0OoO00OOoO0 [ 40 : 42 ] + o0OoO00OOoO0 [ 44 : : ]
 ...
 OoO0O0oOooO = 20 + Ooo000O00 if packet . inner_version == 4 else Ooo000O00
 O00Ooo = struct . pack ( "H" , socket . htons ( OoO0O0oOooO ) )
 o0OoO00OOoO0 = o0OoO00OOoO0 [ 0 : IiI1ii1Ii ] + O00Ooo + o0OoO00OOoO0 [ IiI1ii1Ii + 2 : : ]
 if 40 - 40: OoooooooOO
 if 71 - 71: OOooOOo
 if 88 - 88: O0
 ...
 if ( packet . inner_version == 4 ) :
  ...
  o0OoO00OOoO0 = o0OoO00OOoO0 [ 0 : 10 ] + I1i11i + o0OoO00OOoO0 [ 12 : : ]
  O00Ooo = lisp_ip_checksum ( o0OoO00OOoO0 [ 0 : 20 ] )
  o0OoO00OOoO0 = O00Ooo + o0OoO00OOoO0 [ 20 : : ]
  if 53 - 53: OoooooooOO
  if 41 - 41: i1IIi - oO0o
  if 41 - 41: I11i
  if 92 - 92: i11iIiiIii
  if 62 - 62: i1IIi / I1IiiI - o0oOOo0O0Ooo
 packet . packet = o0OoO00OOoO0 + O0Oo0O00O
 return ( True )
...
def lisp_build_gleaned_multicast ( seid , geid , rloc , port , igmp ) :
 ...
 I1I111i = seid . print_address_no_iid ( )
 I1iiIi111I = green ( "{}" . format ( I1I111i ) , False )
 I1i = green ( "(*, {})" . format ( iiiii1I1III1 ) , False )
 iiiI1I = red ( rloc . print_address_no_iid ( ) + ":" + str ( port ) , False )
 if 77 - 77: oO0o * I1Ii111 - i11iIiiIii + Ii1I + I11i
 if 96 - 96: Ii1I
 if 28 - 28: i1IIi . oO0o . IiII + Oo0Ooo . Oo0Ooo . i1IIi
 if 34 - 34: Oo0Ooo + IiII / i1IIi
 O0OoO = lisp_map_cache_lookup ( seid , geid )
 if ( O0OoO == None ) :
  O0OoO = lisp_mapping ( "" , "" , [ ] )
  O0OoO . group . copy_address ( geid )
  O0OoO . eid . copy_address ( geid )
  O0OoO . eid . address = 0
  O0OoO . eid . mask_len = 0
  O0OoO . mapping_source . copy_address ( rloc )
  O0OoO . map_cache_ttl = LISP_IGMP_TTL
  O0OoO . gleaned = True
  O0OoO . add_cache ( )
 ...
 O0O0OOo0O = O0O0O0o0O = o0Ii11I = None
 if ( O0OoO . rloc_set != [ ] ) :
  O0O0OOo0O = O0OoO . rloc_set [ 0 ]
  if ( O0O0OOo0O . rle ) :
   O0O0O0o0O = O0O0OOo0O . rle
   for ii1i1Iiii in O0O0O0o0O . rle_nodes :
    if ( ii1i1Iiii . rloc_name != I1I111i ) : continue
    o0Ii11I = ii1i1Iiii
    break
    if 86 - 86: i11iIiiIii * OoooooooOO - OOooOOo - i1IIi * i1IIi
    if 34 - 34: II111iiii - I1ii11iIi11i . OoooooooOO - I1IiiI / I1IiiI - OoOoOO00
    if 63 - 63: I11i . Ii1I * o0oOOo0O0Ooo % Oo0Ooo * I1ii11iIi11i / I1IiiI
    if 17 - 17: OoooooooOO % i11iIiiIii % IiII - i1IIi
    if 21 - 21: OoOoOO00 % I1ii11iIi11i . IiII . Oo0Ooo * I1ii11iIi11i - OoO0O00
    if 94 - 94: OoO0O00 - I1ii11iIi11i + OoooooooOO * OOooOOo
    if 49 - 49: i1IIi - I11i * II111iiii
 if ( O0O0OOo0O == None ) :
  O0O0OOo0O = lisp_rloc ( )
  O0OoO . rloc_set = [ O0O0OOo0O ]
  O0O0OOo0O . priority = 253
  O0O0OOo0O . mpriority = 255
  O0OoO . build_best_rloc_set ( )
  if 4 - 4: o0oOOo0O0Ooo + o0oOOo0O0Ooo
 if ( O0O0O0o0O == None ) :
  O0O0O0o0O = lisp_rle ( geid . print_address ( ) )
  O0O0OOo0O . rle = O0O0O0o0O
  if 57 - 57: I1IiiI * OOooOOo . i11iIiiIii * oO0o - OoOoOO00
 if ( o0Ii11I == None ) :
  o0Ii11I = lisp_rle_node ( )
  o0Ii11I . rloc_name = I1I111i
  O0O0O0o0O . rle_nodes . append ( o0Ii11I )
  O0O0O0o0O . build_forwarding_list ( )
 ...
 if ( igmp ) :
  IiI1iiIi1I1i = seid . print_address ( )
  if ( lisp_gleaned_groups . has_key ( IiI1iiIi1I1i ) == False ) :
   lisp_gleaned_groups [ IiI1iiIi1I1i ] = { }
   if 89 - 89: OoooooooOO . OOooOOo
  lisp_gleaned_groups [ IiI1iiIi1I1i ] [ iiiii1I1III1 ] = lisp_get_timestamp ( )
...
def lisp_remove_gleaned_multicast ( seid , geid ) :
 ...
 iiiii1I1III1 = geid . print_address ( )
 IiI1iiIi1I1i = seid . print_address ( )
 I1iiIi111I = green ( "{}" . format ( IiI1iiIi1I1i ) , False )
 I1i = green ( "(*, {})" . format ( iiiii1I1III1 ) , False )
 ...
 if 56 - 56: IiII
 if ( lisp_gleaned_groups . has_key ( IiI1iiIi1I1i ) ) :
  if ( lisp_gleaned_groups [ IiI1iiIi1I1i ] . has_key ( iiiii1I1III1 ) ) :
   lisp_gleaned_groups [ IiI1iiIi1I1i ] . pop ( iiiii1I1III1 )
   if 72 - 72: Oo0Ooo
...
def lisp_change_gleaned_multicast ( seid , rloc , port ) :
 IiI1iiIi1I1i = seid . print_address ( )
 if ( lisp_gleaned_groups . has_key ( IiI1iiIi1I1i ) == False ) : return
 if 7 - 7: iII111i / Oo0Ooo - OoO0O00 + I1Ii111 * II111iiii * ooOoO0o
 for iiIoOOOOoo0O00o in lisp_gleaned_groups [ IiI1iiIi1I1i ] :
...
def lisp_process_igmp_packet ( packet ) :
 ...
 iiIoOOOOoo0O00o . address = socket . ntohl ( struct . unpack ( "II" , i11iI [ : 8 ] ) [ 1 ] )
 ...
 oOooO0Oo00oO = ( iii1iIIi1II in ( 0x12 , 0x16 , 0x17 , 0x22 ) )
 if ( oOooO0Oo00oO == False ) :
  IiiiiII1Iii = "{} ({})" . format ( iii1iIIi1II , igmp_types [ iii1iIIi1II ] ) if igmp_types . has_key ( iii1iIIi1II ) else iii1iIIi1II
  if 27 - 27: OoO0O00 . iIii1I11I1II1 . I1ii11iIi11i - I1Ii111 * I1ii11iIi11i
  lprint ( "IGMP type {} not supported" . format ( IiiiiII1Iii ) )
  return ( [ ] )
  if 51 - 51: I11i - OoooooooOO * Ii1I % iII111i . II111iiii + OoooooooOO
  if 65 - 65: iIii1I11I1II1 * O0
 if ( len ( i11iI ) < 8 ) :
 ...
 if ( iii1iIIi1II == 0x17 ) :
  ...
  if 66 - 66: I1Ii111
 if ( iii1iIIi1II in ( 0x12 , 0x16 ) ) :
  lprint ( "IGMPv{} join (*, {})" . format ( 1 if ( iii1iIIi1II == 0x12 ) else 2 , bold ( iiiii1I1III1 , False ) ) )
 ...
 O0o0Ooo00OOO = iiIoOOOOoo0O00o . address
 i11iI = i11iI [ 8 : : ]
 if 22 - 22: ooOoO0o
 III111I = "BBHI"
 o0oo0Oo0Oo00 = struct . calcsize ( III111I )
 IiI1IiooOOO0O0O0OO = "I"
 ooOOo00OO0O = struct . calcsize ( IiI1IiooOOO0O0O0OO )
 iIiI111ii1Ii = lisp_address ( LISP_AFI_IPV4 , "" , 32 , 0 )
 ...
 I1iiiIi1111IIi1 = [ ]
 for OoOOoO0oOo in range ( O0o0Ooo00OOO ) :
  if ( len ( i11iI ) < o0oo0Oo0Oo00 ) : return
  oO0Iii11 , Ii1i1I1Ii , OoOoo00o0O , iIIiiiI = struct . unpack ( III111I ,
 i11iI [ : o0oo0Oo0Oo00 ] )
  if 46 - 46: I1ii11iIi11i
  i11iI = i11iI [ o0oo0Oo0Oo00 : : ]
  if 81 - 81: I11i
  if ( lisp_igmp_record_types . has_key ( oO0Iii11 ) == False ) :
   lprint ( "Invalid record type {}" . format ( oO0Iii11 ) )
   continue
   if 54 - 54: OoOoOO00 / Ii1I
   if 84 - 84: Oo0Ooo / OoO0O00 . o0oOOo0O0Ooo - iII111i . iII111i - II111iiii
  o0OOO0oOo0 = lisp_igmp_record_types [ oO0Iii11 ]
  OoOoo00o0O = socket . ntohs ( OoOoo00o0O )
  iiIoOOOOoo0O00o . address = socket . ntohl ( iIIiiiI )
  iiiii1I1III1 = iiIoOOOOoo0O00o . print_address_no_iid ( )
  if 53 - 53: iII111i . iIii1I11I1II1
  lprint ( "Record type: {}, group: {}, source-count: {}" . format ( o0OOO0oOo0 , iiiii1I1III1 , OoOoo00o0O ) )
  ...
  Oooo0oOOoOoO = False
  if ( oO0Iii11 in ( 1 , 5 ) ) : Oooo0oOOoOoO = True
  if ( oO0Iii11 in ( 2 , 4 ) and OoOoo00o0O == 0 ) : Oooo0oOOoOoO = True
  i1IIiIi11 = "join" if ( Oooo0oOOoOoO ) else "leave"
  ...
  if ( OoOoo00o0O == 0 ) :
   I1iiiIi1111IIi1 . append ( [ None , iiiii1I1III1 , Oooo0oOOoOoO ] )
   lprint ( "IGMPv3 {} (*, {})" . format ( bold ( i1IIiIi11 , False ) ,
 bold ( iiiii1I1III1 , False ) ) )
  ...
  for Iii1i1IiI in range ( OoOoo00o0O ) :
   if ( len ( i11iI ) < ooOOo00OO0O ) : return
   iIIiiiI = struct . unpack ( IiI1IiooOOO0O0O0OO , i11iI [ : ooOOo00OO0O ] ) [ 0 ]
   iIiI111ii1Ii . address = socket . ntohl ( iIIiiiI )
   OoOOo = iIiI111ii1Ii . print_address_no_iid ( )
   I1iiiIi1111IIi1 . append ( [ OoOOo , iiiii1I1III1 , Oooo0oOOoOoO ] )
   lprint ( "{} ({}, {})" . format ( i1IIiIi11 ,
 green ( OoOOo , False ) , bold ( iiiii1I1III1 , False ) ) )
   i11iI = i11iI [ ooOOo00OO0O : : ]
...
def lisp_glean_map_cache ( seid , rloc , encap_port , igmp ) :
 ...
 OO0O = True
 O0OoO = lisp_map_cache . lookup_cache ( seid , True )
 if ( O0OoO and len ( O0OoO . rloc_set ) != 0 ) :
  O0OoO . last_refresh_time = lisp_get_timestamp ( )
  if 64 - 64: I1ii11iIi11i . OoOoOO00 - i11iIiiIii . Ii1I * i1IIi
  iiI1iI1II = O0OoO . rloc_set [ 0 ]
  OooO0o0OOOOoO = iiI1iI1II . rloc
  IIiII1IiI1iII = iiI1iI1II . translated_port
  OO0O = ( OooO0o0OOOOoO . is_exact_match ( rloc ) == False or
 IIiII1IiI1iII != encap_port )
  if 25 - 25: O0 % OoooooooOO / o0oOOo0O0Ooo
  if ( OO0O ) :
   ...
   iiI1iI1II . delete_from_rloc_probe_list ( O0OoO . eid , O0OoO . group )
   lisp_change_gleaned_multicast ( seid , rloc , encap_port )
   if 8 - 8: OOooOOo * OOooOOo - Ii1I * OoOoOO00 % OoO0O00 * O0
 else :
  O0OoO = lisp_mapping ( "" , "" , [ ] )
  O0OoO . eid . copy_address ( seid )
  O0OoO . mapping_source . copy_address ( rloc )
  O0OoO . map_cache_ttl = LISP_GLEAN_TTL
  O0OoO . gleaned = True
  I1i = green ( seid . print_address ( ) , False )
  iiiI1I = red ( rloc . print_address_no_iid ( ) + ":" + str ( encap_port ) , False )
 ...
 if ( OO0O ) :
  ...
  O0O0OOo0O . add_to_rloc_probe_list ( O0OoO . eid , O0OoO . group )
  O0O0OOo0O . priority = 253
  O0O0OOo0O . mpriority = 255
  oOO000OOO = [ O0O0OOo0O ]
  O0OoO . rloc_set = oOO000OOO
  O0OoO . build_best_rloc_set ( )
 ...
 iii1i = lisp_process_igmp_packet ( igmp )
 if ( type ( iii1i ) == bool ) : return
 if 70 - 70: iIii1I11I1II1 / I1ii11iIi11i . I1Ii111 % I1ii11iIi11i
 for iIiI111ii1Ii , iiIoOOOOoo0O00o , Oooo0oOOoOoO in iii1i :
