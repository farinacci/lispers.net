...
try :
 ...
 if 68 - 68: Ii1I / O0
def Iiii111Ii11I1 ( agg , prefix ) :
 ooO0oooOoO0 , II11i = agg . split ( "/" )
 II11i = int ( II11i )
 i1 = ( 2 ** II11i ) - 1
 i1 <<= 32 - II11i
 if 64 - 64: I1ii11iIi11i % OoO0O00
 ooO0oooOoO0 = ooO0oooOoO0 . split ( "." )
 ooO0oooOoO0 = int ( ooO0oooOoO0 [ 0 ] ) << 24 | int ( ooO0oooOoO0 [ 1 ] ) << 16 | int ( ooO0oooOoO0 [ 2 ] ) << 8 | int ( ooO0oooOoO0 [ 3 ] )
 if ( prefix . find ( "/" ) != - 1 ) : prefix = prefix . split ( "/" ) [ 0 ]
 i1I1Iiii1111 = prefix . split ( "." )
 i1I1Iiii1111 = int ( i1I1Iiii1111 [ 0 ] ) << 24 | int ( i1I1Iiii1111 [ 1 ] ) << 16 | int ( i1I1Iiii1111 [ 2 ] ) << 8 | int ( i1I1Iiii1111 [ 3 ] )
 return ( ( i1I1Iiii1111 & i1 ) == ( ooO0oooOoO0 & i1 ) )
 if 22 - 22: Ii1I . IiII
...
for i1iIIIiI1I in Iii1I111 :
 ...
 if ( Iiii111Ii11I1 ( oo0oooooO0 , OOoO000O0OO ) ) :
