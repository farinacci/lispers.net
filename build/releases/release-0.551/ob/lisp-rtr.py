...
def IIIii ( lisp_packet , thread_name ) :
 ...
 if ( O00o0OO0000oo == None or lisp . lisp_mr_or_pubsub ( O00o0OO0000oo . action ) ) :
  ...
  O00ooOo = ( O00o0OO0000oo and O00o0OO0000oo . action == lisp . LISP_SEND_PUBSUB_ACTION )
  lisp . lisp_send_map_request ( II1iII1i , iiI1iIiI ,
 Ooooo00o0OoO . inner_source , Ooooo00o0OoO . inner_dest , None , O00ooOo )
  if 80 - 80: o0oOOo0O0Ooo - OOooOOo + OoooooooOO
  if ( Ooooo00o0OoO . is_trace ( ) ) :
   OOOO0oooo = oO0oIIII
   O0ooOoO = "map-cache miss"
   lisp . lisp_trace_append ( Ooooo00o0OoO , reason = O0ooOoO , lisp_socket = OOOO0oooo )
 ...
 IIiIi1 , Oo00O0ooOO , IiiI , i11ii , i11I1 , o00oO0oOo00 = O00o0OO0000oo . select_rloc ( Ooooo00o0OoO , None )
 ...
 if ( IIiIi1 ) :
  Ooooo00o0OoO . encap_port = Oo00O0ooOO
  if ( Oo00O0ooOO == 0 ) : Ooooo00o0OoO . encap_port = lisp . LISP_DATA_PORT
  Ooooo00o0OoO . outer_dest . copy_address ( IIiIi1 )
  o00ooo = Ooooo00o0OoO . outer_dest . afi_to_version ( )
  Ooooo00o0OoO . outer_version = o00ooo
  ...
  Ooooo00o0OoO . outer_source . copy_address ( III1ii )
 ...
 lisp_socket = OOOO0oooo ) == False ) : return
  ...
  if ( Ooooo00o0OoO . encode ( IiiI ) == None ) : return
  ...
  Ooooo00o0OoO . send_packet ( iIiiIiiIi , Ooooo00o0OoO . outer_dest )
  ...
  I11i1iIiiIiIi = len ( Ooooo00o0OoO . packet )
  for I1i in i11I1 . rle_forwarding_list :
   ...
   if ( Ooooo00o0OoO . is_trace ( ) ) :
    OOOO0oooo = oO0oIIII
    O0ooOoO = "replicate"
    if ( lisp . lisp_trace_append ( Ooooo00o0OoO , reason = O0ooOoO , lisp_socket = OOOO0oooo ) == False ) : return
   ...
   OO00OO0o0 = len ( Ooooo00o0OoO . packet ) - I11i1iIiiIiIi
...
def O0OOO0 ( lisp_raw_socket , eid , geid , igmp ) :
 ...
 O0ooOoO = lisp . red ( "{}:{}" . format ( Ooooo00o0OoO . outer_dest . print_address_no_iid ( ) ,
 Ooooo00o0OoO . encap_port ) , False )
 ii11i = lisp . bold ( "IGMP Query" , False )
 if 71 - 71: I1Ii111 / I1ii11iIi11i * iIii1I11I1II1
 lisp . lprint ( "Data encapsulate {} to gleaned EID {}, RLOC {}" . format ( ii11i , iiI111I1iIiI , O0ooOoO ) )
...
def iIIi1Ii1III ( ) :
 ...
 if ( lisp . lisp_on_aws ( ) ) :
  ...
  if ( iII1 != None ) :
   iIiiI1 = iII1
   oO00OOoO00 = iII1 . print_address_no_iid ( )
   lisp . lprint ( "{} using RLOC {} on {}" . format ( iII1I11 , oO00OOoO00 , I1Iii1I ) )
  else :
 ...
 i111I11I = "0.0.0.0" if lisp . lisp_is_raspbian ( ) else "0::0"
 II1Ii1iI1i = lisp . lisp_open_listen_socket ( i111I11I ,
 str ( iiI1iIiI ) )
 ...
 Iiii1Ii = os . getenv ( "LISP_PCAP_THREADS" )
 Iiii1Ii = 1 if ( Iiii1Ii == None ) else int ( Iiii1Ii )
 ooOOo00oo0 = os . getenv ( "LISP_WORKER_THREADS" )
 ooOOo00oo0 = 0 if ( ooOOo00oo0 == None ) else int ( ooOOo00oo0 )
 if 40 - 40: OoOoOO00 - OOooOOo - OOooOOo - O0 - O0 . II111iiii
 if 57 - 57: Ii1I - OoooooooOO
 if 68 - 68: o0oOOo0O0Ooo % I1ii11iIi11i / I1Ii111 + I1Ii111 - I1Ii111 . OoO0O00
 if 100 - 100: OoOoOO00 % Oo0Ooo
 for OoOOiI in range ( Iiii1Ii ) :
  IIiiiiIiI1III = lisp . lisp_thread ( "pcap-{}" . format ( OoOOiI ) )
  IIiiiiIiI1III . thread_number = OoOOiI
  IIiiiiIiI1III . number_of_pcap_threads = Iiii1Ii
  IIiiiiIiI1III . number_of_worker_threads = ooOOo00oo0
  I11 . append ( IIiiiiIiI1III )
  threading . Thread ( target = i1i1IiIi1 , args = [ IIiiiiIiI1III ] ) . start ( )
  if 26 - 26: i1IIi
  if 35 - 35: I1IiiI
 ...
 for OoOOiI in range ( ooOOo00oo0 ) :
  IIiiiiIiI1III = lisp . lisp_thread ( "worker-{}" . format ( OoOOiI ) )
  I11 . append ( IIiiiiIiI1III )
  threading . Thread ( target = I1I1iII1i , args = [ IIiiiiIiI1III ] ) . start ( )
...
def I1iiIiiIiiI ( kv_pair ) :
 ...
 if 64 - 64: i1IIi
 if ( iiIIi1 == False and lisp . lisp_rloc_probing ) :
...
OOoO0oO00o = {
 "lisp xtr-parameters" : [ I1iiIiiIiiI , {
...
def i1i1 ( lisp_socket ) :
 ...
 o0o00OOOO , OOOo , OoOO , Ooooo00o0OoO = lisp . lisp_receive ( lisp_socket , False )
 i11iIi1iIIIIi = lisp . lisp_trace ( )
 if ( i11iIi1iIIIIi . decode ( Ooooo00o0OoO ) == False ) : return
 if 43 - 43: ooOoO0o * I1Ii111 * II111iiii % iIii1I11I1II1 / I1ii11iIi11i - IiII
 if 51 - 51: Ii1I
 if 31 - 31: IiII - OoO0O00 / OOooOOo . i1IIi / Ii1I
 if 66 - 66: OoO0O00
 if 72 - 72: I1Ii111
 i11iIi1iIIIIi . rtr_cache_nat_trace ( OOOo , OoOO )
...
O0OO000OOo0o = [ II1Ii1iI1i , Oo0oO0oo0oO00 ,
 i111I , oO0oIIII ]
o0OOOoo0ooo00 = [ II1Ii1iI1i ] * 3
if 1 - 1: OOooOOo - iIii1I11I1II1 * OoO0O00 * I1Ii111 * O0
while ( True ) :
 try : o0 , OOOooO00OO00O , i1I11IiI1iiII = select . select ( O0OO000OOo0o , [ ] , [ ] )
 except : break
 ...
 if ( lisp . lisp_ipc_data_plane and i111I in o0 ) :
 ...
 if ( II1Ii1iI1i in o0 ) :
  o0o00OOOO , OOOo , OoOO , Ooooo00o0OoO = lisp . lisp_receive ( o0OOOoo0ooo00 [ 0 ] ,
 False )
  if ( OOOo == "" ) : break
  ...
  if ( lisp . lisp_is_rloc_probe_reply ( Ooooo00o0OoO [ 0 ] ) ) :
   ...
   continue
   if 55 - 55: oO0o
  lisp . lisp_parse_packet ( o0OOOoo0ooo00 , Ooooo00o0OoO , OOOo , OoOO )
 ...
 if ( Oo0oO0oo0oO00 in o0 ) :
  o0o00OOOO , OOOo , OoOO , Ooooo00o0OoO = lisp . lisp_receive ( Oo0oO0oo0oO00 , True )
  if 28 - 28: IiII * I1IiiI % IiII
  if ( OOOo == "" ) : break
  if 95 - 95: O0 / I11i . I1Ii111
  if ( o0o00OOOO == "command" ) :
   ...
   lispconfig . lisp_process_command ( Oo0oO0oo0oO00 , o0o00OOOO ,
 Ooooo00o0OoO , "lisp-rtr" , [ OOoO0oO00o ] )
  elif ( o0o00OOOO == "api" ) :
   lisp . lisp_process_api ( "lisp-rtr" , Oo0oO0oo0oO00 , Ooooo00o0OoO )
  elif ( o0o00OOOO == "data-packet" ) :
   IIIii ( Ooooo00o0OoO , "" )
  else :
   if ( lisp . lisp_is_rloc_probe_request ( Ooooo00o0OoO [ 0 ] ) ) :
    lisp . lprint ( "RTR ignoring RLOC-probe request, using pcap" )
