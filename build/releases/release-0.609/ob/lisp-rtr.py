 ...
 for oO0O00OoOO0 in mc . rloc_set :
  ...
  if ( oO0O00OoOO0 . rle ) :
   for iiIIiiIi1Ii11 in oO0O00OoOO0 . rle . rle_nodes :
    ...
    Oo0 = iiIIiiIi1Ii11 . address . print_address_no_iid ( ) + ":" + str ( iiIIiiIi1Ii11 . translated_port )
    if 70 - 70: I11i
...
def O0oOO0o ( lisp_raw_socket , eid , geid , igmp ) :
 ...
 for iiIIiiIi1Ii11 in OoOo . rloc_set [ 0 ] . rle . rle_nodes :
  if ( iiIIiiIi1Ii11 . rloc_name == i1i11ii1Ii ) :
   O0iIi1IiII . outer_dest . copy_address ( iiIIiiIi1Ii11 . address )
   O0iIi1IiII . encap_port = iiIIiiIi1Ii11 . translated_port
   break
