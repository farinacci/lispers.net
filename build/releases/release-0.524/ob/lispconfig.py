...
def lisp_itr_rtr_show_rloc_probe_command ( itr_or_rtr ) :
 ...
 lisp . bold ( ":" , True ) , II1 . translated_port )
  ...
  oo = [ II1 ]
  if ( II1 . multicast_rloc_probe_list != { } ) :
   oo += II1 . multicast_rloc_probe_list . values ( )
  ...
  for II1 in oo :
   if ( len ( oo ) != 1 ) :
    I11I1i = II1 . rloc . print_address_no_iid ( )
    I11I1i = lisp . bold ( lisp . lisp_print_cour ( I11I1i ) , True )
    if ( oo . index ( II1 ) != 0 ) : oO0OOo += "<br><br>"
    oO0OOo += "RLOC {}:<br>" . format ( I11I1i )
    if 63 - 63: II111iiii . I1Ii111 % IiII + II111iiii
    if 81 - 81: OOooOOo - I1IiiI % o0oOOo0O0Ooo
   i1iiIiIi1 = lisp . lisp_print_elapsed ( II1 . last_rloc_probe )
   i1iiIiIi1 = lisp . lisp_print_cour ( i1iiIiIi1 )
   ii1II11i1ii1I = lisp . lisp_print_elapsed ( II1 . last_rloc_probe_reply )
   ii1II11i1ii1I = lisp . lisp_print_cour ( ii1II11i1ii1I )
   IiIIiII1I = lisp . lisp_hex_string ( II1 . last_rloc_probe_nonce )
   IiIIiII1I = lisp . lisp_print_cour ( "0x" + IiIIiII1I )
   oO0OOo += ( "Last probe-request sent: {}, " + "last probe-reply received: {}, nonce: {}<br>" ) . format ( i1iiIiIi1 ,
   # IiII . iII111i - i1IIi + I1Ii111
 ii1II11i1ii1I , IiIIiII1I )
   if 54 - 54: OoooooooOO . oO0o - iII111i
   o00oo = II1 . print_recent_rloc_probe_rtts ( )
   o00oo = lisp . lisp_print_cour ( o00oo )
   oO0o00o000Oo0 = II1 . print_recent_rloc_probe_hops ( )
   oO0o00o000Oo0 = lisp . lisp_print_cour ( oO0o00o000Oo0 )
   ii1I1iIi = II1 . print_recent_rloc_probe_latencies ( )
   ii1I1iIi = lisp . lisp_print_cour ( ii1I1iIi )
   O0o0OOo0o0o = II1 . print_rloc_probe_hops ( )
   O0o0OOo0o0o = lisp . lisp_print_cour ( O0o0OOo0o0o )
   ...
   oO0OOo += ( "Telemetry: rtt: {}, hops: {}, latency: {}<br>" + "recent-rtts: {}, recent-hops: {}, recent-latencies: {}" ) . format ( II1 , O0o0OOo0o0o , I11IiI1I11i1i , o00oo , oO0o00o000Oo0 , ii1I1iIi )
   if 90 - 90: I11i
   if 95 - 95: OoO0O00
  ...
  i1iiI11I += lisp_table_row ( i1ii1i1i1 , oO0OOo )
  if 9 - 9: iII111i
...
def lisp_xtr_command ( kv_pair ) :
 ...
 for O00oO0 in kv_pair . keys ( ) :
  ...
  if ( O00oO0 == "checkpoint-map-cache" ) :
   ...
   iI1II1iIiI11I = lisp . lisp_checkpoint_filename
   if ( oo00oO0O0 == "no" and os . path . exists ( iI1II1iIiI11I ) ) :
    os . system ( "rm {}" . format ( iI1II1iIiI11I ) )
    if 19 - 19: ooOoO0o / I1IiiI - Ii1I
    if 53 - 53: oO0o
  if ( O00oO0 == "ipc-data-plane" ) :
   oo0OoO = ( oo00oO0O0 == "yes" )
   if ( oo0OoO and lisp . lisp_ipc_data_plane == False ) :
   ...
   if ( oo0OoO == False and lisp . lisp_ipc_data_plane ) :
   ...
   lisp . lisp_ipc_data_plane = oo0OoO
...
def lisp_show_json_list ( output ) :
 ...
 IIIII1IIiIi = sorted ( lisp . lisp_json_list )
 for oo0o in IIIII1IIiIi :
  i1iiIiI1Ii1i = lisp . lisp_json_list [ oo0o ]
  OOoOoo = lisp . lisp_print_cour ( i1iiIiI1Ii1i . print_json ( True ) )
  output += lisp_table_row ( oo0o , OOoOoo )
...
def lisp_show_rle_list ( output ) :
 ...
 o00OoOO00 = sorted ( lisp . lisp_rle_list )
 for oO0oOOoOo000O in o00OoOO00 :
  IiII1I = lisp . lisp_rle_list [ oO0oOOoOo000O ]
  output += lisp_table_row ( oO0oOOoOo000O , IiII1I . print_rle ( True , True ) )
...
def lisp_show_elp_list ( output ) :
 ...
 I1I1iiI1i = sorted ( lisp . lisp_elp_list )
 for IiII1111I in I1I1iiI1i :
  II1I1iIIiIIii = lisp . lisp_elp_list [ IiII1111I ]
  output += lisp_table_row ( IiII1111I , II1I1iIIiIIii . print_elp ( False ) )
...
def lisp_geo_command ( kv_pair ) :
 ...
 IIiI1I11ii1i = kv_pair [ "geo-name" ]
 o0ooo = lisp . lisp_geo ( IIiI1I11ii1i )
 ...
 ooOOO000O = kv_pair [ "geo-tag" ] [ 1 : : ]
 if ( o0ooo . parse_geo_string ( ooOOO000O ) == False ) : return
 ...
 lisp . lisp_geo_list [ IIiI1I11ii1i ] = o0ooo
 return
...
def lisp_elp_command ( kv_pair ) :
 ...
 if ( kv_pair . has_key ( "address" ) ) :
  for i11Ii1 in range ( len ( kv_pair [ "address" ] ) ) :
   o0o0o0O0oo = lisp . lisp_elp_node ( )
   Oo0oooOooo0OO0O0 . append ( o0o0o0O0oo )
   if 15 - 15: OOooOOo
   if 77 - 77: OoOoOO00
   if 91 - 91: oO0o
 for O00oO0 in kv_pair . keys ( ) :
  ...
  if ( O00oO0 == "elp-name" ) :
   ...
   if 84 - 84: II111iiii
  for Oo0ooooO0o00 in Oo0oooOooo0OO0O0 :
   O0OO0O = Oo0oooOooo0OO0O0 . index ( Oo0ooooO0o00 )
   if ( O0OO0O >= len ( oo00oO0O0 ) ) : O0OO0O = len ( oo00oO0O0 ) - 1
   o00OoO0o0 = oo00oO0O0 [ O0OO0O ]
   if ( O00oO0 == "probe" ) : Oo0ooooO0o00 . probe = ( o00OoO0o0 == "yes" )
   if ( O00oO0 == "strict" ) : Oo0ooooO0o00 . strict = ( o00OoO0o0 == "yes" )
   if ( O00oO0 == "eid" ) : Oo0ooooO0o00 . eid = ( o00OoO0o0 == "yes" )
   if ( O00oO0 == "address" ) : Oo0ooooO0o00 . address . store_address ( o00OoO0o0 )
 ...
 II1I1iIIiIIii . elp_nodes = Oo0oooOooo0OO0O0
...
def lisp_rle_command ( kv_pair ) :
 ...
 if ( kv_pair . has_key ( "address" ) ) :
  for i11Ii1 in range ( len ( kv_pair [ "address" ] ) ) :
   oOIIIi = lisp . lisp_rle_node ( )
   I1iI1111ii1I1 . append ( oOIIIi )
 ...
 for O00oO0 in kv_pair . keys ( ) :
  ...
  for Oo0ooooO0o00 in I1iI1111ii1I1 :
   O0OO0O = I1iI1111ii1I1 . index ( Oo0ooooO0o00 )
   if ( O0OO0O >= len ( oo00oO0O0 ) ) : O0OO0O = len ( oo00oO0O0 ) - 1
   o00OoO0o0 = oo00oO0O0 [ O0OO0O ]
   if ( O00oO0 == "level" ) :
    if ( o00OoO0o0 == "" ) : o00OoO0o0 = "0"
    Oo0ooooO0o00 . level = int ( o00OoO0o0 )
 ...
 IiII1I . rle_nodes = I1iI1111ii1I1
...
def lisp_json_command ( kv_pair ) :
 ...
 try :
  oo0o = kv_pair [ "json-name" ]
  OOoOoo = kv_pair [ "json-string" ]
 except :
  return
  if 5 - 5: OOooOOo + iII111i
  if 23 - 23: I1Ii111 % iIii1I11I1II1 . I11i
 i1iiIiI1Ii1i = lisp . lisp_json ( oo0o , OOoOoo )
 i1iiIiI1Ii1i . add ( )
 return
...
def lisp_get_lookup_string ( input_str ) :
 ...
 Oo0o0OOo0Oo0 = lisp . lisp_address ( lisp . LISP_AFI_NONE , "" , 0 , 0 )
 O00o = lisp . lisp_address ( lisp . LISP_AFI_NONE , "" , 0 , 0 )
 ...
 ii1iIi111i1 = OOOO0oo0 . split ( "/" )
 if ( len ( ii1iIi111i1 ) == 1 ) :
  Oo0o0OOo0Oo0 . store_address ( ii1iIi111i1 [ 0 ] )
  oOoOoO = False
 else :
  Oo0o0OOo0Oo0 . store_prefix ( OOOO0oo0 )
  oOoOoO = True
  if 58 - 58: iII111i - OoooooooOO
  if 56 - 56: iII111i / iII111i
 Ii11iIi1iIiii = oOoOoO
 if ( I11iiI1i1 ) :
  ii1iIi111i1 = I11iiI1i1 . split ( "/" )
  if ( len ( ii1iIi111i1 ) == 1 ) :
   O00o . store_address ( ii1iIi111i1 [ 0 ] )
   Ii11iIi1iIiii = False
  else :
   O00o . store_prefix ( OOOO0oo0 )
   Ii11iIi1iIiii = True
   if 11 - 11: I1ii11iIi11i / I1ii11iIi11i
   if 39 - 39: O0 . I11i
 return ( [ Oo0o0OOo0Oo0 , oOoOoO , O00o , Ii11iIi1iIiii ] )
...
def lisp_show_map_cache_lookup ( eid_str ) :
 Oo0o0OOo0Oo0 , oOoOoO , O00o , Ii11iIi1iIiii = lisp_get_lookup_string ( eid_str )
 if 6 - 6: I1Ii111
 i1iiI11I = "<br>"
 if 46 - 46: II111iiii * I1Ii111
 iiiiI111 = Oo0o0OOo0Oo0 if ( O00o . is_null ( ) ) else O00o
 I1i1i1ii1iiI1 = oOoOoO if ( O00o . is_null ( ) ) else Ii11iIi1iIiii
 if 73 - 73: I1Ii111
 iiI1iii = lisp . lisp_map_cache . lookup_cache ( iiiiI111 , I1i1i1ii1iiI1 )
 if ( iiI1iii == None ) :
  i1iiI11I += "{} {}" . format ( lisp . lisp_print_sans ( "Lookup not found for" ) ,
 lisp . lisp_print_cour ( eid_str ) )
 else :
  if ( iiiiI111 == O00o ) :
   i1IiIiiiii11 = iiI1iii . lookup_source_cache ( Oo0o0OOo0Oo0 , oOoOoO )
   if ( i1IiIiiiii11 ) : iiI1iii = i1IiIiiiii11
   if 58 - 58: OoooooooOO / iIii1I11I1II1
   if 25 - 25: O0 % i11iIiiIii + Ii1I + OOooOOo
  Oo000o = lisp . lisp_print_elapsed ( iiI1iii . uptime )
  i1iiI11I += "{} {} {} {} {} {} {}" . format ( lisp . lisp_print_sans ( "Exact" if oOoOoO else "Longest" ) ,
  # OoO0O00 - ooOoO0o - I1Ii111
 ...
 lisp . lisp_print_cour ( Oo000o ) )
  if 36 - 36: I11i % o0oOOo0O0Ooo % o0oOOo0O0Ooo + OoOoOO00
 i1iiI11I += "<br>"
 return ( i1iiI11I )
 if 81 - 81: Oo0Ooo - II111iiii
...
def lisp_get_clause_for_api ( command ) :
 ...
 for II1i in iiIiiIi :
  ...
  if ( lisp_end_clause ( II1i ) ) :
   III -= 1
   if ( III ) :
    iIi11I11 [ command ] . append ( IIi11III1i )
    IIi11III1i = { }
    continue
    if 26 - 26: O0 % OOooOOo - IiII . OOooOOo
   IIIiiII1iIi1ii1i . append ( iIi11I11 )
   iIi11I11 = { command : [ ] }
   ooOo0o = False
   continue
...
def lisp_put_clause_for_api ( data ) :
 ...
 O00OO0oO = ( o00oO00 in [ "lisp enable" , "lisp debug" , "lisp xtr-parameters" ] )
 ...
 if ( O00OO0oO == False ) :
  Oo0oO = True
  oOooooOo0oo00 = commands . getoutput ( "egrep '{}' ./lisp.config" . format ( o00oO00 ) )
  oOooooOo0oo00 = oOooooOo0oo00 . split ( "\n" )
  for II1i in oOooooOo0oo00 :
   if ( II1i [ 0 : len ( o00oO00 ) ] == o00oO00 ) : Oo0oO = False
   if 74 - 74: i1IIi . I1ii11iIi11i * I11i - i11iIiiIii % iIii1I11I1II1
   if 21 - 21: I11i
   ...
   if 46 - 46: i1IIi / IiII
 OOOo0 = data [ o00oO00 ]
 OOOo0 = lisp_unicode_to_ascii ( OOOo0 )
 iIi11I11 = o00oO00 + " {\n" if Oo0oO else ""
 if 65 - 65: I1ii11iIi11i * iIii1I11I1II1 - II111iiii
 ...
 for Iii1 in OOOo0 :
  ...
  for I1I111iIi in Iii1 :
   ...
   iIi11I11 += "    " + I1iIiIi111I + " {\n"
   for Ooo0OoO0oo0O in oo00oO0O0 : iIi11I11 += "        " + Ooo0OoO0oo0O + " = " + oo00oO0O0 [ Ooo0OoO0oo0O ] + "\n"
   iIi11I11 += "    }\n"
 ...
 IIiiiIi1IiI = "./lisp.config"
 ooOoOoOoOoo = IIiiiIi1IiI + ".temp"
 if 25 - 25: Oo0Ooo + o0oOOo0O0Ooo - OoO0O00
 ooo = open ( IIiiiIi1IiI , "r" )
 I11Ii1 = open ( ooOoOoOoOoo , "w" )
 if 63 - 63: i1IIi
 II1iII11 = False
 iiiI1 = False
 for II1i in ooo :
  if ( iiiI1 ) :
   ...
   iiiI1 = False
   continue
   if 13 - 13: i11iIiiIii - II111iiii - OoooooooOO * I1Ii111
  ...
  if ( II1iII11 == False and lisp_begin_clause ( II1i ) and
 II1i [ 0 : len ( o00oO00 ) ] == o00oO00 ) :
   if ( O00OO0oO == False ) :
    I11Ii1 . write ( II1i )
    for I1i11i in iIi11I11 : I11Ii1 . write ( I1i11i )
    II1iII11 = True
 ...
 os . system ( "cp {} {}" . format ( ooOoOoOoOoo , IIiiiIi1IiI ) )
...
def lisp_remove_clause_for_api ( data ) :
 ...
 if ( o00oO00 == "lisp user-account" ) :
  iIi11I11 = commands . getoutput ( "egrep -A4 '{}' ./lisp.config" . format ( ii1Ii [ 0 ] ) )
 ...
 o0oi1II1I1Ii = ( "lisp user-account" , "lisp site" , "lisp map-server" ,
 "lisp policy" )
 if 13 - 13: I11i + oO0o - II111iiii - o0oOOo0O0Ooo + iII111i + I1Ii111
 IIiiiIi1IiI = "./lisp.config"
 ooo = open ( IIiiiIi1IiI , "r" )
 ...
 for II1i in ooo :
  ...
  for II1i in ooo :
   ...
   oO00O0oO = ( lisp_end_clause ( II1i ) and iIi1I1 )
   if ( oO00O0oO ) : break
   if 69 - 69: OOooOOo + OOooOOo * Ii1I * I11i + I1IiiI
   ii1i11iiII = II1i . replace ( " " , "" )
   ii1i11iiII = ii1i11iiII . replace ( "\n" , "" )
   ii1i11iiII = ii1i11iiII . replace ( "=" , " = " )
   if 40 - 40: iII111i
   if ( ii1i11iiII not in ii1Ii ) :
    iIi1I1 = False
    if ( len ( ii1Ii ) > 1 ) : break
    continue
    if 62 - 62: ooOoO0o / OOooOOo
   iIi1I1 = True
   if 74 - 74: iII111i % I1Ii111 / I1Ii111 - iIii1I11I1II1 - II111iiii + OOooOOo
   oO00O0oO = ( o00oO00 in o0oi1II1I1Ii )
   if ( oO00O0oO ) : break
   if 92 - 92: I11i % I1Ii111
 ...
 iIi1I1 = False
 for II1i in ooo :
  if ( II1i . find ( o00oO00 ) != - 1 ) : IiIi11iI1 -= 1
  if ( IiIi11iI1 == 0 and not iIi1I1 ) :
...
def lisp_u2a_walk_dict_array ( adata , a_dict ) :
 for I1I111iIi in a_dict :
  if ( type ( a_dict [ I1I111iIi ] ) == dict ) :
   ...
   for Ooo0OoO0oo0O in oo00oO0O0 : IIi1IIII11iI [ Ooo0OoO0oo0O . encode ( ) ] = oo00oO0O0 [ Ooo0OoO0oo0O ] . encode ( )
   adata [ I1I111iIi . encode ( ) ] = IIi1IIII11iI
  else :
...
def lisp_unicode_to_ascii ( udata ) :
 i1II = ( type ( udata ) == dict )
 if ( i1II ) : udata = [ udata ]
 if 50 - 50: OoOoOO00
 oO0oo00o = [ ]
 for o0Oo0oOO00O in udata :
  Oo00OO = { }
  if 19 - 19: O0 + Ii1I * Ii1I * i1IIi
  if ( type ( o0Oo0oOO00O ) == dict ) :
   lisp_u2a_walk_dict_array ( Oo00OO , o0Oo0oOO00O )
  elif ( type ( o0Oo0oOO00O ) == list ) :
   iI11Iii1ii111 = [ ]
   for i11IIiiI in o0Oo0oOO00O :
    OOoo = { }
    lisp_u2a_walk_dict_array ( OOoo , i11IIiiI )
    iI11Iii1ii111 . append ( OOoo )
    if 42 - 42: I1ii11iIi11i / ooOoO0o . iIii1I11I1II1
   Oo00OO = iI11Iii1ii111
  else :
   Oo00OO = { o0Oo0oOO00O . keys ( ) [ 0 ] . encode ( ) : Oo00OO }
   if 5 - 5: OoooooooOO
  oO0oo00o . append ( Oo00OO )
  if 21 - 21: OOooOOo
  if 71 - 71: OOooOOo + oO0o . I11i
 if ( i1II ) : oO0oo00o = oO0oo00o [ 0 ]
 return ( oO0oo00o )
 if 9 - 9: OoO0O00
...
def lisp_replace_db_list ( db ) :
 O0OO0O = - 1
 for o0O0ooooO0 in lisp . lisp_db_list :
  if ( db . match_eid_tuple ( o0O0ooooO0 ) ) :
   O0OO0O = lisp . lisp_db_list . index ( o0O0ooooO0 )
   break
 ...
 if ( lisp . lisp_nat_traversal and lisp . lisp_i_am_etr ) :
  for i1iIIiiIiII in o0O0ooooO0 . rloc_set :
...
def lisp_database_mapping_command ( kv_pair , ephem_port = None ) :
 ...
 IIo0oo0OO = [ ]
 for i11Ii1 in range ( len ( kv_pair [ "eid-prefix" ] ) ) :
  iiIii = lisp . lisp_mapping ( "" , "" , OOO )
  IIo0oo0OO . append ( iiIii )
 ...
 for O00oO0 in kv_pair . keys ( ) :
  ...
  if ( O00oO0 == "mr-name" ) :
   for i11Ii1 in range ( len ( IIo0oo0OO ) ) :
    iiIii = IIo0oo0OO [ i11Ii1 ]
    iiIii . use_mr_name = "all" if oo00oO0O0 [ 0 ] == "" else oo00oO0O0 [ i11Ii1 ]
    if 17 - 17: OOooOOo * OoOoOO00 . o0oOOo0O0Ooo
    if 82 - 82: O0 / OoooooooOO . i11iIiiIii - iII111i
  if ( O00oO0 == "ms-name" ) :
   for i11Ii1 in range ( len ( IIo0oo0OO ) ) :
    iiIii = IIo0oo0OO [ i11Ii1 ]
    iiIii . use_ms_name = "all" if oo00oO0O0 [ 0 ] == "" else oo00oO0O0 [ i11Ii1 ]
    if 63 - 63: I1Ii111
  ...
  if ( O00oO0 == "instance-id" ) :
   for i11Ii1 in range ( len ( IIo0oo0OO ) ) :
    ...
    for OOO00O0000 in o00OoO0o0 : o00OoO0o0 [ o00OoO0o0 . index ( OOO00O0000 ) ] = int ( OOO00O0000 )
    iiIii . eid . instance_id = o00OoO0o0 [ 0 ]
    iiIii . eid . iid_list = o00OoO0o0 [ 1 : : ]
    iiIii . group . instance_id = o00OoO0o0 [ 0 ]
  ...
  if ( O00oO0 == "secondary-instance-id" ) :
   for i11Ii1 in range ( len ( IIo0oo0OO ) ) :
    ...
    iiIii . secondary_iid = int ( o00OoO0o0 )
    if ( iiIii . eid . address == 0 ) :
  ...
  if ( O00oO0 == "eid-prefix" ) :
   for i11Ii1 in range ( len ( IIo0oo0OO ) ) :
    iiIii = IIo0oo0OO [ i11Ii1 ]
    o00OoO0o0 = oo00oO0O0 [ i11Ii1 ]
    if ( o00OoO0o0 != "" ) : iiIii . eid . store_prefix ( o00OoO0o0 )
    if ( iiIii . eid . address == 0 ) :
     lisp . lisp_default_secondary_iid = iiIii . secondary_iid
  ...
  if ( O00oO0 == "group-prefix" ) :
   for i11Ii1 in range ( len ( IIo0oo0OO ) ) :
    iiIii = IIo0oo0OO [ i11Ii1 ]
    o00OoO0o0 = oo00oO0O0 [ i11Ii1 ]
    if ( o00OoO0o0 != "" ) : iiIii . group . store_prefix ( o00OoO0o0 )
  ...
  if ( O00oO0 == "dynamic-eid" ) :
   for i11Ii1 in range ( len ( IIo0oo0OO ) ) :
    iiIii = IIo0oo0OO [ i11Ii1 ]
    o00OoO0o0 = oo00oO0O0 [ i11Ii1 ]
    if ( o00OoO0o0 == "yes" ) : iiIii . dynamic_eids = { }
  ...
  if ( O00oO0 == "signature-eid" ) :
   for i11Ii1 in range ( len ( IIo0oo0OO ) ) :
    iiIii = IIo0oo0OO [ i11Ii1 ]
    o00OoO0o0 = oo00oO0O0 [ i11Ii1 ]
    iiIii . signature_eid = ( o00OoO0o0 == "yes" )
 ...
 for iiIii in IIo0oo0OO :
  iiIii . rloc_set = copy . deepcopy ( iiIii . rloc_set )
  iiIii . sort_rloc_set ( )
  iiIii . add_db ( )
  if ( lisp_replace_db_list ( iiIii ) ) : continue
  lisp . lisp_db_list . append ( iiIii )
  if 82 - 82: OoO0O00
 ...
 for iiIii in IIo0oo0OO :
  if ( iiIii . eid . address == 0 and iiIii . eid . mask_len == 0 ) :
   if ( iiIii . eid . is_ipv4 ( ) or iiIii . eid . is_ipv6 ( ) ) :
    lisp . lisp_pitr = True
    break
    if 49 - 49: O0 . Oo0Ooo / Ii1I
    if 29 - 29: I1ii11iIi11i / oO0o * O0 - i11iIiiIii - OoO0O00 + Ii1I
    if 86 - 86: I1IiiI / I1ii11iIi11i * Ii1I % i11iIiiIii
  if ( iiIii . dynamic_eids == None ) : continue
  if ( iiIii . eid . is_mac ( ) and iiIii . eid . address == 0 and iiIii . eid . mask_len == 0 ) :
 ...
 for iiIii in IIo0oo0OO :
  if ( iiIii . dynamic_eids == None ) : continue
  i1I1IiiIIIiiI = iiIii . eid . print_prefix_no_iid ( )
  iIi1I1 = lisp . lisp_i_am_itr
  os . system ( "ip route add {} dev ma1" . format ( i1I1IiiIIIiiI ) )
...
def lisp_show_db_list ( itr_or_etr , output ) :
 ...
 for iiIii in lisp . lisp_db_list :
  Oo0OoO00OO0 = lisp . lisp_print_elapsed ( iiIii . uptime )
  oO000OO0 = iiIii . map_replies_sent
  ...
  if ( iiIii . dynamic_eid_configured ( ) ) :
   i1iiiI = iiIii . eid . print_prefix_url ( )
   Oo00o = len ( iiIii . dynamic_eids )
   OoiIIIiIi1I1i = itr_or_etr . lower ( )
   OO0Oo = ( "<br><a href='/lisp/show/{}/dynamic-eid/{}'>" + "{} dynamic-eids</a>" ) . format ( OoiIIIiIi1I1i , i1iiiI , Oo00o )
   if 83 - 83: i1IIi
   if 38 - 38: OoooooooOO * iIii1I11I1II1
   if 54 - 54: OoooooooOO . I1Ii111
  oo0o0oo0O0O = True
  for i1iIIiiIiII in iiIii . rloc_set :
   if ( oo0o0oo0O0O ) :
    I1Iii1iI = iiIii . print_eid_tuple ( )
    I1Iii1iI = iiIii . star_secondary_iid ( I1Iii1iI )
    I1Iii1iI += OO0Oo
    Oo000o = Oo0OoO00OO0
    oo0o0oo0O0O = False
   else :
    I1Iii1iI , Oo000o , oO000OO0 = ( "" , "" , "" )
    if 22 - 22: I1Ii111
    if 29 - 29: I1Ii111 * Ii1I + I1ii11iIi11i * OoOoOO00 * IiII
   ...
   II1iIii1Ii = i1iIIiiIiII . print_rloc_name ( True )
   if ( II1iIii1Ii != "" ) : II1iiiiI1 += II1iIii1Ii + "<br>"
   ...
   if ( itr_or_etr == "ITR" ) :
    output += lisp_table_row ( I1Iii1iI , Oo000o , II1iiiiI1 ,
 ...
 "Geo-Prefix or Geo-Point" )
  o00OooO = sorted ( lisp . lisp_geo_list )
  for IIiI1I11ii1i in o00OooO :
   o0ooo = lisp . lisp_geo_list [ IIiI1I11ii1i ]
   output += lisp_table_row ( IIiI1I11ii1i , o0ooo . print_geo_url ( ) )
...
def lisp_interface_command ( kv_pair ) :
 ...
 for O00oO0 in kv_pair . keys ( ) :
  oo00oO0O0 = kv_pair [ O00oO0 ]
  if ( O00oO0 == "interface-name" ) : IIiiII11i11I = oo00oO0O0
  if ( O00oO0 == "device" ) : oOO0 = oo00oO0O0
  if ( O00oO0 == "instance-id" ) : II1iiiiII = oo00oO0O0
  if ( O00oO0 == "dynamic-eid" ) : O000ooO0 = oo00oO0O0
  if ( O00oO0 == "multi-tenant-eid" ) : oo0o00oO = oo00oO0O0
  if ( O00oO0 == "dynamic-eid-device" ) : oOO0o0oO0oO00 = oo00oO0O0
  if ( O00oO0 == "dynamic-eid-timeout" ) : ii11IIi111iii = oo00oO0O0
  if ( O00oO0 == "lisp-nat" ) : o00ooOOo0ooO0 = ( oo00oO0O0 == "yes" )
 ...
 if ( lisp . lisp_myinterfaces . has_key ( oOO0 ) and oo0o00oO == None ) :
  oO0ooOoOooO00o00 = lisp . lisp_myinterfaces [ oOO0 ]
 else :
  oO0ooOoOooO00o00 = lisp . lisp_interface ( oOO0 )
  lisp . lisp_myinterfaces [ oOO0 ] = oO0ooOoOooO00o00
 ...
 oO0ooOoOooO00o00 . interface_name = IIiiII11i11I
 if ( II1iiiiII != None ) :
  if ( II1iiiiII . isdigit ( ) == False ) : II1iiiiII = "0"
  oO0ooOoOooO00o00 . instance_id = int ( II1iiiiII )
  if 83 - 83: i1IIi * I1Ii111 - IiII / Ii1I
 if ( O000ooO0 != None ) :
  oO0ooOoOooO00o00 . dynamic_eid . store_prefix ( O000ooO0 )
  oO0ooOoOooO00o00 . dynamic_eid . instance_id = oO0ooOoOooO00o00 . instance_id
  if 48 - 48: oO0o . II111iiii - OoOoOO00 % i1IIi . OoOoOO00
 if ( oOO0o0oO0oO00 != None ) :
  oO0ooOoOooO00o00 . dynamic_eid_device = oOO0o0oO0oO00
  if 32 - 32: Ii1I * I1IiiI - OOooOOo . Oo0Ooo / O0 + Ii1I
 if ( ii11IIi111iii != None ) :
  oO0ooOoOooO00o00 . dynamic_eid_timeout = int ( ii11IIi111iii )
  if 67 - 67: OoOoOO00 % Oo0Ooo
 if ( oo0o00oO != None ) :
  oO0ooOoOooO00o00 . multi_tenant_eid . store_prefix ( oo0o00oO )
  oO0ooOoOooO00o00 . multi_tenant_eid . instance_id = int ( oO0ooOoOooO00o00 . instance_id )
  lisp . lisp_multi_tenant_interfaces . append ( oO0ooOoOooO00o00 )
  if 7 - 7: i11iIiiIii % I1ii11iIi11i / I1Ii111 % Oo0Ooo - OoO0O00
 if ( o00ooOOo0ooO0 ) :
  o0OOo0o0 = "sudo iptables -t nat -C POSTROUTING -o {} -j MASQUERADE"
  o0OOo0o0 = commands . getoutput ( o0OOo0o0 . format ( oOO0 ) )
  if ( o0OOo0o0 != "" ) :
   oOOoO = lisp . lisp_get_loopback_address ( )
   if ( oOOoO ) :
    iIiiI = "sudo iptables -t nat -A POSTROUTING -s {} -j ACCEPT"
    os . system ( iIiiI . format ( oOOoO ) )
    if 66 - 66: I11i
   iIiiI = "sudo iptables -t nat -A POSTROUTING -o {} -j MASQUERADE"
   os . system ( iIiiI . format ( oOO0 ) )
   os . system ( "sudo sysctl net.ipv4.ip_forward=1" )
   if 9 - 9: I1ii11iIi11i * Ii1I
   if 43 - 43: o0oOOo0O0Ooo + OoO0O00 - o0oOOo0O0Ooo - OoooooooOO / OoOoOO00 + O0
   if 61 - 61: OOooOOo . i11iIiiIii % OOooOOo * o0oOOo0O0Ooo * OoOoOO00
 lisp . lisp_iid_to_interface [ II1iiiiII ] = oO0ooOoOooO00o00
 ...
 if ( "SO_BINDTODEVICE" in dir ( socket ) ) : oO0ooOoOooO00o00 . set_socket ( oOO0 )
 if ( "PF_PACKET" in dir ( socket ) ) : oO0ooOoOooO00o00 . set_bridge_socket ( oOO0 )
 ...
 if ( O000ooO0 != None and lisp . lisp_program_hardware ) :
  O0O0Ooooo000 = "ip verify unicast source reachable-via rx"
  lisp . lisp_send_to_arista ( O0O0Ooooo000 , oOO0 )
  O0O0Ooooo000 = 'sysctl -w "net.ipv4.conf.{}.rp_filter=0"' . format ( oOO0 )
...
def lisp_show_dynamic_eid_command ( parm ) :
 ...
 Oo0o0OOo0Oo0 = lisp_get_lookup_string ( parm . split ( "%" ) [ 0 ] )
 Oo0o0OOo0Oo0 = Oo0o0OOo0Oo0 [ 0 ]
 if 46 - 46: iII111i + I1Ii111 % OoooooooOO * I1ii11iIi11i
 iiIii = lisp . lisp_db_for_lookups . lookup_cache ( Oo0o0OOo0Oo0 , False )
 if ( iiIii == None ) : return ( i1iiI11I )
 if 89 - 89: IiII - IiII % iII111i / I11i + oO0o - IiII
 OoiIIIiIi1I1i = "ITR" if lisp . lisp_i_am_itr else "ETR"
 OOOO0oo0 = iiIii . print_eid_tuple ( )
 ...
 for i1I1IiiIIIiiI in iiIii . dynamic_eids . values ( ) :
  Oo0o0OOo0Oo0 = i1I1IiiIIIiiI . dynamic_eid . print_address ( )
  oOoOo0OOOOOO = lisp . lisp_print_elapsed ( i1I1IiiIIIiiI . uptime )
  I1IIiIi = str ( i1I1IiiIIIiiI . timeout ) + " secs"
  if ( OoiIIIiIi1I1i == "ITR" ) :
   OoOO0OOo0Oo = lisp . lisp_print_elapsed ( i1I1IiiIIIiiI . last_packet )
   i1iiI11I += lisp_table_row ( Oo0o0OOo0Oo0 , i1I1IiiIIIiiI . interface , oOoOo0OOOOOO , OoOO0OOo0Oo , I1IIiIi )
  else :
   i1iiI11I += lisp_table_row ( Oo0o0OOo0Oo0 , i1I1IiiIIIiiI . interface , oOoOo0OOOOOO , I1IIiIi )
...
def lisp_clear_decap_stats ( command ) :
 Oo00oiiIi1i = command . split ( "%" ) [ 1 ]
 lisp . lisp_decap_stats [ Oo00oiiIi1i ] = lisp . lisp_stats ( )
...
def lisp_show_decap_stats ( output , etr_or_rtr ) :
 iI1ii1i1iIi = etr_or_rtr . upper ( )
 I11IiI1I11i1i = etr_or_rtr . lower ( )
 if 49 - 49: I1ii11iIi11i * iII111i * I1IiiI + i11iIiiIii
 iIIi11 = [ ]
 for I1I111iIi in lisp . lisp_decap_stats :
  I1I = "<a href='/lisp/clear/{}/stats/{}'>{}</a>" . format ( I11IiI1I11i1i , I1I111iIi , I1I111iIi )
  iIIi11 . append ( I1I )
  if 44 - 44: OoO0O00 / I1Ii111 / OoooooooOO
  if 61 - 61: oO0o / OOooOOo
 iIII1iI = "LISP-{} Decapsulation Stats:" . format ( iI1ii1i1iIi )
 output += lisp_table_header ( iIII1iI , * iIIi11 )
 if 61 - 61: iII111i . i1IIi
 iIIi11 = [ ]
 for i1i1ii11i1I in lisp . lisp_decap_stats . values ( ) :
  iIIi11 . append ( i1i1ii11i1I . get_stats ( False , True ) )
  if 66 - 66: O0 * OoOoOO00 % oO0o * OoOoOO00 - Ii1I . o0oOOo0O0Ooo
...
def lisp_show_crypto_list ( xtr ) :
 i1iiI11I = ""
 ii11I1IiIIi1i1IIi = len ( lisp . lisp_crypto_keys_by_nonce ) != 0
 if 83 - 83: O0 / OoO0O00 / I1IiiI
 if ( lisp . lisp_i_am_itr or lisp . lisp_i_am_rtr ) :
  if ( ii11I1IiIIi1i1IIi ) :
 ...
 "Key Material" )
   for I1I111iIi in lisp . lisp_crypto_keys_by_nonce :
    ...
    for I1I1IiIiIIi1I in oo00oO0O0 :
     if ( I1I1IiIiIIi1I == None ) : continue
     oo0Ooo = lisp . lisp_print_elapsed ( I1I1IiIiIIi1I . uptime )
     o0Oo = I1I1IiIiIIi1I . print_keys ( False )
     i1iiI11I += lisp_table_row ( i1ii1i1i1 , oo0Ooo , I1I1IiIiIIi1I . key_id , o0Oo )
     i1ii1i1i1 = ""
 ...
 "Rekey Count" , "Use Count" , "Key-ID" , "Key Material" )
  for I1I111iIi in lisp . lisp_crypto_keys_by_rloc_encap :
   ...
   for I1I1IiIiIIi1I in oo00oO0O0 :
    if ( I1I1IiIiIIi1I == None ) : continue
    oo0Ooo = lisp . lisp_print_elapsed ( I1I1IiIiIIi1I . uptime )
    o000OOO000o = lisp . lisp_print_elapsed ( I1I1IiIiIIi1I . last_rekey )
    o0Oo = I1I1IiIiIIi1I . print_keys ( False )
    i1iiI11I += lisp_table_row ( i1ii1i1i1 , oo0Ooo , o000OOO000o , I1I1IiIiIIi1I . rekey_count ,
 I1I1IiIiIIi1I . use_count , I1I1IiIiIIi1I . key_id , o0Oo )
    i1ii1i1i1 = ""
    if 71 - 71: I1Ii111 - iII111i % O0
    if 15 - 15: I11i - IiII - iII111i
  i1iiI11I += lisp_table_footer ( )
  if 84 - 84: o0oOOo0O0Ooo / I1Ii111 - O0 + I1IiiI . I1ii11iIi11i
