...
def i11iIIIIIi1 ( jd ) :
 for iiII1i1 in jd :
  print ( "Path from {} to {}:" . format ( iiII1i1 [ "se" ] , iiII1i1 [ "de" ] ) )
  for o00oOO0o in iiII1i1 [ "paths" ] :
   ...
   Oooo0O0oo00oO = o00oOO0o [ "dr" ]
   if ( Oooo0O0oo00oO . find ( "?" ) != - 1 ) : Oooo0O0oo00oO = IIi1i ( Oooo0O0oo00oO )
   if 46 - 46: I1Ii111 % I11i + OoO0O00 . OoOoOO00 . OoO0O00
   print ( "  {} {}: {} -> {}, ts {}, node {}" . format ( o00oOO0o [ "n" ] , OOoOO0oo0ooO , o00oOO0o [ "sr" ] , Oooo0O0oo00oO , OOO00O , oO00o0 ( I1111I1iII11 ) ) )
   if 55 - 55: Oo0Ooo + iIii1I11I1II1 / OoOoOO00 * oO0o - i11iIiiIii - Ii1I
   if 25 - 25: I1ii11iIi11i
   if ( "rtts" in o00oOO0o and "hops" in o00oOO0o and "lats" in o00oOO0o ) :
    ...
    I1 = I1 . replace ( "'" , "" )
    I1 = I1 . replace ( '"' , "" )
    iiIii = json . dumps ( o00oOO0o [ "lats" ] )
    iiIii = iiIii . replace ( "u" , "" )
    iiIii = iiIii . replace ( "'" , "" )
    iiIii = iiIii . replace ( '"' , "" )
    print ( "            " , end = ' ' )
    print ( "recent-rtts {}, recent-hops {}" . format ( Ii1i , I1 ) )
    print ( "             recent-latencies {}" . format ( iiIii ) )
...
def I1111IIi ( eid ) :
 ...
 return ( O0i1II1Iiii1I11 , eid , Oo0oO )
 if 48 - 48: O0
...
def oO0OOOO0 ( match_iid , match_eid , user , pw , http , port , v4v6 ) :
 ...
 for o00oO0oo0OO in I1I1II1I11 :
  ...
  O0i1II1Iiii1I11 , O0O0OOOOoo , Oo0oO = I1111IIi ( O0O0OOOOoo )
...
o000ooooO0o , iI1i11 , Oo0oO = I1111IIi ( sys . argv [ - 1 ] )
if ( o000ooooO0o == None ) :
...
if ( "-s" in sys . argv ) :
 ...
 Iiii1iI1i , I1ii1ii11i1I , Oo0oO = I1111IIi ( sys . argv [ II1I ] )
 if ( Iiii1iI1i == None ) :
  print ( "-s <source-eid> parse error" )
  exit ( 1 )
  if 58 - 58: iII111i + Oo0Ooo
 if ( Oo0oO ) : Iiii1iI1i = None
...
OOOoOoO = iI1i11 if ( iI1i11 . find ( ":" ) != - 1 ) else "::ffff:" + iI1i11
OOO00O = time . time ( )
...
if 45 - 45: ooOoO0o
try :
 OOOOO0O00 . sendto ( Ii11iI1i , ( OOOoOoO , o0o0Oo0oooo0 ) )
except socket . error as I1I1I :
 print ( "sock.sendto() failed: {}" . format ( I1I1I ) )
 exit ( 1 )
...
try :
 Ii11iI1i , iII1iiiiIII = OOOOO0O00 . recvfrom ( 9000 )
 iII1iiiiIII = iII1iiiiIII [ 0 ] . replace ( "::ffff:" , "" )
except socket . timeout :
 exit ( 1 )
except socket . error as I1I1I :
 print ( "sock.recvfrom() failed, error: {}" . format ( I1I1I ) )
 exit ( 1 )
 if 78 - 78: OOooOOo * o0oOOo0O0Ooo / I11i - O0 / IiII
 if 96 - 96: OoOoOO00 . o0oOOo0O0Ooo - ooOoO0o
O0OI11iiiii1II = round ( time . time ( ) - OOO00O , 3 )
if 51 - 51: O0 % oO0o - II111iiii
print ( "Received reply from {}, rtt {} secs" . format ( iII1iiiiIII , O0OI11iiiii1II ) )
print ( "" )
