...
def Oo0o ( lisp , command , yn ) :
 OOO0o0o = { "map-resolver" : "mr" , "map-server" : "ms" ,
 "ddt-node" : "ddt" }
 if 40 - 40: I1IiiI / O0 % ooOoO0o + O0 * i1IIi
 I1Ii11I1Ii1i = False
 Ooo = command . find ( "debug-" )
 if ( Ooo != - 1 ) :
  command = command [ len ( "debug-" ) : : ]
  I1Ii11I1Ii1i = True
  if 56 - 56: I11i - i1IIi
  if 64 - 64: I1Ii111 + iII111i
 ii1Ii = "enable_" if yn == "yes" else "disable_"
 if ( command in OOO0o0o ) : command = OOO0o0o [ command ]
 ...
 if ( I1Ii11I1Ii1i ) :
  o0o0Oo0oooo0 = getattr ( lisp , ii1Ii + command + "_debug" )
  return ( o0o0Oo0oooo0 ( ) )
 ...
 if ( command in lisp . enable_status ) :
  o0o0Oo0oooo0 = getattr ( lisp , ii1Ii + command )
  return ( o0o0Oo0oooo0 ( ) )
  if 30 - 30: OoO0O00
...
if ( II ) :
 ...
 iIi1 = input ( "Confirm to set {}, y/n: " . format ( III1IiiI ) )
 if ( iIi1 != "y" ) : exit ( 0 )
