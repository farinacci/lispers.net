...
def lisp_display_map_cache ( mc , output ) :
 ...
 oOoO000 = mc . print_ttl ( )
 if 86 - 86: iIii1I11I1II1 - I11i % ooOoO0o . OOooOOo * OoOoOO00 . i1IIi
 Ii1iiIIi1i = "encapsulate" if Ii1iiIIi1i == lisp . LISP_NO_ACTION else lisp . lisp_map_reply_action_string [ Ii1iiIIi1i ]
 if 75 - 75: I11i + ooOoO0o / ooOoO0o - OOooOOo * OoO0O00 * ooOoO0o
 if 53 - 53: IiII % Oo0Ooo
 if ( len ( mc . rloc_set ) == 0 ) :
  IiIII = mc . stats . get_stats ( True , True )
  output += lisp_table_row ( OOOO0oo0 , Oo000o + "<br>" + oOoO000 , "--" , oooO00Oo ,
 IiIII , Ii1iiIIi1i , "--" )
  return ( [ True , output ] )
 ...
 for i1iIIiiIiII in mc . rloc_set :
  ...
  if ( i1iIIiiIiII . rloc_exists ( ) ) :
   if ( i1iIIiiIiII . rloc . is_null ( ) == False ) :
    Ii = i1iIIiiIiII . rloc . print_address_no_iid ( ) + "<br>"
    I1I1i1 = ""
    IiIi = lisp . lisp_nonce_echoing and i1iIIiiIiII . echo_nonce_capable
    if ( lisp . lisp_rloc_probing ) :
     I1I1i1 += i1iIIiiIiII . print_rloc_probe_state ( IiIi )
     if 36 - 36: OOooOOo * Ii1I
    if ( IiIi ) :
     i1iIi = lisp . lisp_get_echo_nonce ( i1iIIiiIiII . rloc , None )
     if ( i1iIi ) : I1I1i1 += i1iIi . print_echo_nonce ( )
     if 22 - 22: iII111i + OoO0O00 - ooOoO0o
    if ( I1I1i1 != "" ) : Ii = lisp . lisp_span ( Ii , I1I1i1 )
    if 10 - 10: I1IiiI / I1ii11iIi11i
    if 68 - 68: OOooOOo - OoooooooOO
    if 14 - 14: O0 / oO0o - Oo0Ooo - IiII
  if ( i1iIIiiIiII . translated_port != 0 ) :
   Ii += "encap-port: {}<br>" . format ( i1iIIiiIiII . translated_port )
   if 44 - 44: OoO0O00
   if 32 - 32: OoOoOO00 % OoO0O00 + i11iIiiIii + ooOoO0o - Ii1I + oO0o
  if ( i1iIIiiIiII . rloc_name ) :
   Ii += "rloc-name: {}<br>" . format ( lisp . blue ( i1iIIiiIiII . rloc_name ,
 True ) )
   if 31 - 31: iIii1I11I1II1 - o0oOOo0O0Ooo
   if 57 - 57: Oo0Ooo % OoO0O00
  if ( i1iIIiiIiII . geo ) :
   Ii += "geo: {}<br>" . format ( i1iIIiiIiII . geo . print_geo_url ( ) )
   if 1 - 1: OoOoOO00 * O0 . oO0o % O0 + II111iiii
  if ( i1iIIiiIiII . elp ) :
   i1 = i1iIIiiIiII . elp . print_elp ( True )
   Ii += "elp: {}<br>" . format ( i1 )
   if 68 - 68: i1IIi . I11i . i1IIi + IiII % I1IiiI
  if ( i1iIIiiIiII . rle ) :
   IIoO = i1iIIiiIiII . rle . print_rle ( True )
   Ii += "rle: {}<br>" . format ( IIoO )
   if 13 - 13: i1IIi
  if ( i1iIIiiIiII . json ) :
   i1iiIiI1Ii1i = "json: { ... }<br>"
   Ii += lisp . lisp_span ( i1iiIiI1Ii1i , i1iIIiiIiII . json . print_json ( False ) )
  ...
  IiIII = i1iIIiiIiII . stats . get_stats ( True , True )
  ...
  I1i = ""
  O0o0O0OooOoo = i1iIIiiIiII
  while ( True ) :
   IiII1i11III = lisp . lisp_print_elapsed ( O0o0O0OooOoo . last_state_change )
   if ( IiII1i11III == "never" ) : IiII1i11III = O0oooo0O
   iIIi11 = O0o0O0OooOoo . print_state ( )
   if ( O0o0O0OooOoo . unreach_state ( ) or O0o0O0OooOoo . no_echoed_nonce_state ( ) ) :
    iIIi11 = lisp . red ( iIIi11 , True )
    if 8 - 8: I1Ii111 % oO0o
   I1i += iIIi11 + " since " + IiII1i11III
   if 50 - 50: OoOoOO00 - oO0o + iIii1I11I1II1 - OoO0O00 . Oo0Ooo
   if ( lisp . lisp_rloc_probing ) :
    iiiiIii11i1 = O0o0O0OooOoo . print_rloc_probe_rtt ( )
    if ( iiiiIii11i1 != "none" ) : I1i += "<br>rtt: {}, hops: {}" . format ( iiiiIii11i1 , O0o0O0OooOoo . print_rloc_probe_hops ( ) )
   ...
   if ( lisp . lisp_rloc_probing and O0o0O0OooOoo . rloc_next_hop != None ) :
    Iiii1iIii , Oo00OOoO0oo = O0o0O0OooOoo . rloc_next_hop
    I1i += "<br>{}nh {}({}) " . format ( lisp . lisp_space ( 2 ) , Oo00OOoO0oo , Iiii1iIii )
    if 4 - 4: OoO0O00 - iII111i / i11iIiiIii * O0
    if 78 - 78: IiII - I11i % O0 - OOooOOo % OoO0O00
   O0o0O0OooOoo = O0o0O0OooOoo . next_rloc
   if ( O0o0O0OooOoo == None ) : break
   I1i += "<br>"
   if 43 - 43: OoO0O00
   if 90 - 90: OoooooooOO + O0 + I1ii11iIi11i / I11i / Ii1I * I1ii11iIi11i
  if ( Ii1iiIIi1i == "encapsulate" ) :
   ...
   if ( lisp . lisp_crypto_keys_by_rloc_encap . has_key ( Ii1I1i ) ) :
    ...
    if ( I1I111iIi != None and I1I111iIi . shared_key != None ) :
     Ii1iiIIi1i = "encap-crypto-" + I1I111iIi . cipher_suite_string
     if 19 - 19: I1IiiI
     if 66 - 66: oO0o / OoOoOO00
     if 13 - 13: II111iiii
     if 55 - 55: Oo0Ooo % i1IIi * I11i
  output += lisp_table_row ( OOOO0oo0 , Oo000o + "<br>" + oOoO000 , Ii , oooO00Oo ,
 IiIII , I1i + "<br>" + Ii1iiIIi1i ,
 str ( i1iIIiiIiII . priority ) + "/" + str ( i1iIIiiIiII . weight ) + "<br>" + str ( i1iIIiiIiII . mpriority ) + "/" + str ( i1iIIiiIiII . mweight ) )
  ...
  if ( Oo000o != "" ) : Oo000o , oOoO000 , oooO00Oo = ( "" , "" , "" )
...
def lisp_show_myrlocs ( output ) :
 if ( lisp . lisp_myrlocs [ 2 ] == None ) :
  ...
  Iiii1II111 = lisp . lisp_print_cour ( lisp . lisp_myrlocs [ 2 ] )
  iI11i = lisp . lisp_myrlocs [ 0 ] . print_address_no_iid ( ) if lisp . lisp_myrlocs [ 0 ] != None else "not found"
  if 4 - 4: ooOoO0o % IiII . I1Ii111
  iI11i = lisp . lisp_print_cour ( iI11i )
  oO0o00 = "-f inet" if lisp . lisp_is_macos ( ) else "-4"
  Oo0OOOO0oOoo0 = commands . getoutput ( "netstat -rn {}" . format ( oO0o00 ) )
  iI11i = lisp . lisp_span ( iI11i , Oo0OOOO0oOoo0 )
  if 92 - 92: IiII . Oo0Ooo - Oo0Ooo - o0oOOo0O0Ooo + I1Ii111 - O0
  i1I1Iiii = lisp . lisp_myrlocs [ 1 ] . print_address_no_iid ( ) if lisp . lisp_myrlocs [ 1 ] != None else "not found"
  if 15 - 15: ooOoO0o % o0oOOo0O0Ooo / oO0o - II111iiii . iIii1I11I1II1
  i1I1Iiii = lisp . lisp_print_cour ( i1I1Iiii )
  oO0o00 = "-f inet6" if lisp . lisp_is_macos ( ) else "-6"
  Oo0OOOO0oOoo0 = commands . getoutput ( "netstat -rn {}" . format ( oO0o00 ) )
  i1I1Iiii = lisp . lisp_span ( i1I1Iiii , Oo0OOOO0oOoo0 )
  ...
  output += lisp . lisp_print_sans ( II1i ) . format ( Iiii1II111 , iI11i , i1I1Iiii )
...
def lisp_display_nat_info ( output , dc , dodns ) :
 iiIIIII = len ( lisp . lisp_nat_state_info )
 if ( iiIIIII == 0 ) : return ( output )
 if 19 - 19: II111iiii / OoOoOO00
 I1I1i1 = "{} entries in the NAT-traversal port table" . format ( iiIIIII )
 oOoo00 = lisp . lisp_span ( "NAT-Traversed xTR Information:" , I1I1i1 )
 if 29 - 29: OOooOOo / OoOoOO00 . iIii1I11I1II1 / I11i % OoOoOO00 % iII111i
 if ( dodns ) :
  output += lisp_table_header ( oOoo00 , "xTR Hostname" ,
 ...
 for oOooO0 in lisp . lisp_nat_state_info . values ( ) :
  for oo00o000O in oOooO0 :
   II = oo00o000O . address
   OOoO000O0OO = oo00o000O . uptime
   ii11 = oo00o000O . hostname
   ooO00o = oo00o000O . port
   if 66 - 66: OoooooooOO + o0oOOo0O0Ooo . i1IIi * iII111i
   if ( oo00o000O . timed_out ( ) ) :
   ...
   if ( dodns ) :
    try :
     iiii1ii = socket . gethostbyaddr ( II ) [ 0 ]
    except :
     iiii1ii = "?"
     if 13 - 13: iIii1I11I1II1 - II111iiii % O0 . Ii1I % OoO0O00
    output += lisp_table_row ( ii11 , II , ooO00o , OOoO000O0OO , iiii1ii )
   else :
...
def lisp_itr_rtr_show_command ( parameter , itr_or_rtr , lisp_threads , dns = False ) :
 ...
 if ( len ( lisp_threads ) > 1 ) :
  ...
  for i11Ii1 in range ( len ( lisp_threads ) ) :
   O00OOO000oo0 = lisp_threads [ i11Ii1 ]
   iIIi11 . append ( "{} Input Stats<br>queue-size: {}" . format ( O00OOO000oo0 . thread_name ,
 O00OOO000oo0 . input_queue . qsize ( ) ) )
  ...
  for i11Ii1 in range ( len ( lisp_threads ) ) :
   O00OOO000oo0 = lisp_threads [ i11Ii1 ]
   iIIi11 . append ( O00OOO000oo0 . input_stats . get_stats ( False , True ) )
  ...
  if 73 - 73: OoO0O00
 ii11iiII = lisp . lisp_decent_dns_suffix
 if ( ii11iiII == None ) :
  ii11iiII = ":"
 else :
  ii11iiII = "&nbsp;(dns-suffix '{}'):" . format ( ii11iiII )
 ...
 if 80 - 80: Ii1I
 oOoo00 = "LISP-{} Configured Map-Resolvers{}" . format ( itr_or_rtr , ii11iiII )
 oOoo00 = lisp . lisp_span ( oOoo00 , I1I1i1 )
 if 26 - 26: iIii1I11I1II1 . OoooooooOO - iIii1I11I1II1
 i1iiI11I += lisp_table_header ( oOoo00 , "Map-Resolver" , "Last Used" ,
 ...
 for i1IIi1i1Ii1 in lisp . lisp_map_resolvers_list . values ( ) :
  ...
  I1ii1 = lisp . lisp_print_elapsed ( i1IIi1i1Ii1 . last_reply )
  II1iII1 = 0 if i1IIi1i1Ii1 . neg_map_replies_received is 0 else float ( i1IIi1i1Ii1 . total_rtt / i1IIi1i1Ii1 . neg_map_replies_received )
  if 31 - 31: Ii1I * o0oOOo0O0Ooo * Ii1I + OoO0O00 * o0oOOo0O0Ooo . I1Ii111
  II1iII1 = str ( round ( II1iII1 , 3 ) ) + " ms"
  if 89 - 89: OoooooooOO * Ii1I * I1IiiI . ooOoO0o * Ii1I / iII111i
  i1iiI11I += lisp_table_row ( Ii1I1i , Oo000o , i1IIi1i1Ii1 . map_requests_sent ,
 i1IIi1i1Ii1 . neg_map_replies_received , I1ii1 , II1iII1 )
  if 46 - 46: i11iIiiIii
 i1iiI11I += lisp_table_footer ( )
 ...
 oOoo00 = "LISP-{} {}:{}" . format ( itr_or_rtr , iI1ii , lisp . lisp_space ( 4 ) )
 oOoo00 = lisp . lisp_span ( oOoo00 , I1I1i1 )
 if 18 - 18: Ii1I
...
def lisp_itr_rtr_show_rloc_probe_command ( itr_or_rtr ) :
 oOoo00 = "LISP-{} RLOC-Probe Information:" . format ( itr_or_rtr )
 i1iiI11I = lisp_table_header ( oOoo00 , "RLOC Key State" , "RLOC-Probe State" )
 ...
 for IIi1IiiIi1III in lisp . lisp_rloc_probe_list . values ( ) :
  ...
  OOOO0oo0 = ""
  for O0o0O0OooOoo , i11Ii11I11i , oooOO0OOOO0O in IIi1IiiIi1III :
  ...
  O0o0O0OooOoo , i11Ii11I11i , oooOO0OOOO0O = IIi1IiiIi1III [ 0 ]
  if 38 - 38: oO0o
  if 28 - 28: iIii1I11I1II1 * I11i . I1IiiI
  if 78 - 78: OoooooooOO . OoooooooOO / O0
  if 25 - 25: II111iiii % II111iiii - Ii1I . O0
  Oo00OOoO0oo = lisp . lisp_hex_string ( O0o0O0OooOoo . last_rloc_probe_nonce )
  if ( O0o0O0OooOoo . translated_rloc . not_set ( ) ) :
   O00O0 = O0o0O0OooOoo . rloc . print_address_no_iid ( )
  else :
   O00O0 = "{}{}{}" . format ( O0o0O0OooOoo . translated_rloc . print_address_no_iid ( ) ,
 lisp . bold ( ":" , True ) , O0o0O0OooOoo . translated_port )
   if 19 - 19: I1IiiI + I11i % II111iiii
  O00O0 = lisp . bold ( lisp . lisp_print_cour ( O00O0 ) , True )
  oOO = O0o0O0OooOoo . rloc_name
  if ( oOO != None ) :
   oOO = lisp . bold ( oOO , True )
   O00O0 += ", {}" . format ( lisp . lisp_print_cour ( lisp . blue ( oOO , True ) ) )
   if 49 - 49: o0oOOo0O0Ooo
  I1i = O0o0O0OooOoo . print_state ( )
  if ( O0o0O0OooOoo . up_state ( ) == False ) : I1i = lisp . red ( O0o0O0OooOoo . print_state ( ) , True )
  O00O0 = "RLOC " + O00O0 + ", {}" . format ( I1i )
  ...
  o0o0oooO00O0 = lisp . lisp_print_elapsed ( O0o0O0OooOoo . last_rloc_probe )
  o0o0oooO00O0 = lisp . lisp_print_cour ( o0o0oooO00O0 )
  iiiI = lisp . lisp_print_elapsed ( O0o0O0OooOoo . last_rloc_probe_reply )
  ...
  Oo00OOoO0oo = lisp . lisp_hex_string ( O0o0O0OooOoo . last_rloc_probe_nonce )
  Oo00OOoO0oo = lisp . lisp_print_cour ( "0x" + Oo00OOoO0oo )
  iiiiIii11i1 = O0o0O0OooOoo . print_recent_rloc_probe_rtts ( )
  iiiiIii11i1 = lisp . lisp_print_cour ( iiiiIii11i1 )
  iIi = O0o0O0OooOoo . print_recent_rloc_probe_hops ( )
  iIi = lisp . lisp_print_cour ( iIi )
  oO00O0o0oOOO = O0o0O0OooOoo . print_rloc_probe_hops ( )
  oO00O0o0oOOO = lisp . lisp_print_cour ( oO00O0o0oOOO )
  O0o0O0OooOoo = O0o0O0OooOoo . print_rloc_probe_rtt ( )
  O0o0O0OooOoo = lisp . lisp_print_cour ( O0o0O0OooOoo )
  IIi1II11II += ( "Nonce: {}, rtt: {}, hops: {}<br>" + "Recent-rtts: {}, recent-hops: {}" ) . format ( Oo00OOoO0oo , O0o0O0OooOoo , oO00O0o0oOOO , iiiiIii11i1 , iIi )
...
def lisp_show_json_list ( output ) :
 ...
 oOoo00 = "Configured JSON Entries:"
 output += lisp_table_header ( oOoo00 , "JSON Name" , "JSON String" )
 if 96 - 96: IiII
...
def lisp_show_rle_list ( output ) :
 ...
 oOoo00 = "Configured Replication List Entries (RLEs):"
 output += lisp_table_header ( oOoo00 , "RLE Name" , "RLE Nodes" )
 if 99 - 99: Oo0Ooo
 IiIi1I11 = sorted ( lisp . lisp_rle_list )
 for IiI1 in IiIi1I11 :
  IIoO = lisp . lisp_rle_list [ IiI1 ]
  output += lisp_table_row ( IiI1 , IIoO . print_rle ( True ) )
...
def lisp_show_elp_list ( output ) :
 oOoo00 = "Configured Explicit Locator Paths (ELPs):"
 output += lisp_table_header ( oOoo00 , "ELP Name" , "ELP Nodes" )
 if 70 - 70: I1Ii111 . I1ii11iIi11i / o0oOOo0O0Ooo * oO0o
 OoI1 = sorted ( lisp . lisp_elp_list )
 for OoO00o00 in OoI1 :
  i1 = lisp . lisp_elp_list [ OoO00o00 ]
  output += lisp_table_row ( OoO00o00 , i1 . print_elp ( False ) )
  if 72 - 72: i1IIi
 output += lisp_table_footer ( )
 return ( output )
...
def lisp_elp_command ( kv_pair ) :
 ...
 if 46 - 46: Ii1I
 i1 . elp_nodes = iiiI1I1iiiII
 lisp . lisp_elp_list [ i1 . elp_name ] = i1
 return
...
def lisp_rle_command ( kv_pair ) :
 ...
 IIoO . rle_nodes = I111I
 IIoO . build_forwarding_list ( )
 lisp . lisp_rle_list [ IIoO . rle_name ] = IIoO
 return
...
def lisp_replace_db_list ( db ) :
 ...
 if ( lisp . lisp_nat_traversal and lisp . lisp_i_am_etr ) :
  for i1iIIiiIiII in ooOoo . rloc_set :
   ...
   O0o0O0OooOoo = db . get_rloc_by_interface ( i1iIIiiIiII . interface )
   if ( O0o0O0OooOoo == None ) : continue
   O0o0O0OooOoo . store_translated_rloc ( i1iIIiiIiII . translated_rloc , i1iIIiiIiII . translated_port )
   O0o0O0OooOoo . rloc_name = i1iIIiiIiII . rloc_name
...
def lisp_database_mapping_command ( kv_pair , ephem_port = None ) :
 ...
 oO0Ooo0o00o = ( lisp . lisp_myrlocs [ 0 ] != None )
 lisp . lisp_get_local_addresses ( )
 if 53 - 53: OoOoOO00 % i1IIi
 if ( lisp . lisp_myrlocs [ 0 ] == None and oO0Ooo0o00o ) :
  lisp . lprint ( "No RLOCs found, local addresses changed from RLOC to EID" )
  if 35 - 35: Ii1I + I1ii11iIi11i . oO0o * Oo0Ooo
  if 27 - 27: iIii1I11I1II1 / Ii1I - IiII - Oo0Ooo
 ...
 for OOOooOO0oO in IIo0oo0OO :
  if ( OOOooOO0oO . dynamic_eids == None ) : continue
  I1 = OOOooOO0oO . eid . print_prefix_no_iid ( )
  iIi1I1 = lisp . lisp_i_am_itr
  os . system ( "ip route add {} dev ma1" . format ( I1 ) )
...
def lisp_show_db_list ( itr_or_etr , output ) :
 ...
 oOoo00 = "LISP-{} Configured Database Mappings:" . format ( itr_or_etr )
 oOoo00 = lisp . lisp_span ( oOoo00 , I1I1i1 )
 if 55 - 55: o0oOOo0O0Ooo . I1ii11iIi11i
 OOOoOo0O0O = '<a href="/lisp/show/etr/keys"><br>RLOC Keys</a>'
 if 63 - 63: oO0o
 if ( itr_or_etr == "ITR" ) :
  output += lisp_table_header ( oOoo00 , "EID-Prefix Record" ,
 ...
 for OOOooOO0oO in lisp . lisp_db_list :
  oo00O0OO0oo0O = lisp . lisp_print_elapsed ( OOOooOO0oO . uptime )
  IIiiIIi1II11 = OOOooOO0oO . map_replies_sent
  if 14 - 14: Ii1I - O0
  ...
  if ( OOOooOO0oO . dynamic_eid_configured ( ) ) :
   OoOo00ooOO000 = OOOooOO0oO . eid . print_prefix_url ( )
   iiIIIII = len ( OOOooOO0oO . dynamic_eids )
   OoiIIIiIi1I1i = itr_or_etr . lower ( )
   i1I1Iii1IiiIi = ( "<br><a href='/lisp/show/{}/dynamic-eid/{}'>" + "{} dynamic-eids</a>" ) . format ( OoiIIIiIi1I1i , OoOo00ooOO000 , iiIIIII )
   if 38 - 38: Oo0Ooo . OOooOOo - I1Ii111
   if 10 - 10: oO0o * IiII * iII111i . O0
   if 19 - 19: IiII
  o0oOoooOoo0 = True
  for i1iIIiiIiII in OOOooOO0oO . rloc_set :
   if ( o0oOoooOoo0 ) :
    IiI1Iii1iIIII = OOOooOO0oO . print_eid_tuple ( )
    IiI1Iii1iIIII = OOOooOO0oO . star_secondary_iid ( IiI1Iii1iIIII )
    IiI1Iii1iIIII += i1I1Iii1IiiIi
    Oo000o = oo00O0OO0oo0O
    o0oOoooOoo0 = False
   else :
    IiI1Iii1iIIII , Oo000o , IIiiIIi1II11 = ( "" , "" , "" )
    if 87 - 87: II111iiii . Ii1I * OoO0O00
    if 74 - 74: o0oOOo0O0Ooo % OoOoOO00 . iII111i % I1Ii111 . O0 % II111iiii
   Ii = "" if i1iIIiiIiII . rloc . is_null ( ) else i1iIIiiIiII . rloc . print_address_no_iid ( )
   ...
   if ( i1iIIiiIiII . interface != None ) :
    Ii += " ({})" . format ( i1iIIiiIiII . interface )
    if 55 - 55: OoO0O00
   if ( Ii != "" ) : Ii += "<br>"
   if 20 - 20: ooOoO0o * I1Ii111 * o0oOOo0O0Ooo - ooOoO0o
   if ( i1iIIiiIiII . translated_rloc . not_set ( ) == False ) :
    Ii += "translated RLOC: {}<br>" . format ( i1iIIiiIiII . translated_rloc . print_address_no_iid ( ) )
    if 32 - 32: Ii1I * oO0o
    if 85 - 85: i11iIiiIii . OoO0O00 + OoO0O00
    if 28 - 28: Oo0Ooo
   oOoo0O = i1iIIiiIiII . print_rloc_name ( True )
   if ( oOoo0O != "" ) : Ii += oOoo0O + "<br>"
   if 55 - 55: iIii1I11I1II1 % OoOoOO00
   if ( i1iIIiiIiII . geo_name != None ) :
    Ii += "geo: " + i1iIIiiIiII . geo_name + "<br>"
    if 70 - 70: oO0o - O0 * iIii1I11I1II1 . I1Ii111 % O0
   if ( i1iIIiiIiII . elp_name != None ) :
    Ii += "elp: " + i1iIIiiIiII . elp_name + "<br>"
    if 99 - 99: I1IiiI
   if ( i1iIIiiIiII . rle_name != None ) :
    Ii += "rle: " + i1iIIiiIiII . rle_name + "<br>"
    if 30 - 30: O0 % OoooooooOO % I11i . i1IIi + I1Ii111 % OOooOOo
   if ( i1iIIiiIiII . json_name != None ) :
    Ii += "json: " + i1iIIiiIiII . json_name + "<br>"
    if 9 - 9: O0 . iIii1I11I1II1
    if 44 - 44: I1ii11iIi11i % IiII
   if ( itr_or_etr == "ITR" ) :
    output += lisp_table_row ( IiI1Iii1iIIII , Oo000o , Ii ,
 ...
 OOOooOO0oO . use_mr_name )
    ...
    output += lisp_table_row ( IiI1Iii1iIIII , Oo000o , Ii ,
 str ( i1iIIiiIiII . priority ) + "/" + str ( i1iIIiiIiII . weight ) ,
 str ( i1iIIiiIiII . mpriority ) + "/" + str ( i1iIIiiIiII . mweight ) , IiIII ,
 IIiiIIi1II11 , OOOooOO0oO . use_ms_name )
    if 6 - 6: OoO0O00
 ...
 if ( len ( lisp . lisp_geo_list ) != 0 ) :
  oOoo00 = "Configured Geo-Coordinates:"
  output += lisp_table_header ( oOoo00 , "Geo Name" ,
 "Geo-Prefix or Geo-Point" )
  O0OO00O0oOOoO = sorted ( lisp . lisp_geo_list )
  for o0OoOOoooooOO in O0OO00O0oOOoO :
...
def lisp_interface_command ( kv_pair ) :
 ...
 i1I111II1IiI = None
 oo00O0oOo = None
 if 6 - 6: i1IIi + iII111i - i1IIi - Oo0Ooo - o0oOOo0O0Ooo * I1ii11iIi11i
 for O00oO0 in kv_pair . keys ( ) :
  oo00oO0O0 = kv_pair [ O00oO0 ]
  if ( O00oO0 == "interface-name" ) : I1iI1Ii1I1Iii1 = oo00oO0O0
  if ( O00oO0 == "device" ) : ii1i = oo00oO0O0
  if ( O00oO0 == "instance-id" ) : OO00O0O00oOOO = oo00oO0O0
  if ( O00oO0 == "dynamic-eid" ) : ii1111iIIiIIi = oo00oO0O0
  if ( O00oO0 == "multi-tenant-eid" ) : i1I111II1IiI = oo00oO0O0
  if ( O00oO0 == "dynamic-eid-device" ) : ooOo0Oo = oo00oO0O0
  if ( O00oO0 == "dynamic-eid-timeout" ) : I11 = oo00oO0O0
  if ( O00oO0 == "lisp-nat" ) : oo00O0oOo = ( oo00oO0O0 == "yes" )
  if 90 - 90: ooOoO0o / O0 / o0oOOo0O0Ooo . Ii1I / OoooooooOO
  if 6 - 6: o0oOOo0O0Ooo - iII111i - OOooOOo / OoooooooOO
 if ( ii1i == None ) : return
 ...
 if ( lisp . lisp_myinterfaces . has_key ( ii1i ) and i1I111II1IiI == None ) :
  oooooOO0 = lisp . lisp_myinterfaces [ ii1i ]
 else :
  oooooOO0 = lisp . lisp_interface ( ii1i )
  lisp . lisp_myinterfaces [ ii1i ] = oooooOO0
  if 69 - 69: Oo0Ooo + IiII - I11i . iIii1I11I1II1 - Ii1I
 ...
 oooooOO0 . interface_name = I1iI1Ii1I1Iii1
 if ( OO00O0O00oOOO != None ) :
  if ( OO00O0O00oOOO . isdigit ( ) == False ) : OO00O0O00oOOO = "0"
  oooooOO0 . instance_id = int ( OO00O0O00oOOO )
  if 23 - 23: oO0o . OoOoOO00 + iIii1I11I1II1
 if ( ii1111iIIiIIi != None ) :
  oooooOO0 . dynamic_eid . store_prefix ( ii1111iIIiIIi )
  oooooOO0 . dynamic_eid . instance_id = oooooOO0 . instance_id
  if 17 - 17: IiII
 if ( ooOo0Oo != None ) :
  oooooOO0 . dynamic_eid_device = ooOo0Oo
  if 12 - 12: i1IIi . OoO0O00
 if ( I11 != None ) :
  oooooOO0 . dynamic_eid_timeout = int ( I11 )
  if 14 - 14: OOooOOo + II111iiii % OOooOOo . oO0o * ooOoO0o
 if ( i1I111II1IiI != None ) :
  oooooOO0 . multi_tenant_eid . store_prefix ( i1I111II1IiI )
  oooooOO0 . multi_tenant_eid . instance_id = int ( oooooOO0 . instance_id )
  lisp . lisp_multi_tenant_interfaces . append ( oooooOO0 )
  if 54 - 54: ooOoO0o * I11i - I1Ii111
 if ( oo00O0oOo ) :
  i1iI1 = "sudo iptables -t nat -C POSTROUTING -o {} -j MASQUERADE"
  i1iI1 = commands . getoutput ( i1iI1 . format ( ii1i ) )
  if ( i1iI1 . find ( "No chain" ) != - 1 ) :
   ...
   if 97 - 97: i1IIi
 lisp . lisp_iid_to_interface [ OO00O0O00oOOO ] = oooooOO0
 if 29 - 29: I1IiiI
 ...
 if ( "SO_BINDTODEVICE" in dir ( socket ) ) : oooooOO0 . set_socket ( ii1i )
 if ( "PF_PACKET" in dir ( socket ) ) : oooooOO0 . set_bridge_socket ( ii1i )
 if 31 - 31: I11i / O0
 ...
 if ( ii1111iIIiIIi != None and lisp . lisp_program_hardware ) :
  O0O0Ooooo000 = "ip verify unicast source reachable-via rx"
  lisp . lisp_send_to_arista ( O0O0Ooooo000 , ii1i )
  O0O0Ooooo000 = 'sysctl -w "net.ipv4.conf.{}.rp_filter=0"' . format ( ii1i )
...
def lisp_show_dynamic_eid_command ( parm ) :
 ...
 oOoo00 = "LISP-{} Discovered Dynamic EIDs for {}:" . format ( OoiIIIiIi1I1i , OOOO0oo0 )
 if 6 - 6: I1Ii111 % IiII / Ii1I + I1Ii111 . oO0o
 if ( OoiIIIiIi1I1i == "ITR" ) :
  i1iiI11I = lisp_table_header ( oOoo00 , "Dynamic-EID" , "Interface" , "Uptime" ,
 ...
 for I1 in OOOooOO0oO . dynamic_eids . values ( ) :
  iIIi111I1i1i = I1 . dynamic_eid . print_address ( )
  i1I1I1iiI = lisp . lisp_print_elapsed ( I1 . uptime )
  OOO0ooo = str ( I1 . timeout ) + " secs"
  if ( OoiIIIiIi1I1i == "ITR" ) :
   i1i11I11 = lisp . lisp_print_elapsed ( I1 . last_packet )
   i1iiI11I += lisp_table_row ( iIIi111I1i1i , I1 . interface , i1I1I1iiI , i1i11I11 , OOO0ooo )
  else :
   i1iiI11I += lisp_table_row ( iIIi111I1i1i , I1 . interface , i1I1I1iiI , OOO0ooo )
...
def lisp_show_decap_stats ( output , etr_or_rtr ) :
 Oo0oo = etr_or_rtr . upper ( )
 I11IiI1I11i1i = etr_or_rtr . lower ( )
 if 56 - 56: I1IiiI
 iIIi11 = [ ]
 for I1I111iIi in lisp . lisp_decap_stats :
  ii1i11III1I1 = "<a href='/lisp/clear/{}/stats/{}'>{}</a>" . format ( I11IiI1I11i1i , I1I111iIi , I1I111iIi )
  iIIi11 . append ( ii1i11III1I1 )
  if 96 - 96: IiII / Ii1I % OoO0O00 . iIii1I11I1II1
  if 30 - 30: I11i - OoO0O00
 iiii = "LISP-{} Decapsulation Stats:" . format ( Oo0oo )
 output += lisp_table_header ( iiii , * iIIi11 )
 if 62 - 62: iIii1I11I1II1 % I1Ii111 % I1ii11iIi11i * IiII
 iIIi11 = [ ]
 for oO0OO0o0oo0o in lisp . lisp_decap_stats . values ( ) :
  iIIi11 . append ( oO0OO0o0oo0o . get_stats ( False , True ) )
  if 55 - 55: IiII
...
def lisp_show_crypto_list ( xtr ) :
 i1iiI11I = ""
 oOoO = len ( lisp . lisp_crypto_keys_by_nonce ) != 0
 if 51 - 51: OoooooooOO + I11i % OoOoOO00 . Ii1I % i11iIiiIii * ooOoO0o
 if ( lisp . lisp_i_am_itr or lisp . lisp_i_am_rtr ) :
  if ( oOoO ) :
   oOoo00 = "LISP-{} Nonce Crypto State" . format ( xtr )
   i1iiI11I += lisp_table_header ( oOoo00 , "Nonce" , "Uptime" , "Key-ID" ,
 "Key Material" )
   for I1I111iIi in lisp . lisp_crypto_keys_by_nonce :
    ...
    for iIIIIi1Ii in oo00oO0O0 :
     if ( iIIIIi1Ii == None ) : continue
     oOOOOOOo0O0 = lisp . lisp_print_elapsed ( iIIIIi1Ii . uptime )
     OOOoOo0O0O = iIIIIi1Ii . print_keys ( False )
     i1iiI11I += lisp_table_row ( OO00O00o0O , oOOOOOOo0O0 , iIIIIi1Ii . key_id , OOOoOo0O0O )
     OO00O00o0O = ""
  ...
  oOoo00 = "LISP-{} Encapsulation Crypto State" . format ( xtr )
  i1iiI11I += lisp_table_header ( oOoo00 , "RLOC" , "Uptime" , "Last Rekey" ,
 "Rekey Count" , "Use Count" , "Key-ID" , "Key Material" )
  for I1I111iIi in lisp . lisp_crypto_keys_by_rloc_encap :
   ...
   for iIIIIi1Ii in oo00oO0O0 :
    if ( iIIIIi1Ii == None ) : continue
    oOOOOOOo0O0 = lisp . lisp_print_elapsed ( iIIIIi1Ii . uptime )
    ii1ii = lisp . lisp_print_elapsed ( iIIIIi1Ii . last_rekey )
    OOOoOo0O0O = iIIIIi1Ii . print_keys ( False )
    i1iiI11I += lisp_table_row ( OO00O00o0O , oOOOOOOo0O0 , ii1ii , iIIIIi1Ii . rekey_count ,
 iIIIIi1Ii . use_count , iIIIIi1Ii . key_id , OOOoOo0O0O )
    OO00O00o0O = ""
 ...
 if ( lisp . lisp_i_am_etr or lisp . lisp_i_am_rtr ) :
  oOoo00 = "LISP-{} Decapsulation Crypto State" . format ( xtr )
  i1iiI11I += lisp_table_header ( oOoo00 , "RLOC" , "Uptime" , "Last Rekey" ,
 "Rekey Count" , "Use Count" , "Key-ID" , "Key Material" )
