...
class lisp_rloc ( object ) :
 ...
 def store_rloc_from_record ( self , rloc_record , nonce , source ) :
  ...
  if ( I1Ii1i111I . is_null ( ) == False ) :
   IiIiiII1I = lisp_get_nat_info ( I1Ii1i111I , self . rloc_name )
   if ( IiIiiII1I ) :
    I1I = IiIiiII1I . port
    OOIIIIiI1III = lisp_nat_state_info [ self . rloc_name ] [ 0 ]
    O0O0 = I1Ii1i111I . print_address_no_iid ( )
    IIi11IiiiI11i = red ( O0O0 , False )
    OOo = "" if self . rloc_name == None else blue ( self . rloc_name , False )
    ...
    if ( IiIiiII1I . timed_out ( ) ) :
     lprint ( ( "    Matched stored NAT state timed out for " + "RLOC {}:{}, {}" ) . format ( IIi11IiiiI11i , I1I , OOo ) )
     if 68 - 68: O0 + IiII / iII111i - OoOoOO00
     if 5 - 5: I1IiiI * OoooooooOO - II111iiii
     IiIiiII1I = None if ( IiIiiII1I == OOIIIIiI1III ) else OOIIIIiI1III
     if ( IiIiiII1I and IiIiiII1I . timed_out ( ) ) :
      I1I = IiIiiII1I . port
      IIi11IiiiI11i = red ( IiIiiII1I . address , False )
 ...
 OOo ) )
    ...
    if ( IiIiiII1I ) :
     if ( IiIiiII1I . address != O0O0 ) :
      lprint ( "RLOC conflict, RLOC-record {}, NAT state {}" . format ( IIi11IiiiI11i , red ( IiIiiII1I . address , False ) ) )
      if 88 - 88: o0oOOo0O0Ooo % I1Ii111
      self . rloc . store_address ( IiIiiII1I . address )
      if 4 - 4: i11iIiiIii + o0oOOo0O0Ooo % I11i - I1ii11iIi11i * I1ii11iIi11i
     IIi11IiiiI11i = red ( IiIiiII1I . address , False )
     I1I = IiIiiII1I . port
     lprint ( "    Use NAT translated RLOC {}:{} for {}" . format ( IIi11IiiiI11i , I1I , OOo ) )
  ...
  if ( self . rle ) :
   for iI11i1ii11i11 in self . rle . rle_nodes :
    ...
    IiIiiII1I = lisp_get_nat_info ( iI11i1ii11i11 . address , OO000o )
...
def lisp_send_map_request ( lisp_sockets , lisp_ephem_port , seid , deid , rloc ,
 ...
 if ( i1ii1Iii1 != None ) :
  if ( rloc . is_rloc_translated ( ) ) :
   IiIiiII1I = lisp_get_nat_info ( i1ii1Iii1 , rloc . rloc_name )
   ...
   if ( IiIiiII1I == None ) :
    ...
    IiIiiII1I = lisp_nat_info ( O00o00o00OO0 , Oo , iIIiiIi )
    if 1 - 1: I11i % II111iiii / OoO0O00 + OoO0O00
   lisp_encapsulate_rloc_probe ( lisp_sockets , i1ii1Iii1 , IiIiiII1I ,
 Oo00oo )
   return
...
def lisp_update_encap_port ( mc ) :
 for I1Ii1i111I in mc . rloc_set :
  IiIiiII1I = lisp_get_nat_info ( I1Ii1i111I . rloc , I1Ii1i111I . rloc_name )
  if ( IiIiiII1I == None ) : continue
  if ( I1Ii1i111I . translated_port == IiIiiII1I . port ) : continue
  if 38 - 38: Oo0Ooo
  lprint ( ( "Encap-port changed from {} to {} for RLOC {}, " + "EID-prefix {}" ) . format ( I1Ii1i111I . translated_port , IiIiiII1I . port ,
  # I11i / i11iIiiIii * IiII . OOooOOo
 red ( I1Ii1i111I . rloc . print_address_no_iid ( ) , False ) ,
 green ( mc . print_eid_tuple ( ) , False ) ) )
  if 79 - 79: I1Ii111 - OOooOOo - OoOoOO00
  I1Ii1i111I . store_translated_rloc ( I1Ii1i111I . rloc , IiIiiII1I . port )
...
def lisp_store_nat_info ( hostname , rloc , port ) :
 ...
 IiIiiII1I = lisp_nat_state_info [ hostname ] [ 0 ]
 if ( IiIiiII1I . address == O0O0 and IiIiiII1I . port == port ) :
  IiIiiII1I . uptime = lisp_get_timestamp ( )
 ...
 ooooOo0ooo = None
 for IiIiiII1I in lisp_nat_state_info [ hostname ] :
  if ( IiIiiII1I . address == O0O0 and IiIiiII1I . port == port ) :
   ooooOo0ooo = IiIiiII1I
   break
...
def lisp_get_nat_info ( rloc , hostname ) :
 ...
 O0O0 = rloc . print_address_no_iid ( )
 for IiIiiII1I in lisp_nat_state_info [ hostname ] :
  if ( IiIiiII1I . address == O0O0 ) : return ( IiIiiII1I )
...
def lisp_build_crypto_decap_lookup_key ( addr , port ) :
 ...
 if ( lisp_i_am_rtr ) :
  ...
  for IiIiiII1I in list ( lisp_nat_state_info . values ( ) ) :
   for Ooo0000 in IiIiiII1I :
