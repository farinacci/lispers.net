...
i1iIIi1 = commands . getoutput ( "egrep 'program-hardware = yes' ./lisp.config" )
...
Iii1I111 = commands . getoutput ( IiI1i )
Iii1I111 = [ ] if Iii1I111 == "" else Iii1I111 . split ( "\n" )
OO0O0O00OooO = commands . getoutput ( "arp -n | egrep vlan4094" )
...
i1iIIi1 = commands . getoutput ( i1iIIi1 )
if ( i1iIIi1 == "" ) : exit ( 0 )
...
Iii1I111 = commands . getoutput ( "ip route" )
...
for i1iIIIiI1I in Iii1I111 :
 ...
 if ( o0oO0 ( oo0oooooO0 , OOoO000O0OO ) ) :
