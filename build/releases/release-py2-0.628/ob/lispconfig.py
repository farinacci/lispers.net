...
def lisp_show_json_list ( output ) :
 ...
 if 37 - 37: iII111i
 iIiI1I1II1 = sorted ( lisp . lisp_json_list )
 for iiI1ii in iIiI1I1II1 :
  I1Iiiiiii = lisp . lisp_json_list [ iiI1ii ]
  iII1I1IIiiiI = lisp . lisp_print_cour ( I1Iiiiiii . print_json ( True ) )
  output += lisp_table_row ( iiI1ii , iII1I1IIiiiI )
...
def lisp_show_rle_list ( output ) :
 ...
 o0o0Oo0oo = sorted ( lisp . lisp_rle_list )
 for O0oooOO in o0o0Oo0oo :
  oO0o000oOO = lisp . lisp_rle_list [ O0oooOO ]
  output += lisp_table_row ( O0oooOO , oO0o000oOO . print_rle ( True , True ) )
...
def lisp_show_elp_list ( output ) :
 ...
 o0Oo = sorted ( lisp . lisp_elp_list )
 for IiiiiiiI111i in o0Oo :
  iIiiII = lisp . lisp_elp_list [ IiiiiiiI111i ]
  output += lisp_table_row ( IiiiiiiI111i , iIiiII . print_elp ( False ) )
...
def lisp_geo_command ( kv_pair ) :
 ...
 ii11I = kv_pair [ "geo-name" ]
 iI1 = lisp . lisp_geo ( ii11I )
 ...
 O0Oo00o0o = kv_pair [ "geo-tag" ] [ 1 : : ]
 if ( iI1 . parse_geo_string ( O0Oo00o0o ) == False ) : return
...
def lisp_elp_command ( kv_pair ) :
 ...
 for iiiI11 in list ( kv_pair . keys ( ) ) :
  ...
  if ( iiiI11 == "elp-name" ) :
   ...
   if 1 - 1: O0
   if 2 - 2: OoO0O00 . I11i
  for oO00Oo in oOooOOoo :
   O0OO0O = oOooOOoo . index ( oO00Oo )
   if ( O0OO0O >= len ( oo00oO0O0 ) ) : O0OO0O = len ( oo00oO0O0 ) - 1
   ooiIii1I1111 = oo00oO0O0 [ O0OO0O ]
   if ( iiiI11 == "probe" ) : oO00Oo . probe = ( ooiIii1I1111 == "yes" )
   if ( iiiI11 == "strict" ) : oO00Oo . strict = ( ooiIii1I1111 == "yes" )
   if ( iiiI11 == "eid" ) : oO00Oo . eid = ( ooiIii1I1111 == "yes" )
   if ( iiiI11 == "address" ) : oO00Oo . address . store_address ( ooiIii1I1111 )
...
def lisp_rle_command ( kv_pair ) :
 ...
 for iiiI11 in list ( kv_pair . keys ( ) ) :
  ...
  for oO00Oo in I1I :
   O0OO0O = I1I . index ( oO00Oo )
   if ( O0OO0O >= len ( oo00oO0O0 ) ) : O0OO0O = len ( oo00oO0O0 ) - 1
   ooiIii1I1111 = oo00oO0O0 [ O0OO0O ]
   if ( iiiI11 == "level" ) :
    if ( ooiIii1I1111 == "" ) : ooiIii1I1111 = "0"
    oO00Oo . level = int ( ooiIii1I1111 )
    if 23 - 23: I1Ii111 % iIii1I11I1II1 . I11i
   if ( iiiI11 == "address" ) : oO00Oo . rloc . rloc . store_address ( ooiIii1I1111 )
...
def lisp_json_command ( kv_pair ) :
 ...
 try :
  iiI1ii = kv_pair [ "json-name" ]
  iII1I1IIiiiI = kv_pair [ "json-string" ]
 except :
  return
  if 66 - 66: iIii1I11I1II1 * II111iiii % Oo0Ooo % I1IiiI - Ii1I
  if 59 - 59: IiII % oO0o
 I1Iiiiiii = lisp . lisp_json ( iiI1ii , iII1I1IIiiiI )
 I1Iiiiiii . add ( )
 return
...
def lisp_get_lookup_string ( input_str ) :
 ...
 II111I1i1 = lisp . lisp_address ( lisp . LISP_AFI_NONE , "" , 0 , 0 )
 Iio0o0o = lisp . lisp_address ( lisp . LISP_AFI_NONE , "" , 0 , 0 )
 ...
 Ooooo = OOOO0oo0 . split ( "/" )
 if ( len ( Ooooo ) == 1 ) :
  II111I1i1 . store_address ( Ooooo [ 0 ] )
  OOi1IIII11II1 = False
 else :
  II111I1i1 . store_prefix ( OOOO0oo0 )
  OOi1IIII11II1 = True
  if 75 - 75: OoO0O00 - OoOoOO00 - i1IIi % Oo0Ooo - II111iiii
  if 61 - 61: Oo0Ooo + OoooooooOO / i11iIiiIii
 I11 = OOi1IIII11II1
 if ( I11iiI1i1 ) :
  Ooooo = I11iiI1i1 . split ( "/" )
  if ( len ( Ooooo ) == 1 ) :
   Iio0o0o . store_address ( Ooooo [ 0 ] )
   I11 = False
  else :
   Iio0o0o . store_prefix ( OOOO0oo0 )
   I11 = True
   if 75 - 75: i1IIi / i1IIi . OoOoOO00 + OoOoOO00
   if 47 - 47: OoO0O00 + I1Ii111 . I1Ii111 * O0 / Oo0Ooo + OOooOOo
 return ( [ II111I1i1 , OOi1IIII11II1 , Iio0o0o , I11 ] )
...
def lisp_show_map_cache_lookup ( eid_str ) :
 II111I1i1 , OOi1IIII11II1 , Iio0o0o , I11 = lisp_get_lookup_string ( eid_str )
 if 1 - 1: IiII
 I1i1iii = "<br>"
 if 27 - 27: OoOoOO00 . I1Ii111 * OoOoOO00
 iI111iI11iII = II111I1i1 if ( Iio0o0o . is_null ( ) ) else Iio0o0o
 O000o0Oo0 = OOi1IIII11II1 if ( Iio0o0o . is_null ( ) ) else I11
 if 31 - 31: O0 * iII111i - iII111i / iII111i - ooOoO0o / OoOoOO00
 IIiI1i = lisp . lisp_map_cache . lookup_cache ( iI111iI11iII , O000o0Oo0 )
 if ( IIiI1i == None ) :
  I1i1iii += "{} {}" . format ( lisp . lisp_print_sans ( "Lookup not found for" ) ,
 lisp . lisp_print_cour ( eid_str ) )
 else :
  if ( iI111iI11iII == Iio0o0o ) :
   iI1IiiiI = IIiI1i . lookup_source_cache ( II111I1i1 , OOi1IIII11II1 )
   if ( iI1IiiiI ) : IIiI1i = iI1IiiiI
   if 93 - 93: I1IiiI
   if 89 - 89: OoooooooOO % i11iIiiIii + I1Ii111
  oO0OOoO0 = lisp . lisp_print_elapsed ( IIiI1i . uptime )
  I1i1iii += "{} {} {} {} {} {} {}" . format ( lisp . lisp_print_sans ( "Exact" if OOi1IIII11II1 else "Longest" ) ,
  # i1IIi
...
def lisp_get_clause_for_api ( command ) :
 ...
 for O00oO0 in i1i1I1II :
  ...
  if ( lisp_begin_clause ( O00oO0 ) ) :
   O00o += 1
   oO0OO = O00oO0 . replace ( " " , "" )
   oO0OO = oO0OO . replace ( "\t" , "" )
   oO0OO = oO0OO . replace ( "\n" , "" )
   oO0OO = oO0OO . replace ( "{" , "" )
   OOo0O0 = { oO0OO : { } }
   continue
   if 89 - 89: oO0o - I1Ii111 + OoOoOO00 % o0oOOo0O0Ooo % Ii1I - i11iIiiIii
  ...
  if ( len ( OOo0O0 ) == 0 ) :
   ...
   OOo0O0 [ oO0OO ] [ oo000O0o ] = oo00oO0O0
...
def lisp_duplicate_command_clause ( command , clause ) :
 ...
 if 17 - 17: o0oOOo0O0Ooo * i11iIiiIii * II111iiii - Ii1I % o0oOOo0O0Ooo / O0
 if 22 - 22: o0oOOo0O0Ooo / OoO0O00 + I1Ii111 - i1IIi / IiII
...
def lisp_put_clause_for_api ( data ) :
 ...
 if ( I111i1I1 not in list ( lisp_commands . keys ( ) ) ) :
  ...
  if 21 - 21: II111iiii
 iI1iIiii111 = ( I111i1I1 in [ "lisp enable" , "lisp debug" , "lisp xtr-parameters" ] )
 ...
 I1IIII = False
 if ( iI1iIiii111 == False ) :
  I1IIII = True
  oo0oO0o00Oo0 = getoutput ( "egrep '{}' ./lisp.config" . format ( I111i1I1 ) )
  oo0oO0o00Oo0 = oo0oO0o00Oo0 . split ( "\n" )
  for O00oO0 in oo0oO0o00Oo0 :
   if ( O00oO0 [ 0 : len ( I111i1I1 ) ] == I111i1I1 ) : I1IIII = False
   if 22 - 22: II111iiii
 ...
 iIo0O000O00o = data [ I111i1I1 ]
 iIo0O000O00o = lisp_unicode_to_ascii ( iIo0O000O00o )
 OOoO0o = I111i1I1 + " {\n" if I1IIII else ""
 ...
 for IiI1i11iiII in iIo0O000O00o :
  if ( type ( iIo0O000O00o ) == dict ) :
   oo00oO0O0 = iIo0O000O00o [ IiI1i11iiII ]
   if ( type ( oo00oO0O0 ) == dict ) : oo00oO0O0 = json_dumps ( oo00oO0O0 )
   OOoO0o += "    " + IiI1i11iiII + " = " + oo00oO0O0 + "\n"
   continue
   if 64 - 64: Ii1I
   if 47 - 47: I1IiiI * i11iIiiIii . OOooOOo . iII111i . i11iIiiIii
  for oo000O0o in IiI1i11iiII :
   if ( type ( IiI1i11iiII ) == dict ) :
    IIii1i1II11 = oo000O0o
    oo00oO0O0 = IiI1i11iiII [ oo000O0o ]
    if 61 - 61: I1IiiI * Ii1I % II111iiii - OoooooooOO / o0oOOo0O0Ooo
   if ( type ( IiI1i11iiII ) == list ) :
    IIii1i1II11 = list ( oo000O0o . keys ( ) ) [ 0 ]
    oo00oO0O0 = list ( oo000O0o . values ( ) ) [ 0 ]
    if 15 - 15: II111iiii - Ii1I - iII111i . oO0o / i11iIiiIii
    if 38 - 38: OoO0O00
   if ( type ( oo00oO0O0 ) != dict ) :
    OOoO0o += "    " + oo000O0o + " = " + IiI1i11iiII [ oo000O0o ] + "\n"
    continue
   ...
   OOoO0o += "    " + IIii1i1II11 + " {\n"
   for iiIIiIi1i1I1 in oo00oO0O0 : OOoO0o += "        " + iiIIiIi1i1I1 + " = " + oo00oO0O0 [ iiIIiIi1i1I1 ] + "\n"
   OOoO0o += "    }\n"
 ...
 iiI = "./lisp.config"
 OOOoOOooOoo = iiI + ".temp"
 if 89 - 89: ooOoO0o % oO0o * Ii1I - Oo0Ooo / o0oOOo0O0Ooo + OoO0O00
 Ooo00oo0ooO0 = open ( iiI , "r" )
 i1ii1i1 = open ( OOOoOOooOoo , "w" )
 if 42 - 42: oO0o
 iiiiiiI1iIi = False
 iI1Ii11IIiII = False
 for O00oO0 in Ooo00oo0ooO0 :
  if ( iI1Ii11IIiII ) :
   if ( lisp_end_clause ( O00oO0 ) == False ) : continue
   iI1Ii11IIiII = False
   continue
   ...
   if 12 - 12: Ii1I
   if 2 - 2: OoooooooOO
  if ( iiiiiiI1iIi == False and lisp_begin_clause ( O00oO0 ) and
 O00oO0 [ 0 : len ( I111i1I1 ) ] == I111i1I1 ) :
   if ( iI1iIiii111 == False ) :
    i1ii1i1 . write ( O00oO0 )
    for OO0o in OOoO0o : i1ii1i1 . write ( OO0o )
    iiiiiiI1iIi = True
    if 88 - 88: OoooooooOO
 ...
 os . system ( "cp {} {}" . format ( OOOoOOooOoo , iiI ) )
 os . system ( "rm {}" . format ( OOOoOOooOoo ) )
 return ( [ { I111i1I1 : [ { "!" : "add/replace" } ] } ] )
...
def lisp_remove_clause_for_api ( data ) :
 ...
 oOoOoo0 = [ ]
 oo000O0o = list ( iIo0O000O00o . keys ( ) ) [ 0 ]
 oo00oO0O0 = iIo0O000O00o [ oo000O0o ]
 if 4 - 4: oO0o . I11i
 if ( type ( oo00oO0O0 ) == dict ) :
  for oo000O0o in list ( oo00oO0O0 . keys ( ) ) :
   OO0Ooo0O0OOOo = oo00oO0O0 [ oo000O0o ]
   oOoOoo0 . append ( oo000O0o + " = " + OO0Ooo0O0OOOo )
   if 46 - 46: iII111i + OOooOOo * Oo0Ooo + OoooooooOO
 else :
  oOoOoo0 . append ( oo000O0o + " = " + oo00oO0O0 )
  if 90 - 90: OoooooooOO + OOooOOo % i11iIiiIii
  if 62 - 62: ooOoO0o % O0
  if 63 - 63: o0oOOo0O0Ooo + iIii1I11I1II1 + I1Ii111 - I11i - iII111i . I1IiiI
 ...
 if ( I111i1I1 == "lisp user-account" ) :
  OOoO0o = getoutput ( "egrep -A4 '{}' ./lisp.config" . format ( oOoOoo0 [ 0 ] ) )
  if 75 - 75: OoooooooOO / OoOoOO00 - iIii1I11I1II1 + oO0o % i1IIi / ooOoO0o
  if 69 - 69: Ii1I * i1IIi % o0oOOo0O0Ooo * I1ii11iIi11i * iIii1I11I1II1
  if ( OOoO0o . find ( "super-user = yes" ) != - 1 ) :
   return ( [ { "lisp user-account" : [ { "?" : "found-superuser" } ] } ] )
   if 41 - 41: I1Ii111 % OoooooooOO
   if 77 - 77: OoooooooOO * Oo0Ooo * OoooooooOO * i1IIi * OOooOOo
 ...
 IiI1i1i1 = ( "lisp user-account" , "lisp site" , "lisp map-server" ,
 "lisp policy" )
 ...
 for O00oO0 in Ooo00oo0ooO0 :
  ...
  for O00oO0 in Ooo00oo0ooO0 :
   ...
   iI1IIiiIII1 = ( lisp_end_clause ( O00oO0 ) and OooOo0OOO )
   if ( iI1IIiiIII1 ) : break
   if 67 - 67: I1ii11iIi11i + Ii1I * I11i / oO0o
   i111Iii11i1Ii = O00oO0 . replace ( " " , "" )
   i111Iii11i1Ii = i111Iii11i1Ii . replace ( "\n" , "" )
   i111Iii11i1Ii = i111Iii11i1Ii . replace ( "=" , " = " )
   if 65 - 65: iIii1I11I1II1 * IiII
   if ( i111Iii11i1Ii not in oOoOoo0 ) :
    OooOo0OOO = False
    if ( len ( oOoOoo0 ) > 1 ) : break
    continue
    if 89 - 89: IiII % i11iIiiIii . i11iIiiIii + oO0o / I1ii11iIi11i
   OooOo0OOO = True
   if 19 - 19: I1IiiI
   iI1IIiiIII1 = ( I111i1I1 in IiI1i1i1 )
   if ( iI1IIiiIII1 ) : break
 ...
 OooOo0OOO = False
 for O00oO0 in Ooo00oo0ooO0 :
  if ( O00oO0 . find ( I111i1I1 ) != - 1 ) : iiIii1I1Ii -= 1
  if ( iiIii1I1Ii == 0 and not OooOo0OOO ) :
...
def lisp_u2a_walk_dict_array ( adata , a_dict ) :
 for oo000O0o in a_dict :
  if ( type ( a_dict [ oo000O0o ] ) == dict ) :
   ...
   for iiIIiIi1i1I1 in oo00oO0O0 : iII1i [ str ( iiIIiIi1i1I1 ) ] = str ( oo00oO0O0 [ iiIIiIi1i1I1 ] )
   adata [ str ( oo000O0o ) ] = iII1i
  else :
...
def lisp_unicode_to_ascii ( udata ) :
 OO000o0O0o = ( type ( udata ) == dict )
 if ( OO000o0O0o ) : udata = [ udata ]
 if 67 - 67: OOooOOo . i11iIiiIii + ooOoO0o . iIii1I11I1II1
 iiIi1i = [ ]
 for I1i11IIiiIiI in udata :
  II1iiiiI1Ii11 = { }
  if 69 - 69: I11i / i1IIi / oO0o . I1Ii111
  if ( type ( I1i11IIiiIiI ) == dict ) :
   lisp_u2a_walk_dict_array ( II1iiiiI1Ii11 , I1i11IIiiIiI )
  elif ( type ( I1i11IIiiIiI ) == list ) :
   iII1iiI11IIi = [ ]
   for i1i in I1i11IIiiIiI :
    i11Iii11 = { }
    lisp_u2a_walk_dict_array ( i11Iii11 , i1i )
    iII1iiI11IIi . append ( i11Iii11 )
    if 56 - 56: Oo0Ooo
   II1iiiiI1Ii11 = iII1iiI11IIi
  else :
   II1iiiiI1Ii11 = { str ( list ( I1i11IIiiIiI . keys ( ) ) [ 0 ] ) : II1iiiiI1Ii11 }
   if 77 - 77: OoooooooOO
  iiIi1i . append ( II1iiiiI1Ii11 )
  if 52 - 52: iII111i - OoO0O00 % i11iIiiIii . I11i
  if 98 - 98: OoooooooOO + OoOoOO00 . OoOoOO00 / O0 / i11iIiiIii
 if ( OO000o0O0o ) : iiIi1i = iiIi1i [ 0 ]
 return ( iiIi1i )
...
def lisp_replace_db_list ( db ) :
 O0OO0O = - 1
 for iiIii in lisp . lisp_db_list :
  if ( db . match_eid_tuple ( iiIii ) ) :
   O0OO0O = lisp . lisp_db_list . index ( iiIii )
   break
   if 18 - 18: I11i / ooOoO0o
   if 67 - 67: I1Ii111 - OoO0O00 * I11i . I1Ii111
 if ( O0OO0O == - 1 ) : return ( False )
 if 17 - 17: OOooOOo * OoOoOO00 . o0oOOo0O0Ooo
 if 82 - 82: O0 / OoooooooOO . i11iIiiIii - iII111i
 if 63 - 63: I1Ii111
 if 94 - 94: i1IIi % Ii1I % I1ii11iIi11i - Ii1I * iIii1I11I1II1 + iIii1I11I1II1
 if 98 - 98: o0oOOo0O0Ooo % ooOoO0o - o0oOOo0O0Ooo * IiII % I1Ii111 * IiII
 if ( lisp . lisp_nat_traversal and lisp . lisp_i_am_etr ) :
  for oooo0O0Oooo in iiIii . rloc_set :
   ...
   if 31 - 31: Ii1I
   if 46 - 46: o0oOOo0O0Ooo + I1ii11iIi11i * o0oOOo0O0Ooo + i11iIiiIii + iII111i / II111iiii
   if 5 - 5: O0 + iII111i * Oo0Ooo
 lisp . lisp_db_list [ O0OO0O ] = db
 return ( True )
 if 9 - 9: oO0o . OoooooooOO . OOooOOo * I1ii11iIi11i
...
def lisp_map_server_command ( kv_pairs ) :
 ...
 for iiiI11 in list ( kv_pairs . keys ( ) ) :
  ...
  if ( iiiI11 == "dns-name" ) :
   for o00oo in range ( len ( oo00oO0O0 ) ) :
    I11IIi . append ( oo00oO0O0 [ o00oo ] )
    if 31 - 31: o0oOOo0O0Ooo
    if 59 - 59: Oo0Ooo / Oo0Ooo
  if ( iiiI11 == "authentication-type" ) :
   oOOooo0O = lisp . LISP_SHA_1_96_ALG_ID if ( oo00oO0O0 == "sha1" ) else lisp . LISP_SHA_256_128_ALG_ID if ( oo00oO0O0 == "sha2" ) else ""
   if 87 - 87: I1ii11iIi11i % OoOoOO00 + Ii1I . i11iIiiIii / Ii1I
   if 32 - 32: Ii1I + IiII + I1ii11iIi11i
  if ( iiiI11 == "authentication-key" ) :
   if ( oOOooo0O == 0 ) : oOOooo0O = lisp . LISP_SHA_256_128_ALG_ID
   oo00o = lisp . lisp_parse_auth_key ( oo00oO0O0 )
   OoOOOO0ooO0 = list ( oo00o . keys ( ) ) [ 0 ]
   o0O0OO = oo00o [ OoOOOO0ooO0 ]
   if 14 - 14: Ii1I + Ii1I * OoooooooOO * I11i + Oo0Ooo . I1IiiI
  if ( iiiI11 == "proxy-reply" ) :
   O0O000 = True if oo00oO0O0 == "yes" else False
   if 61 - 61: OOooOOo . OOooOOo
  if ( iiiI11 == "merge-registrations" ) :
   o00OoOoo0 = True if oo00oO0O0 == "yes" else False
   if 17 - 17: II111iiii / ooOoO0o
  if ( iiiI11 == "refresh-registrations" ) :
   iiiiiiiiiiiI = True if oo00oO0O0 == "yes" else False
   if 80 - 80: OOooOOo * OoO0O00 + Ii1I
  if ( iiiI11 == "want-map-notify" ) :
   iI111iiI1II = True if oo00oO0O0 == "yes" else False
   if 62 - 62: OoooooooOO . O0 % Oo0Ooo
  if ( iiiI11 == "site-id" ) :
   OOOoooO000O0 = int ( oo00oO0O0 )
   if 98 - 98: o0oOOo0O0Ooo * Oo0Ooo - Ii1I . ooOoO0o
  if ( iiiI11 == "encryption-key" ) :
   II1 = lisp . lisp_parse_auth_key ( oo00oO0O0 )
   Ii1iIi = list ( II1 . keys ( ) ) [ 0 ]
   II1 = II1 [ Ii1iIi ]
 ...
 for Ii1I1i in i1II :
  if ( Ii1I1i == "" ) : continue
  II1Ii = lisp . lisp_ms ( Ii1I1i , None , OOO0o0OO , oOOooo0O , OoOOOO0ooO0 , o0O0OO ,
 O0O000 , o00OoOoo0 , iiiiiiiiiiiI , iI111iiI1II , OOOoooO000O0 , Ii1iIi , II1 )
  if 98 - 98: II111iiii + I1IiiI - I1ii11iIi11i . Ii1I
 for O00o0O in I11IIi :
  if ( O00o0O == "" ) : continue
  II1Ii = lisp . lisp_ms ( None , O00o0O , OOO0o0OO , oOOooo0O , OoOOOO0ooO0 , o0O0OO ,
 O0O000 , o00OoOoo0 , iiiiiiiiiiiI , iI111iiI1II , OOOoooO000O0 , Ii1iIi , II1 )
...
def lisp_database_mapping_command ( kv_pair , ephem_port = None , replace = True ) :
 ...
 if ( lisp_clause_syntax_error ( kv_pair , "eid-prefix" , "prefix" ) ) : return
 for o00oo in range ( len ( kv_pair [ "eid-prefix" ] ) ) :
  o0oo0oo0 = lisp . lisp_mapping ( "" , "" , oooooO00OOO )
  IIii1i . append ( o0oo0oo0 )
  if 2 - 2: OoO0O00 + I1Ii111 . oO0o - I1ii11iIi11i % iII111i
  if 49 - 49: O0 . Oo0Ooo / Ii1I
 for iiiI11 in list ( kv_pair . keys ( ) ) :
  oo00oO0O0 = kv_pair [ iiiI11 ]
  if ( iiiI11 == "mr-name" ) :
   for o00oo in range ( len ( IIii1i ) ) :
    o0oo0oo0 = IIii1i [ o00oo ]
    o0oo0oo0 . use_mr_name = "all" if oo00oO0O0 [ 0 ] == "" else oo00oO0O0 [ o00oo ]
    if 29 - 29: I1ii11iIi11i / oO0o * O0 - i11iIiiIii - OoO0O00 + Ii1I
    if 86 - 86: I1IiiI / I1ii11iIi11i * Ii1I % i11iIiiIii
  if ( iiiI11 == "ms-name" ) :
   for o00oo in range ( len ( IIii1i ) ) :
    o0oo0oo0 = IIii1i [ o00oo ]
    o0oo0oo0 . use_ms_name = "all" if oo00oO0O0 [ 0 ] == "" else oo00oO0O0 [ o00oo ]
  ...
  if ( iiiI11 == "instance-id" ) :
   for o00oo in range ( len ( IIii1i ) ) :
    ...
    for o0OooO0ooo00o in ooiIii1I1111 : ooiIii1I1111 [ ooiIii1I1111 . index ( o0OooO0ooo00o ) ] = int ( o0OooO0ooo00o )
    o0oo0oo0 . eid . instance_id = ooiIii1I1111 [ 0 ]
    o0oo0oo0 . eid . iid_list = ooiIii1I1111 [ 1 : : ]
    o0oo0oo0 . group . instance_id = ooiIii1I1111 [ 0 ]
  ...
  if ( iiiI11 == "secondary-instance-id" ) :
   for o00oo in range ( len ( IIii1i ) ) :
    ...
    o0oo0oo0 . secondary_iid = int ( ooiIii1I1111 )
    if ( o0oo0oo0 . eid . address == 0 ) :
  ...
  if ( iiiI11 == "eid-prefix" ) :
   for o00oo in range ( len ( IIii1i ) ) :
    o0oo0oo0 = IIii1i [ o00oo ]
    ooiIii1I1111 = oo00oO0O0 [ o00oo ]
    if ( ooiIii1I1111 != "" ) : o0oo0oo0 . eid . store_prefix ( ooiIii1I1111 )
    if ( o0oo0oo0 . eid . address == 0 ) :
     lisp . lisp_default_secondary_iid = o0oo0oo0 . secondary_iid
  ...
  if ( iiiI11 == "group-prefix" ) :
   for o00oo in range ( len ( IIii1i ) ) :
    o0oo0oo0 = IIii1i [ o00oo ]
    ooiIii1I1111 = oo00oO0O0 [ o00oo ]
    if ( ooiIii1I1111 != "" ) : o0oo0oo0 . group . store_prefix ( ooiIii1I1111 )
  ...
  if ( iiiI11 == "dynamic-eid" ) :
   for o00oo in range ( len ( IIii1i ) ) :
    o0oo0oo0 = IIii1i [ o00oo ]
    ooiIii1I1111 = oo00oO0O0 [ o00oo ]
    if ( ooiIii1I1111 == "yes" ) : o0oo0oo0 . dynamic_eids = { }
  ...
  if ( iiiI11 == "signature-eid" ) :
   for o00oo in range ( len ( IIii1i ) ) :
    o0oo0oo0 = IIii1i [ o00oo ]
    ooiIii1I1111 = oo00oO0O0 [ o00oo ]
    o0oo0oo0 . signature_eid = ( ooiIii1I1111 == "yes" )
    if 22 - 22: iII111i
  ...
  if ( iiiI11 == "register-ttl" ) :
   for o00oo in range ( len ( IIii1i ) ) :
    ...
    o0oo0oo0 = IIii1i [ o00oo ]
    o0oo0oo0 . register_ttl = int ( oo00oO0O0 [ o00oo ] )
 ...
 for o0oo0oo0 in IIii1i :
  o0oo0oo0 . rloc_set = copy . deepcopy ( o0oo0oo0 . rloc_set )
  o0oo0oo0 . sort_rloc_set ( )
  o0oo0oo0 . add_db ( )
  if ( replace and lisp_replace_db_list ( o0oo0oo0 ) ) : continue
  lisp . lisp_db_list . append ( o0oo0oo0 )
 ...
 for o0oo0oo0 in IIii1i :
  if ( o0oo0oo0 . group . is_null ( ) == False ) : continue
  if ( o0oo0oo0 . eid . address == 0 and o0oo0oo0 . eid . mask_len == 0 ) :
   if ( o0oo0oo0 . eid . is_ipv4 ( ) or o0oo0oo0 . eid . is_ipv6 ( ) ) :
    lisp . lisp_pitr = True
    break
    if 56 - 56: oO0o - i1IIi * OoooooooOO - II111iiii
    if 28 - 28: i1IIi / I11i . o0oOOo0O0Ooo
    if 11 - 11: Oo0Ooo * OoooooooOO - i11iIiiIii
  if ( o0oo0oo0 . dynamic_eids == None ) : continue
  if ( o0oo0oo0 . eid . is_mac ( ) and o0oo0oo0 . eid . address == 0 and o0oo0oo0 . eid . mask_len == 0 ) :
 ...
 IiIIIii1iIII1 = ( lisp . lisp_myrlocs [ 0 ] != None )
 lisp . lisp_get_local_addresses ( )
 if 69 - 69: i1IIi / i11iIiiIii + Oo0Ooo - OoOoOO00
 if ( lisp . lisp_myrlocs [ 0 ] == None and IiIIIii1iIII1 ) :
 ...
 for o0oo0oo0 in IIii1i :
  if ( o0oo0oo0 . dynamic_eids == None ) : continue
  o0o0O0oOOoO0 = o0oo0oo0 . eid . print_prefix_no_iid ( )
  OooOo0OOO = lisp . lisp_i_am_itr
  os . system ( "ip route add {} dev ma1" . format ( o0o0O0oOOoO0 ) )
...
def lisp_show_db_list ( itr_or_etr , output ) :
 ...
 for o0oo0oo0 in lisp . lisp_db_list :
  o0Oo0oo0o0o0 = lisp . lisp_print_elapsed ( o0oo0oo0 . uptime )
  O0o0O00O0 = o0oo0oo0 . map_replies_sent
  ...
  oOOo00ooO00 = ""
  if ( o0oo0oo0 . dynamic_eid_configured ( ) ) :
   o0oO0OO = o0oo0oo0 . eid . print_prefix_url ( )
   IiIIii = len ( o0oo0oo0 . dynamic_eids )
   O0oOo = itr_or_etr . lower ( )
   oOOo00ooO00 = ( "<br><a href='/lisp/show/{}/dynamic-eid/{}'>" + "{} dynamic-eids</a>" ) . format ( O0oOo , o0oO0OO , IiIIii )
   if 2 - 2: I11i . i1IIi - o0oOOo0O0Ooo / OoooooooOO + i11iIiiIii + iIii1I11I1II1
   if 26 - 26: i11iIiiIii . OOooOOo - O0
   if 73 - 73: I1IiiI
  OO0OOOOOOoo = True
  for oooo0O0Oooo in o0oo0oo0 . rloc_set :
   if ( OO0OOOOOOoo ) :
    iIo0o000OOO = o0oo0oo0 . print_eid_tuple ( )
    iIo0o000OOO = o0oo0oo0 . star_secondary_iid ( iIo0o000OOO )
    iIo0o000OOO += oOOo00ooO00
    oO0OOoO0 = o0Oo0oo0o0o0
    OO0OOOOOOoo = False
   else :
    iIo0o000OOO , oO0OOoO0 , O0o0O00O0 = ( "" , "" , "" )
   ...
   iiIi1I1IIIII1IIi = oooo0O0Oooo . print_rloc_name ( True )
   if ( iiIi1I1IIIII1IIi != "" ) : iIii += iiIi1I1IIIII1IIi + "<br>"
 ...
 "Geo-Prefix or Geo-Point" )
  o0o00O00Oo0 = sorted ( lisp . lisp_geo_list )
  for ii11I in o0o00O00Oo0 :
   iI1 = lisp . lisp_geo_list [ ii11I ]
   output += lisp_table_row ( ii11I , iI1 . print_geo_url ( ) )
   if 96 - 96: iII111i
  output += lisp_table_footer ( )
...
def lisp_interface_command ( kv_pair ) :
 ...
 ooooooO0o00 = None
 Oo00o00O00 = None
 if 94 - 94: I1ii11iIi11i + II111iiii - I1ii11iIi11i + I11i
 for iiiI11 in list ( kv_pair . keys ( ) ) :
  oo00oO0O0 = kv_pair [ iiiI11 ]
  if ( iiiI11 == "interface-name" ) : ooOO = oo00oO0O0
  if ( iiiI11 == "device" ) : I111iIii1i1 = oo00oO0O0
  if ( iiiI11 == "instance-id" ) : I1i1I1i1I1 = oo00oO0O0
  if ( iiiI11 == "dynamic-eid" ) : i1IOO = oo00oO0O0
  if ( iiiI11 == "multi-tenant-eid" ) : ooooooO0o00 = oo00oO0O0
  if ( iiiI11 == "dynamic-eid-device" ) : Oo0OO0ooO0O0O = oo00oO0O0
  if ( iiiI11 == "dynamic-eid-timeout" ) : oO00O = oo00oO0O0
  if ( iiiI11 == "lisp-nat" ) : Oo00o00O00 = ( oo00oO0O0 == "yes" )
  if 90 - 90: iIii1I11I1II1
  if 18 - 18: I11i * I1ii11iIi11i / i11iIiiIii / iIii1I11I1II1 * OoooooooOO . OOooOOo
 if ( I111iIii1i1 == None ) : return
 ...
 if 81 - 81: OOooOOo
 if ( I111iIii1i1 in lisp . lisp_myinterfaces and ooooooO0o00 == None ) :
  Ooo = lisp . lisp_myinterfaces [ I111iIii1i1 ]
 else :
  Ooo = lisp . lisp_interface ( I111iIii1i1 )
  lisp . lisp_myinterfaces [ I111iIii1i1 ] = Ooo
  ...
  if 82 - 82: IiII
 Ooo . interface_name = ooOO
 if ( I1i1I1i1I1 != None ) :
  if ( I1i1I1i1I1 . isdigit ( ) == False ) : I1i1I1i1I1 = "0"
  Ooo . instance_id = int ( I1i1I1i1I1 )
 else :
  Ooo . instance_id = 0
  if 10 - 10: Oo0Ooo % OOooOOo / I11i * IiII - o0oOOo0O0Ooo
 if ( i1IOO != None ) :
  Ooo . dynamic_eid . store_prefix ( i1IOO )
  Ooo . dynamic_eid . instance_id = Ooo . instance_id
  if 54 - 54: i11iIiiIii / iIii1I11I1II1 % I1ii11iIi11i / I1IiiI . iIii1I11I1II1 / iII111i
 if ( Oo0OO0ooO0O0O != None ) :
  Ooo . dynamic_eid_device = Oo0OO0ooO0O0O
  if 1 - 1: I1Ii111 / OoOoOO00 * OoOoOO00 - o0oOOo0O0Ooo % Ii1I
 if ( oO00O != None ) :
  Ooo . dynamic_eid_timeout = int ( oO00O )
  if 96 - 96: IiII / Ii1I % OoO0O00 . iIii1I11I1II1
 if ( ooooooO0o00 != None ) :
  Ooo . multi_tenant_eid . store_prefix ( ooooooO0o00 )
  Ooo . multi_tenant_eid . instance_id = int ( Ooo . instance_id )
  lisp . lisp_multi_tenant_interfaces . append ( Ooo )
  if 30 - 30: I11i - OoO0O00
 if ( Oo00o00O00 ) :
  iiiiOo000O00o0O = "sudo iptables -t nat -C POSTROUTING -o {} -j MASQUERADE"
  iiiiOo000O00o0O = getoutput ( iiiiOo000O00o0O . format ( I111iIii1i1 ) )
  if ( iiiiOo000O00o0O != "" ) :
   o0o0oo0oO = lisp . lisp_get_loopback_address ( )
   if ( o0o0oo0oO ) :
    Ii1iii1 = "sudo iptables -t nat -A POSTROUTING -s {} -j ACCEPT"
    os . system ( Ii1iii1 . format ( o0o0oo0oO ) )
    if 75 - 75: Oo0Ooo / i11iIiiIii * I1IiiI - OoooooooOO
   Ii1iii1 = "sudo iptables -t nat -A POSTROUTING -o {} -j MASQUERADE"
   os . system ( Ii1iii1 . format ( I111iIii1i1 ) )
   os . system ( "sudo sysctl net.ipv4.ip_forward=1" )
   if 25 - 25: I11i / I1ii11iIi11i * OoO0O00 . iII111i
   if 18 - 18: O0 % o0oOOo0O0Ooo + iII111i + I1Ii111 % IiII
   if 18 - 18: IiII * IiII - IiII % i1IIi
 lisp . lisp_iid_to_interface [ I1i1I1i1I1 ] = Ooo
 if 82 - 82: o0oOOo0O0Ooo % IiII - ooOoO0o
 if 92 - 92: OoooooooOO % i1IIi + ooOoO0o - ooOoO0o . OoooooooOO
 if 67 - 67: i1IIi / O0 - o0oOOo0O0Ooo - I1IiiI * OoooooooOO
 if 74 - 74: OoOoOO00 . Ii1I % i11iIiiIii * OoOoOO00 * Oo0Ooo
 if 66 - 66: Oo0Ooo - i11iIiiIii - IiII
 if ( "SO_BINDTODEVICE" in dir ( socket ) ) : Ooo . set_socket ( I111iIii1i1 )
 if ( "PF_PACKET" in dir ( socket ) ) : Ooo . set_bridge_socket ( I111iIii1i1 )
 if 54 - 54: OOooOOo
 ...
 if ( i1IOO != None and lisp . lisp_program_hardware ) :
  OO00OO0O0 = "ip verify unicast source reachable-via rx"
  lisp . lisp_send_to_arista ( OO00OO0O0 , I111iIii1i1 )
  OO00OO0O0 = 'sysctl -w "net.ipv4.conf.{}.rp_filter=0"' . format ( I111iIii1i1 )
  os . system ( OO00OO0O0 )
...
def lisp_show_dynamic_eid_command ( parm ) :
 ...
 if 55 - 55: ooOoO0o
 II111I1i1 = lisp_get_lookup_string ( parm . split ( "%" ) [ 0 ] )
 II111I1i1 = II111I1i1 [ 0 ]
 if 1 - 1: OoO0O00
 o0oo0oo0 = lisp . lisp_db_for_lookups . lookup_cache ( II111I1i1 , False )
 if ( o0oo0oo0 == None ) : return ( I1i1iii )
 if 43 - 43: iIii1I11I1II1 - OOooOOo - o0oOOo0O0Ooo + I1ii11iIi11i - I1Ii111 % I1ii11iIi11i
 O0oOo = "ITR" if lisp . lisp_i_am_itr else "ETR"
 OOOO0oo0 = o0oo0oo0 . print_eid_tuple ( )
 if 58 - 58: OoOoOO00
 ...
 for o0o0O0oOOoO0 in list ( o0oo0oo0 . dynamic_eids . values ( ) ) :
  II111I1i1 = o0o0O0oOOoO0 . dynamic_eid . print_address ( )
  O00000oooOO = lisp . lisp_print_elapsed ( o0o0O0oOOoO0 . uptime )
  iI11iiI1 = str ( o0o0O0oOOoO0 . timeout ) + " secs"
  if ( O0oOo == "ITR" ) :
   I1Ioo000oooooooO = lisp . lisp_print_elapsed ( o0o0O0oOOoO0 . last_packet )
   I1i1iii += lisp_table_row ( II111I1i1 , o0o0O0oOOoO0 . interface , O00000oooOO , I1Ioo000oooooooO , iI11iiI1 )
  else :
   I1i1iii += lisp_table_row ( II111I1i1 , o0o0O0oOOoO0 . interface , O00000oooOO , iI11iiI1 )
...
def lisp_show_decap_stats ( output , etr_or_rtr ) :
 O0IIIiiiIi1I1 = etr_or_rtr . upper ( )
 I111Ii111 = etr_or_rtr . lower ( )
 if 10 - 10: OoO0O00 - II111iiii % o0oOOo0O0Ooo - OoOoOO00 + OoO0O00
 iIIi11 = [ ]
 for oo000O0o in lisp . lisp_decap_stats :
  OoO00OoOo0 = "<a href='/lisp/clear/{}/stats/{}'>{}</a>" . format ( I111Ii111 , oo000O0o , oo000O0o )
  iIIi11 . append ( OoO00OoOo0 )
  if 44 - 44: ooOoO0o * i11iIiiIii . iII111i / iIii1I11I1II1
  if 44 - 44: OoO0O00
 O00oO0ooooOOo = "LISP-{} Decapsulation Stats:" . format ( O0IIIiiiIi1I1 )
 output += lisp_table_header ( O00oO0ooooOOo , * iIIi11 )
 if 95 - 95: OoooooooOO
 iIIi11 = [ ]
 for Iii1ii in list ( lisp . lisp_decap_stats . values ( ) ) :
  iIIi11 . append ( Iii1ii . get_stats ( False , True ) )
 ...
 "Key Material" )
   for oo000O0o in lisp . lisp_crypto_keys_by_nonce :
    ...
    for OO0 in oo00oO0O0 :
     ...
     O00o0oOOo = lisp . lisp_print_elapsed ( OO0 . uptime )
     iIi11 = OO0 . print_keys ( False )
     I1i1iii += lisp_table_row ( i1iiIiIi1 , O00o0oOOo , OO0 . key_id , iIi11 )
     i1iiIiIi1 = ""
 ...
 "Rekey Count" , "Use Count" , "Key-ID" , "Key Material" )
  for oo000O0o in lisp . lisp_crypto_keys_by_rloc_encap :
   ...
   for OO0 in oo00oO0O0 :
    if ( OO0 == None ) : continue
    O00o0oOOo = lisp . lisp_print_elapsed ( OO0 . uptime )
    OO00O = lisp . lisp_print_elapsed ( OO0 . last_rekey )
    iIi11 = OO0 . print_keys ( False )
    I1i1iii += lisp_table_row ( i1iiIiIi1 , O00o0oOOo , OO00O , OO0 . rekey_count ,
 OO0 . use_count , OO0 . key_id , iIi11 )
    i1iiIiIi1 = ""
...
def lisp_decent_prefix_command ( kv_pair ) :
 ...
 for o00oo in range ( len ( kv_pair [ "eid-prefix" ] ) ) :
  iI1i = kv_pair [ "eid-prefix" ] [ o00oo ]
  O0OooO00O0 = kv_pair [ "lookup-length" ] [ o00oo ]
  O0OooO00O0 = int ( O0OooO00O0 )
  if 11 - 11: OOooOOo
  ...
  if ( "instance-id" in kv_pair and len ( kv_pair [ "instance-id" ] ) > o00oo ) :
   if ( kv_pair [ "instance-id" ] [ o00oo ] != "" ) :
    try :
     I1i1I1i1I1 = int ( kv_pair [ "instance-id" ] [ o00oo ] )
    except :
     I1i1I1i1I1 = 0
  ...
  II111I1i1 = lisp . lisp_address ( lisp . LISP_AFI_NONE , "" , 0 , 0 )
  II111I1i1 . store_prefix ( iI1i )
  II111I1i1 . instance_id = I1i1I1i1I1
  if 8 - 8: iII111i + I1ii11iIi11i . Ii1I
  if 50 - 50: Oo0Ooo
  if 16 - 16: Ii1I - OoOoOO00 % Oo0Ooo / Ii1I . I11i + ooOoO0o
  if 78 - 78: iIii1I11I1II1 + OoO0O00 + i11iIiiIii
  if ( O0OooO00O0 < II111I1i1 . mask_len ) :
   lisp . lprint ( "decent-lookup error, EID-prefix {} length > than lookup-length {}" . format ( II111I1i1 . print_prefix ( ) , O0OooO00O0 ) )
  ...
  Ii1iii1 = True
  for oooOoO0oo0o0 , ooOoO00 in lisp . lisp_decent_lookup_prefixes . items ( ) :
   if ( II111I1i1 . is_exact_match ( oooOoO0oo0o0 ) and ooOoO00 == O0OooO00O0 ) : Ii1iii1 = False
   if 61 - 61: i11iIiiIii % I1Ii111 / o0oOOo0O0Ooo
   if 40 - 40: OOooOOo / Ii1I % I1IiiI / o0oOOo0O0Ooo . iII111i
  if ( Ii1iii1 ) :
   lisp . lisp_decent_lookup_prefixes [ II111I1i1 ] = O0OooO00O0
   lisp . lprint ( "decent-prefix configured, EID-prefix {} -> lookup-length {}" . format ( II111I1i1 . print_prefix ( ) , O0OooO00O0 ) )
