...
def lisp_process_api_site_cache_summary ( site_cache ) :
 ...
 for OOO00o00Oo0 in site_cache . cache_sorted :
  for ooOOO in list ( site_cache . cache [ OOO00o00Oo0 ] . entries . values ( ) ) :
   ...
   if ( ooOOO . site . site_name not in iiioo ) :
    iiioo [ ooOOO . site . site_name ] = [ ]
   ...
   for oooOoOo0oOo00 in ooOOO . more_specific_registrations :
   ...
   iiioo [ ooOOO . site . site_name ] . append ( oO0ooOOO )
...
def lisp_process_rloc_probe_timer ( lisp_sockets ) :
 ...
 red ( O0O0 , False ) , OOOOOO0O00O00 ) )
    ...
    lprint ( "Send {}{} {}, last rtt: {}{}" . format ( i11i11i , I11iii11I ,
...
def lisp_process_rloc_probe_reply ( rloc_entry , source , port , map_reply , ttl ,
 ...
 iII = "@tp-"
 if ( rloc_name . find ( iII ) != - 1 ) :
  port = int ( rloc_name . split ( iII ) [ - 1 ] )
 ...
 if ( IiI not in Oo00O ) :
  ...
  if ( IiI not in Oo00O ) :
   ...
   if ( IiI not in Oo00O ) :
    IiI += ":" + str ( port )
    lprint ( "    Received unsolicited {} from {}/{}, port {}" . format ( i11i11i , red ( OOo0oO0oooO , False ) , red ( IIIiI1IiIiii ,
    # i1IIi
 False ) , port ) )
    return
    if 99 - 99: iIii1I11I1II1 * OoO0O00 - IiII % o0oOOo0O0Ooo
    if 72 - 72: IiII . i1IIi
    if 37 - 37: OoOoOO00 - Oo0Ooo / oO0o
    if 47 - 47: OoooooooOO - Ii1I
 ...
 if ( oOooo0oOOOO in lisp_rloc_probe_nonce_list ) :
  II111iIII11 = lisp_rloc_probe_nonce_list . pop ( oOooo0oOOOO )
  if ( II111iIII11 != IiI ) :
   IiI = II111iIII11
...
def lisp_decode_dist_name ( packet ) :
 ...
 while ( packet [ 0 : 1 ] != b"\x00" ) :
  ...
  oo0o0OoOo0Ooo += packet [ 0 : 1 ]
  packet = packet [ 1 : : ]
  O0oo0oOo += 1
  if 59 - 59: II111iiii
  if 11 - 11: OOooOOo * I1Ii111 - I1Ii111 * Ii1I
 packet = packet [ 1 : : ]
 return ( packet , oo0o0OoOo0Ooo . decode ( ) )
...
def lisp_write_flow_log ( flow_log ) :
 ...
 for iII1iii in flow_log :
  Oo00oo = iII1iii [ 3 ]
  OoOIiIiiIiI1i = Oo00oo . print_flow ( iII1iii [ 0 ] , iII1iii [ 1 ] , iII1iii [ 2 ] )
  Oo0OoooOoO0O0 . write ( OoOIiIiiIiI1i )
  O0oo0oOo += 1
...
def lisp_policy_command ( kv_pair ) :
 ...
 for O0ooO00oo in list ( kv_pair . keys ( ) ) :
  ...
  if ( O0ooO00oo == "instance-id" ) :
   for iIi1iIIIiIiI in range ( len ( iIIOoo0 ) ) :
    i1iio0O0O = oOO0 [ iIi1iIIIiIiI ]
    if ( i1iio0O0O == "" ) : continue
    oOOoi1Ii1 = iIIOoo0 [ iIi1iIIIiIiI ]
    if ( oOOoi1Ii1 . source_eid == None ) :
     oOOoi1Ii1 . source_eid = lisp_address ( LISP_AFI_NONE , "" , 0 , 0 )
     if 17 - 17: OoOoOO00
    if ( oOOoi1Ii1 . dest_eid == None ) :
     oOOoi1Ii1 . dest_eid = lisp_address ( LISP_AFI_NONE , "" , 0 , 0 )
     if 61 - 61: II111iiii . Oo0Ooo + iII111i * Oo0Ooo + iII111i . OoOoOO00
    oOOoi1Ii1 . source_eid . instance_id = int ( i1iio0O0O )
    oOOoi1Ii1 . dest_eid . instance_id = int ( i1iio0O0O )
    if 3 - 3: Ii1I * OoooooooOO + i1IIi / OOooOOo - II111iiii
    if 96 - 96: I1ii11iIi11i . Ii1I
  if ( O0ooO00oo == "source-eid" ) :
   for iIi1iIIIiIiI in range ( len ( iIIOoo0 ) ) :
    i1iio0O0O = oOO0 [ iIi1iIIIiIiI ]
    if ( i1iio0O0O == "" ) : continue
    oOOoi1Ii1 = iIIOoo0 [ iIi1iIIIiIiI ]
    ...
    oooo = oOOoi1Ii1 . source_eid . instance_id
    oOOoi1Ii1 . source_eid . store_prefix ( i1iio0O0O )
    oOOoi1Ii1 . source_eid . instance_id = oooo
    if 8 - 8: I1Ii111 * Ii1I
    if 89 - 89: o0oOOo0O0Ooo
  if ( O0ooO00oo == "destination-eid" ) :
   for iIi1iIIIiIiI in range ( len ( iIIOoo0 ) ) :
    i1iio0O0O = oOO0 [ iIi1iIIIiIiI ]
    if ( i1iio0O0O == "" ) : continue
    oOOoi1Ii1 = iIIOoo0 [ iIi1iIIIiIiI ]
    ...
    oooo = oOOoi1Ii1 . dest_eid . instance_id
    oOOoi1Ii1 . dest_eid . store_prefix ( i1iio0O0O )
    oOOoi1Ii1 . dest_eid . instance_id = oooo
    if 80 - 80: oO0o / i1IIi * iIii1I11I1II1
    if 38 - 38: Ii1I
  if ( O0ooO00oo == "source-rloc" ) :
   for iIi1iIIIiIiI in range ( len ( iIIOoo0 ) ) :
    i1iio0O0O = oOO0 [ iIi1iIIIiIiI ]
    if ( i1iio0O0O == "" ) : continue
    oOOoi1Ii1 = iIIOoo0 [ iIi1iIIIiIiI ]
    oOOoi1Ii1 . source_rloc = lisp_address ( LISP_AFI_NONE , "" , 0 , 0 )
    oOOoi1Ii1 . source_rloc . store_prefix ( i1iio0O0O )
    if 20 - 20: iIii1I11I1II1 + Oo0Ooo - Ii1I / i11iIiiIii . OoO0O00
    if 66 - 66: OoooooooOO - Ii1I / iII111i . I1IiiI + I1ii11iIi11i - I1Ii111
  if ( O0ooO00oo == "destination-rloc" ) :
   for iIi1iIIIiIiI in range ( len ( iIIOoo0 ) ) :
    i1iio0O0O = oOO0 [ iIi1iIIIiIiI ]
    if ( i1iio0O0O == "" ) : continue
    oOOoi1Ii1 = iIIOoo0 [ iIi1iIIIiIiI ]
    oOOoi1Ii1 . dest_rloc = lisp_address ( LISP_AFI_NONE , "" , 0 , 0 )
    oOOoi1Ii1 . dest_rloc . store_prefix ( i1iio0O0O )
    if 36 - 36: I1Ii111 - OoO0O00 . I1ii11iIi11i * I1ii11iIi11i
    if 9 - 9: OOooOOo - oO0o - iIii1I11I1II1 * i11iIiiIii / I11i
  if ( O0ooO00oo == "rloc-record-name" ) :
   for iIi1iIIIiIiI in range ( len ( iIIOoo0 ) ) :
    i1iio0O0O = oOO0 [ iIi1iIIIiIiI ]
    if ( i1iio0O0O == "" ) : continue
    oOOoi1Ii1 = iIIOoo0 [ iIi1iIIIiIiI ]
    oOOoi1Ii1 . rloc_record_name = i1iio0O0O
    if 2 - 2: i1IIi % iII111i * ooOoO0o / OoOoOO00 + Oo0Ooo
    if 59 - 59: i11iIiiIii / I1IiiI * iII111i
  if ( O0ooO00oo == "geo-name" ) :
   for iIi1iIIIiIiI in range ( len ( iIIOoo0 ) ) :
    i1iio0O0O = oOO0 [ iIi1iIIIiIiI ]
    if ( i1iio0O0O == "" ) : continue
    oOOoi1Ii1 = iIIOoo0 [ iIi1iIIIiIiI ]
    oOOoi1Ii1 . geo_name = i1iio0O0O
    if 16 - 16: i11iIiiIii * II111iiii - ooOoO0o
    if 80 - 80: iIii1I11I1II1 + iIii1I11I1II1 + I1Ii111 - IiII * iII111i - Ii1I
  if ( O0ooO00oo == "elp-name" ) :
   for iIi1iIIIiIiI in range ( len ( iIIOoo0 ) ) :
    i1iio0O0O = oOO0 [ iIi1iIIIiIiI ]
    if ( i1iio0O0O == "" ) : continue
    oOOoi1Ii1 = iIIOoo0 [ iIi1iIIIiIiI ]
    oOOoi1Ii1 . elp_name = i1iio0O0O
    if 89 - 89: O0 * ooOoO0o
    if 36 - 36: I1ii11iIi11i * II111iiii * iII111i + I1IiiI + OoO0O00 + oO0o
  if ( O0ooO00oo == "rle-name" ) :
   for iIi1iIIIiIiI in range ( len ( iIIOoo0 ) ) :
    i1iio0O0O = oOO0 [ iIi1iIIIiIiI ]
    if ( i1iio0O0O == "" ) : continue
    oOOoi1Ii1 = iIIOoo0 [ iIi1iIIIiIiI ]
    oOOoi1Ii1 . rle_name = i1iio0O0O
    if 28 - 28: Ii1I - i11iIiiIii . oO0o / II111iiii
    if 82 - 82: iII111i * iII111i . IiII * II111iiii
  if ( O0ooO00oo == "json-name" ) :
   for iIi1iIIIiIiI in range ( len ( iIIOoo0 ) ) :
    i1iio0O0O = oOO0 [ iIi1iIIIiIiI ]
    if ( i1iio0O0O == "" ) : continue
    oOOoi1Ii1 = iIIOoo0 [ iIi1iIIIiIiI ]
    oOOoi1Ii1 . json_name = i1iio0O0O
    if 17 - 17: OoooooooOO % I1Ii111 * I1Ii111 / II111iiii . OoOoOO00 * iII111i
    if 80 - 80: IiII % i11iIiiIii
  if ( O0ooO00oo == "datetime-range" ) :
   for iIi1iIIIiIiI in range ( len ( iIIOoo0 ) ) :
    i1iio0O0O = oOO0 [ iIi1iIIIiIiI ]
    oOOoi1Ii1 = iIIOoo0 [ iIi1iIIIiIiI ]
    if ( i1iio0O0O == "" ) : continue
    oOO0O0ooOOOo = lisp_datetime ( i1iio0O0O [ 0 : 19 ] )
    iIiiIIiII1iII11 = lisp_datetime ( i1iio0O0O [ 19 : : ] )
    if ( oOO0O0ooOOOo . valid_datetime ( ) and iIiiIIiII1iII11 . valid_datetime ( ) ) :
     oOOoi1Ii1 . datetime_lower = oOO0O0ooOOOo
     oOOoi1Ii1 . datetime_upper = iIiiIIiII1iII11
  ...
  if ( O0ooO00oo == "set-destination-eid" ) :
   if ( iIIiiIi . set_dest_eid == None ) :
    iIIiiIi . set_dest_eid = lisp_address ( LISP_AFI_NONE , "" , 0 , 0 )
...
def lisp_encap_rloc_probe ( lisp_sockets , rloc , nat_info , packet ) :
 ...
 oOi1IiIiiIIiii = lisp_sockets [ 3 ]
 packet . send_packet ( oOi1IiIiiIIiii , packet . outer_dest )
 del ( packet )
 return
...
def lisp_get_default_route_next_hops ( ) :
 ...
 if ( lisp_is_macos ( ) ) :
  ...
  IIIi1i1IiIIii = getoutput ( oO00o00 ) . split ( "\n" )
  OO0000O0 = i111IIiIiiI1 = None
  for Oo0OoooOoO0O0 in IIIi1i1IiIIii :
   if ( Oo0OoooOoO0O0 . find ( "gateway: " ) != - 1 ) : OO0000O0 = Oo0OoooOoO0O0 . split ( ": " ) [ 1 ]
   if ( Oo0OoooOoO0O0 . find ( "interface: " ) != - 1 ) : i111IIiIiiI1 = Oo0OoooOoO0O0 . split ( ": " ) [ 1 ]
   if 81 - 81: II111iiii / ooOoO0o
  return ( [ [ i111IIiIiiI1 , OO0000O0 ] ] )
  if 5 - 5: OoOoOO00
  if 79 - 79: I1IiiI
  if 88 - 88: i1IIi % IiII + I1ii11iIi11i * Ii1I
  if 60 - 60: oO0o . ooOoO0o / IiII * oO0o . o0oOOo0O0Ooo - I11i
  if 87 - 87: II111iiii + Oo0Ooo . ooOoO0o
 oO00o00 = "ip route | egrep 'default via'"
 OOo00O00O0O = getoutput ( oO00o00 ) . split ( "\n" )
 if 79 - 79: II111iiii / i11iIiiIii
 i1i1i11i = [ ]
 for iIIIi in OOo00O00O0O :
  ...
  try :
   ...
   continue
   if 55 - 55: O0 - iIii1I11I1II1 - iIii1I11I1II1 % OoO0O00 + OoooooooOO / Oo0Ooo
...
def lisp_check_dp_socket ( ) :
 O00OO = lisp_ipc_dp_socket_name
 if ( os . path . exists ( O00OO ) == False ) :
  II11iiiII1II1 = bold ( "does not exist" , False )
  lprint ( "Socket '{}' {}" . format ( O00OO , II11iiiII1II1 ) )
  return ( False )
  if 73 - 73: I1IiiI / Ii1I - OoOoOO00 . iIii1I11I1II1 % OOooOOo
 return ( True )
 if 99 - 99: OoooooooOO
...
def lisp_write_to_dp_socket ( entry ) :
 try :
  oOoIiI11iIi1 = json . dumps ( entry )
  iIiI111i1 = bold ( "Write IPC" , False )
  lprint ( "{} record to named socket: '{}'" . format ( iIiI111i1 , oOoIiI11iIi1 ) )
  lisp_ipc_dp_socket . sendto ( oOoIiI11iIi1 , lisp_ipc_dp_socket_name )
 except :
  lprint ( "Failed to write IPC record to named socket: '{}'" . format ( oOoIiI11iIi1 ) )
  if 39 - 39: I1Ii111
 return
 if 21 - 21: ooOoO0o - I1IiiI % iIii1I11I1II1
 if 84 - 84: OoOoOO00 + IiII * Oo0Ooo + Ii1I * i11iIiiIii
 if 89 - 89: ooOoO0o % Oo0Ooo * I1Ii111 % oO0o - II111iiii - I1ii11iIi11i
 if 74 - 74: ooOoO0o
...
def lisp_write_ipc_map_cache ( add_or_delete , mc , dont_send = False ) :
 ...
 if ( O0OOoOO000 ) :
  if ( len ( mc . rloc_set ) >= 1 and mc . rloc_set [ 0 ] . rle ) :
   for iI11i1ii11i11 in mc . rloc_set [ 0 ] . rle . rle_forwarding_list :
    ...
    oOO0o00ooo0o0 , oOOo0Oo0o = iI11i1ii11i11 . get_encap_keys ( )
    O00o00o00OO0 = lisp_build_json_keys ( O00o00o00OO0 , oOO0o00ooo0o0 , oOOo0Oo0o , "encrypt-key" )
 ...
 I1I }
   oOO0o00ooo0o0 , oOOo0Oo0o = I1Ii1i111I . get_encap_keys ( )
   O00o00o00OO0 = lisp_build_json_keys ( O00o00o00OO0 , oOO0o00ooo0o0 , oOOo0Oo0o , "encrypt-key" )
...
def lisp_write_ipc_decap_key ( rloc_addr , keys ) :
 ...
 III1i11Ii1ii = rloc_addr . split ( ":" )
 if ( len ( III1i11Ii1ii ) == 1 ) :
  oo0O00OOOOO = { "type" : "decap-keys" , "rloc" : III1i11Ii1ii [ 0 ] }
 else :
  oo0O00OOOOO = { "type" : "decap-keys" , "rloc" : III1i11Ii1ii [ 0 ] , "port" : III1i11Ii1ii [ 1 ] }
  if 82 - 82: I1ii11iIi11i - OoooooooOO . OoooooooOO - OoO0O00 / iII111i
 oo0O00OOOOO = lisp_build_json_keys ( oo0O00OOOOO , oOO0o00ooo0o0 , oOOo0Oo0o , "decrypt-key" )
...
def lisp_write_ipc_database_mappings ( ephem_port ) :
 ...
 for i1ii1I11iIII in lisp_db_list :
  ...
  IIIi1i1I = { "instance-id" : str ( i1ii1I11iIII . eid . instance_id ) ,
 "eid-prefix" : i1ii1I11iIII . eid . print_prefix_no_iid ( ) }
  oo0O00OOOOO [ "database-mappings" ] . append ( IIIi1i1I )
  if 73 - 73: O0 + OoO0O00 + Oo0Ooo * O0
 lisp_write_to_dp_socket ( oo0O00OOOOO )
 if 53 - 53: iII111i + iIii1I11I1II1 / IiII
 if 2 - 2: O0 + IiII + Oo0Ooo * II111iiii * I1IiiI % IiII
...
def lisp_write_ipc_interfaces ( ) :
 ...
 for i111IIiIiiI1 in list ( lisp_myinterfaces . values ( ) ) :
  ...
  IIIi1i1I = { "interface" : i111IIiIiiI1 . device ,
 "instance-id" : str ( i111IIiIiiI1 . instance_id ) }
  oo0O00OOOOO [ "interfaces" ] . append ( IIIi1i1I )
...
def lisp_parse_auth_key ( value ) :
 ...
 for i1iio0O0O in ii1oo :
  if ( i1iio0O0O == "" ) : continue
  OOOooo0OooOoO = i1iio0O0O . find ( "]" )
  i11iII1 = i1iio0O0O [ 0 : OOOooo0OooOoO ]
  try : i11iII1 = int ( i11iII1 )
  except : return
  if 18 - 18: I1ii11iIi11i
  I11III [ i11iII1 ] = i1iio0O0O [ OOOooo0OooOoO + 1 : : ]
...
def lisp_reassemble ( packet ) :
 ...
 iiI1II1Ii = ( i1i1IIi & 0x2000 == 0 and ( i1i1IIi & 0x1fff ) != 0 )
 oo0O00OOOOO = [ ( i1i1IIi & 0x1fff ) * 8 , o000oO0O0ooo - 20 , packet , iiI1II1Ii ]
 if 65 - 65: IiII - iIii1I11I1II1 + oO0o % iIii1I11I1II1
 if 45 - 45: I1ii11iIi11i
 if 34 - 34: iIii1I11I1II1 * O0 * OOooOOo + OOooOOo % OoO0O00 . OoO0O00
 if 48 - 48: iII111i
 ...
 OOoO0 = IiI . print_address_no_iid ( )
 IiI . address = socket . ntohl ( struct . unpack ( "I" , packet [ 16 : 20 ] ) [ 0 ] )
 Ii1IIIiIi = IiI . print_address_no_iid ( )
 IiI = red ( "{} -> {}" . format ( OOoO0 , Ii1IIIiIi ) , False )
 ...
 iiiIIiiIiI11 = queue [ 0 ]
 for Ii in queue [ 1 : : ] :
  i1i1IIi = Ii [ 0 ]
  i1II1IIi , III1ii = iiiIIiiIiI11 [ 0 ] , iiiIIiiIiI11 [ 1 ]
  if ( i1II1IIi + III1ii != i1i1IIi ) : return ( None )
  iiiIIiiIiI11 = Ii
  if 43 - 43: I11i
...
def lisp_get_crypto_decap_lookup_key ( addr , port ) :
 ...
 if 8 - 8: i1IIi % I11i
 for I1IiOOOoo in lisp_crypto_keys_by_rloc_decap :
  OO0O00o0 = I1IiOOOoo . split ( ":" )
  if ( len ( OO0O00o0 ) == 1 ) : continue
  OO0O00o0 = OO0O00o0 [ 0 ] if len ( OO0O00o0 ) == 2 else ":" . join ( OO0O00o0 [ 0 : - 1 ] )
  if ( OO0O00o0 == O0O0 ) :
   iI1iiiiiii = lisp_crypto_keys_by_rloc_decap [ I1IiOOOoo ]
 ...
 if ( lisp_i_am_rtr ) :
  ...
  for ooOoo00 in list ( lisp_nat_state_info . values ( ) ) :
   for I11II1iI1i in ooOoo00 :
    if ( addr == I11II1iI1i . address ) : return ( o0OOo )
...
def lisp_is_rloc_probe ( packet , device , rr ) :
 ...
 O0o0oo = ( socket . htons ( LISP_CTRL_PORT ) in [ oooooO0oO0ooO , iIII1IiI ] )
 if ( O0o0oo == False ) : return ( [ packet , None , None , None ] )
...
def lisp_process_data_plane_restart ( do_clear = False ) :
 ...
 if 49 - 49: O0
 o0Ooo0OooOoO = { "type" : "entire-map-cache" , "entries" : [ ] }
 if 69 - 69: iIii1I11I1II1 % I1ii11iIi11i
 if ( do_clear == False ) :
  o00OooO = o0Ooo0OooOoO [ "entries" ]
  lisp_map_cache . walk_cache ( lisp_ipc_walk_map_cache , o00OooO )
  if 95 - 95: O0 % o0oOOo0O0Ooo . Ii1I % OoOoOO00 % IiII
  if 27 - 27: OoOoOO00 + OOooOOo - oO0o % Oo0Ooo . iII111i
 lisp_write_to_dp_socket ( o0Ooo0OooOoO )
 return
...
def lisp_process_data_plane_stats ( msg , lisp_sockets , lisp_port ) :
 ...
 for msg in msg [ "entries" ] :
  ...
  for IiIi1IIIi in O0Oo0O00O :
   if ( "rloc" not in IiIi1IIIi ) : continue
   if 46 - 46: I1IiiI
   IIi11IiiiI11i = IiIi1IIIi [ "rloc" ]
   ...
   OOoOoOO0 = 0 if ( "packet-count" not in IiIi1IIIi ) else IiIi1IIIi [ "packet-count" ]
   if 40 - 40: OOooOOo - Ii1I * I1ii11iIi11i * OoooooooOO + II111iiii / ooOoO0o
   i1oOOoo00OOOO = 0 if ( "byte-count" not in IiIi1IIIi ) else IiIi1IIIi [ "byte-count" ]
   if 11 - 11: OoooooooOO * ooOoO0o / II111iiii * oO0o / OoOoOO00 . iIii1I11I1II1
   Oo0OO0000oooo = 0 if ( "seconds-last-packet" not in IiIi1IIIi ) else IiIi1IIIi [ "seconds-last-packet" ]
   if 9 - 9: iII111i
   if 13 - 13: IiII - Oo0Ooo
   OoO000Oo000 . stats . packet_count += OOoOoOO0
   ...
   lprint ( "Update stats {}/{}/{}s for {} RLOC {}" . format ( OOoOoOO0 , i1oOOoo00OOOO ,
...
def lisp_process_data_plane_decap_stats ( msg , lisp_ipc_socket ) :
 ...
 "outer-header-error" ]
 if 58 - 58: i1IIi + II111iiii / OoO0O00 - oO0o . OOooOOo + Ii1I
 for i1i1iIIIIIIi in ooo0o00OO :
  OOoOoOO0 = 0 if ( i1i1iIIIIIIi not in msg ) else msg [ i1i1iIIIIIIi ] [ "packet-count" ]
  lisp_decap_stats [ i1i1iIIIIIIi ] . packet_count += OOoOoOO0
  if 98 - 98: I11i / O0 + i1IIi * I11i
  i1oOOoo00OOOO = 0 if ( i1i1iIIIIIIi not in msg ) else msg [ i1i1iIIIIIIi ] [ "byte-count" ]
  lisp_decap_stats [ i1i1iIIIIIIi ] . byte_count += i1oOOoo00OOOO
  if 39 - 39: I11i * o0oOOo0O0Ooo - I11i + II111iiii . I1Ii111 * O0
  Oo0OO0000oooo = 0 if ( i1i1iIIIIIIi not in msg ) else msg [ i1i1iIIIIIIi ] [ "seconds-last-packet" ]
  if 90 - 90: OoooooooOO + II111iiii - i11iIiiIii * I11i + IiII + OOooOOo
  lisp_decap_stats [ i1i1iIIIIIIi ] . last_increment = lisp_get_timestamp ( ) - Oo0OO0000oooo
  if 66 - 66: OoO0O00
 return
 if 94 - 94: O0
...
def lisp_process_punt ( punt_socket , lisp_send_sockets , lisp_ephem_port ) :
 ooO0o , I1 = punt_socket . recvfrom ( 4000 )
 if 84 - 84: IiII - I1ii11iIi11i
 IiiIIiI = json . loads ( ooO0o )
 ...
 IIOOOO = bold ( "Punt" , False )
 lprint ( "{} message from '{}': '{}'" . format ( IIOOOO , I1 , IiiIIiI ) )
 if 70 - 70: ooOoO0o
 ...
 if ( "dest-eid" in IiiIIiI ) :
  O0OOo0 = IiiIIiI [ "dest-eid" ]
  IiiO00o0OoO00ooo = lisp_address ( LISP_AFI_NONE , O0OOo0 , 0 , oooo )
  if ( IiiO00o0OoO00ooo . is_null ( ) ) :
   lprint ( "Invalid dest-EID format '{}'" . format ( O0OOo0 ) )
   return
   if 27 - 27: iIii1I11I1II1
...
def lisp_itr_discover_eid ( db , eid , input_interface , routed_interface ,
 ...
 if ( input_interface != routed_interface ) :
  OO0o0OOooO = ", routed-interface " + routed_interface
  if 38 - 38: Oo0Ooo % i1IIi + oO0o . o0oOOo0O0Ooo
  if 27 - 27: Ii1I * Oo0Ooo - I1ii11iIi11i
 IiIII1i1i1 = green ( i1iiii , False ) + bold ( " discovered" , False )
 lprint ( "Dynamic-EID {} on interface {}{}, timeout {}" . format ( IiIII1i1i1 , input_interface , OO0o0OOooO , I1Ii111I111 . timeout ) )
...
def lisp_retry_decap_keys ( addr_str , packet , iv , packet_icv ) :
 ...
 for Ooo00o000o in lisp_crypto_keys_by_rloc_decap :
  ...
  ii1iiiIiiii1 = oo0O00OOOOO [ 1 ]
  if ( packet_icv != ii1iiiIiiii1 . do_icv ( packet , iv ) ) :
...
def lisp_get_decent_index ( eid ) :
 i1iiii = eid . print_prefix ( )
 o0oI1Iii1iIIi1 = hmac . new ( b"lisp-decent" , i1iiii , hashlib . sha256 ) . hexdigest ( )
 ...
 IIiIi1I1IIi = os . getenv ( "LISP_DECENT_HASH_WIDTH" )
 if ( IIiIi1I1IIi in [ "" , None ] ) :
  IIiIi1I1IIi = 12
 else :
  IIiIi1I1IIi = int ( IIiIi1I1IIi )
  if ( IIiIi1I1IIi > 32 ) :
   IIiIi1I1IIi = 12
  else :
   IIiIi1I1IIi *= 2
   if 17 - 17: OOooOOo * iIii1I11I1II1 * iIii1I11I1II1 . oO0o
   if 76 - 76: I11i + I1ii11iIi11i % I1Ii111
   if 38 - 38: iII111i . OoOoOO00 / I1Ii111 * I11i + iII111i
 Oo00IIii1iiI1Iiii = o0oI1Iii1iIIi1 [ 0 : IIiIi1I1IIi ]
 OOOooo0OooOoO = int ( Oo00IIii1iiI1Iiii , 16 ) % lisp_decent_modulus
 if 45 - 45: O0 / iIii1I11I1II1 % II111iiii + II111iiii
 lprint ( "LISP-Decent modulus {}, hash-width {}, mod-value {}, index {}" . format ( lisp_decent_modulus , old_div ( IIiIi1I1IIi , 2 ) , Oo00IIii1iiI1Iiii , OOOooo0OooOoO ) )
...
def lisp_trace_append ( packet , reason = None , ed = "encap" , lisp_socket = None ,
 ...
 ooOo0 = packet . packet [ oo00 : : ]
 OO0oooOOoOO0O = lisp_trace ( )
 if ( OO0oooOOoOO0O . decode ( ooOo0 ) == False ) :
  lprint ( "Could not decode JSON portion of a LISP-Trace packet" )
  return ( False )
  if 14 - 14: O0
  if 59 - 59: I11i % II111iiii . iIii1I11I1II1 * oO0o % Ii1I
 ooooo00O = "?" if packet . outer_dest . is_null ( ) else packet . outer_dest . print_address_no_iid ( )
 ...
 if ( ooooo00O != "?" and packet . encap_port != LISP_DATA_PORT ) :
  if ( ed == "encap" ) : ooooo00O += ":{}" . format ( packet . encap_port )
 ...
 o0000 = packet . outer_source
 if ( o0000 . is_null ( ) ) : o0000 = lisp_myrlocs [ 0 ]
 oo0O00OOOOO [ "sr" ] = o0000 . print_address_no_iid ( )
 if 37 - 37: II111iiii
 if 12 - 12: II111iiii - iII111i . I1Ii111 % Ii1I + I1Ii111
 if 32 - 32: I1ii11iIi11i % i11iIiiIii
 if 87 - 87: ooOoO0o / I1IiiI . Ii1I * OoooooooOO * i1IIi * ooOoO0o
 if 10 - 10: OoooooooOO
 if ( oo0O00OOOOO [ "n" ] == "ITR" and packet . inner_sport != LISP_TRACE_PORT ) :
  oo0O00OOOOO [ "sr" ] += ":{}" . format ( packet . inner_sport )
  if 90 - 90: ooOoO0o . OoO0O00
  if 93 - 93: OoOoOO00 - ooOoO0o * IiII
 oo0O00OOOOO [ "hn" ] = lisp_hostname
 Ooo00o000o = ed [ 0 ] + "ts"
 oo0O00OOOOO [ Ooo00o000o ] = lisp_get_timestamp ( )
 if 62 - 62: OoooooooOO / i11iIiiIii * OoOoOO00 - I1ii11iIi11i
 if 96 - 96: I11i / I1IiiI + I11i % i11iIiiIii
 ...
 if ( ooooo00O == "?" and oo0O00OOOOO [ "n" ] == "ETR" ) :
 ...
 if ( OO0oooOOoOO0O . packet_json == [ ] ) :
  oOoIiI11iIi1 = { }
  oOoIiI11iIi1 [ "se" ] = iIiIII11i1i
  oOoIiI11iIi1 [ "de" ] = IiiO00o0OoO00ooo
  oOoIiI11iIi1 [ "paths" ] = [ ]
  OO0oooOOoOO0O . packet_json . append ( oOoIiI11iIi1 )
 ...
 for oOoIiI11iIi1 in OO0oooOOoOO0O . packet_json :
  if ( oOoIiI11iIi1 [ "de" ] != IiiO00o0OoO00ooo ) : continue
  oOoIiI11iIi1 [ "paths" ] . append ( oo0O00OOOOO )
  break
 ...
 OO0oooOOoOO0O . myeid ( packet . inner_dest ) ) :
  oOoIiI11iIi1 = { }
  oOoIiI11iIi1 [ "se" ] = IiiO00o0OoO00ooo
  oOoIiI11iIi1 [ "de" ] = iIiIII11i1i
  oOoIiI11iIi1 [ "paths" ] = [ ]
  OO0oooOOoOO0O . packet_json . append ( oOoIiI11iIi1 )
  IiiIiii1I11Ii = True
 ...
 Ooooo0o = OO0oooOOoOO0O . packet_json [ 0 ] [ "paths" ] [ 0 ] [ "sr" ]
 if ( ooooo00O == "?" ) :
  lprint ( "LISP-Trace return to sender RLOC {}" . format ( Ooooo0o ) )
  OO0oooOOoOO0O . return_to_sender ( lisp_socket , Ooooo0o , ooOo0 )
  return ( False )
  if 34 - 34: i1IIi % I1ii11iIi11i / I1ii11iIi11i + iIii1I11I1II1 + I11i + OoooooooOO
  if 90 - 90: OoO0O00 / I1Ii111 - i1IIi
  if 53 - 53: I11i . I11i
 ...
 I1i = 20 + Ooo000O00 if packet . inner_version == 4 else Ooo000O00
 ooo0OOoO = struct . pack ( "H" , socket . htons ( I1i ) )
 iiiI1 = iiiI1 [ 0 : oo00 ] + ooo0OOoO + iiiI1 [ oo00 + 2 : : ]
 if 68 - 68: i11iIiiIii * Oo0Ooo
 if 14 - 14: oO0o / O0 / ooOoO0o
 if 75 - 75: OOooOOo % I11i / oO0o
 if 52 - 52: iIii1I11I1II1 / I1IiiI
 if ( packet . inner_version == 4 ) :
  IIIiIi11 = struct . pack ( "H" , 0 )
  iiiI1 = iiiI1 [ 0 : 10 ] + IIIiIi11 + iiiI1 [ 12 : : ]
  ooo0OOoO = lisp_ip_checksum ( iiiI1 [ 0 : 20 ] )
  iiiI1 = ooo0OOoO + iiiI1 [ 20 : : ]
  if 94 - 94: iII111i + oO0o
  if 43 - 43: iIii1I11I1II1 + iIii1I11I1II1
  if 8 - 8: iIii1I11I1II1
  if 30 - 30: OOooOOo - I1ii11iIi11i * iIii1I11I1II1 + Oo0Ooo
  if 25 - 25: IiII
 packet . packet = iiiI1 + ooOo0
 return ( True )
...
def lisp_build_gleaned_multicast ( seid , geid , rloc , port , igmp ) :
 ...
 o0O0Ooo0 = seid . print_address_no_iid ( )
 I111 = green ( "{}" . format ( o0O0Ooo0 ) , False )
 ...
 OoO000Oo000 = O0oOi1 = iI11i1ii11i11 = None
 if ( I1I11II1i . rloc_set != [ ] ) :
  OoO000Oo000 = I1I11II1i . rloc_set [ 0 ]
  if ( OoO000Oo000 . rle ) :
   O0oOi1 = OoO000Oo000 . rle
   for ooO00OoOooOo0 in O0oOi1 . rle_nodes :
    if ( ooO00OoOooOo0 . rloc_name != o0O0Ooo0 ) : continue
 ...
 if ( O0oOi1 == None ) :
  O0oOi1 = lisp_rle ( geid . print_address ( ) )
  OoO000Oo000 . rle = O0oOi1
  if 56 - 56: I1Ii111
 if ( iI11i1ii11i11 == None ) :
  iI11i1ii11i11 = lisp_rle_node ( )
  iI11i1ii11i11 . rloc_name = o0O0Ooo0
  O0oOi1 . rle_nodes . append ( iI11i1ii11i11 )
  O0oOi1 . build_forwarding_list ( )
...
def lisp_process_igmp_packet ( packet ) :
 ...
 iII1i1111 = ( struct . unpack ( "B" , packet [ 0 : 1 ] ) [ 0 ] & 0x0f ) * 4
 if 82 - 82: I1Ii111
 ...
 iIiI11i = packet [ iII1i1111 : : ]
 OoOOO0OO0O = struct . unpack ( "B" , iIiI11i [ 0 : 1 ] ) [ 0 ]
 ...
 o0o0Oo0o0oOo . address = socket . ntohl ( struct . unpack ( "II" , iIiI11i [ : 8 ] ) [ 1 ] )
 ...
 OOOOo0ooOoO = ( OoOOO0OO0O in ( 0x12 , 0x16 , 0x17 , 0x22 ) )
 if ( OOOOo0ooOoO == False ) :
  IIi11iI = "{} ({})" . format ( OoOOO0OO0O , igmp_types [ OoOOO0OO0O ] ) if ( OoOOO0OO0O in igmp_types ) else OoOOO0OO0O
  if 45 - 45: OoooooooOO * II111iiii
  lprint ( "IGMP type {} not supported" . format ( IIi11iI ) )
  return ( [ ] )
  if 67 - 67: iII111i
 ...
 if ( OoOOO0OO0O == 0x17 ) :
  ...
  if 60 - 60: OoooooooOO
 if ( OoOOO0OO0O in ( 0x12 , 0x16 ) ) :
  lprint ( "IGMPv{} join (*, {})" . format ( 1 if ( OoOOO0OO0O == 0x12 ) else 2 , bold ( IIiI11I1I1i1i , False ) ) )
  if 31 - 31: O0 - I11i
 ...
 if 45 - 45: I1ii11iIi11i
 Oo0Oo0o000 = "BBHI"
 oOo0oO = struct . calcsize ( Oo0Oo0o000 )
 I1iI1IiI1I1 = "I"
 Ii1I1iiiiiI1 = struct . calcsize ( I1iI1IiI1I1 )
 I1 = lisp_address ( LISP_AFI_IPV4 , "" , 32 , 0 )
 if 27 - 27: OoOoOO00 * OoooooooOO % II111iiii - oO0o % OoOoOO00 - i11iIiiIii
 if 81 - 81: OoO0O00 + I1IiiI % iII111i - o0oOOo0O0Ooo . OoooooooOO . I1Ii111
 if 61 - 61: II111iiii / OOooOOo + I1Ii111 . o0oOOo0O0Ooo / O0
 if 75 - 75: I1ii11iIi11i * OoOoOO00 - iII111i / I1Ii111 + iIii1I11I1II1
 iIiIII = [ ]
 for iIi1iIIIiIiI in range ( I1I1iI1IIII ) :
  if ( len ( iIiI11i ) < oOo0oO ) : return
  iIO00000 , iIiiiI1 , iIi11i1Ii1 , I1IIIi = struct . unpack ( Oo0Oo0o000 ,
 iIiI11i [ : oOo0oO ] )
  if 37 - 37: OoO0O00 / Ii1I
  iIiI11i = iIiI11i [ oOo0oO : : ]
  if 58 - 58: o0oOOo0O0Ooo / o0oOOo0O0Ooo % OoOoOO00
  if ( iIO00000 not in lisp_igmp_record_types ) :
   lprint ( "Invalid record type {}" . format ( iIO00000 ) )
   continue
   if 13 - 13: IiII / IiII . OoooooooOO
   if 57 - 57: Ii1I - I1IiiI / ooOoO0o . I1IiiI
  Oo0oOO0Oo0o = lisp_igmp_record_types [ iIO00000 ]
  iIi11i1Ii1 = socket . ntohs ( iIi11i1Ii1 )
  o0o0Oo0o0oOo . address = socket . ntohl ( I1IIIi )
  IIiI11I1I1i1i = o0o0Oo0o0oOo . print_address_no_iid ( )
  if 92 - 92: I11i
  lprint ( "Record type: {}, group: {}, source-count: {}" . format ( Oo0oOO0Oo0o , IIiI11I1I1i1i , iIi11i1Ii1 ) )
  ...
  OOO0o = False
  if ( iIO00000 in ( 1 , 5 ) ) : OOO0o = True
  if ( iIO00000 in ( 2 , 4 ) and iIi11i1Ii1 == 0 ) : OOO0o = True
  i1iI = "join" if ( OOO0o ) else "leave"
  ...
  if ( iIi11i1Ii1 == 0 ) :
   iIiIII . append ( [ None , IIiI11I1I1i1i , OOO0o ] )
   lprint ( "IGMPv3 {} (*, {})" . format ( bold ( i1iI , False ) ,
 bold ( IIiI11I1I1i1i , False ) ) )
   ...
   if 79 - 79: Oo0Ooo
  for IiIIIiIII1I in range ( iIi11i1Ii1 ) :
   if ( len ( iIiI11i ) < Ii1I1iiiiiI1 ) : return
   I1IIIi = struct . unpack ( I1iI1IiI1I1 , iIiI11i [ : Ii1I1iiiiiI1 ] ) [ 0 ]
   I1 . address = socket . ntohl ( I1IIIi )
   iiii = I1 . print_address_no_iid ( )
   iIiIII . append ( [ iiii , IIiI11I1I1i1i , OOO0o ] )
   lprint ( "{} ({}, {})" . format ( i1iI ,
 green ( iiii , False ) , bold ( IIiI11I1I1i1i , False ) ) )
   iIiI11i = iIiI11i [ Ii1I1iiiiiI1 : : ]
   if 3 - 3: I1Ii111
...
def lisp_glean_map_cache ( seid , rloc , encap_port , igmp ) :
 ...
 if ( I1I11II1i and len ( I1I11II1i . rloc_set ) != 0 ) :
  ...
  if 59 - 59: iIii1I11I1II1 % i11iIiiIii + I1Ii111 * OoooooooOO % i1IIi
  iIIIIi1111iI = I1I11II1i . rloc_set [ 0 ]
  OOoOo = iIIIIi1111iI . rloc
  iIiIIi = iIIIIi1111iI . translated_port
  OOooOo = ( OOoOo . is_exact_match ( rloc ) == False or
 iIiIIi != encap_port )
  ...
  if ( OOooOo ) :
   ...
   iIIIIi1111iI . delete_from_rloc_probe_list ( I1I11II1i . eid , I1I11II1i . group )
 ...
 o00OooO = lisp_process_igmp_packet ( igmp )
 if ( type ( o00OooO ) == bool ) : return
 if 65 - 65: iIii1I11I1II1 * II111iiii * II111iiii % ooOoO0o
 for I1 , o0o0Oo0o0oOo , OOO0o in o00OooO :
  if ( I1 != None ) : continue
