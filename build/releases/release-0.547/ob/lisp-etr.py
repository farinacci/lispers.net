...
def OoooooOoo ( kv_pair ) :
 ...
 if ( o0o00ooo0 ) :
  OoO000 = lisp . lisp_map_servers_list . values ( ) [ 0 ]
...
def o0o ( clause ) :
 ...
 for OoO000 in lisp . lisp_map_servers_list . values ( ) :
 ...
 "Sources" , "Use MS" )
  for Ii1I1Ii in lisp . lisp_group_mapping_list . values ( ) :
   OOoO0 = ""
...
def oO0o0o0oo ( kv_pairs ) :
 ...
 for iiI11ii1I1 in kv_pairs . keys ( ) :
...
def II1IIIIiII1i ( quiet , db , eid , group , ttl ) :
 ...
 for IIi1i1I11Iii in [ eid . instance_id ] + eid . iid_list :
  ...
  for iII1i11IIi1i in iI1i11II1i . values ( ) :
   iiI1iI111ii1i = lisp . lisp_rloc_record ( )
...
def i1iiI11I ( lisp_sockets , ttl , eid_only , ms_only , refresh ) :
 ...
 for O0oOoOO in lisp . lisp_db_list :
  ...
  if ( o0o0oOoOO0O . has_key ( i1i1IIIIi1i ) == False ) : continue
  if 92 - 92: ooOoO0o
  ...
  if ( O0oOoOO . dynamic_eid_configured ( ) ) :
   for I1IIIiI1I1ii1 in O0oOoOO . dynamic_eids . values ( ) :
 ...
 for OoO000 in lisp . lisp_map_servers_list . values ( ) :
  ...
  for II11iI111i1 in o0o0oOoOO0O [ i1i1IIIIi1i ] :
   ...
   OO000oooo0 = oo000 . encode_xtr_id ( "" )
...
def oo0Oo00Oo0 ( ms ) :
 ...
 for iII1i11IIi1i in lisp . lisp_rtr_list . values ( ) :
  if ( iII1i11IIi1i == None ) : continue
...
def oOoOOOo ( lisp_sockets , entries ) :
 ...
 for OoO000 in lisp . lisp_map_servers_list . values ( ) :
  ...
  if ( o0o0oOoOO0O . has_key ( iii1III1i ) == False ) : continue
...
def i1II11Iii1I ( parms , not_used , packet ) :
 ...
 o00ooo0 = packet . decode ( True , Ooo , lisp . lisp_decap_stats )
 ...
 if ( packet . lisp_header . get_instance_id ( ) == 0xffffff ) :
  ...
  if ( lisp . lisp_is_rloc_probe_request ( II [ 0 ] ) ) :
   I11Iii1 = struct . unpack ( "B" , iIi1Iii111I [ 8 ] ) [ 0 ] - 1
   if 29 - 29: iII111i + i11iIiiIii % I11i
  ooooooo00o = packet . outer_source . print_address_no_iid ( )
  lisp . lisp_parse_packet ( o0oOoO00o , II , ooooooo00o , 0 , I11Iii1 )
  return
 ...
 if ( ooo000oOO == None ) : ooo000oOO = i1
...
def oO0O ( lisp_raw_socket , packet , source ) :
 ...
 o00ooo0 = packet . decode ( False , Ooo ,
 ...
 if ( packet . lisp_header . get_instance_id ( ) == 0xffffff ) :
  ...
  lisp . lisp_parse_packet ( o0oOoO00o , II , source , 0 , I11Iii1 )
  return
...
def I1i1II1 ( ) :
 ...
 OooOOOOoO00OoOO = ""
 for IiIi1Ii in IIIiiiIiI : OooOOOOoO00OoOO += struct . pack ( "I" , IiIi1Ii )
 if 39 - 39: Ii1I
 ...
 while ( True ) :
  iiI1iI = commands . getoutput ( "ls join-*" ) . replace ( "join-" , "" )
  iiI1iI = iiI1iI . split ( "\n" )
  if 84 - 84: OoooooooOO + I1Ii111 / I1IiiI % OOooOOo % I1ii11iIi11i * I1IiiI
  for oOO0oo in iiI1iI :
   ...
   O0oo00oOOO0o = os . path . exists ( "leave-{}" . format ( oOO0oo ) )
   lisp . lprint ( "Internal {} group {}" . format ( "leaving" if O0oo00oOOO0o else "joining" , oOO0oo ) )
...
def o0OO0oooo ( ) :
 ...
 oOoO = pcappy . open_live ( iIi1Ii , 1600 , 0 , 100 )
 if 32 - 32: O0 + oO0o % Oo0Ooo
 iI1iI = "(proto 2) or "
 if 100 - 100: ooOoO0o / ooOoO0o - OOooOOo % OOooOOo * oO0o / IiII
 iI1iI += "((dst host "
 for IIIIIIi in lisp . lisp_get_all_addresses ( ) + o0Ooo0o0Oo :
  iI1iI += "{} or " . format ( IIIIIIi )
  if 59 - 59: oO0o / I1IiiI * Ii1I % O0 - II111iiii + OoooooooOO
 iI1iI = iI1iI [ 0 : - 4 ]
 iI1iI += ") and ((udp dst port 4341 or 8472 or 4789) or "
 iI1iI += "(udp src port 4341) or "
 iI1iI += "(udp dst port 4342 and ip[28] == 0x12) or "
 iI1iI += "(proto 17 and (ip[6]&0xe0 == 0x20 or " + "(ip[6]&0xe0 == 0 and ip[7] != 0)))))"
 if 21 - 21: I1Ii111
 if 60 - 60: I1IiiI % oO0o / o0oOOo0O0Ooo % oO0o * i11iIiiIii / iII111i
 lisp . lprint ( "Capturing packets for: '{}' on device {}" . format ( iI1iI ,
 iIi1Ii ) )
 oOoO . filter = iI1iI
 ...
 oOoO . loop ( - 1 , i1II11Iii1I , [ iIi1Ii , i1 ] )
 return
...
def II1i ( ipc ) :
 ...
 iIIIIiiIii = ipc [ 1 ]
 o0Oo00oOO = ipc [ 2 ]
 if ( o0Oo00oOO == "None" ) : o0Oo00oOO = None
 ...
 I1IIIiI1I1ii1 = None
 if ( O0oOoOO . dynamic_eids . has_key ( iIIIIiiIii ) ) : I1IIIiI1I1ii1 = O0oOoOO . dynamic_eids [ iIIIIiiIii ]
 if 50 - 50: i11iIiiIii - OoooooooOO . oO0o + O0 . i1IIi
 if ( I1IIIiI1I1ii1 == None and o0Oo00oOO == None ) :
  ...
  if 92 - 92: OoO0O00
 if ( I1IIIiI1I1ii1 and o0Oo00oOO ) :
  if ( I1IIIiI1I1ii1 . interface == o0Oo00oOO ) :
   lisp . lprint ( "ITR sent redundant IPC for {}" . format ( lisp . green ( iIIIIiiIii , False ) ) )
   if 15 - 15: IiII / IiII + iIii1I11I1II1 % OoooooooOO
  else :
   lisp . lprint ( "Dynamic-EID {} interface change, {} -> {}" . format ( lisp . green ( iIIIIiiIii , False ) , I1IIIiI1I1ii1 . interface , o0Oo00oOO ) )
   if 12 - 12: ooOoO0o
   I1IIIiI1I1ii1 . interface = o0Oo00oOO
 ...
 if ( o0Oo00oOO ) :
  ...
  I1IIIiI1I1ii1 . interface = o0Oo00oOO
  I1IIIiI1I1ii1 . get_timeout ( o0Oo00oOO )
  O0oOoOO . dynamic_eids [ iIIIIiiIii ] = I1IIIiI1I1ii1
  if 80 - 80: OOooOOo % OoO0O00 / OoOoOO00
  OOOOO000oo0 = lisp . bold ( "Registering" , False )
  iIIIIiiIii = lisp . bold ( iIIIIiiIii , False )
  lisp . lprint ( "{} dynamic-EID {} on interface {}, timeout {}" . format ( OOOOO000oo0 ,
 lisp . green ( iIIIIiiIii , False ) , o0Oo00oOO , I1IIIiI1I1ii1 . timeout ) )
  if 2 - 2: I1Ii111 * I1IiiI . IiII * iII111i
  i1iiI11I ( o0oOoO00o , None , i1OO0oOOoo , None , False )
  if 30 - 30: IiII
  if 98 - 98: iII111i / iIii1I11I1II1 . I11i * i11iIiiIii + Oo0Ooo * I11i
  if 67 - 67: iII111i
  if 88 - 88: Oo0Ooo
  if ( lisp . lisp_is_macos ( ) == False ) :
   iIIIIiiIii = i1OO0oOOoo . print_prefix_no_iid ( )
   i1ii111i = "ip route add {} dev {}" . format ( iIIIIiiIii , o0Oo00oOO )
   os . system ( i1ii111i )
 ...
 if ( O0oOoOO . dynamic_eids . has_key ( iIIIIiiIii ) ) :
  o0Oo00oOO = O0oOoOO . dynamic_eids [ iIIIIiiIii ] . interface
  O0oo0oOo = lisp . bold ( "Deregistering" , False )
  lisp . lprint ( "{} dynamic-EID {}" . format ( O0oo0oOo ,
 lisp . green ( iIIIIiiIii , False ) ) )
  ...
  if ( lisp . lisp_is_macos ( ) == False ) :
   iIIIIiiIii = i1OO0oOOoo . print_prefix_no_iid ( )
   i1ii111i = "ip route delete {} dev {}" . format ( iIIIIiiIii , o0Oo00oOO )
   os . system ( i1ii111i )
...
def i1I1i1i1I1 ( ipc ) :
 ...
 Ii1Ii1 , o0OOOooo0OOo , o00ooo0 = ipc . split ( "%" )
 if ( lisp . lisp_rtr_list . has_key ( o0OOOooo0OOo ) == False ) : return
 if 62 - 62: I1Ii111 * I11i
 lisp . lprint ( "Process ITR IPC message, RTR {} has gone {}" . format (
 lisp . red ( o0OOOooo0OOo , False ) , lisp . bold ( o00ooo0 , False ) ) )
 ...
 if 47 - 47: ooOoO0o
def o00oOoo0o00 ( ipc ) :
 iIiiI11II11i , Ii1Ii1 , o00OoO0o0 , o0O = ipc . split ( "%" )
 o0O = int ( o0O , 16 )
 if 64 - 64: oO0o * I1ii11iIi11i / i1IIi * OoO0O00 . oO0o
 o0oO0oOOOo = lisp . lisp_get_echo_nonce ( None , o00OoO0o0 )
 if ( o0oO0oOOOo == None ) : o0oO0oOOOo = lisp . lisp_echo_nonce ( o00OoO0o0 )
 if 90 - 90: i1IIi - Ii1I
 if ( Ii1Ii1 == "R" ) :
  o0oO0oOOOo . request_nonce_sent = o0O
  lisp . lprint ( "Waiting for echo-nonce 0x{} from {}" . format ( lisp . lisp_hex_string ( o0O ) , lisp . red ( o0oO0oOOOo . rloc_str , False ) ) )
  if 79 - 79: II111iiii - oO0o * I1ii11iIi11i - OoOoOO00 . I1ii11iIi11i
 elif ( Ii1Ii1 == "E" ) :
  o0oO0oOOOo . echo_nonce_sent = o0O
  lisp . lprint ( "Sent echo-nonce 0x{} to {}" . format ( lisp . lisp_hex_string ( o0O ) , lisp . red ( o0oO0oOOOo . rloc_str , False ) ) )
...
while ( True ) :
 try : iiiiii1Ii , I1111i , iIiiI11II11i = select . select ( oO00oOoo00o0 , [ ] , [ ] )
 except : break
 if 79 - 79: I1Ii111
 ...
 if ( Oo in iiiiii1Ii ) :
  Ii1Ii1 , ooooooo00o , Iiii1iiiIiI1 , OooOOOOoO00OoOO = lisp . lisp_receive ( Oo , False )
  if 74 - 74: II111iiii / O0
  if ( ooooooo00o == "" ) : break
  if 56 - 56: I11i - O0 / O0 * i1IIi . OoooooooOO % iIii1I11I1II1
  if ( Iiii1iiiIiI1 == lisp . LISP_DATA_PORT ) :
   oO0O ( i1 , OooOOOOoO00OoOO , ooooooo00o )
  else :
   if ( lisp . lisp_is_rloc_probe_request ( OooOOOOoO00OoOO [ 0 ] ) ) :
    lisp . lprint ( "ETR ignoring RLOC-probe request, using pcap" )
    continue
    if 21 - 21: IiII - I1IiiI % OoooooooOO + o0oOOo0O0Ooo
   o00O0o = lisp . lisp_parse_packet ( o0oOoO00o , OooOOOOoO00OoOO ,
 ...
 if ( Ooo in iiiiii1Ii ) :
  Ii1Ii1 , ooooooo00o , Iiii1iiiIiI1 , OooOOOOoO00OoOO = lisp . lisp_receive ( Ooo , True )
 ...
 Ii1Ii1 , OooOOOOoO00OoOO , "lisp-etr" , [ i11i ] )
