...
def lisp_process_map_register ( lisp_sockets , packet , source , sport ) :
 ...
 oOOOO0ooo . registered ) :
  ...
  oOOOO0ooo . auth_sha1_or_sha2 = o00o
  oOOOO0ooo . proxy_reply_requested = IiiI1iI1i1 . proxy_reply_requested
  oOOOO0ooo . lisp_sec_present = IiiI1iI1i1 . lisp_sec_present
  oOOOO0ooo . map_notify_requested = IiiI1iI1i1 . map_notify_requested
  oOOOO0ooo . mobile_node_requested = IiiI1iI1i1 . mobile_node
  oOOOO0ooo . merge_register_requested = IiiI1iI1i1 . merge_register_requested
  if 73 - 73: oO0o + i1IIi + i11iIiiIii / I1ii11iIi11i
  oOOOO0ooo . use_register_ttl_requested = IiiI1iI1i1 . use_ttl_for_timeout
  ...
  oOOOO0ooo . xtr_id_present = IiiI1iI1i1 . xtr_id_present
  if ( oOOOO0ooo . xtr_id_present ) :
   oOOOO0ooo . xtr_id = IiiI1iI1i1 . xtr_id
   oOOOO0ooo . site_id = IiiI1iI1i1 . site_id
...
def lisp_send_map_register ( lisp_sockets , packet , map_register , ms ) :
 ...
 if ( lisp_decent_pull_xtr_configured ( ) ) :
  I1iIi111i = ", decent-index {}" . format ( bold ( ms . dns_name , False ) )
  if 62 - 62: II111iiii + ooOoO0o + I1IiiI
  if 70 - 70: o0oOOo0O0Ooo + Ii1I . OoO0O00 * Ii1I + OOooOOo + ooOoO0o
 lprint ( "Send Map-Register to map-server {}{}{}" . format ( Ii1II1I11i1I . print_address ( ) , ", ms-name '{}'" . format ( ms . ms_name ) , I1iIi111i ) )
 if 13 - 13: I1ii11iIi11i
...
class lisp_cache ( ) :
 ...
 def lookup_cache ( self , prefix , exact ) :
  i1OO0OO0oO0o000 , o0Oo = self . build_key ( prefix )
  if ( exact ) :
   if ( self . cache . has_key ( i1OO0OO0oO0o000 ) == False ) : return ( None )
   if ( self . cache [ i1OO0OO0oO0o000 ] . entries . has_key ( o0Oo ) == False ) : return ( None )
   return ( self . cache [ i1OO0OO0oO0o000 ] . entries [ o0Oo ] )
  ...
  for iiIi in self . cache_sorted :
   if ( i1OO0OO0oO0o000 < iiIi ) : return ( ooOoOO0o )
 ...
 def walk_cache ( self , function , parms ) :
  for iiIi in self . cache_sorted :
   for i1ii1i1Ii11 in self . cache [ iiIi ] . entries . values ( ) :
    iIiIi1iiII1I , parms = function ( i1ii1i1Ii11 , parms )
    if ( iIiIi1iiII1I == False ) : return ( parms )
...
def lisp_referral_cache_lookup ( eid , group , exact ) :
 ...
 ooOo0Oo0OOo = IiII111IiII1 . lookup_source_cache ( eid , exact )
 if ( ooOo0Oo0OOo ) : return ( ooOo0Oo0OOo )
...
def lisp_ddt_cache_lookup ( eid , group , exact ) :
 ...
 I1i11 = O0oo0OoOO . lookup_source_cache ( eid , exact )
 if ( I1i11 ) : return ( I1i11 )
...
class lisp_address ( ) :
 ...
 def is_private_address ( self ) :
  ...
  if ( ( ( o0o00O0oOooO0 & 0xff000000 ) >> 24 ) == 172 ) :
   i1IIIii111 = ( o0o00O0oOooO0 & 0x00ff0000 ) >> 16
   if ( i1IIIii111 >= 16 and i1IIIii111 <= 31 ) : return ( True )
 ...
 def pack_address ( self ) :
  ...
  if ( self . is_ipv4 ( ) ) :
   ...
   OOo00OoOOOOO0 = o0o00O0oOooO0 & 0xffff
   IiiiIi1iiii11 = struct . pack ( O0O00Oo , ooOo0O0 , ooo0 , OOo00OoOOOOO0 )
  elif ( self . is_e164 ( ) ) :
   o0o00O0oOooO0 = self . address
  ...
  return ( IiiiIi1iiii11 )
  if 20 - 20: O0 + i1IIi % OoooooooOO % OoooooooOO
 ...
 def unpack_address ( self , packet ) :
  ...
  if ( self . is_ipv4 ( ) ) :
   ...
   if ( o0o00O0oOooO0 [ 0 ] <= 0xffff and ( o0o00O0oOooO0 [ 0 ] & 0xff ) == 0 ) :
    O0OoiI11Ii = ( o0o00O0oOooO0 [ 0 ] << 48 ) << 64
   else :
    O0OoiI11Ii = byte_swap_64 ( o0o00O0oOooO0 [ 0 ] ) << 64
    if 58 - 58: i11iIiiIii
   iIi11I11I = byte_swap_64 ( o0o00O0oOooO0 [ 1 ] )
   self . address = O0OoiI11Ii | iIi11I11I
   if 3 - 3: OoO0O00
  elif ( self . is_mac ( ) ) :
   oO0o00oO000oO = o0o00O0oOooO0 [ 0 ]
   IIi1 = o0o00O0oOooO0 [ 1 ]
   oO0oOOOOOOoOO = o0o00O0oOooO0 [ 2 ]
   self . address = ( oO0o00oO000oO << 32 ) + ( IIi1 << 16 ) + oO0oOOOOOOoOO
 ...
 def store_address ( self , addr_str ) :
  ...
  if ( self . is_ipv4 ( ) ) :
   OOOoO0Oo = addr_str . split ( "." )
   Oo00OO0OO = int ( OOOoO0Oo [ 0 ] ) << 24
   Oo00OO0OO += int ( OOOoO0Oo [ 1 ] ) << 16
   Oo00OO0OO += int ( OOOoO0Oo [ 2 ] ) << 8
   Oo00OO0OO += int ( OOOoO0Oo [ 3 ] )
 ...
 def zero_host_bits ( self ) :
  ...
  iIiiii = ( 2 ** self . mask_len ) - 1
  i11Iiii1iiiii = self . addr_length ( ) * 8 - self . mask_len
  iIiiii <<= i11Iiii1iiiii
  self . address &= iIiiii
  if 35 - 35: iII111i * I1IiiI
  if 67 - 67: iIii1I11I1II1 - o0oOOo0O0Ooo - IiII - O0
 def is_geo_string ( self , addr_str ) :
  ...
  oOoo0ooOOOO0o = len ( I1Ii1i111I )
  if ( oOoo0ooOOOO0o < 8 or oOoo0ooOOOO0o > 9 ) : return ( False )
  if 98 - 98: OoOoOO00 . OoooooooOO * II111iiii % iII111i % i11iIiiIii / I1IiiI
  for IIIiiIiI in range ( 0 , oOoo0ooOOOO0o ) :
   if ( IIIiiIiI == 3 ) :
    if ( I1Ii1i111I [ IIIiiIiI ] in [ "N" , "S" ] ) : continue
    return ( False )
    if 45 - 45: iII111i . oO0o * iII111i
   if ( IIIiiIiI == 7 ) :
    if ( I1Ii1i111I [ IIIiiIiI ] in [ "W" , "E" ] ) : continue
    return ( False )
    if 3 - 3: OoOoOO00 / Oo0Ooo - Oo0Ooo
   if ( I1Ii1i111I [ IIIiiIiI ] . isdigit ( ) == False ) : return ( False )
 ...
 def print_address_no_iid ( self ) :
  if ( self . is_ipv4 ( ) ) :
   o0o00O0oOooO0 = self . address
   iIi1I = o0o00O0oOooO0 >> 24
   ooO0o00Oo = ( o0o00O0oOooO0 >> 16 ) & 0xff
   Oooo0O0Oo0 = ( o0o00O0oOooO0 >> 8 ) & 0xff
   O00000OO0O00O = o0o00O0oOooO0 & 0xff
   return ( "{}.{}.{}.{}" . format ( iIi1I , ooO0o00Oo , Oooo0O0Oo0 , O00000OO0O00O ) )
  elif ( self . is_ipv6 ( ) ) :
 ...
 def print_prefix ( self ) :
  ...
  if ( self . is_iid_range ( ) ) :
   ...
   ii1iII1iIII1II1 = self . instance_id + ( 2 ** ( 32 - self . mask_len ) - 1 )
   return ( "[{}-{}]" . format ( self . instance_id , ii1iII1iIII1II1 ) )
 ...
 def print_sg ( self , g ) :
  ...
  iI1iiI = OO0o0OO0 . find ( "]" ) + 1
  g = g . print_prefix ( )
  iiiI11i1II = g . find ( "]" ) + 1
  iii1IIiI = "[{}]({}, {})" . format ( self . instance_id , OO0o0OO0 [ iI1iiI : : ] , g [ iiiI11i1II : : ] )
  return ( iii1IIiI )
  if 98 - 98: OoooooooOO % i11iIiiIii * II111iiii . i1IIi / ooOoO0o
 ...
 def is_more_specific ( self , prefix ) :
  ...
  if ( prefix . afi == LISP_AFI_IID_RANGE ) :
   II1iiiIiiI = 2 ** ( 32 - oO00OO0Ooo00O )
   i1II1II1i1i = prefix . instance_id
   ii1iII1iIII1II1 = i1II1II1i1i + II1iiiIiiI
   return ( self . instance_id in range ( i1II1II1i1i , ii1iII1iIII1II1 ) )
   if 27 - 27: Oo0Ooo
  ...
  if ( self . is_binary ( ) == False ) :
   ...
   o0o00O0oOooO0 = self . address
   ooOOoOoooOO0o = prefix . address
   if ( self . is_geo_prefix ( ) ) :
    o0o00O0oOooO0 = self . address . print_geo ( )
    ooOOoOoooOO0o = prefix . address . print_geo ( )
    if 14 - 14: Ii1I + OoooooooOO - I1Ii111 + I1Ii111 % IiII % OoooooooOO
   if ( len ( o0o00O0oOooO0 ) < len ( ooOOoOoooOO0o ) ) : return ( False )
   return ( o0o00O0oOooO0 . find ( ooOOoOoooOO0o ) == 0 )
  ...
  i11Iiii1iiiii = ( prefix . addr_length ( ) * 8 ) - oO00OO0Ooo00O
  iIiiii = ( 2 ** oO00OO0Ooo00O - 1 ) << i11Iiii1iiiii
  return ( ( self . address & iIiiii ) == prefix . address )
  if 4 - 4: IiII * OoO0O00 % I1ii11iIi11i * Ii1I . iII111i
  if 41 - 41: OoooooooOO % I11i . O0 + I1Ii111
 def mask_address ( self , mask_len ) :
  i11Iiii1iiiii = ( self . addr_length ( ) * 8 ) - mask_len
  iIiiii = ( 2 ** mask_len - 1 ) << i11Iiii1iiiii
  self . address &= iIiiii
  if 67 - 67: OoOoOO00 * OOooOOo / OOooOOo / OoooooooOO
  if 67 - 67: I11i - i1IIi . OoooooooOO / iIii1I11I1II1
 def is_exact_match ( self , prefix ) :
  if ( self . instance_id != prefix . instance_id ) : return ( False )
  iIiIiiIiIiiiI = self . print_prefix ( )
  i1i11i1Iii = prefix . print_prefix ( ) if prefix else ""
  return ( iIiIiiIiIiiiI == i1i11i1Iii )
  if 11 - 11: I11i * Ii1I * I1IiiI - I1IiiI % OoooooooOO
  if 83 - 83: i11iIiiIii % iII111i * O0 % OoooooooOO
 def is_local ( self ) :
  if ( self . is_ipv4 ( ) ) :
   OO0O00OO0OO = lisp_myrlocs [ 0 ]
   if ( OO0O00OO0OO == None ) : return ( False )
   OO0O00OO0OO = OO0O00OO0OO . print_address_no_iid ( )
   return ( self . print_address_no_iid ( ) == OO0O00OO0OO )
   if 58 - 58: i11iIiiIii
  if ( self . is_ipv6 ( ) ) :
   OO0O00OO0OO = lisp_myrlocs [ 1 ]
   if ( OO0O00OO0OO == None ) : return ( False )
   OO0O00OO0OO = OO0O00OO0OO . print_address_no_iid ( )
   return ( self . print_address_no_iid ( ) == OO0O00OO0OO )
 ...
 def lcaf_encode_iid ( self ) :
  ...
  I1ii1iiI1I1I1 = struct . pack ( "BBBBH" , 0 , 0 , OOOoooO000O0 , iiIi , IiIi11 )
  I1ii1iiI1I1I1 += struct . pack ( "IH" , socket . htonl ( IiIIi11i111 ) , socket . htons ( IiiiII ) )
  if ( IiiiII == 0 ) : return ( I1ii1iiI1I1I1 )
  if 56 - 56: OoooooooOO * o0oOOo0O0Ooo
  if ( self . afi == LISP_AFI_GEO_COORD ) :
   I1ii1iiI1I1I1 = I1ii1iiI1I1I1 [ 0 : - 2 ]
   I1ii1iiI1I1I1 += self . address . encode_geo ( )
   return ( I1ii1iiI1I1I1 )
   if 42 - 42: Oo0Ooo
   if 97 - 97: IiII / IiII . iII111i * O0 + II111iiii
  I1ii1iiI1I1I1 += self . pack_address ( )
  return ( I1ii1iiI1I1I1 )
 ...
 def lcaf_decode_iid ( self , packet ) :
  ...
  if ( len ( packet ) < IiIii1i ) : return ( None )
  if 80 - 80: OOooOOo
  oOo0oo , IIIi1i1iIIIi , OOOoooO000O0 , I1iI , oOOoO0O = struct . unpack ( O0O00Oo ,
 packet [ : IiIii1i ] )
  packet = packet [ IiIii1i : : ]
  if 74 - 74: OoO0O00 - i1IIi - iIii1I11I1II1 - ooOoO0o
  if ( OOOoooO000O0 != LISP_LCAF_INSTANCE_ID_TYPE ) : return ( None )
  if 13 - 13: oO0o . ooOoO0o / iII111i % Ii1I
  O0O00Oo = "IH"
  IiIii1i = struct . calcsize ( O0O00Oo )
  if ( len ( packet ) < IiIii1i ) : return ( None )
  if 91 - 91: OoooooooOO . I1IiiI . O0 . Oo0Ooo % O0
  IiIIi11i111 , IiiiII = struct . unpack ( O0O00Oo , packet [ : IiIii1i ] )
  packet = packet [ IiIii1i : : ]
  if 22 - 22: O0 - I1ii11iIi11i % o0oOOo0O0Ooo - OOooOOo
  oOOoO0O = socket . ntohs ( oOOoO0O )
  self . instance_id = socket . ntohl ( IiIIi11i111 )
  IiiiII = socket . ntohs ( IiiiII )
  self . afi = IiiiII
  if ( I1iI != 0 and IiiiII == 0 ) : self . mask_len = I1iI
  if ( IiiiII == 0 ) :
   self . afi = LISP_AFI_IID_RANGE if I1iI else LISP_AFI_ULTIMATE_ROOT
   if 100 - 100: OOooOOo
   if 20 - 20: I1IiiI * Ii1I
   if 99 - 99: I1ii11iIi11i
   if 45 - 45: I11i
   if 77 - 77: I1Ii111 . oO0o . OoO0O00
  if ( IiiiII == 0 ) : return ( packet )
  if 76 - 76: IiII * O0
  if 26 - 26: II111iiii % OoOoOO00 . IiII % ooOoO0o
  if 91 - 91: ooOoO0o - Ii1I % OoooooooOO . OOooOOo + i11iIiiIii + OoOoOO00
 ...
 def lcaf_encode_sg ( self , group ) :
  ...
  IiIi11 = socket . htons ( self . lcaf_length ( OOOoooO000O0 ) )
  I1ii1iiI1I1I1 = struct . pack ( "BBBBHIHBB" , 0 , 0 , OOOoooO000O0 , 0 , IiIi11 , IiIIi11i111 ,
 0 , self . mask_len , group . mask_len )
  if 63 - 63: OoooooooOO % ooOoO0o
  I1ii1iiI1I1I1 += struct . pack ( "H" , socket . htons ( self . afi ) )
  I1ii1iiI1I1I1 += self . pack_address ( )
  I1ii1iiI1I1I1 += struct . pack ( "H" , socket . htons ( group . afi ) )
  I1ii1iiI1I1I1 += group . pack_address ( )
  return ( I1ii1iiI1I1I1 )
  if 26 - 26: OOooOOo + Oo0Ooo
 ...
 def lcaf_decode_sg ( self , packet ) :
  ...
  oOo0oo , IIIi1i1iIIIi , OOOoooO000O0 , iI111iiI1II , oOOoO0O , IiIIi11i111 , Iii1iIIIiI , I111i , iIiiIi111i11 = struct . unpack ( O0O00Oo , packet [ : IiIii1i ] )
  if 79 - 79: OoO0O00
  packet = packet [ IiIii1i : : ]
  if 8 - 8: OoooooooOO * I11i
  ...
  OOo0oOOO0 . mask_len = iIiiIi111i11
...
class lisp_elp ( ) :
  ...
  for IIii in self . elp_nodes :
   ...
   if ( want_marker ) :
    if ( IIii == self . use_elp_node ) :
     ...
     if 10 - 10: i1IIi
   OoOiIIiI += "{}{}({}{}{}), " . format ( ii1io0O0oO0oOO ,
 ...
 def select_elp_node ( self ) :
  iI1O0OOOo , IIi1IIii1I , OoO0o0OOOO = lisp_myrlocs
  ooo = None
  if 24 - 24: Ii1I
  for IIii in self . elp_nodes :
   if ( iI1O0OOOo and IIii . address . is_exact_match ( iI1O0OOOo ) ) :
    ooo = self . elp_nodes . index ( IIii )
    break
    if 39 - 39: O0 % Ii1I
   if ( IIi1IIii1I and IIii . address . is_exact_match ( IIi1IIii1I ) ) :
    ooo = self . elp_nodes . index ( IIii )
    break
...
class lisp_geo ( ) :
 ...
 def parse_geo_string ( self , geo_str ) :
  ...
  if ( geo_str . find ( "/" ) != - 1 ) :
   geo_str , o0O0Oo0OO0OO = geo_str . split ( "/" )
   self . radius = int ( o0O0Oo0OO0OO )
   if 97 - 97: I1IiiI * I1ii11iIi11i - oO0o + oO0o
  ...
  I1IiIi = geo_str [ 0 : 4 ]
  OO000oOO = geo_str [ 4 : 8 ]
  if 7 - 7: o0oOOo0O0Ooo
  if 84 - 84: iII111i * IiII % oO0o - Oo0Ooo
  if 41 - 41: O0 / oO0o . Ii1I * OoO0O00
  if 77 - 77: I1IiiI - Ii1I / IiII
  if ( len ( geo_str ) > 8 ) : self . altitude = int ( geo_str [ 8 ] )
  if 88 - 88: Ii1I % IiII - O0 % OOooOOo % OOooOOo
  if 18 - 18: iII111i . i1IIi + OoOoOO00 + iIii1I11I1II1 - I1Ii111
  if 25 - 25: ooOoO0o
  if 87 - 87: iII111i - OoO0O00 . Ii1I / ooOoO0o
  self . latitude = int ( I1IiIi [ 0 ] )
  self . lat_mins = int ( I1IiIi [ 1 ] )
  self . lat_secs = int ( I1IiIi [ 2 ] )
  if ( I1IiIi [ 3 ] == "N" ) : self . latitude = - self . latitude
  if 88 - 88: O0 % OOooOOo . iII111i
  if 40 - 40: O0 . Ii1I % IiII % I1ii11iIi11i - OoOoOO00
  if 94 - 94: I1IiiI . I1Ii111
  if 37 - 37: i1IIi - O0
  self . longitude = int ( OO000oOO [ 0 ] )
  self . long_mins = int ( OO000oOO [ 1 ] )
  self . long_secs = int ( OO000oOO [ 2 ] )
  if ( OO000oOO [ 3 ] == "E" ) : self . longitude = - self . longitude
  return ( True )
  if 36 - 36: I1Ii111 . OoooooooOO - i1IIi % iII111i - II111iiii * i11iIiiIii
  if 90 - 90: OoOoOO00 % iII111i - Oo0Ooo
 def print_geo ( self ) :
  IIiiO0oO0000OOo0O = "N" if self . latitude < 0 else "S"
  ooo00 = "E" if self . longitude < 0 else "W"
  if 69 - 69: I1ii11iIi11i
  I1i1iiIII1i1 = "{}-{}-{}-{}-{}-{}-{}-{}" . format ( abs ( self . latitude ) ,
 self . lat_mins , self . lat_secs , IIiiO0oO0000OOo0O , abs ( self . longitude ) ,
 self . long_mins , self . long_secs , ooo00 )
 ...
 def geo_url ( self ) :
  O0ooOo0o0oo0O = os . getenv ( "LISP_GEO_ZOOM_LEVEL" )
  O0ooOo0o0oo0O = "10" if ( O0ooOo0o0oo0O == "" or O0ooOo0o0oo0O . isdigit ( ) == False ) else O0ooOo0o0oo0O
  i1IiiiIIIIIi1 , iIiiII = self . dms_to_decimal ( )
  OoOIiiIIIii1I = ( "http://maps.googleapis.com/maps/api/staticmap?center={},{}" + "&markers=color:blue%7Clabel:lisp%7C{},{}" + "&zoom={}&size=1024x1024&sensor=false" ) . format ( i1IiiiIIIIIi1 , iIiiII , i1IiiiIIIIIi1 , iIiiII ,
  # oO0o
  # Oo0Ooo + i1IIi + OoooooooOO % o0oOOo0O0Ooo
 O0ooOo0o0oo0O )
  return ( OoOIiiIIIii1I )
  if 4 - 4: I1IiiI
  if 74 - 74: oO0o / i11iIiiIii + Oo0Ooo
 def print_geo_url ( self ) :
  I1Ii1i111I = self . print_geo ( )
  if ( self . radius == 0 ) :
   OoOIiiIIIii1I = self . geo_url ( )
   O0ooo = "<a href='{}'>{}</a>" . format ( OoOIiiIIIii1I , I1Ii1i111I )
  else :
   OoOIiiIIIii1I = I1Ii1i111I . replace ( "/" , "-" )
   O0ooo = "<a href='/lisp/geo-map/{}'>{}</a>" . format ( OoOIiiIIIii1I , I1Ii1i111I )
 ...
 def dms_to_decimal ( self ) :
  iiIIII1I1ii , O0ooI11Ii1 , oO000 = self . latitude , self . lat_mins , self . lat_secs
  OOo0oOOO0oOOOOoOO0Oo = float ( abs ( iiIIII1I1ii ) )
  OOo0oOOO0oOOOOoOO0Oo += float ( O0ooI11Ii1 * 60 + oO000 ) / 3600
  if ( iiIIII1I1ii > 0 ) : OOo0oOOO0oOOOOoOO0Oo = - OOo0oOOO0oOOOOoOO0Oo
  OOO00O000O0OO = OOo0oOOO0oOOOOoOO0Oo
  if 96 - 96: Ii1I
  iiIIII1I1ii , O0ooI11Ii1 , oO000 = self . longitude , self . long_mins , self . long_secs
  OOo0oOOO0oOOOOoOO0Oo = float ( abs ( iiIIII1I1ii ) )
  OOo0oOOO0oOOOOoOO0Oo += float ( O0ooI11Ii1 * 60 + oO000 ) / 3600
  if ( iiIIII1I1ii > 0 ) : OOo0oOOO0oOOOOoOO0Oo = - OOo0oOOO0oOOOOoOO0Oo
  i1I11Ii111i = OOo0oOOO0oOOOOoOO0Oo
  return ( ( OOO00O000O0OO , i1I11Ii111i ) )
  if 40 - 40: OoO0O00 . i11iIiiIii
  if 36 - 36: o0oOOo0O0Ooo * iII111i / I1ii11iIi11i % i1IIi % I1ii11iIi11i + i11iIiiIii
 def get_distance ( self , geo_point ) :
  i1I1iIii111II1I11I = self . dms_to_decimal ( )
  IIiioo0oO0Ooooo0 = geo_point . dms_to_decimal ( )
  IiI1iI1I = vincenty ( i1I1iIii111II1I11I , IIiioo0oO0Ooooo0 )
  return ( IiI1iI1I . km )
  if 63 - 63: I11i
  if 42 - 42: OOooOOo * ooOoO0o / i1IIi . i11iIiiIii - oO0o - Ii1I
 def point_in_circle ( self , geo_point ) :
  iiii1ii = self . get_distance ( geo_point )
  return ( iiii1ii <= self . radius )
  if 25 - 25: IiII - I11i + IiII + iII111i + OoOoOO00 - Oo0Ooo
  if 31 - 31: iII111i . II111iiii - iIii1I11I1II1
 def encode_geo ( self ) :
  I1i = socket . htons ( LISP_AFI_LCAF )
  oOoo0ooOOOO0o = socket . htons ( 20 + 2 )
  O0OooO00O0 = 0
  if 38 - 38: ooOoO0o - IiII % OoO0O00 - i11iIiiIii
  i1IiiiIIIIIi1 = abs ( self . latitude )
  i1I1II = ( ( self . lat_mins * 60 ) + self . lat_secs ) * 1000
  if ( self . latitude < 0 ) : O0OooO00O0 |= 0x40
  if 24 - 24: oO0o
  iIiiII = abs ( self . longitude )
  ...
  OO0OOOo = 0
  if ( self . no_geo_altitude ( ) == False ) :
   OO0OOOo = socket . htonl ( self . altitude )
   O0OooO00O0 |= 0x10
   if 89 - 89: II111iiii
  o0O0Oo0OO0OO = socket . htons ( self . radius )
  if ( o0O0Oo0OO0OO != 0 ) : O0OooO00O0 |= 0x06
  if 41 - 41: iIii1I11I1II1
  iIIiI = struct . pack ( "HBBBBH" , I1i , 0 , 0 , LISP_LCAF_GEO_COORD_TYPE ,
 0 , oOoo0ooOOOO0o )
  iIIiI += struct . pack ( "BBHBBHBBHIHHH" , O0OooO00O0 , 0 , 0 , i1IiiiIIIIIi1 , i1I1II >> 16 ,
 socket . htons ( i1I1II & 0x0ffff ) , iIiiII , OoO00OoOo >> 16 ,
 socket . htons ( OoO00OoOo & 0xffff ) , OO0OOOo , o0O0Oo0OO0OO , 0 , 0 )
 ...
 def decode_geo ( self , packet , lcaf_len , radius_hi ) :
  ...
  O0OooO00O0 , Oooo0O , Ooi11I1i1IiI1i , i1IiiiIIIIIi1 , i1I , i1I1II , iIiiII , i11I , OoO00OoOo , OO0OOOo , o0O0Oo0OO0OO , I1iiiiII11 , IiiiII = struct . unpack ( O0O00Oo ,
  # II111iiii + II111iiii * O0 % Oo0Ooo / O0 * OOooOOo
 packet [ : IiIii1i ] )
  ...
  if ( IiiiII == LISP_AFI_LCAF ) : return ( None )
  if 91 - 91: OOooOOo
  if ( O0OooO00O0 & 0x40 ) : i1IiiiIIIIIi1 = - i1IiiiIIIIIi1
  self . latitude = i1IiiiIIIIIi1
  OoiI111i1I1i1 = ( ( i1I << 16 ) | socket . ntohs ( i1I1II ) ) / 1000
  self . lat_mins = OoiI111i1I1i1 / 60
  self . lat_secs = OoiI111i1I1i1 % 60
  if 31 - 31: o0oOOo0O0Ooo
  if ( O0OooO00O0 & 0x20 ) : iIiiII = - iIiiII
  self . longitude = iIiiII
  ooOOoOo0OOOOo = ( ( i11I << 16 ) | socket . ntohs ( OoO00OoOo ) ) / 1000
  self . long_mins = ooOOoOo0OOOOo / 60
  self . long_secs = ooOOoOo0OOOOo % 60
  if 59 - 59: O0 - Oo0Ooo - I1ii11iIi11i * O0
  self . altitude = socket . ntohl ( OO0OOOo ) if ( O0OooO00O0 & 0x10 ) else - 1
  o0O0Oo0OO0OO = socket . ntohs ( o0O0Oo0OO0OO )
  self . radius = o0O0Oo0OO0OO if ( O0OooO00O0 & 0x02 ) else o0O0Oo0OO0OO * 1000
  if 30 - 30: Ii1I - I11i
  self . geo_name = None
  packet = packet [ IiIii1i : : ]
  if 18 - 18: I1Ii111 * I11i . IiII . i11iIiiIii . Oo0Ooo - iIii1I11I1II1
  if ( IiiiII != 0 ) :
   self . rloc . afi = IiiiII
   packet = self . rloc . unpack_address ( packet )
   self . rloc . mask_len = self . rloc . host_mask_len ( )
   if 92 - 92: I1ii11iIi11i + O0 / Ii1I - OoO0O00 + OOooOOo
  return ( packet )
 ...
 def print_rle ( self , html , do_formatting ) :
  ...
  for IiioOoo in self . rle_nodes :
   ...
   if ( IiioOoo . rloc_name != None ) :
    Oo00OoO = IiioOoo . rloc_name
    if ( do_formatting ) : Oo00OoO = blue ( Oo00OoO , html )
    Oo00OoO = "({})" . format ( Oo00OoO )
    if 23 - 23: Ii1I * I1IiiI * ooOoO0o . ooOoO0o . iII111i
    if 38 - 38: OoooooooOO * IiII * i11iIiiIii - I1ii11iIi11i . OoOoOO00
   oo0o00OO = IiioOoo . address . print_address_no_iid ( )
   if ( IiioOoo . address . is_local ( ) ) : oo0o00OO = red ( oo0o00OO , html )
   oOOOO0o000OoO += "{}{}{}, " . format ( oo0o00OO , "" if Oo0o == 0 else ":" + str ( Oo0o ) , Oo00OoO )
   if 71 - 71: i1IIi . i11iIiiIii . OoOoOO00 . i11iIiiIii % I1ii11iIi11i % Oo0Ooo
...
class lisp_json ( ) :
 ...
 def print_json ( self , html ) :
  OO0OO0 = self . json_string
  IiiiIi = "***"
  if ( html ) : IiiiIi = red ( IiiiIi , html )
  oO0OoOOOoO = IiiiIi + self . json_string + IiiiIi
  if ( self . valid_json ( ) ) : return ( OO0OO0 )
  return ( oO0OoOOOoO )
  if 48 - 48: OoO0O00
 ...
 def encrypt_json ( self ) :
  ...
  IIIIIiII1iI = json . loads ( self . json_string )
  for o0Oo in IIIIIiII1iI :
   Oo00OO0OO = IIIIIiII1iI [ o0Oo ]
   if ( type ( Oo00OO0OO ) != str ) : Oo00OO0OO = str ( Oo00OO0OO )
   Oo00OO0OO = chacha . ChaCha ( II11iI11i1 , OO000OOOo0Oo ) . encrypt ( Oo00OO0OO )
   IIIIIiII1iI [ o0Oo ] = binascii . hexlify ( Oo00OO0OO )
   if 39 - 39: OoOoOO00 - I11i / i11iIiiIii . Ii1I * OoOoOO00 - II111iiii
  self . json_string = json . dumps ( IIIIIiII1iI )
 ...
 def decrypt_json ( self ) :
  ...
  IIIIIiII1iI = json . loads ( self . json_string )
  for o0Oo in IIIIIiII1iI :
   Oo00OO0OO = binascii . unhexlify ( IIIIIiII1iI [ o0Oo ] )
   IIIIIiII1iI [ o0Oo ] = chacha . ChaCha ( II11iI11i1 , OO000OOOo0Oo ) . encrypt ( Oo00OO0OO )
...
class lisp_stats ( ) :
 ...
 def get_stats ( self , summary , html ) :
  i1i111I = self . last_rate_check
  IiIIOo = self . last_packet_count
  O0O0O = self . last_byte_count
  self . last_rate_check = lisp_get_timestamp ( )
  self . last_packet_count = self . packet_count
  self . last_byte_count = self . byte_count
  if 74 - 74: iII111i / OoOoOO00
  oO0OoO0oo0 = self . last_rate_check - i1i111I
  if ( oO0OoO0oo0 == 0 ) :
   o0O000Oooooo = 0
   i111II111iIi = 0
  else :
   o0O000Oooooo = int ( ( self . packet_count - IiIIOo ) / oO0OoO0oo0 )
   i111II111iIi = ( self . byte_count - O0O0O ) / oO0OoO0oo0
   i111II111iIi = ( i111II111iIi * 8 ) / 1000000
   i111II111iIi = round ( i111II111iIi , 2 )
   ...
   if 33 - 33: ooOoO0o
  i1111111II = self . normalize ( self . packet_count )
  ...
  if ( summary ) :
   i11I1i = "<br>" if html else ""
   i1111111II , ooooo0o0 = self . stat_colors ( i1111111II , ooooo0o0 , html )
   III1IiiiIii = "packet-count: {}{}byte-count: {}" . format ( i1111111II , i11I1i , ooooo0o0 )
   ii = "packet-rate: {} pps\nbit-rate: {} Mbps" . format ( o0O000Oooooo , i111II111iIi )
   if 46 - 46: Oo0Ooo % i11iIiiIii * o0oOOo0O0Ooo
   if ( html != "" ) : ii = lisp_span ( III1IiiiIii , ii )
  else :
   II11111Iii1I = str ( o0O000Oooooo )
   OoOO000O = str ( i111II111iIi )
   if ( html ) :
    i1111111II = lisp_print_cour ( i1111111II )
    II11111Iii1I = lisp_print_cour ( II11111Iii1I )
    ooooo0o0 = lisp_print_cour ( ooooo0o0 )
    OoOO000O = lisp_print_cour ( OoOO000O )
    if 15 - 15: i11iIiiIii % I1ii11iIi11i - i11iIiiIii
   i11I1i = "<br>" if html else ", "
   if 68 - 68: ooOoO0o
   ii = ( "packet-count: {}{}packet-rate: {} pps{}byte-count: " + "{}{}bit-rate: {} mbps" ) . format ( i1111111II , i11I1i , II11111Iii1I , i11I1i , ooooo0o0 , i11I1i ,
   # OoooooooOO - Ii1I . OoooooooOO + o0oOOo0O0Ooo
 OoOO000O )
...
class lisp_rloc ( ) :
 def __init__ ( self , recurse = True ) :
  ...
  i1iIIiiI1iI1i = lisp_get_default_route_next_hops ( )
  if ( i1iIIiiI1iI1i == [ ] or len ( i1iIIiiI1iI1i ) == 1 ) : return
  if 37 - 37: OOooOOo - O0 / OoO0O00 * OoooooooOO - ooOoO0o
  self . rloc_next_hop = i1iIIiiI1iI1i [ 0 ]
  IiI1i11iiII = self
  for OoO0o0oOoOo in i1iIIiiI1iI1i [ 1 : : ] :
   ii1II = lisp_rloc ( False )
   ii1II = copy . deepcopy ( self )
   ii1II . rloc_next_hop = OoO0o0oOoOo
   IiI1i11iiII . next_rloc = ii1II
   IiI1i11iiII = ii1II
   if 43 - 43: OoO0O00 . IiII / OoooooooOO . Oo0Ooo + OOooOOo + ooOoO0o
   if 36 - 36: i1IIi . Ii1I % II111iiii / Ii1I + oO0o
   if 23 - 23: Ii1I + I11i / IiII
 def up_state ( self ) :
  return ( self . state == LISP_RLOC_UP_STATE )
  if 17 - 17: O0 % OOooOOo * Ii1I - ooOoO0o
  if 11 - 11: OoO0O00 - II111iiii . oO0o % OoOoOO00 * oO0o
 ...
 def store_rloc_from_record ( self , rloc_record , nonce , source ) :
  ...
  if ( I1II . is_null ( ) == False ) :
   iII1iiIiiii1I = lisp_get_nat_info ( I1II , self . rloc_name )
   if ( iII1iiIiiii1I ) :
    Oo0o = iII1iiIiiii1I . port
    oO00oo = lisp_nat_state_info [ self . rloc_name ] [ 0 ]
    oo0o00OO = I1II . print_address_no_iid ( )
    O0ooo0Ooo = red ( oo0o00OO , False )
    IIIiIII = "" if self . rloc_name == None else blue ( self . rloc_name , False )
    ...
    if ( iII1iiIiiii1I . timed_out ( ) ) :
     lprint ( ( "    Matched stored NAT state timed out for " + "RLOC {}:{}, {}" ) . format ( O0ooo0Ooo , Oo0o , IIIiIII ) )
     if 7 - 7: I1ii11iIi11i % OoOoOO00 - O0 . I1Ii111
     if 9 - 9: Ii1I . OoooooooOO / ooOoO0o + i1IIi
     iII1iiIiiii1I = None if ( iII1iiIiiii1I == oO00oo ) else oO00oo
     if ( iII1iiIiiii1I and iII1iiIiiii1I . timed_out ( ) ) :
      Oo0o = iII1iiIiiii1I . port
      O0ooo0Ooo = red ( iII1iiIiiii1I . address , False )
      lprint ( ( "    Youngest stored NAT state timed out " + " for RLOC {}:{}, {}" ) . format ( O0ooo0Ooo , Oo0o ,
      # oO0o + Ii1I - ooOoO0o + OoOoOO00 % OOooOOo - Oo0Ooo
 IIIiIII ) )
      iII1iiIiiii1I = None
    ...
    if ( iII1iiIiiii1I ) :
     if ( iII1iiIiiii1I . address != oo0o00OO ) :
      lprint ( "RLOC conflict, RLOC-record {}, NAT state {}" . format ( O0ooo0Ooo , red ( iII1iiIiiii1I . address , False ) ) )
      if 13 - 13: OoO0O00
      self . rloc . store_address ( iII1iiIiiii1I . address )
      if 56 - 56: OoOoOO00 . ooOoO0o * oO0o - I11i
     O0ooo0Ooo = red ( iII1iiIiiii1I . address , False )
     Oo0o = iII1iiIiiii1I . port
     lprint ( "    Use NAT translated RLOC {}:{} for {}" . format ( O0ooo0Ooo , Oo0o , IIIiIII ) )
  ...
  if ( self . rle ) :
   for IiioOoo in self . rle . rle_nodes :
    ...
    iII1iiIiiii1I = lisp_get_nat_info ( IiioOoo . address , IIiiI11iI )
    if ( iII1iiIiiii1I == None ) : continue
 ...
 rloc_record . probe_bit == False ) : self . state = LISP_RLOC_UP_STATE
  ...
  OooOOO00Oo0oo = source . is_exact_match ( rloc_record . rloc ) if source != None else None
  if 99 - 99: I1ii11iIi11i
  if ( rloc_record . keys != None and OooOOO00Oo0oo ) :
 ...
 def print_state_change ( self , new_state ) :
  O00oO0Ooo00O = self . print_state ( )
  O0ooo = "{} -> {}" . format ( O00oO0Ooo00O , new_state )
 ...
 def print_recent_rloc_probe_rtts ( self ) :
  Oo00oooOO00o0 = str ( self . recent_rloc_probe_rtts )
  Oo00oooOO00o0 = Oo00oooOO00o0 . replace ( "-1" , "?" )
 ...
 def compute_rloc_probe_rtt ( self ) :
  ...
  OoOo00ooo0O = self . recent_rloc_probe_rtts
  self . recent_rloc_probe_rtts = [ IiI1i11iiII ] + OoOo00ooo0O [ 0 : - 1 ]
 ...
 def store_rloc_probe_hops ( self , to_hops , from_ttl ) :
  ...
  if ( from_ttl < LISP_RLOC_PROBE_TTL / 2 ) :
   ...
   II1III1 = str ( LISP_RLOC_PROBE_TTL - from_ttl )
   if 88 - 88: OOooOOo . OoO0O00
   if 86 - 86: OoOoOO00 . o0oOOo0O0Ooo / ooOoO0o * I1IiiI . OoO0O00 / I1Ii111
  IiI1i11iiII = self . rloc_probe_hops
  self . rloc_probe_hops = to_hops + "/" + II1III1
  OoOo00ooo0O = self . recent_rloc_probe_hops
  self . recent_rloc_probe_hops = [ IiI1i11iiII ] + OoOo00ooo0O [ 0 : - 1 ]
 ...
 def store_rloc_probe_latencies ( self , json_telemetry ) :
  O00oo0 = lisp_decode_telemetry ( json_telemetry )
  if 94 - 94: II111iiii + OoooooooOO . i1IIi + OoO0O00 + OoOoOO00
  o0O00o000OOoO = round ( float ( O00oo0 [ "etr-in" ] ) - float ( O00oo0 [ "itr-out" ] ) , 3 )
  iiiI111ii = round ( float ( O00oo0 [ "itr-in" ] ) - float ( O00oo0 [ "etr-out" ] ) , 3 )
  if 88 - 88: I1Ii111 + I11i + I1Ii111 % OoO0O00 / I1ii11iIi11i - I11i
  IiI1i11iiII = self . rloc_probe_latency
  self . rloc_probe_latency = str ( o0O00o000OOoO ) + "/" + str ( iiiI111ii )
  OoOo00ooo0O = self . recent_rloc_probe_latencies
  self . recent_rloc_probe_latencies = [ IiI1i11iiII ] + OoOo00ooo0O [ 0 : - 1 ]
 ...
 def print_recent_rloc_probe_latencies ( self ) :
  O000O0o00o0o = str ( self . recent_rloc_probe_latencies )
  return ( O000O0o00o0o )
 ...
 def process_rloc_probe_reply ( self , ts , nonce , eid , group , hc , ttl , jt ) :
  ...
  OO00OoooOoO0 = I1II . print_state_change ( "up" )
  ...
  oo0o00OO = I1II . rloc . print_address_no_iid ( )
  o0oooOO0o = bold ( str ( I1II . print_rloc_probe_rtt ( ) ) , False )
  IiI1i1i1 = ":{}" . format ( self . translated_port ) if self . translated_port != 0 else ""
  if 10 - 10: Ii1I + I1IiiI . OoooooooOO / iIii1I11I1II1 - ooOoO0o
  OoO0o0oOoOo = ""
  if ( I1II . rloc_next_hop != None ) :
   o0 , OOOOoo00 = I1II . rloc_next_hop
   OoO0o0oOoOo = ", nh {}({})" . format ( OOOOoo00 , o0 )
   if 15 - 15: I11i
   if 23 - 23: Oo0Ooo - OoO0O00 . II111iiii
  i1IiiiIIIIIi1 = bold ( I1II . print_rloc_probe_latency ( ) , False )
  i1IiiiIIIIIi1 = ", latency {}" . format ( i1IiiiIIIIIi1 ) if jt else ""
  ...
  # I1Ii111 / o0oOOo0O0Ooo / II111iiii . o0oOOo0O0Ooo . Ii1I / I11i
 OO00OoooOoO0 , o0oooOO0o , OoO0o0oOoOo , str ( hc ) + "/" + str ( ttl ) , i1IiiiIIIIIi1 ) )
  ...
  while ( True ) :
   ...
   if 59 - 59: oO0o
   if ( iII1ii1 == None ) : iII1ii1 = I1II
   if ( I1II . rloc_probe_rtt < iII1ii1 . rloc_probe_rtt ) : iII1ii1 = I1II
   if 43 - 43: II111iiii - OoooooooOO
   if 11 - 11: I1IiiI
  if ( iII1ii1 != None ) :
   o0 , OOOOoo00 = iII1ii1 . rloc_next_hop
   OoO0o0oOoOo = bold ( "nh {}({})" . format ( OOOOoo00 , o0 ) , False )
   lprint ( "    Install host-route via best {}" . format ( OoO0o0oOoOo ) )
   lisp_install_host_route ( oo0o00OO , None , False )
   lisp_install_host_route ( oo0o00OO , OOOOoo00 , True )
 ...
 def delete_from_rloc_probe_list ( self , eid , group ) :
  ...
  for i1ii1i1Ii11 in lisp_rloc_probe_list [ oo0o00OO ] :
   ...
   ii1IO0 = i1ii1i1Ii11
   break
   if 76 - 76: OoooooooOO / O0 * OoOoOO00 . Oo0Ooo % IiII + Oo0Ooo
  if ( ii1IO0 == [ ] ) : return
  if 59 - 59: OoOoOO00 + O0 / I1IiiI % O0 / OoooooooOO * Ii1I
  try :
   lisp_rloc_probe_list [ oo0o00OO ] . remove ( ii1IO0 )
   if ( lisp_rloc_probe_list [ oo0o00OO ] == [ ] ) :
    lisp_rloc_probe_list . pop ( oo0o00OO )
 ...
 def print_rloc_probe_state ( self , trailing_linefeed ) :
  ...
  I1II = self
  while ( True ) :
   I111I1Ii = I1II . last_rloc_probe
   if ( I111I1Ii == None ) : I111I1Ii = 0
   I11Ii = I1II . last_rloc_probe_reply
   if ( I11Ii == None ) : I11Ii = 0
   o0oooOO0o = I1II . print_rloc_probe_rtt ( )
   OO0o0OO0 = space ( 4 )
   ...
   if ( I1II . rloc_next_hop == None ) :
    ...
    if 9 - 9: Ii1I
    if 13 - 13: O0
   oOOO += ( "{}RLOC-probe request sent: {}\n{}RLOC-probe reply " + "received: {}, rtt {}" ) . format ( OO0o0OO0 , lisp_print_elapsed ( I111I1Ii ) ,
   # Oo0Ooo - Oo0Ooo % O0 - Ii1I / o0oOOo0O0Ooo % Oo0Ooo
 OO0o0OO0 , lisp_print_elapsed ( I11Ii ) , o0oooOO0o )
...
class lisp_mapping ( ) :
 ...
 def refresh_multicast ( self ) :
  ...
  OooooOooo = ( Ooo0o0oo0 in [ 0 , 1 , 2 ] )
  if ( OooooOooo == False ) : return ( False )
  if 41 - 41: i11iIiiIii / ooOoO0o - Ii1I + I11i
  if 15 - 15: I1ii11iIi11i
  if 22 - 22: iIii1I11I1II1 - i1IIi - i11iIiiIii / I1IiiI + o0oOOo0O0Ooo
  if 56 - 56: I1IiiI . ooOoO0o
  IiII1I1I1i1 = ( ( time . time ( ) - self . last_multicast_map_request ) <= 2 )
  if ( IiII1I1I1i1 ) : return ( False )
 ...
 def has_ttl_elapsed ( self ) :
  ...
  Ii1IOo0Oo0oOoO = self . map_cache_ttl - ( self . map_cache_ttl / 10 )
  if ( Ooo0o0oo0 >= Ii1IOo0Oo0oOoO ) : return ( True )
  return ( False )
 ...
 def build_best_rloc_set ( self ) :
  iiI11i11iiiiI = self . best_rloc_set
  self . best_rloc_set = [ ]
  ...
  for I1II in self . rloc_set :
   if ( I1II . up_state ( ) ) : Ooo0O0OO0O00o = min ( I1II . priority , Ooo0O0OO0O00o )
   if 70 - 70: Oo0Ooo
   ...
   if 12 - 12: I1IiiI
  for I1II in self . rloc_set :
   if ( I1II . priority <= Ooo0O0OO0O00o ) :
    ...
    if 8 - 8: OoooooooOO
  for I1II in iiI11i11iiiiI :
   if ( I1II . priority < Ooo0O0OO0O00o ) : continue
   I1II . delete_from_rloc_probe_list ( self . eid , self . group )
 ...
 def select_rloc ( self , lisp_packet , ipc_socket ) :
  ...
  oO00OOoOOoO = lisp_packet . inner_version
  ...
  if ( lisp_data_plane_logging ) :
   ...
   for I1I111iIiI in self . best_rloc_set :
    ...
    IIi1111111 . append ( [ I1I111iIiI . rloc . print_address_no_iid ( ) , I1I111iIiI . print_state ( ) ] )
    if 40 - 40: o0oOOo0O0Ooo
   dprint ( "Packet hash {}, index {}, best-rloc-list: {}" . format ( hex ( I1iI1111ii1I1 ) , I1iI1111ii1I1 % oOOoO0O , red ( str ( IIi1111111 ) , False ) ) )
   if 79 - 79: i11iIiiIii / IiII . Ii1I
   if 66 - 66: i11iIiiIii
   if 79 - 79: iIii1I11I1II1 % I1Ii111
  ...
  if ( I1II . up_state ( ) == False ) :
   IiIiiiiI11I = I1iI1111ii1I1 % oOOoO0O
   ooo = ( IiIiiiiI11I + 1 ) % oOOoO0O
   while ( ooo != IiIiiiiI11I ) :
 ...
 None ] )
  ...
  I1II11i11Iiii = None if ( I1II . rloc . is_null ( ) ) else I1II . rloc
  Oo0o = I1II . translated_port
  iI1IIi1I = self . action if ( I1II11i11Iiii == None ) else None
  ...
  if ( oooooO0oO0o and oooooO0oO0o . request_nonce_timeout ( ) == False ) :
   o0OOO = oooooO0oO0o . get_request_or_echo_nonce ( ipc_socket , I1II11i11Iiii )
  ...
  return ( [ I1II11i11Iiii , Oo0o , o0OOO , iI1IIi1I , None , I1II ] )
 ...
 def delete_cache ( self ) :
  ...
  if ( self . group . is_null ( ) ) :
   ...
   if ( lisp_program_hardware ) :
    O0oooOO00O = self . eid . print_prefix_no_iid ( )
    os . system ( "ip route delete {}" . format ( O0oooOO00O ) )
    if 25 - 25: I1IiiI
  else :
   o0oO0o00 = lisp_map_cache . lookup_cache ( self . group , True )
   if ( o0oO0o00 == None ) : return
   if 10 - 10: II111iiii + i1IIi * I1IiiI * ooOoO0o
   iI1O000 = o0oO0o00 . lookup_source_cache ( self . eid , True )
...
class lisp_dynamic_eid ( ) :
 ...
 def get_timeout ( self , interface ) :
  try :
   I11i11IIIII = lisp_myinterfaces [ interface ]
   self . timeout = I11i11IIIII . dynamic_eid_timeout
  except :
   self . timeout = LISP_DEFAULT_DYN_EID_TIMEOUT
...
def lisp_lookup_group ( group ) :
 IIi1111111 = None
 for oo00oo0 in lisp_group_mapping_list . values ( ) :
  oO00OO0Ooo00O = lisp_is_group_more_specific ( group , oo00oo0 )
  if ( oO00OO0Ooo00O == - 1 ) : continue
  if ( IIi1111111 == None or oO00OO0Ooo00O > IIi1111111 . group_prefix . mask_len ) : IIi1111111 = oo00oo0
...
class lisp_site_eid ( ) :
 ...
 def print_flags ( self , html ) :
  if ( html == False ) :
   ...
   # IiII + iII111i % oO0o . i11iIiiIii % Oo0Ooo / I11i
 "S" if self . lisp_sec_present else "s" ,
 "I" if self . xtr_id_present else "i" ,
 ...
 "N" if self . map_notify_requested else "n" )
   ...
   oOOO = ""
   for O0000 in O0o0ooo00o00 :
    Oooo0 = lisp_site_flags [ O0000 . upper ( ) ]
    Oooo0 = Oooo0 . format ( "" if O0000 . isupper ( ) else "not " )
    oOOO += lisp_span ( O0000 , Oooo0 )
    if ( O0000 . lower ( ) != "n" ) : oOOO += "-"
 ...
 def build_sort_key ( self ) :
  oo0Oo0OOOO = lisp_cache ( )
  iiIi , o0Oo = oo0Oo0OOOO . build_key ( self . eid )
  Ii1II1i11ii = ""
  if ( self . group . is_null ( ) == False ) :
   iIiiIi111i11 , Ii1II1i11ii = oo0Oo0OOOO . build_key ( self . group )
   Ii1II1i11ii = "-" + Ii1II1i11ii [ 0 : 12 ] + "-" + str ( iIiiIi111i11 ) + "-" + Ii1II1i11ii [ 12 : : ]
   if 39 - 39: o0oOOo0O0Ooo
  o0Oo = o0Oo [ 0 : 12 ] + "-" + str ( iiIi ) + "-" + o0Oo [ 12 : : ] + Ii1II1i11ii
  del ( oo0Oo0OOOO )
  return ( o0Oo )
 ...
 def merge_in_site_eid ( self , child ) :
  ...
  if ( self . group . is_null ( ) ) :
   ...
   i11Iiiii11 = self . merge_rles_in_site_eid ( )
   if 76 - 76: I1ii11iIi11i
   if 64 - 64: I11i
   if 32 - 32: iIii1I11I1II1 - OoOoOO00 * OoooooooOO / II111iiii . oO0o * Oo0Ooo
   if 10 - 10: iII111i . i1IIi - O0 . OoOoOO00 / oO0o
   if 100 - 100: IiII % O0 - OOooOOo / I1IiiI / iIii1I11I1II1
   if 66 - 66: iIii1I11I1II1 % OoOoOO00 * o0oOOo0O0Ooo - O0
  if ( child != None ) :
 ...
 def copy_rloc_records ( self ) :
  ...
  for o0oO0O00 in self . registered_rlocs :
   O0OoooO0Oo . append ( copy . deepcopy ( o0oO0O00 ) )
 ...
 def merge_rlocs_in_site_eid ( self ) :
  ...
  O0OoooO0Oo = [ ]
  for o0oO0O00 in self . registered_rlocs :
   if ( o0oO0O00 . rloc . is_null ( ) or len ( O0OoooO0Oo ) == 0 ) :
    O0OoooO0Oo . append ( o0oO0O00 )
    continue
    if 75 - 75: I1IiiI
   for OoooOOoOo in O0OoooO0Oo :
    if ( OoooOOoOo . rloc . is_null ( ) ) : continue
    if ( o0oO0O00 . rloc . is_exact_match ( OoooOOoOo . rloc ) ) : break
    if 91 - 91: I11i + Ii1I / iII111i % iIii1I11I1II1 . o0oOOo0O0Ooo + I1IiiI
   if ( OoooOOoOo == O0OoooO0Oo [ - 1 ] ) : O0OoooO0Oo . append ( o0oO0O00 )
   if 25 - 25: i1IIi * o0oOOo0O0Ooo
  self . registered_rlocs = O0OoooO0Oo
  if 82 - 82: oO0o
 ...
 def merge_rles_in_site_eid ( self ) :
  ...
  for o0oO0O00 in self . registered_rlocs :
   ...
   for IiioOoo in o0oO0O00 . rle . rle_nodes :
    ...
    O0oOO0O0o0 [ o0o00O0oOooO0 ] = IiioOoo . address
  ...
  for o0oO0O00 in self . registered_rlocs :
   if ( self . registered_rlocs . index ( o0oO0O00 ) == 0 ) :
    iIiI111i1i1 . append ( o0oO0O00 )
    continue
    if 88 - 88: II111iiii / o0oOOo0O0Ooo
   if ( o0oO0O00 . rle == None ) : iIiI111i1i1 . append ( o0oO0O00 )
   if 44 - 44: I1Ii111 + ooOoO0o
  self . registered_rlocs = iIiI111i1i1
  ...
  for oOOOO0ooo in self . individual_registrations . values ( ) :
   if ( oOOOO0ooo . registered == False ) : continue
   ooooOOOO0O0o0 = oOOOO0ooo . registered_rlocs [ 0 ] . rle
   if ( ooooOOOO0O0o0 == None ) : continue
   if 9 - 9: Oo0Ooo - OoO0O00 + ooOoO0o / o0oOOo0O0Ooo
   IIiiI11iI = oOOOO0ooo . registered_rlocs [ 0 ] . rloc_name
   for oo0oO0OO in ooooOOOO0O0o0 . rle_nodes :
    o0o00O0oOooO0 = oo0oO0OO . address . print_address_no_iid ( )
    if ( o0OOOoOo . has_key ( o0o00O0oOooO0 ) ) : break
    if 39 - 39: i11iIiiIii - iII111i / O0 % Oo0Ooo
    IiioOoo = lisp_rle_node ( )
    IiioOoo . address . copy_address ( oo0oO0OO . address )
    IiioOoo . level = oo0oO0OO . level
    IiioOoo . rloc_name = IIiiI11iI
    iI1Ii11 . rle_nodes . append ( IiioOoo )
    o0OOOoOo [ o0o00O0oOooO0 ] = oo0oO0OO . address
  ...
  if ( O0oOO0O0o0 . keys ( ) == o0OOOoOo . keys ( ) ) : return ( False )
  ...
  # OoooooooOO / OoO0O00 + OoooooooOO % I1IiiI * iIii1I11I1II1 / O0
 O0oOO0O0o0 . keys ( ) , o0OOOoOo . keys ( ) ) )
...
class lisp_mr ( ) :
 ...
 time . time ( ) - self . last_dns_resolve < 30 ) : return
  ...
  for o0o00O0oOooO0 in oo0OooO000oO0 [ 1 : : ] :
   oO0OO = lisp_address ( LISP_AFI_NONE , o0o00O0oOooO0 , 0 , 0 )
   oOO00O0oooo00 = lisp_get_map_resolver ( oO0OO , None )
   if ( oOO00O0oooo00 != None and oOO00O0oooo00 . a_record_index == oo0OooO000oO0 . index ( o0o00O0oOooO0 ) ) :
    continue
    if 12 - 12: i1IIi + o0oOOo0O0Ooo / oO0o . O0
   oOO00O0oooo00 = lisp_mr ( o0o00O0oOooO0 , None , None )
   oOO00O0oooo00 . a_record_index = oo0OooO000oO0 . index ( o0o00O0oOooO0 )
  ...
  for oOO00O0oooo00 in lisp_map_resolvers_list . values ( ) :
   ...
   if ( oO0OO in oo0OooO000oO0 ) : continue
   o0o0O0o . append ( oOO00O0oooo00 )
   if 87 - 87: O0 . iIii1I11I1II1
  for oOO00O0oooo00 in o0o0O0o : oOO00O0oooo00 . delete_mr ( )
...
class lisp_referral ( ) :
 ...
 def print_referral ( self , eid_indent , referral_indent ) :
  Oo00O = lisp_print_elapsed ( self . uptime )
  O0000o0 = lisp_print_future ( self . expires )
  lprint ( "{}Referral EID {}, uptime/expires {}/{}, {} referrals:" . format ( eid_indent , green ( self . eid . print_prefix ( ) , False ) , Oo00O ,
  # I1IiiI % II111iiii + Oo0Ooo + OoOoOO00 + Oo0Ooo . I1Ii111
 O0000o0 , len ( self . referral_set ) ) )
 ...
 def delete_cache ( self ) :
  if ( self . group . is_null ( ) ) :
   ...
   ooOo0Oo0OOo = IiII111IiII1 . lookup_source_cache ( self . eid , True )
   if ( ooOo0Oo0OOo == None ) : return
   if 66 - 66: IiII
...
class lisp_referral_node ( ) :
 ...
 def print_ref_node ( self , indent ) :
  ...
  # O0 * Oo0Ooo - OoooooooOO % OoOoOO00 . I1ii11iIi11i
...
class lisp_ms ( ) :
 ...
 time . time ( ) - self . last_dns_resolve < 30 ) : return
  ...
  for o0o00O0oOooO0 in oo0OooO000oO0 [ 1 : : ] :
   ...
   if ( ii1i != None and ii1i . a_record_index == oo0OooO000oO0 . index ( o0o00O0oOooO0 ) ) :
    continue
    if 50 - 50: i11iIiiIii % I1IiiI * iII111i / Ii1I
   ii1i = copy . deepcopy ( self )
   ii1i . map_server . store_address ( o0o00O0oOooO0 )
   ii1i . a_record_index = oo0OooO000oO0 . index ( o0o00O0oOooO0 )
  ...
  for ii1i in o0o0O0o : ii1i . delete_ms ( )
  if 15 - 15: i11iIiiIii
...
class lisp_datetime ( ) :
 ...
 def valid_datetime ( self ) :
  I1Iii = self . datetime_name
  if ( I1Iii . find ( ":" ) == - 1 ) : return ( False )
  if ( I1Iii . find ( "-" ) == - 1 ) : return ( False )
  i1iII , iI1iiIIIi1iii , I111i11iii1Ii , time = I1Iii [ 0 : 4 ] , I1Iii [ 5 : 7 ] , I1Iii [ 8 : 10 ] , I1Iii [ 11 : : ]
  if 5 - 5: iIii1I11I1II1 / oO0o - Oo0Ooo - I1IiiI + iIii1I11I1II1
  if ( ( i1iII + iI1iiIIIi1iii + I111i11iii1Ii ) . isdigit ( ) == False ) : return ( False )
  if ( iI1iiIIIi1iii < "01" and iI1iiIIIi1iii > "12" ) : return ( False )
  if ( I111i11iii1Ii < "01" and I111i11iii1Ii > "31" ) : return ( False )
  if 63 - 63: iIii1I11I1II1 / ooOoO0o + O0 - o0oOOo0O0Ooo
  i1iiIi11iIi , i1I1IIi , iIIi1iIiiII = time . split ( ":" )
  if 31 - 31: oO0o + ooOoO0o * oO0o
  if ( ( i1iiIi11iIi + i1I1IIi + iIIi1iIiiII ) . isdigit ( ) == False ) : return ( False )
  if ( i1iiIi11iIi < "00" and i1iiIi11iIi > "23" ) : return ( False )
  if ( i1I1IIi < "00" and i1I1IIi > "59" ) : return ( False )
  if ( iIIi1iIiiII < "00" and iIIi1iIiiII > "59" ) : return ( False )
  return ( True )
  if 76 - 76: iII111i * ooOoO0o . O0
  if 37 - 37: I1ii11iIi11i
 def parse_datetime ( self ) :
  ii1o0o0OOoO0ooo = self . datetime_name
  ii1o0o0OOoO0ooo = ii1o0o0OOoO0ooo . replace ( "-" , "" )
  ii1o0o0OOoO0ooo = ii1o0o0OOoO0ooo . replace ( ":" , "" )
  self . datetime = int ( ii1o0o0OOoO0ooo )
...
class lisp_policy ( ) :
 ...
 def match_policy_map_request ( self , mr , srloc ) :
  for i1iI11i in self . match_clauses :
   ...
   ooo0oOoooO = i1iI11i . datetime_upper
   if ( IIi1I1 and ooo0oOoooO and IIi1I1 . now_in_range ( ooo0oOoooO ) == False ) : continue
   return ( True )
 ...
 self . set_elp_name == None and self . set_rle_name == None )
  ...
  if ( self . set_geo_name ) :
   ...
   II1 = I1II . geo_name
   i11I1iIi1I1I = "" if lisp_geo_list . has_key ( II1 ) else "(not configured)"
   if 68 - 68: OoO0O00 * OOooOOo * ooOoO0o / ooOoO0o . O0 + I11i
   lprint ( "Policy set-geo-name '{}' {}" . format ( II1 , i11I1iIi1I1I ) )
   if 79 - 79: iIii1I11I1II1 / I1IiiI / OoooooooOO % IiII . OoOoOO00
  if ( self . set_elp_name ) :
   I1II . elp_name = self . set_elp_name
   II1 = I1II . elp_name
   i11I1iIi1I1I = "" if lisp_elp_list . has_key ( II1 ) else "(not configured)"
   if 70 - 70: OoOoOO00 + OoooooooOO + iIii1I11I1II1 / Ii1I
   lprint ( "Policy set-elp-name '{}' {}" . format ( II1 , i11I1iIi1I1I ) )
   if 92 - 92: II111iiii - IiII / II111iiii
  if ( self . set_rle_name ) :
   I1II . rle_name = self . set_rle_name
   II1 = I1II . rle_name
   i11I1iIi1I1I = "" if lisp_rle_list . has_key ( II1 ) else "(not configured)"
   if 23 - 23: Ii1I * II111iiii - I1ii11iIi11i
   lprint ( "Policy set-rle-name '{}' {}" . format ( II1 , i11I1iIi1I1I ) )
   if 86 - 86: ooOoO0o . OoO0O00 + I1Ii111 - I11i % i11iIiiIii / OoOoOO00
  if ( self . set_json_name ) :
   I1II . json_name = self . set_json_name
   II1 = I1II . json_name
   i11I1iIi1I1I = "" if lisp_json_list . has_key ( II1 ) else "(not configured)"
   if 47 - 47: IiII
   lprint ( "Policy set-json-name '{}' {}" . format ( II1 , i11I1iIi1I1I ) )
...
class lisp_pubsub ( ) :
 ...
 def add ( self , eid_prefix ) :
  ...
  lprint ( "{} pubsub state {} for {}, xtr-id: {}, ttl {}" . format ( O0O , iiI1I1IIi ,
...
class lisp_trace ( ) :
 ...
 def print_trace ( self ) :
  IIIIIiII1iI = self . packet_json
  lprint ( "LISP-Trace JSON: '{}'" . format ( IIIIIiII1iI ) )
 ...
 def decode ( self , packet ) :
  ...
  o0OiiI1iiI11 = o0o00O0oOooO0 >> 24
  iI1iIii1Ii = ( o0o00O0oOooO0 >> 16 ) & 0xff
  I1iI1II1i = ( o0o00O0oOooO0 >> 8 ) & 0xff
  iI1O0OOOo = o0o00O0oOooO0 & 0xff
  self . local_rloc = "{}.{}.{}.{}" . format ( o0OiiI1iiI11 , iI1iIii1Ii , I1iI1II1i , iI1O0OOOo )
 ...
 def packet_length ( self ) :
  oOoO0OOO00O = 8 ; o0o0OO = 4 + 4 + 8
  return ( oOoO0OOO00O + o0o0OO + len ( json . dumps ( self . packet_json ) ) )
  if 35 - 35: I1Ii111
...
def lisp_get_map_resolver ( address , eid ) :
 ...
 if ( eid == "" ) :
  ...
  iii111 = "all" if Oooo00oo == None else Oooo00oo . use_mr_name
  if 46 - 46: II111iiii / Ii1I . oO0o - I11i % oO0o
  if 77 - 77: ooOoO0o . I1Ii111 / OoO0O00
 ii11IIiI1iIi = None
 for oOO00O0oooo00 in lisp_map_resolvers_list . values ( ) :
  if ( iii111 == "" ) : return ( oOO00O0oooo00 )
  if ( oOO00O0oooo00 . mr_name != iii111 ) : continue
  if ( ii11IIiI1iIi == None or oOO00O0oooo00 . last_used < ii11IIiI1iIi . last_used ) : ii11IIiI1iIi = oOO00O0oooo00
...
def lisp_get_decent_map_resolver ( eid ) :
 ...
 oo0o0ooo0O = str ( ooo ) + "." + lisp_decent_dns_suffix
 if 25 - 25: OoooooooOO
 lprint ( "Use LISP-Decent map-resolver {} for EID {}" . format ( bold ( oo0o0ooo0O , False ) , eid . print_prefix ( ) ) )
 if 39 - 39: oO0o * I1Ii111 % OoOoOO00 % oO0o
 if 87 - 87: i1IIi % ooOoO0o + Ii1I + I11i % OoOoOO00
 ii11IIiI1iIi = None
 for oOO00O0oooo00 in lisp_map_resolvers_list . values ( ) :
  if ( oo0o0ooo0O != oOO00O0oooo00 . dns_name ) : continue
  if ( ii11IIiI1iIi == None or oOO00O0oooo00 . last_used < ii11IIiI1iIi . last_used ) : ii11IIiI1iIi = oOO00O0oooo00
...
def lisp_rate_limit_map_request ( dest ) :
 OOOOo0O0O = lisp_get_timestamp ( )
 if 77 - 77: OOooOOo
 if 74 - 74: O0
 if 86 - 86: OoOoOO00
 if 4 - 4: OoooooooOO * OoO0O00
 Ooo0o0oo0 = OOOOo0O0O - lisp_no_map_request_rate_limit
 ...
 Ooo0o0oo0 = OOOOo0O0O - lisp_last_map_request_sent
 IiII1I1I1i1 = ( Ooo0o0oo0 < LISP_MAP_REQUEST_RATE_LIMIT )
 if 60 - 60: II111iiii - Oo0Ooo
 if ( IiII1I1I1i1 ) :
...
def lisp_send_map_request ( lisp_sockets , lisp_ephem_port , seid , deid , rloc ) :
 ...
 if 78 - 78: i11iIiiIii
 if 20 - 20: Ii1I
 oo0Ii = oooOoi1iiii1II = None
 if ( rloc ) :
  oo0Ii = rloc . rloc
  oooOoi1iiii1II = rloc . translated_port if lisp_i_am_rtr else LISP_DATA_PORT
  if 67 - 67: ooOoO0o * IiII - I1IiiI
  if 53 - 53: I11i % OoO0O00 * IiII % IiII % IiII
  if 81 - 81: I1ii11iIi11i
  if 59 - 59: I11i + i11iIiiIii
  if 48 - 48: Oo0Ooo
 I111i1ii1 , iii1i1iIii111 , OoO0o0OOOO = lisp_myrlocs
 if ( I111i1ii1 == None ) :
  lprint ( "Suppress sending Map-Request, IPv4 RLOC not found" )
  return
  if 88 - 88: i1IIi - OoOoOO00
 if ( iii1i1iIii111 == None and oo0Ii != None and oo0Ii . is_ipv6 ( ) ) :
 ...
 if ( oo0Ii != None and lisp_nat_traversal and lisp_i_am_rtr == False ) :
  if ( oo0Ii . is_private_address ( ) == False ) :
   I111i1ii1 = lisp_get_any_translated_rloc ( )
 ...
 if ( oo0Ii == None or oo0Ii . is_ipv4 ( ) ) :
  if ( lisp_nat_traversal and oo0Ii == None ) :
   iiIiI11I11i11 = lisp_get_any_translated_rloc ( )
   if ( iiIiI11I11i11 != None ) : I111i1ii1 = iiIiI11I11i11
   if 16 - 16: I1Ii111 % i1IIi
  Ooo00 . itr_rlocs . append ( I111i1ii1 )
  if 50 - 50: OoOoOO00 / OoO0O00 * I11i / I11i / oO0o . Oo0Ooo
 if ( oo0Ii == None or oo0Ii . is_ipv6 ( ) ) :
  if ( iii1i1iIii111 == None or iii1i1iIii111 . is_ipv6_link_local ( ) ) :
   iii1i1iIii111 = None
  else :
   Ooo00 . itr_rloc_count = 1 if ( oo0Ii == None ) else 0
   Ooo00 . itr_rlocs . append ( iii1i1iIii111 )
 ...
 if ( oo0Ii != None and Ooo00 . itr_rlocs != [ ] ) :
  o00O00oOO00 = Ooo00 . itr_rlocs [ 0 ]
 else :
  if ( deid . is_ipv4 ( ) ) :
   o00O00oOO00 = I111i1ii1
  elif ( deid . is_ipv6 ( ) ) :
   o00O00oOO00 = iii1i1iIii111
  else :
   o00O00oOO00 = I111i1ii1
   ...
   if 7 - 7: OoooooooOO
 IiiiIi1iiii11 = Ooo00 . encode ( oo0Ii , oooOoi1iiii1II )
 Ooo00 . print_map_request ( )
 ...
 if ( oo0Ii != None ) :
  if ( rloc . is_rloc_translated ( ) ) :
   iII1iiIiiii1I = lisp_get_nat_info ( oo0Ii , rloc . rloc_name )
 ...
 iiIii1Ii1I1 = None if lisp_i_am_rtr else seid
 if ( lisp_decent_pull_xtr_configured ( ) ) :
  oOO00O0oooo00 = lisp_get_decent_map_resolver ( deid )
 else :
  oOO00O0oooo00 = lisp_get_map_resolver ( None , iiIii1Ii1I1 )
  if 16 - 16: ooOoO0o
 if ( oOO00O0oooo00 == None ) :
...
def lisp_send_info_request ( lisp_sockets , dest , port , device_name ) :
 ...
 II1iI11i = lisp_info ( )
 II1iI11i . nonce = lisp_get_control_nonce ( )
 if ( device_name ) : II1iI11i . hostname += "-" + device_name
 if 80 - 80: Ii1I
 ...
 I1iI1i1 = False
 if ( device_name ) :
  iiIIi1 = lisp_get_host_route_next_hop ( oo0o00OO )
  ...
  if ( port == LISP_CTRL_PORT and iiIIi1 != None ) :
   while ( True ) :
    time . sleep ( .01 )
    iiIIi1 = lisp_get_host_route_next_hop ( oo0o00OO )
    if ( iiIIi1 == None ) : break
    if 51 - 51: OoOoOO00 / Ii1I . I1IiiI / Ii1I . II111iiii - iIii1I11I1II1
    if 78 - 78: I11i
    if 42 - 42: Ii1I
  Iii1i = lisp_get_default_route_next_hops ( )
  for OoO0o0OOOO , OoO0o0oOoOo in Iii1i :
   ...
   if 76 - 76: OoooooooOO
   if ( iiIIi1 != OoO0o0oOoOo ) :
    if ( iiIIi1 != None ) :
     lisp_install_host_route ( oo0o00OO , iiIIi1 , False )
     if 78 - 78: IiII % i11iIiiIii
    lisp_install_host_route ( oo0o00OO , OoO0o0oOoOo , True )
    I1iI1i1 = True
 ...
 if ( I1iI1i1 ) :
  lisp_install_host_route ( oo0o00OO , None , False )
  if ( iiIIi1 != None ) : lisp_install_host_route ( oo0o00OO , iiIIi1 , True )
...
def lisp_process_info_request ( lisp_sockets , packet , addr_str , sport , rtr_list ) :
 ...
 II1iI11i . info_reply = True
 II1iI11i . global_etr_rloc . store_address ( addr_str )
 II1iI11i . etr_port = sport
 if 68 - 68: Ii1I
 if 98 - 98: iII111i
 if 33 - 33: OoO0O00 - ooOoO0o % O0 % iIii1I11I1II1 * iII111i - iII111i
 if 27 - 27: i11iIiiIii + I1ii11iIi11i + i1IIi
 if 67 - 67: o0oOOo0O0Ooo
 if ( II1iI11i . hostname != None ) :
  II1iI11i . private_etr_rloc . afi = LISP_AFI_NAME
  II1iI11i . private_etr_rloc . store_address ( II1iI11i . hostname )
  if 58 - 58: IiII % o0oOOo0O0Ooo + i1IIi
  if 33 - 33: II111iiii
 if ( rtr_list != None ) : II1iI11i . rtr_list = rtr_list
 packet = II1iI11i . encode ( )
 II1iI11i . print_info ( )
 if 61 - 61: I1Ii111
 ...
 o0O0oo = lisp_info_source ( II1iI11i . hostname , addr_str , sport )
 o0O0oo . cache_address_for_info_source ( )
 return
...
def lisp_get_all_translated_rlocs ( ) :
 ...
 for Oooo00oo in lisp_db_list :
  for o0oO0O00 in Oooo00oo . rloc_set :
   ...
   oO0oO0oOOOo . append ( o0o00O0oOooO0 )
...
def lisp_update_default_routes ( map_resolver , iid , rtr_list ) :
 ...
 for IiiiII in [ LISP_AFI_IPV4 , LISP_AFI_IPV6 , LISP_AFI_MAC ] :
  ...
  O0oooOO00O = lisp_address ( IiiiII , "" , 0 , iid )
  O0oooOO00O . make_default_route ( O0oooOO00O )
  o0oO0o00 = lisp_map_cache . lookup_cache ( O0oooOO00O , True )
  if ( o0oO0o00 ) :
  ...
  oo0oO00ooo0O . append ( [ O0oooOO00O , "" ] )
  ...
  iI1i1iIi1 = lisp_map_cache . lookup_cache ( OOo0oOOO0 , True )
  if ( iI1i1iIi1 ) : iI1i1iIi1 = iI1i1iIi1 . source_cache . lookup_cache ( O0oooOO00O , True )
  if ( iI1i1iIi1 ) : iI1i1iIi1 . delete_cache ( )
  if 89 - 89: O0 - OoO0O00
  oo0oO00ooo0O . append ( [ O0oooOO00O , OOo0oOOO0 ] )
  if 8 - 8: I1ii11iIi11i / oO0o - OoooooooOO + ooOoO0o + o0oOOo0O0Ooo % i11iIiiIii
 if ( len ( oo0oO00ooo0O ) == 0 ) : return
 if 32 - 32: O0 + IiII
 ...
 OoO0oOOooOO = [ ]
 for iIi in rtr_list :
  O00oIIi1iI1i111 = rtr_list [ iIi ]
  o0oO0O00 = lisp_rloc ( )
  o0oO0O00 . rloc . copy_address ( O00oIIi1iI1i111 )
 ...
 for O0oooOO00O in oo0oO00ooo0O :
  o0oO0o00 = lisp_mapping ( O0oooOO00O [ 0 ] , O0oooOO00O [ 1 ] , OoO0oOOooOO )
...
def lisp_process_info_reply ( source , packet , store ) :
 ...
 if ( store == False ) :
  return ( [ II1iI11i . global_etr_rloc , II1iI11i . etr_port , Ii1I1Iii ] )
 ...
 for Oooo00oo in lisp_db_list :
  for o0oO0O00 in Oooo00oo . rloc_set :
   ...
   if ( II1i == None ) :
    ...
    if ( II1iI11i . private_etr_rloc . is_null ( ) == False and
 I1II . is_exact_match ( II1iI11i . private_etr_rloc ) == False ) :
     continue
     if 49 - 49: Ii1I + iIii1I11I1II1 . O0 * OOooOOo * OoooooooOO - OOooOOo
   elif ( II1iI11i . private_etr_rloc . is_dist_name ( ) ) :
    IIiiI11iI = II1iI11i . private_etr_rloc . address
   ...
   IIii1i1i1 = II1iI11i . global_etr_rloc . is_exact_match ( I1II )
   if ( o0oO0O00 . translated_port == 0 and IIii1i1i1 ) :
 ...
 II1i , Ii1i1 ) )
   ...
   oOOOOOoo0 = II1iI11i . global_etr_rloc
   O0oO0 = o0oO0O00 . translated_rloc
   if ( O0oO0 . is_exact_match ( oOOOOOoo0 ) and
 II1iI11i . etr_port == o0oO0O00 . translated_port ) : continue
   if 42 - 42: iII111i
   lprint ( "Store translation {}:{} for {} ({}), EID-prefix {}" . format ( red ( II1iI11i . global_etr_rloc . print_address_no_iid ( ) , False ) ,
   # i11iIiiIii
 II1iI11i . etr_port , O0ooo0Ooo , II1i , Ii1i1 ) )
   if 81 - 81: i1IIi + OoooooooOO . OoO0O00 * I1IiiI * I11i % II111iiii
   o0oO0O00 . store_translated_rloc ( II1iI11i . global_etr_rloc ,
 II1iI11i . etr_port )
   if 35 - 35: oO0o
   if 65 - 65: II111iiii
 return ( [ II1iI11i . global_etr_rloc , II1iI11i . etr_port , Ii1I1Iii ] )
...
def lisp_test_mr ( lisp_sockets , port ) :
 ...
 ooo00o0 = threading . Timer ( LISP_TEST_MR_INTERVAL , lisp_test_mr ,
 [ lisp_sockets , port ] )
 ooo00o0 . start ( )
 return
 if 80 - 80: I11i % I1ii11iIi11i % IiII
...
def lisp_update_local_rloc ( rloc ) :
 ...
 iiiII1Ii11I1 = rloc . rloc . print_address_no_iid ( )
 Ooo00O0ooOo = o0o00O0oOooO0 . print_address_no_iid ( )
 if 94 - 94: OoOoOO00 / OoO0O00 / ooOoO0o + II111iiii
 if ( iiiII1Ii11I1 == Ooo00O0ooOo ) : return
 if 55 - 55: II111iiii - IiII
 lprint ( "Local interface address changed on {} from {} to {}" . format ( rloc . interface , iiiII1Ii11I1 , Ooo00O0ooOo ) )
...
def lisp_update_encap_port ( mc ) :
 for I1II in mc . rloc_set :
  iII1iiIiiii1I = lisp_get_nat_info ( I1II . rloc , I1II . rloc_name )
  if ( iII1iiIiiii1I == None ) : continue
  if ( I1II . translated_port == iII1iiIiiii1I . port ) : continue
  if 42 - 42: OoO0O00 . I1IiiI . OOooOOo + ooOoO0o
  lprint ( ( "Encap-port changed from {} to {} for RLOC {}, " + "EID-prefix {}" ) . format ( I1II . translated_port , iII1iiIiiii1I . port ,
  # OOooOOo . OoooooooOO + Oo0Ooo + OOooOOo . iIii1I11I1II1 - iII111i
 red ( I1II . rloc . print_address_no_iid ( ) , False ) ,
 green ( mc . print_eid_tuple ( ) , False ) ) )
  if 23 - 23: ooOoO0o * II111iiii . II111iiii % I1Ii111
  I1II . store_translated_rloc ( I1II . rloc , iII1iiIiiii1I . port )
...
def lisp_timeout_map_cache_entry ( mc , delete_list ) :
 ...
 if ( mc . last_refresh_time + mc . map_cache_ttl > OOOOo0O0O ) :
...
def lisp_timeout_map_cache_walk ( mc , parms ) :
 ...
 if ( mc . group . is_null ( ) ) :
  iIiIi1iiII1I , o0o0O0o = lisp_timeout_map_cache_entry ( mc , o0o0O0o )
  if ( o0o0O0o == [ ] or mc != o0o0O0o [ - 1 ] ) :
   oOo0o00oo = lisp_write_checkpoint_entry ( oOo0o00oo , mc )
   if 98 - 98: oO0o / iII111i - Oo0Ooo / I1Ii111 * oO0o - OoO0O00
  return ( [ iIiIi1iiII1I , parms ] )
...
def lisp_timeout_map_cache ( lisp_map_cache ) :
 ...
 o0o0O0o = I1I1i [ 0 ]
 for o0oO0o00 in o0o0O0o : o0oO0o00 . delete_cache ( )
...
def lisp_store_nat_info ( hostname , rloc , port ) :
 ...
 iiI11Ii1I = "{} NAT state for {}, RLOC {}, port {}" . format ( "{}" ,
 blue ( hostname , False ) , red ( oo0o00OO , False ) , port )
 if 71 - 71: ooOoO0o
 ii11ii11IiIi = lisp_nat_info ( oo0o00OO , hostname , port )
 if 85 - 85: IiII / oO0o % OoOoOO00 + oO0o % OoO0O00
 if ( lisp_nat_state_info . has_key ( hostname ) == False ) :
  lisp_nat_state_info [ hostname ] = [ ii11ii11IiIi ]
  lprint ( iiI11Ii1I . format ( "Store initial" ) )
  return ( True )
  if 6 - 6: IiII - i1IIi . iII111i
  if 80 - 80: O0 / I11i . o0oOOo0O0Ooo / I1Ii111 . I11i . o0oOOo0O0Ooo
  if 80 - 80: ooOoO0o
  if 69 - 69: O0 / OoO0O00 - i11iIiiIii / iII111i / OOooOOo
  if 61 - 61: I1IiiI / IiII . oO0o * oO0o
  if 25 - 25: IiII - IiII
 iII1iiIiiii1I = lisp_nat_state_info [ hostname ] [ 0 ]
 if ( iII1iiIiiii1I . address == oo0o00OO and iII1iiIiiii1I . port == port ) :
  iII1iiIiiii1I . uptime = lisp_get_timestamp ( )
  lprint ( iiI11Ii1I . format ( "Refresh existing" ) )
  return ( False )
  ...
  if 86 - 86: i11iIiiIii
 O0Oo00oO0 = None
 for iII1iiIiiii1I in lisp_nat_state_info [ hostname ] :
  if ( iII1iiIiiii1I . address == oo0o00OO and iII1iiIiiii1I . port == port ) :
   O0Oo00oO0 = iII1iiIiiii1I
   break
   if 2 - 2: II111iiii
   if 38 - 38: Oo0Ooo
   if 14 - 14: IiII . I1Ii111 + Oo0Ooo - iII111i + I1IiiI % OOooOOo
 if ( O0Oo00oO0 == None ) :
  lprint ( iiI11Ii1I . format ( "Store new" ) )
 else :
  lisp_nat_state_info [ hostname ] . remove ( O0Oo00oO0 )
  lprint ( iiI11Ii1I . format ( "Use previous" ) )
  if 73 - 73: I1ii11iIi11i / OoO0O00
  if 31 - 31: iII111i - I1IiiI - o0oOOo0O0Ooo - OoO0O00 + IiII . iIii1I11I1II1
 O0OO0OoOOooo = lisp_nat_state_info [ hostname ]
 lisp_nat_state_info [ hostname ] = [ ii11ii11IiIi ] + O0OO0OoOOooo
 return ( True )
...
def lisp_get_nat_info ( rloc , hostname ) :
 ...
 oo0o00OO = rloc . print_address_no_iid ( )
 for iII1iiIiiii1I in lisp_nat_state_info [ hostname ] :
  if ( iII1iiIiiii1I . address == oo0o00OO ) : return ( iII1iiIiiii1I )
...
def lisp_build_info_requests ( lisp_sockets , dest , port ) :
 ...
 if ( dest == None ) :
  for oOO00O0oooo00 in lisp_map_resolvers_list . values ( ) :
   O00o0OoOOOOO . append ( oOO00O0oooo00 . map_resolver )
   if 96 - 96: OoOoOO00
  i1ioo = O00o0OoOOOOO
  if ( i1ioo == [ ] ) :
   for ii1i in lisp_map_servers_list . values ( ) :
    i1ioo . append ( ii1i . map_server )
 ...
 for Oooo00oo in lisp_db_list :
  for o0oO0O00 in Oooo00oo . rloc_set :
   ...
   if ( o0o00O0oOooO0 in oO0oO0oOOOo ) : continue
   oO0oO0oOOOo [ o0o00O0oOooO0 ] = o0oO0O00 . interface
 ...
 for o0o00O0oOooO0 in oO0oO0oOOOo :
  II1i = oO0oO0oOOOo [ o0o00O0oOooO0 ]
  oO0OO = red ( o0o00O0oOooO0 , False )
  lprint ( "Build Info-Request for private address {} ({})" . format ( oO0OO ,
 II1i ) )
  OoO0o0OOOO = II1i if len ( oO0oO0oOOOo ) > 1 else None
  for dest in i1ioo :
...
def lisp_valid_address_format ( kw , value ) :
 ...
 if ( value . find ( "." ) != - 1 ) :
  ...
  for I1I1Iii1I1111 in o0o00O0oOooO0 :
   if ( I1I1Iii1I1111 . isdigit ( ) == False ) : return ( False )
   if ( int ( I1I1Iii1I1111 ) > 255 ) : return ( False )
 ...
 if ( value . find ( "-" ) != - 1 ) :
  ...
  for iII1I in o0o00O0oOooO0 :
   try : int ( iII1I , 16 )
   except : return ( False )
   if 11 - 11: Oo0Ooo - Ii1I / oO0o . I11i
  return ( True )
 ...
 if ( value [ 0 ] == "+" ) :
  ...
  for oO000OO0oOO0 in o0o00O0oOooO0 :
   if ( oO000OO0oOO0 . isdigit ( ) == False ) : return ( False )
...
def lisp_process_api ( process , lisp_socket , data_structure ) :
 o000O0ooo , I1I1i = data_structure . split ( "%" )
 if 34 - 34: iII111i - i1IIi / I11i . Ii1I - I11i / iII111i
 lprint ( "Process API request '{}', parameters: '{}'" . format ( o000O0ooo ,
 I1I1i ) )
 if 25 - 25: ooOoO0o + OoO0O00 % iII111i % I1ii11iIi11i . I1ii11iIi11i % OoO0O00
 oOO00o0 = [ ]
 if ( o000O0ooo == "map-cache" ) :
  if ( I1I1i == "" ) :
...
def lisp_fill_rloc_in_json ( rloc ) :
 ...
 OO00oOoOOo0 = rloc . last_rloc_probe_reply
 if ( OO00oOoOOo0 ) :
  I1I111iIiI [ "last-rloc-probe-reply" ] = lisp_print_elapsed ( OO00oOoOOo0 )
 ...
 i11Iiii = [ ]
 for o0oooOO0o in rloc . recent_rloc_probe_rtts : i11Iiii . append ( str ( o0oooOO0o ) )
 I1I111iIiI [ "recent-rloc-probe-rtts" ] = i11Iiii
 return ( I1I111iIiI )
...
def lisp_process_api_map_cache_entry ( parms ) :
 ...
 if ( o0oO0o00 ) : iIiIi1iiII1I , oOO00o0 = lisp_process_api_map_cache ( o0oO0o00 , oOO00o0 )
 return ( oOO00o0 )
...
def lisp_process_api_site_cache_summary ( site_cache ) :
 ...
 for iiIi in site_cache . cache_sorted :
  for iIiIi1I in site_cache . cache [ iiIi ] . entries . values ( ) :
   ...
   if ( i1IIiIIi1I1 . has_key ( iIiIi1I . site . site_name ) == False ) :
    i1IIiIIi1I1 [ iIiIi1I . site . site_name ] = [ ]
   ...
   for i1iI1iI111iI in iIiIi1I . more_specific_registrations :
    if ( i1iI1iI111iI . registered ) : iIIi1iI1I1IIi [ "registered-count" ] += 1
    if 75 - 75: Oo0Ooo % IiII + II111iiii + oO0o
   i1IIiIIi1I1 [ iIiIi1I . site . site_name ] . append ( iIIi1iI1I1IIi )
 ...
 oOO00o0 = [ ]
 for i11I11iiiI1 in i1IIiIIi1I1 :
  OO0o0OO0 = copy . deepcopy ( ooo000O0O )
  OO0o0OO0 [ "site" ] = i11I11iiiI1
  OO0o0OO0 [ "registrations" ] = i1IIiIIi1I1 [ i11I11iiiI1 ]
...
def lisp_process_api_ms_or_mr ( ms_or_mr , data ) :
 ...
 oo0o0ooo0O = data [ "dns-name" ] if data . has_key ( "dns-name" ) else None
 ...
 if ( ms_or_mr ) :
  for ii1i in lisp_map_servers_list . values ( ) :
   if ( oo0o0ooo0O ) :
    if ( oo0o0ooo0O != ii1i . dns_name ) : continue
   else :
...
def lisp_process_api_database_mapping ( ) :
 ...
 for Oooo00oo in lisp_db_list :
  ...
  for I1I111iIiI in Oooo00oo . rloc_set :
   ...
   O0OoIiiIIiii = I1I111iIiI . translated_rloc
   if ( O0OoIiiIIiii . is_null ( ) == False ) :
    I1II [ "translated-rloc" ] = O0OoIiiIIiii . print_address_no_iid ( )
...
def lisp_get_interface_instance_id ( device , source_eid ) :
 ...
 oOooO00Ooo = source_eid . instance_id
 IIi1111111 = None
 for II1i in lisp_multi_tenant_interfaces :
  if ( II1i . device != device ) : continue
  O0oooOO00O = II1i . multi_tenant_eid
  source_eid . instance_id = O0oooOO00O . instance_id
  if ( source_eid . is_more_specific ( O0oooOO00O ) == False ) : continue
  if ( IIi1111111 == None or IIi1111111 . multi_tenant_eid . mask_len < O0oooOO00O . mask_len ) :
   IIi1111111 = II1i
   if 36 - 36: OoooooooOO . oO0o * Ii1I * i11iIiiIii
   if 83 - 83: IiII * i1IIi + I1Ii111 + o0oOOo0O0Ooo * i1IIi * iII111i
 source_eid . instance_id = oOooO00Ooo
 if 5 - 5: iII111i + O0 / IiII + II111iiii . I1IiiI
 if ( IIi1111111 == None ) : return ( IiIIi11i111 )
 return ( IIi1111111 . get_instance_id ( ) )
...
def lisp_allow_dynamic_eid ( device , eid ) :
 ...
 II1i = lisp_myinterfaces [ device ]
 OO00O0OO00o0 = device if II1i . dynamic_eid_device == None else II1i . dynamic_eid_device
 if 12 - 12: OoooooooOO - I1ii11iIi11i * iII111i / ooOoO0o
 if 99 - 99: I1ii11iIi11i + I11i
 if ( II1i . does_dynamic_eid_match ( eid ) ) : return ( OO00O0OO00o0 )
 return ( None )
...
def lisp_start_rloc_probe_timer ( interval , lisp_sockets ) :
 ...
 IIiiIi = lisp_process_rloc_probe_timer
 iiI1I = threading . Timer ( interval , IIiiIi , [ lisp_sockets ] )
 lisp_rloc_probe_timer = iiI1I
 iiI1I . start ( )
 return
 if 13 - 13: O0 + o0oOOo0O0Ooo
 if 44 - 44: I1Ii111
 if 66 - 66: OoooooooOO
...
def lisp_show_rloc_probe_list ( ) :
 ...
 for o0Oo in lisp_rloc_probe_list :
  I1iII1i11ii = lisp_rloc_probe_list [ o0Oo ]
  lprint ( "RLOC {}:" . format ( o0Oo ) )
  for I1I111iIiI , iIIi1iI1I1IIi , i11ii in I1iII1i11ii :
...
def lisp_process_rloc_probe_timer ( lisp_sockets ) :
 ...
 OOooO0o0oo00o = lisp_get_default_route_next_hops ( )
 if 59 - 59: Oo0Ooo
 ...
 I1I1 = 0
 oO0oo000O = bold ( "RLOC-probe" , False )
 for o0OiIII1iii in lisp_rloc_probe_list . values ( ) :
  ...
  if 91 - 91: I11i
  I1Ii11 = None
  for iiiiioOoooOoO00OO , iiI1I1IIi , OOo0oOOO0 in o0OiIII1iii :
   oo0o00OO = iiiiioOoooOoO00OO . rloc . print_address_no_iid ( )
   ...
   if 94 - 94: OoooooooOO
   oO0ooO0O000 , OoO0Oo0oOo00o , IIIi1i1iIIIi = lisp_allow_gleaning ( iiI1I1IIi , None , iiiiioOoooOoO00OO )
   if ( oO0ooO0O000 and OoO0Oo0oOo00o == False ) :
    iIIi1iI1I1IIi = green ( iiI1I1IIi . print_address ( ) , False )
    oo0o00OO += ":{}" . format ( iiiiioOoooOoO00OO . translated_port )
   ...
   if ( iiiiioOoooOoO00OO . down_state ( ) ) : continue
   ...
   if ( I1Ii11 ) :
    iiiiioOoooOoO00OO . last_rloc_probe_nonce = I1Ii11 . last_rloc_probe_nonce
    if 9 - 9: I1ii11iIi11i * o0oOOo0O0Ooo . oO0o
    if ( I1Ii11 . translated_port == iiiiioOoooOoO00OO . translated_port and I1Ii11 . rloc_name == iiiiioOoooOoO00OO . rloc_name ) :
     ...
     iiiiioOoooOoO00OO . last_rloc_probe = I1Ii11 . last_rloc_probe
     continue
   ...
   I1II = None
   while ( True ) :
    I1II = iiiiioOoooOoO00OO if I1II == None else I1II . next_rloc
    if ( I1II == None ) : break
    ...
    if ( I1II . rloc_next_hop != None ) :
     if ( I1II . rloc_next_hop not in OOooO0o0oo00o ) :
      if ( I1II . up_state ( ) ) :
       o0 , OOOOoo00 = I1II . rloc_next_hop
       I1II . state = LISP_RLOC_UNREACH_STATE
       I1II . last_state_change = lisp_get_timestamp ( )
       ...
       if 33 - 33: iII111i
      o0OO0OO0 = bold ( "unreachable" , False )
      lprint ( "Next-hop {}({}) for RLOC {} is {}" . format ( OOOOoo00 , o0 ,
 red ( oo0o00OO , False ) , o0OO0OO0 ) )
      continue
    ...
    I1ii1II11IiI = 0 if IiI1i11iiII == None else time . time ( ) - IiI1i11iiII
    if ( I1II . unreach_state ( ) and I1ii1II11IiI < LISP_RLOC_PROBE_INTERVAL ) :
    ...
    if ( oooooO0oO0o and oooooO0oO0o . request_nonce_timeout ( ) ) :
     ...
     I1II . last_state_change = lisp_get_timestamp ( )
     o0OO0OO0 = bold ( "unreachable" , False )
     lprint ( "RLOC {} went {}, nonce-echo failed" . format ( red ( oo0o00OO , False ) , o0OO0OO0 ) )
     if 52 - 52: OoOoOO00
     lisp_update_rtr_updown ( I1II . rloc , False )
     continue
    ...
    if ( I1II . last_rloc_probe != None ) :
     ...
     I1ii1II11IiI = time . time ( ) - IiI1i11iiII
     if ( I1II . up_state ( ) and I1ii1II11IiI >= LISP_RLOC_PROBE_REPLY_WAIT ) :
      if 37 - 37: I11i % I1IiiI
      I1II . state = LISP_RLOC_UNREACH_STATE
      I1II . last_state_change = lisp_get_timestamp ( )
      lisp_update_rtr_updown ( I1II . rloc , False )
      o0OO0OO0 = bold ( "unreachable" , False )
      lprint ( "RLOC {} went {}, probe it" . format ( red ( oo0o00OO , False ) , o0OO0OO0 ) )
      if 32 - 32: OOooOOo + OoooooooOO . IiII . Oo0Ooo * iII111i
      if 86 - 86: I1ii11iIi11i . iII111i + Ii1I - IiII / i11iIiiIii + OoOoOO00
      lisp_mark_rlocs_for_other_eids ( o0OiIII1iii )
      if 50 - 50: o0oOOo0O0Ooo - IiII + OoOoOO00 - II111iiii
      if 24 - 24: I1Ii111 - IiII % I1IiiI - OoooooooOO % Ii1I
      if 56 - 56: I1ii11iIi11i
    I1II . last_rloc_probe = lisp_get_timestamp ( )
    if 40 - 40: OoooooooOO
    o000o00o = "" if I1II . unreach_state ( ) == False else " unreachable"
    if 73 - 73: Oo0Ooo
    ...
    if ( I1II . rloc_next_hop != None ) :
     o0 , OOOOoo00 = I1II . rloc_next_hop
     lisp_install_host_route ( oo0o00OO , OOOOoo00 , True )
     OoOoo00Oo0o0O = ", send on nh {}({})" . format ( OOOOoo00 , o0 )
     if 48 - 48: I1IiiI
    ...
    if ( I1II . translated_port != 0 ) :
     iiI111i1 += ":{}" . format ( I1II . translated_port )
     if 77 - 77: ooOoO0o / i11iIiiIii * I1IiiI
    iiI111i1 = red ( iiI111i1 , False )
    if ( I1II . rloc_name != None ) :
     iiI111i1 += " (" + blue ( I1II . rloc_name , False ) + ")"
     if 36 - 36: i11iIiiIii * i1IIi % iII111i . Oo0Ooo
    lprint ( "Send {}{} {}, last rtt: {}{}" . format ( oO0oo000O , o000o00o ,
 iiI111i1 , o0oooOO0o , OoOoo00Oo0o0O ) )
    ...
    if ( I1II . rloc_next_hop != None ) :
     OoO0o0oOoOo = lisp_get_host_route_next_hop ( oo0o00OO )
     if ( OoO0o0oOoOo ) : lisp_install_host_route ( oo0o00OO , OoO0o0oOoOo , False )
    ...
    if ( I1II . rloc . is_null ( ) ) :
     I1II . rloc . copy_address ( iiiiioOoooOoO00OO . rloc )
     if 18 - 18: iII111i
    ...
    i1IIIiI = iiI1I1IIi if ( OOo0oOOO0 . is_null ( ) ) else OOo0oOOO0
    lisp_send_map_request ( lisp_sockets , 0 , i1I1I , i1IIIiI , I1II )
    I1Ii11 = iiiiioOoooOoO00OO
    if 66 - 66: IiII . I1IiiI
    if 60 - 60: II111iiii * I1ii11iIi11i
    if 98 - 98: i11iIiiIii % OoOoOO00 * OoO0O00 * iIii1I11I1II1 . o0oOOo0O0Ooo - oO0o
    if 99 - 99: OoooooooOO . oO0o + I1Ii111 + iII111i - oO0o + I1IiiI
    if ( OOOOoo00 ) : lisp_install_host_route ( oo0o00OO , OOOOoo00 , False )
   ...
   if ( OoO0o0oOoOo ) : lisp_install_host_route ( oo0o00OO , OoO0o0oOoOo , True )
...
def lisp_update_rtr_updown ( rtr , updown ) :
 ...
 o0OoOOO0oo0 = rtr . print_address_no_iid ( )
 ...
 if ( lisp_rtr_list . has_key ( o0OoOOO0oo0 ) == False ) : return
 if 62 - 62: I1ii11iIi11i
 updown = "up" if updown else "down"
 lprint ( "Send ETR IPC message, RTR {} has done {}" . format (
 red ( o0OoOOO0oo0 , False ) , bold ( updown , False ) ) )
 ...
 oOOO0oo0 = "rtr%{}%{}" . format ( o0OoOOO0oo0 , updown )
...
def lisp_process_rloc_probe_reply ( rloc_entry , source , port , map_reply , ttl ,
 ...
 oo000o0OOOo = map_reply . hop_count
 oO0oo000O = bold ( "RLOC-probe reply" , False )
 ooOoO = I1II . print_address_no_iid ( )
 OO0oOOOOo = source . print_address_no_iid ( )
 O0OOOOOOo000 = lisp_rloc_probe_list
 ...
 if ( mrloc != None ) :
  ii1iiiiiIiIi = mrloc . rloc . print_address_no_iid ( )
  if ( mrloc . multicast_rloc_probe_list . has_key ( ooOoO ) == False ) :
   O0O0O0o00 = lisp_rloc ( )
   O0O0O0o00 = copy . deepcopy ( mrloc )
   O0O0O0o00 . rloc . copy_address ( I1II )
   O0O0O0o00 . multicast_rloc_probe_list = { }
   mrloc . multicast_rloc_probe_list [ ooOoO ] = O0O0O0o00
   if 91 - 91: OoooooooOO
  O0O0O0o00 = mrloc . multicast_rloc_probe_list [ ooOoO ]
  O0O0O0o00 . last_rloc_probe_nonce = mrloc . last_rloc_probe_nonce
  O0O0O0o00 . last_rloc_probe = mrloc . last_rloc_probe
  I1I111iIiI , iiI1I1IIi , OOo0oOOO0 = lisp_rloc_probe_list [ ii1iiiiiIiIi ] [ 0 ]
  O0O0O0o00 . process_rloc_probe_reply ( i1 , o0OOO , iiI1I1IIi , OOo0oOOO0 , oo000o0OOOo , ttl , oOooo0o )
  mrloc . process_rloc_probe_reply ( i1 , o0OOO , iiI1I1IIi , OOo0oOOO0 , oo000o0OOOo , ttl , oOooo0o )
  return
 ...
 o0o00O0oOooO0 = ooOoO
 if ( O0OOOOOOo000 . has_key ( o0o00O0oOooO0 ) == False ) :
  o0o00O0oOooO0 += ":" + str ( port )
  if ( O0OOOOOOo000 . has_key ( o0o00O0oOooO0 ) == False ) :
   o0o00O0oOooO0 = OO0oOOOOo
   if ( O0OOOOOOo000 . has_key ( o0o00O0oOooO0 ) == False ) :
    o0o00O0oOooO0 += ":" + str ( port )
    lprint ( "    Received unsolicited {} from {}/{}, port {}" . format ( oO0oo000O , red ( ooOoO , False ) , red ( OO0oOOOOo ,
    # iIii1I11I1II1
 False ) , port ) )
    return
    if 11 - 11: o0oOOo0O0Ooo
 ...
 for I1II , iiI1I1IIi , OOo0oOOO0 in lisp_rloc_probe_list [ o0o00O0oOooO0 ] :
  ...
  I1II . process_rloc_probe_reply ( i1 , o0OOO , iiI1I1IIi , OOo0oOOO0 , oo000o0OOOo , ttl , oOooo0o )
...
def lisp_decode_dist_name ( packet ) :
 I1I1 = 0
 O0o0oOOOO = ""
 if 44 - 44: I1Ii111 * iII111i . oO0o - O0 % I1IiiI . OoooooooOO
 while ( packet [ 0 : 1 ] != "\0" ) :
  if ( I1I1 == 255 ) : return ( [ None , None ] )
  O0o0oOOOO += packet [ 0 : 1 ]
  packet = packet [ 1 : : ]
  I1I1 += 1
  if 56 - 56: I1Ii111 % OoooooooOO
  if 34 - 34: I1ii11iIi11i + I1IiiI * iII111i . O0 . iII111i
 packet = packet [ 1 : : ]
 return ( packet , O0o0oOOOO )
...
def lisp_write_flow_log ( flow_log ) :
 ...
 for o00oo00O0OoOo in flow_log :
  ...
  oOOoooO0 = IiiiIi1iiii11 . print_flow ( o00oo00O0OoOo [ 0 ] , o00oo00O0OoOo [ 1 ] , o00oo00O0OoOo [ 2 ] )
  I1ii1ii . write ( oOOoooO0 )
  I1I1 += 1
...
def lisp_policy_command ( kv_pair ) :
 ...
 for iIi1I1 in range ( len ( kv_pair [ "datetime-range" ] ) ) :
  iii1IiI1ii . append ( lisp_policy_match ( ) )
  if 18 - 18: I1IiiI
  if 73 - 73: OoOoOO00 % II111iiii - I1ii11iIi11i - I11i / I1ii11iIi11i . I1ii11iIi11i
 for ooi1III in kv_pair . keys ( ) :
  Oo00OO0OO = kv_pair [ ooi1III ]
  if 91 - 91: i11iIiiIii * oO0o - iII111i * OoOoOO00 . I1Ii111 / i11iIiiIii
  if 78 - 78: OoO0O00 * o0oOOo0O0Ooo . Ii1I / I1IiiI / o0oOOo0O0Ooo
  if 32 - 32: I1IiiI . II111iiii
  if 70 - 70: O0
  if ( ooi1III == "instance-id" ) :
   for iIi1I1 in range ( len ( iii1IiI1ii ) ) :
    I11i1 = Oo00OO0OO [ iIi1I1 ]
    if ( I11i1 == "" ) : continue
    I1I1I = iii1IiI1ii [ iIi1I1 ]
    if ( I1I1I . source_eid == None ) :
     I1I1I . source_eid = lisp_address ( LISP_AFI_NONE , "" , 0 , 0 )
     if 45 - 45: I1Ii111 % I1Ii111 * O0 % i11iIiiIii - ooOoO0o
    if ( I1I1I . dest_eid == None ) :
     I1I1I . dest_eid = lisp_address ( LISP_AFI_NONE , "" , 0 , 0 )
     if 78 - 78: IiII - i1IIi - i11iIiiIii * o0oOOo0O0Ooo / I1IiiI
    I1I1I . source_eid . instance_id = int ( I11i1 )
    I1I1I . dest_eid . instance_id = int ( I11i1 )
    if 98 - 98: i11iIiiIii / ooOoO0o * OOooOOo
    if 34 - 34: I1IiiI * oO0o + i1IIi * Oo0Ooo / ooOoO0o . Ii1I
  if ( ooi1III == "source-eid" ) :
   for iIi1I1 in range ( len ( iii1IiI1ii ) ) :
    I11i1 = Oo00OO0OO [ iIi1I1 ]
    if ( I11i1 == "" ) : continue
    I1I1I = iii1IiI1ii [ iIi1I1 ]
    ...
    IiIIi11i111 = I1I1I . source_eid . instance_id
    I1I1I . source_eid . store_prefix ( I11i1 )
    I1I1I . source_eid . instance_id = IiIIi11i111
    if 3 - 3: Ii1I % IiII + O0 % iIii1I11I1II1
    if 2 - 2: IiII - i1IIi * IiII % O0 / Ii1I
  if ( ooi1III == "destination-eid" ) :
   for iIi1I1 in range ( len ( iii1IiI1ii ) ) :
    I11i1 = Oo00OO0OO [ iIi1I1 ]
    if ( I11i1 == "" ) : continue
    I1I1I = iii1IiI1ii [ iIi1I1 ]
    if ( I1I1I . dest_eid == None ) :
     I1I1I . dest_eid = lisp_address ( LISP_AFI_NONE , "" , 0 , 0 )
     if 64 - 64: iII111i - Oo0Ooo
    IiIIi11i111 = I1I1I . dest_eid . instance_id
    I1I1I . dest_eid . store_prefix ( I11i1 )
    I1I1I . dest_eid . instance_id = IiIIi11i111
    if 73 - 73: iIii1I11I1II1 * I1Ii111 * OoO0O00
    if 68 - 68: ooOoO0o * Ii1I / I1ii11iIi11i * OoooooooOO + OoooooooOO . OoooooooOO
  if ( ooi1III == "source-rloc" ) :
   for iIi1I1 in range ( len ( iii1IiI1ii ) ) :
    I11i1 = Oo00OO0OO [ iIi1I1 ]
    if ( I11i1 == "" ) : continue
    I1I1I = iii1IiI1ii [ iIi1I1 ]
    I1I1I . source_rloc = lisp_address ( LISP_AFI_NONE , "" , 0 , 0 )
    I1I1I . source_rloc . store_prefix ( I11i1 )
    if 50 - 50: I1IiiI % o0oOOo0O0Ooo
    if 1 - 1: II111iiii
  if ( ooi1III == "destination-rloc" ) :
   for iIi1I1 in range ( len ( iii1IiI1ii ) ) :
    I11i1 = Oo00OO0OO [ iIi1I1 ]
    if ( I11i1 == "" ) : continue
    I1I1I = iii1IiI1ii [ iIi1I1 ]
    I1I1I . dest_rloc = lisp_address ( LISP_AFI_NONE , "" , 0 , 0 )
    I1I1I . dest_rloc . store_prefix ( I11i1 )
    if 22 - 22: I1Ii111 + iII111i
    if 50 - 50: iII111i % OoOoOO00 - II111iiii + II111iiii / OoO0O00
  if ( ooi1III == "rloc-record-name" ) :
   for iIi1I1 in range ( len ( iii1IiI1ii ) ) :
    I11i1 = Oo00OO0OO [ iIi1I1 ]
    if ( I11i1 == "" ) : continue
    I1I1I = iii1IiI1ii [ iIi1I1 ]
    I1I1I . rloc_record_name = I11i1
  ...
  if ( ooi1III == "rle-name" ) :
   for iIi1I1 in range ( len ( iii1IiI1ii ) ) :
    ...
    if ( I11i1 == "" ) : continue
    I1I1I = iii1IiI1ii [ iIi1I1 ]
    I1I1I . rle_name = I11i1
    if 28 - 28: II111iiii + IiII / Oo0Ooo * I1IiiI - OOooOOo
    if 2 - 2: oO0o + I11i / I1Ii111 . I11i
  if ( ooi1III == "json-name" ) :
   for iIi1I1 in range ( len ( iii1IiI1ii ) ) :
    I11i1 = Oo00OO0OO [ iIi1I1 ]
    if ( I11i1 == "" ) : continue
    I1I1I = iii1IiI1ii [ iIi1I1 ]
    I1I1I . json_name = I11i1
    if 59 - 59: Ii1I
    if 47 - 47: iII111i % iII111i
  if ( ooi1III == "datetime-range" ) :
   for iIi1I1 in range ( len ( iii1IiI1ii ) ) :
    I11i1 = Oo00OO0OO [ iIi1I1 ]
    I1I1I = iii1IiI1ii [ iIi1I1 ]
    if ( I11i1 == "" ) : continue
    IIi1I1 = lisp_datetime ( I11i1 [ 0 : 19 ] )
    ooo0oOoooO = lisp_datetime ( I11i1 [ 19 : : ] )
    if ( IIi1I1 . valid_datetime ( ) and ooo0oOoooO . valid_datetime ( ) ) :
     I1I1I . datetime_lower = IIi1I1
     I1I1I . datetime_upper = ooo0oOoooO
  ...
  if ( ooi1III == "set-instance-id" ) :
   ...
   o0OoooOOO00 = int ( Oo00OO0OO )
   IiI1i1i1 . set_source_eid . instance_id = o0OoooOOO00
   IiI1i1i1 . set_dest_eid . instance_id = o0OoooOOO00
   if 48 - 48: I1Ii111 * oO0o / o0oOOo0O0Ooo * OoOoOO00 * ooOoO0o
  if ( ooi1III == "set-source-eid" ) :
   if ( IiI1i1i1 . set_source_eid == None ) :
    IiI1i1i1 . set_source_eid = lisp_address ( LISP_AFI_NONE , "" , 0 , 0 )
    if 38 - 38: I1IiiI * Ii1I + Oo0Ooo - OoooooooOO
   IiI1i1i1 . set_source_eid . store_prefix ( Oo00OO0OO )
   if ( o0OoooOOO00 != None ) : IiI1i1i1 . set_source_eid . instance_id = o0OoooOOO00
   if 63 - 63: I1ii11iIi11i
  if ( ooi1III == "set-destination-eid" ) :
   if ( IiI1i1i1 . set_dest_eid == None ) :
    IiI1i1i1 . set_dest_eid = lisp_address ( LISP_AFI_NONE , "" , 0 , 0 )
    if 99 - 99: I1Ii111 % oO0o - II111iiii . ooOoO0o
   IiI1i1i1 . set_dest_eid . store_prefix ( Oo00OO0OO )
   if ( o0OoooOOO00 != None ) : IiI1i1i1 . set_dest_eid . instance_id = o0OoooOOO00
   if 26 - 26: I1ii11iIi11i * iII111i . OoooooooOO - Oo0Ooo - IiII
  if ( ooi1III == "set-rloc-address" ) :
 ...
 IiI1i1i1 . match_clauses = iii1IiI1ii
...
def lisp_send_to_arista ( command , interface ) :
 ...
 ooo000OOo0Ooo = command
 if ( interface != "" ) : ooo000OOo0Ooo = interface + ": " + ooo000OOo0Ooo
 lprint ( "Send CLI command '{}' to hardware" . format ( ooo000OOo0Ooo ) )
...
def lisp_arista_is_alive ( prefix ) :
 ...
 oOOO = oOOO . split ( "\n" ) [ 1 ]
 OoOo00oo0OooO = oOOO . split ( " " )
 OoOo00oo0OooO = OoOo00oo0OooO [ - 1 ] . replace ( "\r" , "" )
...
def lisp_program_vxlan_hardware ( mc ) :
 ...
 o0OIii = commands . getoutput ( "ip route get {} | egrep vlan4094" . format ( IiI1Iiii ) )
 if 88 - 88: OoooooooOO
 if ( o0OIii != "" ) :
  lprint ( "Route {} already in hardware: '{}'" . format ( green ( IiI1Iiii , False ) , o0OIii ) )
 ...
 oO0O0 = commands . getoutput ( "ifconfig | egrep 'vxlan|vlan4094'" )
 if ( oO0O0 . find ( "vxlan" ) == - 1 ) :
  lprint ( "No VXLAN interface found, cannot program hardware" )
  return
  if 86 - 86: Ii1I * II111iiii % ooOoO0o
 if ( oO0O0 . find ( "vlan4094" ) == - 1 ) :
  lprint ( "No vlan4094 interface found, cannot program hardware" )
  return
  if 82 - 82: OOooOOo . Oo0Ooo * ooOoO0o % II111iiii % II111iiii - oO0o
 OoooOOOOO0 = commands . getoutput ( "ip addr | egrep vlan4094 | egrep inet" )
 if ( OoooOOOOO0 == "" ) :
  lprint ( "No IP address found on vlan4094, cannot program hardware" )
  return
  if 36 - 36: O0 / I1ii11iIi11i + iII111i * Oo0Ooo
 OoooOOOOO0 = OoooOOOOO0 . split ( "inet " ) [ 1 ]
 OoooOOOOO0 = OoooOOOOO0 . split ( "/" ) [ 0 ]
 ...
 O00oo0o = [ ]
 oOOOOooo0OOO0 = commands . getoutput ( "arp -i vlan4094" ) . split ( "\n" )
 for oOOo0ooO0 in oOOOOooo0OOO0 :
  if ( oOOo0ooO0 . find ( "vlan4094" ) == - 1 ) : continue
  if ( oOOo0ooO0 . find ( "(incomplete)" ) == - 1 ) : continue
  OoO0o0oOoOo = oOOo0ooO0 . split ( " " ) [ 0 ]
  O00oo0o . append ( OoO0o0oOoOo )
  if 88 - 88: i11iIiiIii
  if 5 - 5: I1ii11iIi11i % OOooOOo - I1ii11iIi11i + iII111i % II111iiii + iII111i
 OoO0o0oOoOo = None
 OO0O00OO0OO = OoooOOOOO0
 OoooOOOOO0 = OoooOOOOO0 . split ( "." )
 for iIi1I1 in range ( 1 , 255 ) :
  OoooOOOOO0 [ 3 ] = str ( iIi1I1 )
  o0o00O0oOooO0 = "." . join ( OoooOOOOO0 )
  if ( o0o00O0oOooO0 in O00oo0o ) : continue
  if ( o0o00O0oOooO0 == OO0O00OO0OO ) : continue
  OoO0o0oOoOo = o0o00O0oOooO0
  break
 ...
 i11iIIiiiI = I1II . split ( "." )
 OOo00ooO = lisp_hex_string ( i11iIIiiiI [ 1 ] ) . zfill ( 2 )
 IiiiiIi11iiI = lisp_hex_string ( i11iIIiiiI [ 2 ] ) . zfill ( 2 )
 i1I1i1II11I = lisp_hex_string ( i11iIIiiiI [ 3 ] ) . zfill ( 2 )
 i1III1iI = "00:00:00:{}:{}:{}" . format ( OOo00ooO , IiiiiIi11iiI , i1I1i1II11I )
 oooOoOOOo = "0000.00{}.{}{}" . format ( OOo00ooO , IiiiiIi11iiI , i1I1i1II11I )
 oOO0 = "arp -i vlan4094 -s {} {}" . format ( OoO0o0oOoOo , i1III1iI )
 os . system ( oOO0 )
 if 18 - 18: II111iiii
 if 51 - 51: O0 - I11i
 if 6 - 6: i1IIi . Ii1I - OoOoOO00 / iIii1I11I1II1
 if 11 - 11: oO0o - OOooOOo - I11i * I1IiiI
 II11i1I1I = ( "mac address-table static {} vlan 4094 " + "interface vxlan 1 vtep {}" ) . format ( oooOoOOOo , I1II )
 if 55 - 55: II111iiii
 lisp_send_to_arista ( II11i1I1I , None )
 ...
 oOOO0OoO = "ip route add {} via {}" . format ( IiI1Iiii , OoO0o0oOoOo )
 os . system ( oOOO0OoO )
 if 24 - 24: ooOoO0o
 lprint ( "Hardware programmed with commands:" )
 oOOO0OoO = oOOO0OoO . replace ( IiI1Iiii , green ( IiI1Iiii , False ) )
 lprint ( "  " + oOOO0OoO )
 lprint ( "  " + oOO0 )
 II11i1I1I = II11i1I1I . replace ( I1II , red ( I1II , False ) )
 lprint ( "  " + II11i1I1I )
 return
 if 19 - 19: oO0o
 if 97 - 97: IiII
...
def lisp_clear_hardware_walk ( mc , parms ) :
 O0oooOO00O = mc . eid . print_prefix_no_iid ( )
 os . system ( "ip route delete {}" . format ( O0oooOO00O ) )
 return ( [ True , None ] )
...
def lisp_clear_map_cache ( ) :
 ...
 if 90 - 90: OOooOOo
 i11iii = bold ( "User cleared" , False )
 I1I1 = lisp_map_cache . cache_count
 lprint ( "{} map-cache with {} entries" . format ( i11iii , I1I1 ) )
...
def lisp_encapsulate_rloc_probe ( lisp_sockets , rloc , nat_info , packet ) :
 ...
 17 , 0 , socket . htonl ( oOoOOo0OO0 . address ) , socket . htonl ( rloc . address ) )
 ooooo0Oo0 = lisp_ip_checksum ( ooooo0Oo0 )
 ...
 packet . inner_source . copy_address ( oOoOOo0OO0 )
 packet . inner_ttl = 64
 packet . outer_dest . copy_address ( rloc )
 packet . outer_source . copy_address ( oOoOOo0OO0 )
 ...
 o0ooO000Oo0oO = lisp_sockets [ 3 ]
 packet . send_packet ( o0ooO000Oo0oO , packet . outer_dest )
 del ( packet )
 return
...
def lisp_get_default_route_next_hops ( ) :
 ...
 if ( lisp_is_macos ( ) ) :
  ...
  iIioo0O0 = II1i = None
  for I1ii1ii in IIIIiII :
   if ( I1ii1ii . find ( "gateway: " ) != - 1 ) : iIioo0O0 = I1ii1ii . split ( ": " ) [ 1 ]
   if ( I1ii1ii . find ( "interface: " ) != - 1 ) : II1i = I1ii1ii . split ( ": " ) [ 1 ]
   if 18 - 18: iIii1I11I1II1 + Ii1I . o0oOOo0O0Ooo * I11i + OoooooooOO + i1IIi
  return ( [ [ II1i , iIioo0O0 ] ] )
  if 9 - 9: I1ii11iIi11i
 ...
 Iii1i = commands . getoutput ( ooO0ooooO ) . split ( "\n" )
 if 37 - 37: oO0o . IiII + I1ii11iIi11i
 i1iIIiiI1iI1i = [ ]
 for o0OIii in Iii1i :
  if ( o0OIii . find ( " metric " ) != - 1 ) : continue
  I1I111iIiI = o0OIii . split ( " " )
  try :
   O0oOooo0o0O0 = I1I111iIiI . index ( "via" ) + 1
   if ( O0oOooo0o0O0 >= len ( I1I111iIiI ) ) : continue
   o0oOO0O0 = I1I111iIiI . index ( "dev" ) + 1
   if ( o0oOO0O0 >= len ( I1I111iIiI ) ) : continue
  except :
   continue
   if 64 - 64: O0 % o0oOOo0O0Ooo + OoooooooOO - I1IiiI
   if 29 - 29: o0oOOo0O0Ooo - OoOoOO00 - OoooooooOO / OoOoOO00
  i1iIIiiI1iI1i . append ( [ I1I111iIiI [ o0oOO0O0 ] , I1I111iIiI [ O0oOooo0o0O0 ] ] )
  if 88 - 88: OoOoOO00 - IiII
 return ( i1iIIiiI1iI1i )
...
def lisp_get_host_route_next_hop ( rloc ) :
 ...
 o0OIii = commands . getoutput ( ooO0ooooO ) . split ( " " )
 if 17 - 17: Ii1I % I1ii11iIi11i + I11i
 try : ooo = o0OIii . index ( "via" ) + 1
 except : return ( None )
 if 80 - 80: i1IIi . OoooooooOO % OoooooooOO . oO0o / OOooOOo
 if ( ooo >= len ( o0OIii ) ) : return ( None )
 return ( o0OIii [ ooo ] )
 if 85 - 85: OOooOOo
...
def lisp_install_host_route ( dest , nh , install ) :
 ...
 OoOoo00Oo0o0O = "none" if nh == None else nh
 if 21 - 21: I1ii11iIi11i
 lprint ( "{} host-route {}, nh {}" . format ( install . title ( ) , dest , OoOoo00Oo0o0O ) )
 if 60 - 60: i1IIi / OoO0O00 . Ii1I
 if ( nh == None ) :
  O0O = "ip route {} {}/32" . format ( install , dest )
 else :
  O0O = "ip route {} {}/32 via {}" . format ( install , dest , nh )
...
def lisp_check_dp_socket ( ) :
 oo0000oO0 = lisp_ipc_dp_socket_name
 if ( os . path . exists ( oo0000oO0 ) == False ) :
  ii11II1II1 = bold ( "does not exist" , False )
  lprint ( "Socket '{}' {}" . format ( oo0000oO0 , ii11II1II1 ) )
  return ( False )
  if 68 - 68: I11i
 return ( True )
...
def lisp_write_to_dp_socket ( entry ) :
 try :
  oOoOOO = json . dumps ( entry )
  oo00o0o = bold ( "Write IPC" , False )
  lprint ( "{} record to named socket: '{}'" . format ( oo00o0o , oOoOOO ) )
  lisp_ipc_dp_socket . sendto ( oOoOOO , lisp_ipc_dp_socket_name )
 except :
  lprint ( "Failed to write IPC record to named socket: '{}'" . format ( oOoOOO ) )
...
def lisp_write_ipc_map_cache ( add_or_delete , mc , dont_send = False ) :
 ...
 if ( I1Ii11iI ) :
  if ( len ( mc . rloc_set ) >= 1 and mc . rloc_set [ 0 ] . rle ) :
   for IiioOoo in mc . rloc_set [ 0 ] . rle . rle_forwarding_list :
    ...
    II11iI11i1 , I11iII1iIi11 = IiioOoo . get_encap_keys ( )
    I1I111iIiI = lisp_build_json_keys ( I1I111iIiI , II11iI11i1 , I11iII1iIi11 , "encrypt-key" )
 ...
 Oo0o }
   II11iI11i1 , I11iII1iIi11 = I1II . get_encap_keys ( )
   I1I111iIiI = lisp_build_json_keys ( I1I111iIiI , II11iI11i1 , I11iII1iIi11 , "encrypt-key" )
...
def lisp_write_ipc_decap_key ( rloc_addr , keys ) :
 ...
 iI1ii11i = rloc_addr . split ( ":" )
 if ( len ( iI1ii11i ) == 1 ) :
  i1ii1i1Ii11 = { "type" : "decap-keys" , "rloc" : iI1ii11i [ 0 ] }
 else :
  i1ii1i1Ii11 = { "type" : "decap-keys" , "rloc" : iI1ii11i [ 0 ] , "port" : iI1ii11i [ 1 ] }
  if 63 - 63: oO0o + OoOoOO00
 i1ii1i1Ii11 = lisp_build_json_keys ( i1ii1i1Ii11 , II11iI11i1 , I11iII1iIi11 , "decrypt-key" )
...
def lisp_write_ipc_database_mappings ( ephem_port ) :
 ...
 for Oooo00oo in lisp_db_list :
  ...
  iiIIiII1I = { "instance-id" : str ( Oooo00oo . eid . instance_id ) ,
 "eid-prefix" : Oooo00oo . eid . print_prefix_no_iid ( ) }
  i1ii1i1Ii11 [ "database-mappings" ] . append ( iiIIiII1I )
...
def lisp_write_ipc_interfaces ( ) :
 ...
 for II1i in lisp_myinterfaces . values ( ) :
  ...
  iiIIiII1I = { "interface" : II1i . device ,
 "instance-id" : str ( II1i . instance_id ) }
  i1ii1i1Ii11 [ "interfaces" ] . append ( iiIIiII1I )
...
def lisp_parse_auth_key ( value ) :
 o0OiIII1iii = value . split ( "[" )
 I111I1iiIIi = { }
 if ( len ( o0OiIII1iii ) == 1 ) :
  I111I1iiIIi [ 0 ] = value
  return ( I111I1iiIIi )
  if 27 - 27: IiII
  if 86 - 86: iIii1I11I1II1 + OOooOOo % IiII . o0oOOo0O0Ooo % Oo0Ooo
 for I11i1 in o0OiIII1iii :
  if ( I11i1 == "" ) : continue
  ooo = I11i1 . find ( "]" )
  o00oO = I11i1 [ 0 : ooo ]
  try : o00oO = int ( o00oO )
...
def lisp_reassemble ( packet ) :
 ...
 o0O00o000OOoO = socket . ntohs ( struct . unpack ( "H" , packet [ 2 : 4 ] ) [ 0 ] )
 if 63 - 63: I11i % OoOoOO00
 IiiI111 = ( Ooi1IIii1i & 0x2000 == 0 and ( Ooi1IIii1i & 0x1fff ) != 0 )
 i1ii1i1Ii11 = [ ( Ooi1IIii1i & 0x1fff ) * 8 , o0O00o000OOoO - 20 , packet , IiiI111 ]
 ...
 oo0Oo0 = o0o00O0oOooO0 . print_address_no_iid ( )
 o0o00O0oOooO0 . address = socket . ntohl ( struct . unpack ( "I" , packet [ 16 : 20 ] ) [ 0 ] )
 i11iIIiIII = o0o00O0oOooO0 . print_address_no_iid ( )
 o0o00O0oOooO0 = red ( "{} -> {}" . format ( oo0Oo0 , i11iIIiIII ) , False )
 ...
 if ( iIIIi [ 0 ] [ 0 ] != 0 or iIIIi [ - 1 ] [ 3 ] == False ) : return ( None )
 OoOOooOoO = iIIIi [ 0 ]
 for o0o00OoOo0 in iIIIi [ 1 : : ] :
  Ooi1IIii1i = o0o00OoOo0 [ 0 ]
  Ii1I11iII , Ooo000 = OoOOooOoO [ 0 ] , OoOOooOoO [ 1 ]
  if ( Ii1I11iII + Ooo000 != Ooi1IIii1i ) : return ( None )
  OoOOooOoO = o0o00OoOo0
 ...
 packet = iIIIi [ 0 ] [ 2 ]
 for o0o00OoOo0 in iIIIi [ 1 : : ] : packet += o0o00OoOo0 [ 2 ] [ 20 : : ]
...
def lisp_get_crypto_decap_lookup_key ( addr , port ) :
 ...
 for OOOOO0oOO0 in lisp_crypto_keys_by_rloc_decap :
  oO0OO = OOOOO0oOO0 . split ( ":" )
  if ( len ( oO0OO ) == 1 ) : continue
  oO0OO = oO0OO [ 0 ] if len ( oO0OO ) == 2 else ":" . join ( oO0OO [ 0 : - 1 ] )
  if ( oO0OO == oo0o00OO ) :
   iIi11III = lisp_crypto_keys_by_rloc_decap [ OOOOO0oOO0 ]
...
def lisp_build_crypto_decap_lookup_key ( addr , port ) :
 ...
 if ( lisp_i_am_rtr ) :
  ...
  if 63 - 63: OoO0O00
  for iII1iiIiiii1I in lisp_nat_state_info . values ( ) :
   for oO0ooo in iII1iiIiiii1I :
    if ( addr == oO0ooo . address ) : return ( Oo00OO000oo0O )
    if 66 - 66: iIii1I11I1II1
    if 98 - 98: iII111i . oO0o % I1Ii111 + Oo0Ooo
  return ( addr )
  if 83 - 83: Oo0Ooo % oO0o - iII111i
 return ( Oo00OO000oo0O )
...
def lisp_is_rloc_probe ( packet , rr ) :
 ...
 oooOoOOo = ( socket . htons ( LISP_CTRL_PORT ) in [ oo0O , O0o0o0ooO0ooo ] )
 if ( oooOoOOo == False ) : return ( [ packet , None , None , None ] )
...
def lisp_process_data_plane_restart ( do_clear = False ) :
 ...
 if ( do_clear == False ) :
  o0Ooo0oOo = IIIII1 [ "entries" ]
  lisp_map_cache . walk_cache ( lisp_ipc_walk_map_cache , o0Ooo0oOo )
  if 6 - 6: OoOoOO00 / I1IiiI - I11i + i1IIi % iII111i . OoooooooOO
  if 2 - 2: OoooooooOO % o0oOOo0O0Ooo / iIii1I11I1II1
 lisp_write_to_dp_socket ( IIIII1 )
 return
 if 46 - 46: OoO0O00
 if 39 - 39: II111iiii + I1ii11iIi11i - I1IiiI
 if 56 - 56: OOooOOo + o0oOOo0O0Ooo - I11i - OoooooooOO % OoooooooOO . II111iiii
 if 37 - 37: I1Ii111 * iII111i . O0 / I1IiiI . i11iIiiIii - Oo0Ooo
 if 67 - 67: OoO0O00 . O0 * I1ii11iIi11i / OOooOOo * iIii1I11I1II1
 if 22 - 22: OoOoOO00 * I1Ii111 * OoooooooOO * OoO0O00 . iII111i
 if 97 - 97: I1IiiI * OOooOOo * oO0o
 if 7 - 7: o0oOOo0O0Ooo . Ii1I
 if 81 - 81: iIii1I11I1II1 % I11i * ooOoO0o * o0oOOo0O0Ooo / IiII
...
def lisp_process_data_plane_stats ( msg , lisp_sockets , lisp_port ) :
 ...
 for msg in msg [ "entries" ] :
  ...
  for i111IIi in Ii11I11I :
   if ( i111IIi . has_key ( "rloc" ) == False ) : continue
   if 78 - 78: II111iiii * Oo0Ooo
   O0ooo0Ooo = i111IIi [ "rloc" ]
   ...
   oo0O0O00o00O = 0 if i111IIi . has_key ( "packet-count" ) == False else i111IIi [ "packet-count" ]
   if 5 - 5: OoOoOO00 + Ii1I - OoO0O00
   ooooo0o0 = 0 if i111IIi . has_key ( "byte-count" ) == False else i111IIi [ "byte-count" ]
   if 21 - 21: i1IIi
   i1 = 0 if i111IIi . has_key ( "seconds-last-packet" ) == False else i111IIi [ "seconds-last-packet" ]
   if 11 - 11: Oo0Ooo % o0oOOo0O0Ooo % Oo0Ooo + Oo0Ooo + iIii1I11I1II1 / OOooOOo
   if 64 - 64: OoOoOO00
   o0oO0O00 . stats . packet_count += oo0O0O00o00O
   o0oO0O00 . stats . byte_count += ooooo0o0
   o0oO0O00 . stats . last_increment = lisp_get_timestamp ( ) - i1
   if 37 - 37: ooOoO0o - oO0o - i1IIi
   lprint ( "Update stats {}/{}/{}s for {} RLOC {}" . format ( oo0O0O00o00O , ooooo0o0 ,
 i1 , Ii1i1 , O0ooo0Ooo ) )
...
def lisp_process_data_plane_decap_stats ( msg , lisp_ipc_socket ) :
 ...
 OO00O0ooO = [ "good-packets" , "ICV-error" , "checksum-error" ,
 "lisp-header-error" , "no-decrypt-key" , "bad-inner-version" ,
 "outer-header-error" ]
 if 72 - 72: i1IIi * iII111i * Ii1I / o0oOOo0O0Ooo . I1Ii111 + i11iIiiIii
 for I11I in OO00O0ooO :
  oo0O0O00o00O = 0 if msg . has_key ( I11I ) == False else msg [ I11I ] [ "packet-count" ]
  if 45 - 45: o0oOOo0O0Ooo . i1IIi - I1IiiI + iIii1I11I1II1 * O0 . I1Ii111
  lisp_decap_stats [ I11I ] . packet_count += oo0O0O00o00O
  if 61 - 61: I1Ii111 . i1IIi % OoooooooOO
  ooooo0o0 = 0 if msg . has_key ( I11I ) == False else msg [ I11I ] [ "byte-count" ]
  if 54 - 54: Oo0Ooo
  lisp_decap_stats [ I11I ] . byte_count += ooooo0o0
  if 26 - 26: II111iiii
  i1 = 0 if msg . has_key ( I11I ) == False else msg [ I11I ] [ "seconds-last-packet" ]
  if 15 - 15: OoooooooOO * oO0o
  lisp_decap_stats [ I11I ] . last_increment = lisp_get_timestamp ( ) - i1
...
def lisp_process_punt ( punt_socket , lisp_send_sockets , lisp_ephem_port ) :
 Ii1I11I , iI1Iii1i1 = punt_socket . recvfrom ( 4000 )
 if 76 - 76: I11i * i11iIiiIii % I1ii11iIi11i
 iiI11Ii1I = json . loads ( Ii1I11I )
 if ( type ( iiI11Ii1I ) != dict ) :
 ...
 iIiI1II = bold ( "Punt" , False )
 lprint ( "{} message from '{}': '{}'" . format ( iIiI1II , iI1Iii1i1 , iiI11Ii1I ) )
 if 23 - 23: I1Ii111 / iII111i . O0 % II111iiii
 if ( iiI11Ii1I . has_key ( "type" ) == False ) :
 ...
 if ( iiI11Ii1I [ "type" ] == "statistics" ) :
  lisp_process_data_plane_stats ( iiI11Ii1I , lisp_send_sockets , lisp_ephem_port )
  return
  if 1 - 1: I1ii11iIi11i % O0 - I1ii11iIi11i / OoooooooOO / OoO0O00
 if ( iiI11Ii1I [ "type" ] == "decap-statistics" ) :
  lisp_process_data_plane_decap_stats ( iiI11Ii1I , punt_socket )
  return
  if 82 - 82: i1IIi % Ii1I
 ...
 if ( iiI11Ii1I [ "type" ] != "discovery" ) :
  lprint ( "Punt IPC message has wrong format" )
  return
  if 61 - 61: i1IIi
 if ( iiI11Ii1I . has_key ( "interface" ) == False ) :
 ...
 OoO0o0OOOO = iiI11Ii1I [ "interface" ]
 if ( OoO0o0OOOO == "" ) :
  IiIIi11i111 = int ( iiI11Ii1I [ "instance-id" ] )
 ...
 i1I1I = None
 if ( iiI11Ii1I . has_key ( "source-eid" ) ) :
  i1i1Ii1iiII1I = iiI11Ii1I [ "source-eid" ]
 ...
 i1IIIiI = None
 if ( iiI11Ii1I . has_key ( "dest-eid" ) ) :
  II1IIiI1 = iiI11Ii1I [ "dest-eid" ]
  i1IIIiI = lisp_address ( LISP_AFI_NONE , II1IIiI1 , 0 , IiIIi11i111 )
  if ( i1IIIiI . is_null ( ) ) :
   lprint ( "Invalid dest-EID format '{}'" . format ( II1IIiI1 ) )
   return
   if 55 - 55: OoO0O00
 ...
 if ( i1IIIiI ) :
  o0oO0o00 = lisp_map_cache_lookup ( i1I1I , i1IIIiI )
  if ( o0oO0o00 == None or o0oO0o00 . action == LISP_SEND_MAP_REQUEST_ACTION ) :
   ...
   if ( lisp_rate_limit_map_request ( i1IIIiI ) ) : return
   lisp_send_map_request ( lisp_send_sockets , lisp_ephem_port ,
 i1I1I , i1IIIiI , None )
  else :
   iIIi1iI1I1IIi = green ( i1IIIiI . print_address ( ) , False )
...
def lisp_itr_discover_eid ( db , eid , input_interface , routed_interface ,
 ...
 if ( input_interface != routed_interface ) :
  iiI1II1Ii = ", routed-interface " + routed_interface
  if 65 - 65: IiII - iIii1I11I1II1 + oO0o % iIii1I11I1II1
  if 45 - 45: I1ii11iIi11i
 Ii1iII11iIII = green ( Ii1i1 , False ) + bold ( " discovered" , False )
 lprint ( "Dynamic-EID {} on interface {}{}, timeout {}" . format ( Ii1iII11iIII , input_interface , iiI1II1Ii , OO0oOo . timeout ) )
 if 4 - 4: OoO0O00 * OoooooooOO % Oo0Ooo - o0oOOo0O0Ooo % iII111i
 if 60 - 60: iIii1I11I1II1
 if 15 - 15: OoO0O00
...
def lisp_retry_decap_keys ( addr_str , packet , iv , packet_icv ) :
 ...
 for o0Oo in lisp_crypto_keys_by_rloc_decap :
  ...
  O0ooiiiIIiiIiI11 = i1ii1i1Ii11 [ 1 ]
  if ( packet_icv != O0ooiiiIIiiIiI11 . do_icv ( packet , iv ) ) :
   lprint ( "Test ICV with key {} failed" . format ( red ( o0Oo , False ) ) )
   continue
   if 47 - 47: IiII - I1ii11iIi11i
   if 65 - 65: OoOoOO00 - i1IIi / OoO0O00 % I1ii11iIi11i + O0 * OoooooooOO
...
def lisp_get_decent_index ( eid ) :
 Ii1i1 = eid . print_prefix ( )
 I1IiOOOoo = hmac . new ( "lisp-decent" , Ii1i1 , hashlib . sha256 ) . hexdigest ( )
 ...
 if 80 - 80: I11i
 o0O0 = os . getenv ( "LISP_DECENT_HASH_WIDTH" )
 if ( o0O0 in [ "" , None ] ) :
  o0O0 = 12
 else :
  o0O0 = int ( o0O0 )
 ...
 Iii111i1iI1 = I1IiOOOoo [ 0 : o0O0 ]
 ooo = int ( Iii111i1iI1 , 16 ) % lisp_decent_modulus
 if 100 - 100: II111iiii + Oo0Ooo - O0 - OoO0O00 . o0oOOo0O0Ooo * i1IIi
 lprint ( "LISP-Decent modulus {}, hash-width {}, mod-value {}, index {}" . format ( lisp_decent_modulus , o0O0 / 2 , Iii111i1iI1 , ooo ) )
...
def lisp_trace_append ( packet , reason = None , ed = "encap" , lisp_socket = None ,
 ...
 iIi11iii1I1 = packet . packet [ oO0ooOoO : : ]
 o0o0OO = lisp_trace ( )
 if ( o0o0OO . decode ( iIi11iii1I1 ) == False ) :
  lprint ( "Could not decode JSON portion of a LISP-Trace packet" )
  return ( False )
  if 45 - 45: ooOoO0o
  if 52 - 52: I1ii11iIi11i % Ii1I - iIii1I11I1II1 . ooOoO0o % I1IiiI
 oO0ooO0OOOO = "?" if packet . outer_dest . is_null ( ) else packet . outer_dest . print_address_no_iid ( )
 if 68 - 68: iIii1I11I1II1 * i11iIiiIii / I1IiiI * iII111i
 ...
 if ( oO0ooO0OOOO != "?" and packet . encap_port != LISP_DATA_PORT ) :
  if ( ed == "encap" ) : oO0ooO0OOOO += ":{}" . format ( packet . encap_port )
  if 98 - 98: II111iiii
 ...
 IIi111 = packet . outer_source
 if ( IIi111 . is_null ( ) ) : IIi111 = lisp_myrlocs [ 0 ]
 i1ii1i1Ii11 [ "srloc" ] = IIi111 . print_address_no_iid ( )
 ...
 if ( oO0ooO0OOOO == "?" and reason != None ) :
 ...
 i1IIIiI = packet . inner_dest . print_address ( )
 if ( o0o0OO . packet_json == [ ] ) :
  oOoOOO = { }
  oOoOOO [ "seid" ] = i1I1I
  oOoOOO [ "deid" ] = i1IIIiI
  oOoOOO [ "paths" ] = [ ]
  o0o0OO . packet_json . append ( oOoOOO )
 ...
 for oOoOOO in o0o0OO . packet_json :
  if ( oOoOOO [ "deid" ] != i1IIIiI ) : continue
  oOoOOO [ "paths" ] . append ( i1ii1i1Ii11 )
  break
 ...
 II11iiII = False
 if ( len ( o0o0OO . packet_json ) == 1 and i1ii1i1Ii11 [ "node" ] == "ETR" and
 o0o0OO . myeid ( packet . inner_dest ) ) :
  oOoOOO = { }
  oOoOOO [ "seid" ] = i1IIIiI
  oOoOOO [ "deid" ] = i1I1I
  oOoOOO [ "paths" ] = [ ]
 ...
 i11i1I = o0o0OO . packet_json [ 0 ] [ "paths" ] [ 0 ] [ "srloc" ]
 if ( oO0ooO0OOOO == "?" ) :
  lprint ( "LISP-Trace return to sender RLOC {}" . format ( i11i1I ) )
  o0o0OO . return_to_sender ( lisp_socket , i11i1I , iIi11iii1I1 )
  return ( False )
  if 51 - 51: iIii1I11I1II1 . I1Ii111 / oO0o
  if 77 - 77: O0 . iIii1I11I1II1 % I1Ii111
 ...
 O00ooOoO0O0Ooo = packet . packet [ 0 : oO0ooOoO ]
 IiI1i1i1 = struct . pack ( "HH" , socket . htons ( iIIIIi ) , 0 )
 O00ooOoO0O0Ooo = O00ooOoO0O0Ooo [ 0 : oO0ooOoO - 4 ] + IiI1i1i1
 if ( packet . inner_version == 6 and i1ii1i1Ii11 [ "node" ] == "ETR" and
 len ( o0o0OO . packet_json ) == 2 ) :
  oOoO0OOO00O = O00ooOoO0O0Ooo [ oO0ooOoO - 8 : : ] + iIi11iii1I1
  oOoO0OOO00O = lisp_udp_checksum ( i1I1I , i1IIIiI , oOoO0OOO00O )
  O00ooOoO0O0Ooo = O00ooOoO0O0Ooo [ 0 : oO0ooOoO - 8 ] + oOoO0OOO00O [ 0 : 8 ]
 ...
 if ( II11iiII ) :
  if ( packet . inner_version == 4 ) :
   O00ooOoO0O0Ooo = O00ooOoO0O0Ooo [ 0 : 12 ] + O00ooOoO0O0Ooo [ 16 : 20 ] + O00ooOoO0O0Ooo [ 12 : 16 ] + O00ooOoO0O0Ooo [ 22 : 24 ] + O00ooOoO0O0Ooo [ 20 : 22 ] + O00ooOoO0O0Ooo [ 24 : : ]
   if 60 - 60: o0oOOo0O0Ooo - ooOoO0o + i11iIiiIii % I1ii11iIi11i % II111iiii
  else :
   O00ooOoO0O0Ooo = O00ooOoO0O0Ooo [ 0 : 8 ] + O00ooOoO0O0Ooo [ 24 : 40 ] + O00ooOoO0O0Ooo [ 8 : 24 ] + O00ooOoO0O0Ooo [ 42 : 44 ] + O00ooOoO0O0Ooo [ 40 : 42 ] + O00ooOoO0O0Ooo [ 44 : : ]
   if 62 - 62: Ii1I
 ...
 I11II1IiiI = 20 + iIIIIi if packet . inner_version == 4 else iIIIIi
 i11I1i = struct . pack ( "H" , socket . htons ( I11II1IiiI ) )
 O00ooOoO0O0Ooo = O00ooOoO0O0Ooo [ 0 : oO0ooOoO ] + i11I1i + O00ooOoO0O0Ooo [ oO0ooOoO + 2 : : ]
 ...
 if ( packet . inner_version == 4 ) :
  ...
  O00ooOoO0O0Ooo = O00ooOoO0O0Ooo [ 0 : 10 ] + IiiI11iIi + O00ooOoO0O0Ooo [ 12 : : ]
  i11I1i = lisp_ip_checksum ( O00ooOoO0O0Ooo [ 0 : 20 ] )
  O00ooOoO0O0Ooo = i11I1i + O00ooOoO0O0Ooo [ 20 : : ]
 ...
 packet . packet = O00ooOoO0O0Ooo + iIi11iii1I1
 return ( True )
...
def lisp_allow_gleaning ( eid , group , rloc ) :
 ...
 for i1ii1i1Ii11 in lisp_glean_mappings :
  if ( i1ii1i1Ii11 . has_key ( "instance-id" ) ) :
   IiIIi11i111 = eid . instance_id
   iIi11I11I , O0OoiI11Ii = i1ii1i1Ii11 [ "instance-id" ]
   if ( IiIIi11i111 < iIi11I11I or IiIIi11i111 > O0OoiI11Ii ) : continue
...
def lisp_build_gleaned_multicast ( seid , geid , rloc , port , igmp ) :
 ...
 i1i11iiIIii = seid . print_address_no_iid ( )
 OO0o0OO0 = green ( "{}" . format ( i1i11iiIIii ) , False )
 ...
 o0oO0O00 = iiIIIII1 = IiioOoo = None
 if ( o0oO0o00 . rloc_set != [ ] ) :
  o0oO0O00 = o0oO0o00 . rloc_set [ 0 ]
  if ( o0oO0O00 . rle ) :
   iiIIIII1 = o0oO0O00 . rle
   for O0oOO in iiIIIII1 . rle_nodes :
    if ( O0oOO . rloc_name != i1i11iiIIii ) : continue
    IiioOoo = O0oOO
    break
 ...
 if ( o0oO0O00 == None ) :
  ...
  if 24 - 24: OoooooooOO
 if ( iiIIIII1 == None ) :
  iiIIIII1 = lisp_rle ( geid . print_address ( ) )
  o0oO0O00 . rle = iiIIIII1
  if 11 - 11: i11iIiiIii / iIii1I11I1II1 % ooOoO0o + OOooOOo
 if ( IiioOoo == None ) :
  IiioOoo = lisp_rle_node ( )
  IiioOoo . rloc_name = i1i11iiIIii
  iiIIIII1 . rle_nodes . append ( IiioOoo )
  iiIIIII1 . build_forwarding_list ( )
...
def lisp_process_igmp_packet ( packet ) :
 ...
 o0OOooOOo = ( struct . unpack ( "B" , packet [ 0 ] ) [ 0 ] & 0x0f ) * 4
 if 47 - 47: oO0o % I1ii11iIi11i + IiII . i11iIiiIii % Oo0Ooo + Oo0Ooo
 if 90 - 90: Ii1I
 if 33 - 33: Oo0Ooo / OoO0O00 + o0oOOo0O0Ooo * Ii1I / iIii1I11I1II1 / i1IIi
 if 66 - 66: iII111i - ooOoO0o / i11iIiiIii + I1ii11iIi11i - Ii1I
 i1iiIi1I = packet [ o0OOooOOo : : ]
 O0o0OoooO = struct . unpack ( "B" , i1iiIi1I [ 0 ] ) [ 0 ]
 if 7 - 7: i1IIi + II111iiii
 ...
 OOo0oOOO0 . address = socket . ntohl ( struct . unpack ( "II" , i1iiIi1I [ : 8 ] ) [ 1 ] )
 ...
 OOOoOoo000 = ( O0o0OoooO in ( 0x12 , 0x16 , 0x17 , 0x22 ) )
 if ( OOOoOoo000 == False ) :
  i1iIi1III11 = "{} ({})" . format ( O0o0OoooO , igmp_types [ O0o0OoooO ] ) if igmp_types . has_key ( O0o0OoooO ) else O0o0OoooO
  if 67 - 67: i11iIiiIii / Oo0Ooo - o0oOOo0O0Ooo % II111iiii / iIii1I11I1II1 . o0oOOo0O0Ooo
  lprint ( "IGMP type {} not supported" . format ( i1iIi1III11 ) )
  return ( [ ] )
  if 49 - 49: II111iiii
  if 9 - 9: o0oOOo0O0Ooo
 if ( len ( i1iiIi1I ) < 8 ) :
 ...
 if ( O0o0OoooO in ( 0x12 , 0x16 ) ) :
  lprint ( "IGMPv{} join (*, {})" . format ( 1 if ( O0o0OoooO == 0x12 ) else 2 , bold ( oo0oo , False ) ) )
 ...
 if 99 - 99: I1ii11iIi11i + Oo0Ooo
 iI1I1 = "BBHI"
 ooOOooO = struct . calcsize ( iI1I1 )
 oooOOo00Oo000 = "I"
 iIII1IiiIII1iII = struct . calcsize ( oooOOo00Oo000 )
 iI1Iii1i1 = lisp_address ( LISP_AFI_IPV4 , "" , 32 , 0 )
 ...
 i1iiI = [ ]
 for iIi1I1 in range ( O000oOooO0oo ) :
  if ( len ( i1iiIi1I ) < ooOOooO ) : return
  I111Iii11I1 , oOo0oo , OO00 , ii1i1II11II1i = struct . unpack ( iI1I1 ,
 i1iiIi1I [ : ooOOooO ] )
  if 35 - 35: I1ii11iIi11i * I11i
  i1iiIi1I = i1iiIi1I [ ooOOooO : : ]
  if 43 - 43: II111iiii / II111iiii - I1ii11iIi11i - i1IIi + OoOoOO00
  if ( lisp_igmp_record_types . has_key ( I111Iii11I1 ) == False ) :
   lprint ( "Invalid record type {}" . format ( I111Iii11I1 ) )
   continue
   if 29 - 29: Ii1I
   if 20 - 20: I11i * OoooooooOO
  O0OOOoo00OoOO = lisp_igmp_record_types [ I111Iii11I1 ]
  OO00 = socket . ntohs ( OO00 )
  OOo0oOOO0 . address = socket . ntohl ( ii1i1II11II1i )
  oo0oo = OOo0oOOO0 . print_address_no_iid ( )
  if 16 - 16: OoOoOO00 * iIii1I11I1II1 + OoOoOO00 / iIii1I11I1II1 / ooOoO0o
  lprint ( "Record type: {}, group: {}, source-count: {}" . format ( O0OOOoo00OoOO , oo0oo , OO00 ) )
  if 5 - 5: Oo0Ooo + OoO0O00 + I1Ii111 + OoOoOO00
  if 78 - 78: I11i
  if 30 - 30: iIii1I11I1II1
  ...
  Oo0OoOo0OO = False
  if ( I111Iii11I1 in ( 1 , 5 ) ) : Oo0OoOo0OO = True
  if ( I111Iii11I1 in ( 2 , 4 ) and OO00 == 0 ) : Oo0OoOo0OO = True
  IiIi1i1 = "join" if ( Oo0OoOo0OO ) else "leave"
  ...
  if ( OO00 == 0 ) :
   i1iiI . append ( [ None , oo0oo , Oo0OoOo0OO ] )
 ...
 bold ( oo0oo , False ) ) )
  ...
  for oO00000o0OO0 in range ( OO00 ) :
   if ( len ( i1iiIi1I ) < iIII1IiiIII1iII ) : return
   ii1i1II11II1i = struct . unpack ( oooOOo00Oo000 , i1iiIi1I [ : iIII1IiiIII1iII ] ) [ 0 ]
   iI1Iii1i1 . address = socket . ntohl ( ii1i1II11II1i )
   o000OO0O0O0 = iI1Iii1i1 . print_address_no_iid ( )
   i1iiI . append ( [ o000OO0O0O0 , oo0oo , Oo0OoOo0OO ] )
   lprint ( "{} ({}, {})" . format ( IiIi1i1 ,
 green ( o000OO0O0O0 , False ) , bold ( oo0oo , False ) ) )
   i1iiIi1I = i1iiIi1I [ iIII1IiiIII1iII : : ]
   if 43 - 43: ooOoO0o - o0oOOo0O0Ooo / OoO0O00 % II111iiii
   if 44 - 44: Oo0Ooo % I1Ii111
   if 53 - 53: OoooooooOO . ooOoO0o - OOooOOo
   if 89 - 89: iIii1I11I1II1
   if 14 - 14: OoO0O00 % I11i + I1ii11iIi11i % I1Ii111
   if 38 - 38: iII111i . OoOoOO00 / I1Ii111 * I11i + iII111i
 ...
 if 50 - 50: I1IiiI . OoooooooOO + Oo0Ooo + OoooooooOO % I1Ii111
 if 61 - 61: oO0o - OoO0O00 + I1ii11iIi11i % OoO0O00 . i1IIi
...
def lisp_glean_map_cache ( seid , rloc , encap_port , igmp ) :
 ...
 if ( o0oO0o00 and len ( o0oO0o00 . rloc_set ) != 0 ) :
  ...
  if 2 - 2: I1IiiI + Ii1I / IiII
  iIiii1IiiIi1 = o0oO0o00 . rloc_set [ 0 ]
  iIii1Iiii1i = iIiii1IiiIi1 . rloc
  iI1Ii1 = iIiii1IiiIi1 . translated_port
  O0OO = ( iIii1Iiii1i . is_exact_match ( rloc ) == False or
 iI1Ii1 != encap_port )
  ...
  if ( O0OO ) :
   ...
   iIiii1IiiIi1 . delete_from_rloc_probe_list ( o0oO0o00 . eid , o0oO0o00 . group )
 ...
 o0Ooo0oOo = lisp_process_igmp_packet ( igmp )
 if ( type ( o0Ooo0oOo ) == bool ) : return
 if 11 - 11: II111iiii . i11iIiiIii % ooOoO0o * Ii1I * OoOoOO00 * OoooooooOO
 for iI1Iii1i1 , OOo0oOOO0 , Oo0OoOo0OO in o0Ooo0oOo :
...
def lisp_is_json_telemetry ( json_string ) :
 try :
  O00oo0 = json . loads ( json_string )
  if ( type ( O00oo0 ) != dict ) : return ( None )
 except :
  lprint ( "Could not decode telemetry json: {}" . format ( json_string ) )
  return ( None )
  if 55 - 55: o0oOOo0O0Ooo
  if 95 - 95: OoO0O00 * ooOoO0o * oO0o % Oo0Ooo
 if ( O00oo0 . has_key ( "type" ) == False ) : return ( None )
 if ( O00oo0 . has_key ( "sub-type" ) == False ) : return ( None )
 if ( O00oo0 [ "type" ] != "telemetry" ) : return ( None )
 if ( O00oo0 [ "sub-type" ] != "timestamps" ) : return ( None )
 return ( O00oo0 )
...
def lisp_encode_telemetry ( json_string , ii = "?" , io = "?" , ei = "?" , eo = "?" ) :
 O00oo0 = lisp_is_json_telemetry ( json_string )
 if ( O00oo0 == None ) : return ( json_string )
 if 59 - 59: II111iiii . II111iiii - iII111i
 if ( O00oo0 [ "itr-in" ] == "?" ) : O00oo0 [ "itr-in" ] = ii
 if ( O00oo0 [ "itr-out" ] == "?" ) : O00oo0 [ "itr-out" ] = io
 if ( O00oo0 [ "etr-in" ] == "?" ) : O00oo0 [ "etr-in" ] = ei
 if ( O00oo0 [ "etr-out" ] == "?" ) : O00oo0 [ "etr-out" ] = eo
 json_string = json . dumps ( O00oo0 )
 return ( json_string )
