...
def I1i1iii ( lisp_sockets , ttl , eid_only , ms_only , refresh ) :
 ...
 for iiIiIIi in list ( lisp . lisp_map_servers_list . values ( ) ) :
  ...
  for II11iI111i1 in o0o0oOoOO0O [ i1i1IIIIi1i ] :
   ...
   Ii1iI111 = oo000 . encode_xtr_id ( b"" )
...
def OooOO0o0 ( lisp_sockets , entries ) :
 ...
 if ( oOOO0oo0 == False ) :
  for iiIiIIi in list ( lisp . lisp_map_servers_list . values ( ) ) :
   o0o0oOoOO0O [ iiIiIIi . ms_name ] = [ b"" , 0 ]
...
def iiIii ( parms , not_used , packet ) :
 ...
 IiiIIi = struct . unpack ( "B" , packet [ 9 : 10 ] ) [ 0 ]
 if ( IiiIIi == 2 ) :
 ...
 if ( packet . lisp_header . get_instance_id ( ) == 0xffffff ) :
  ...
  II = iIi1Iii111I [ 28 : : ]
  ooo00Oo = - 1
  if ( lisp . lisp_is_rloc_probe_request ( II [ 0 : 1 ] ) ) :
   ooo00Oo = struct . unpack ( "B" , iIi1Iii111I [ 8 : 9 ] ) [ 0 ] - 1
...
def O00oO0O ( ipc ) :
 ...
 if ( I1IIIiI1I1ii1 and IiiI111I11 ) :
  if ( I1IIIiI1I1ii1 . interface == IiiI111I11 ) :
   ...
   lisp . lprint ( "Dynamic-EID {} interface change, {} -> {}" . format ( lisp . green ( OOO0o , False ) , I1IIIiI1I1ii1 . interface , IiiI111I11 ) )
 ...
 lisp . green ( OOO0o , False ) , IiiI111I11 , I1IIIiI1I1ii1 . timeout ) )
  ...
  if ( lisp . lisp_is_macos ( ) == False ) :
   ...
   ooOoOoO0 = "ip route add {} dev {}" . format ( OOO0o , IiiI111I11 )
   os . system ( ooOoOoO0 )
 ...
 if ( OOO0o in O0oOoOO . dynamic_eids ) :
  IiiI111I11 = O0oOoOO . dynamic_eids [ OOO0o ] . interface
 ...
 lisp . green ( OOO0o , False ) ) )
  ...
  if ( lisp . lisp_is_macos ( ) == False ) :
   OOO0o = i1OO0oOOoo . print_prefix_no_iid ( )
   ooOoOoO0 = "ip route delete {} dev {}" . format ( OOO0o , IiiI111I11 )
   os . system ( ooOoOoO0 )
   if 40 - 40: Oo0Ooo
   if 47 - 47: OoOoOO00
 return
...
while ( True ) :
 ...
 if ( Oo0oO0ooo in I1111i ) :
  ...
  if ( Oo000 == lisp . LISP_DATA_PORT ) :
   ...
   if ( lisp . lisp_is_rloc_probe_request ( Oo [ 0 : 1 ] ) ) :
