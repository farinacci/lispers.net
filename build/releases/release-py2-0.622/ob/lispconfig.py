...
def lisp_decent_prefix_command ( kv_pair ) :
 ...
 if ( len ( kv_pair [ "eid-prefix" ] ) != len ( kv_pair [ "lookup-length" ] ) ) :
  ...
  if 35 - 35: OOooOOo
 for o00oo in range ( len ( kv_pair [ "eid-prefix" ] ) ) :
  oOiiiIIIi = kv_pair [ "eid-prefix" ] [ o00oo ]
  O0o0ooOoOO = kv_pair [ "lookup-length" ] [ o00oo ]
  ...
  if ( "instance-id" in kv_pair and len ( kv_pair [ "instance-id" ] ) > o00oo ) :
   if ( kv_pair [ "instance-id" ] [ o00oo ] != "" ) :
    try :
     i11iii1II1I1 = int ( kv_pair [ "instance-id" ] [ o00oo ] )
    except :
     i11iii1II1I1 = 0
  ...
  oO0OOOO00o = lisp . lisp_address ( lisp . LISP_AFI_NONE , "" , 0 , 0 )
  oO0OOOO00o . store_prefix ( oOiiiIIIi )
  oO0OOOO00o . instance_id = i11iii1II1I1
  if 85 - 85: OoooooooOO * IiII . OOooOOo / iII111i / OoooooooOO
  if 87 - 87: OoO0O00
  if 32 - 32: i11iIiiIii - OoOoOO00 * I11i . Oo0Ooo * ooOoO0o
  if 21 - 21: OOooOOo
  if ( O0o0ooOoOO < oO0OOOO00o . mask_len ) :
   lisp . lprint ( "decent-lookup error, EID-prefix {} length > than lookup-length {}" . format ( oO0OOOO00o . print_prefix ( ) , O0o0ooOoOO ) )
  ...
  Ooo = True
  for IIIIiI1ii1 , OOooO00O0oo0 in lisp . lisp_decent_lookup_prefixes . items ( ) :
   if ( oO0OOOO00o . is_exact_match ( IIIIiI1ii1 ) and OOooO00O0oo0 == O0o0ooOoOO ) : Ooo = False
   if 12 - 12: OoooooooOO * OOooOOo * I1ii11iIi11i * ooOoO0o
   if 26 - 26: OoooooooOO . i1IIi + OoO0O00
  if ( Ooo ) :
   lisp . lisp_decent_lookup_prefixes [ oO0OOOO00o ] = O0o0ooOoOO
   lisp . lprint ( "decent-prefix configured, EID-prefix {} -> lookup-length {}" . format ( oO0OOOO00o . print_prefix ( ) , O0o0ooOoOO ) )
