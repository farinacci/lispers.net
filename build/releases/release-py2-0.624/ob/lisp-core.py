...
def I1ii11 ( ) :
 ...
 iII1iii = "egrep 'PID|python lisp|python -O lisp|python2 -O lisp|python3 -O lisp'"
...
def iii ( ) :
 ...
 iIIi1Ii1III = ""
 if os . path . exists ( "lisp-lig.pyo" ) : iIIi1Ii1III = "python2 -O lisp-lig.pyo"
 if os . path . exists ( "lisp-lig.pyc" ) : iIIi1Ii1III = "python3 -O lisp-lig.pyc"
 if os . path . exists ( "lisp-lig.py" ) : iIIi1Ii1III = "python2 lisp-lig.py"
...
def i111I11I ( ) :
 ...
 Ooo000O00 = ""
 if os . path . exists ( "lisp-rig.pyo" ) : Ooo000O00 = "python2 -O lisp-rig.pyo"
 if os . path . exists ( "lisp-rig.pyc" ) : Ooo000O00 = "python3 -O lisp-rig.pyo"
 if os . path . exists ( "lisp-rig.py" ) : Ooo000O00 = "python2 lisp-rig.py"
