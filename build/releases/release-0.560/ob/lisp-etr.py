...
def oO ( kv_pair ) :
 ...
 if ( Ii11iI1i ) :
  iiIiIIi = lisp . lisp_map_servers_list . values ( ) [ 0 ]
...
def o0o ( clause ) :
 ...
 for iiIiIIi in lisp . lisp_map_servers_list . values ( ) :
...
def OooOO0o0 ( lisp_sockets , entries ) :
 ...
 for iiIiIIi in lisp . lisp_map_servers_list . values ( ) :
  ...
  if ( o0o0oOoOO0O . has_key ( I1i ) == False ) : continue
...
def o0OO0oooo ( ) :
 ...
 oOoO = pcappy . open_live ( ooo0oo , 1600 , 0 , 100 )
 ...
 oOoO . loop ( - 1 , iiIii , [ ooo0oo , i1111 ] )
 return
...
def II1i ( ipc ) :
 ...
 I1IIIiI1I1ii1 = None
 if ( O0oOoOO . dynamic_eids . has_key ( OOO0o ) ) : I1IIIiI1I1ii1 = O0oOoOO . dynamic_eids [ OOO0o ]
 ...
 if ( I1IIIiI1I1ii1 and o0Oo00oOO ) :
  if ( I1IIIiI1I1ii1 . interface == o0Oo00oOO ) :
   ...
   lisp . lprint ( "Dynamic-EID {} interface change, {} -> {}" . format ( lisp . green ( OOO0o , False ) , I1IIIiI1I1ii1 . interface , o0Oo00oOO ) )
   if 12 - 12: ooOoO0o
 ...
 lisp . green ( OOO0o , False ) , o0Oo00oOO , I1IIIiI1I1ii1 . timeout ) )
  ...
  if ( lisp . lisp_is_macos ( ) == False ) :
   ...
   i1ii111i = "ip route add {} dev {}" . format ( OOO0o , o0Oo00oOO )
   os . system ( i1ii111i )
 ...
 if ( O0oOoOO . dynamic_eids . has_key ( OOO0o ) ) :
  o0Oo00oOO = O0oOoOO . dynamic_eids [ OOO0o ] . interface
 ...
 lisp . green ( OOO0o , False ) ) )
  ...
  if ( lisp . lisp_is_macos ( ) == False ) :
   OOO0o = i1OO0oOOoo . print_prefix_no_iid ( )
   i1ii111i = "ip route delete {} dev {}" . format ( OOO0o , o0Oo00oOO )
   os . system ( i1ii111i )
...
def i1I1i1i1I1 ( ipc ) :
 ...
 Ii1Ii1 , o0OOOooo0OOo , I11I1i1iI = ipc . split ( "%" )
...
while ( True ) :
 ...
 if ( Oo0oO0ooo in iiiiii1Ii ) :
  Ii1Ii1 , ooooooo00o , Oo000 , Oo = lisp . lisp_receive ( Oo0oO0ooo , False )
  ...
  if ( Oo000 == lisp . LISP_DATA_PORT ) :
   ...
   o00O0o = lisp . lisp_parse_packet ( oOOoo00O0O , Oo ,
 ooooooo00o , Oo000 )
   if 28 - 28: I1IiiI
 ...
 if ( i1 in iiiiii1Ii ) :
  Ii1Ii1 , ooooooo00o , Oo000 , Oo = lisp . lisp_receive ( i1 , True )
