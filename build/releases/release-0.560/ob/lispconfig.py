...
def lisp_banner_top ( no_hover ) :
 iiiii11iII1 = socket . gethostname ( )
 O0o = lisp . lisp_print_cour ( iiiii11iII1 )
 if ( no_hover == False ) :
  oO0 = getoutput ( "ifconfig" )
  O0o = lisp . lisp_span ( O0o , oO0 )
 ...
 i11IiIiiIIIII = '''
    ...
    ''' . format ( iiiii11iII1 , lisp . green ( "lispers" , True ) , lisp . red ( "net" , True ) ,
 lisp . bold ( "Scalable Open Overlay Networking" , True ) , O0o )
...
def lisp_clause_syntax_error ( kv_pair , parm , clause ) :
 OoO0ooO = ( kv_pair . has_key ( parm ) and type ( kv_pair [ parm ] ) == list )
...
def lisp_syntax_check ( kv_pairs , clause ) :
 ...
 for OOo00OoO in clause :
  ...
  if ( not kv_pairs . has_key ( IiII1II11I ) ) :
  ...
  if ( kv_pairs [ IiII1II11I ] [ 0 ] and oO . has_key ( IiII1II11I ) ) :
...
def lisp_find_user_account ( username , password ) :
 ...
 if ( II1iiIIiIii [ 1 ] == "" ) :
  ...
  if ( II1iiIIiIii [ 2 ] != IIi1 ) : return ( False )
 else :
...
def lisp_landing_page ( ) :
 ...
 oo0o = oo0o [ "lisp debug" ] if oo0o . has_key ( "lisp debug" ) else None
 o0 = "lisp xtr-parameters"
 IiiiI111I = lisp_get_clause_for_api ( o0 ) [ 0 ]
 III1I11i1iIi = False
 if ( IiiiI111I . has_key ( o0 ) ) :
 ...
 Ii11IiIi = { }
 for OOo0o in oo0o : Ii11IiIi [ OOo0o . keys ( ) [ 0 ] ] = OOo0o . values ( ) [ 0 ]
 oo0o = Ii11IiIi
 ...
 if ( i1II1I ) :
  ...
  if ( "yes" in oo0o . values ( ) or III1I11i1iIi ) :
...
def lisp_process_show_command ( lisp_socket , command ) :
 ...
 if ( lisp . lisp_is_running ( oOoo0 ) == False ) :
  i1iiI11I = ( "<i>Process '{}' is not running, command cannot be " + "executed</i><br>" ) . format ( oOoo0 )
 ...
 if ( oooO00Oo == "" ) :
  ...
  i1iiI11I = lisp_drain_socket ( lisp_socket , oOoo0 )
...
def lisp_start_stop_process ( process , startstop ) :
 ...
 ooooo0Oo0 = "python -O " if lisp . lisp_is_python2 ( ) else "python3.8 -O "
 ...
 if ( lisp . lisp_is_ubuntu ( ) or lisp . lisp_is_raspbian ( ) or lisp . lisp_is_debian ( ) or lisp . lisp_is_debian_kali ( ) ) :
  ...
  i1I111i1ii = ooooo0Oo0 + oO0O + " 2>&1 > " + Iiii1I + " &"
 else :
  i1I111i1ii = ooooo0Oo0 + oO0O + " >& " + Iiii1I + " &"
  if 81 - 81: Oo0Ooo - I11i
  if 24 - 24: OoooooooOO . OoO0O00 * II111iiii
 o0oO00 = getoutput ( "date" )
 if ( startstop and os . path . exists ( oO0O ) ) :
  lisp . lprint ( "Start process '{}' on {}" . format ( process , o0oO00 ) )
  os . system ( i1I111i1ii )
  time . sleep ( 1 )
  return
 ...
 if ( startstop == False and os . path . exists ( oO0O ) ) :
  lisp . lprint ( "Stop process '{}' on {}" . format ( process , o0oO00 ) )
  I1ii1i = getoutput ( "pgrep -f " + oO0O )
  I1ii1i = I1ii1i . split ( "\n" ) [ 0 ]
  os . system ( "kill " + I1ii1i )
...
def lisp_enable_command ( clause ) :
 ...
 for OoooooOo in oo0OoOO0o0o . keys ( ) :
...
def lisp_process_command_lines ( lisp_socket , old , new , line ) :
 ...
 if ( lisp_commands . has_key ( OO0OO00oo0 ) == False ) :
  line = "#>>> " + line . replace ( "\n" , " <<< invalid command\n" )
  new . write ( line )
  return
  if 66 - 66: O0
 ...
 for OOo00OoO in iiIiiIi :
  ...
  if ( lisp_begin_clause ( OOo00OoO ) ) :
   if ( IIIIiiI == 0 ) :
    ...
    OO0OO00oo0 = OO0OO00oo0 [ 0 ]
    OO0OO00oo0 = OO0OO00oo0 [ 0 : - 1 ]
    if ( lisp_commands . has_key ( OO0OO00oo0 ) ) :
...
def lisp_map_resolver_command ( kv_pair ) :
 ...
 for IiII1II11I in kv_pair . keys ( ) :
  ...
  if ( IiII1II11I == "rle-name" ) :
   for i1iIIiiIiII in range ( len ( III11i1iI11 ) ) :
    ...
    if ( oOOo0oO != "" ) :
     ...
     if ( lisp . lisp_rle_list . has_key ( oOOo0oO ) ) :
  ...
  if ( IiII1II11I == "elp-name" ) :
   for i1iIIiiIiII in range ( len ( III11i1iI11 ) ) :
    ...
    if ( oOOo0oO != "" ) :
     ...
     if ( lisp . lisp_elp_list . has_key ( oOOo0oO ) ) :
...
def lisp_display_map_cache ( mc , output ) :
 ...
 for I1IIi1I in mc . recent_sources :
  ...
  oO0 += "  " + I1IIi1I + ": " + lisp . lisp_print_elapsed ( oo0O ) + "\n"
  if 100 - 100: OoooooooOO - O0 . I11i / I11i + II111iiii * OoOoOO00
 OOOO0oo0 = lisp . lisp_span ( OOOO0oo0 , oO0 [ 0 : - 1 ] )
 i11111 = mc . action
 if 60 - 60: OOooOOo
 if 73 - 73: ooOoO0o
 ...
 if ( len ( mc . rloc_set ) == 0 ) :
  ...
  output += lisp_table_row ( OOOO0oo0 , Oo000o + "<br>" + i1iIi , "--" , oooO00Oo ,
 IiIII , i11111 , "--" )
  return ( [ True , output ] )
 ...
 iI1iI . print_rloc_probe_latency ( ) )
  ...
  if ( i11111 == "encapsulate" ) :
   ...
   if ( lisp . lisp_i_am_rtr and o0o0OOo0O . translated_port != 0 ) :
    ...
    if 6 - 6: Oo0Ooo
   Ii1I1i = o0o0OOo0O . rloc . print_address_no_iid ( ) + ":" + str ( ooO00o )
  ...
  output += lisp_table_row ( OOOO0oo0 , Oo000o + "<br>" + i1iIi , i1 , oooO00Oo ,
 ...
 str ( o0o0OOo0O . priority ) + "/" + str ( o0o0OOo0O . weight ) + "<br>" + str ( o0o0OOo0O . mpriority ) + "/" + str ( o0o0OOo0O . mweight ) )
  ...
  if ( Oo000o != "" ) : Oo000o , i1iIi , oooO00Oo = ( "" , "" , "" )
  if 58 - 58: I11i
 return ( [ True , output ] )
...
def lisp_display_nat_info ( output , dc , dodns ) :
 ...
 oO0 = "{} entries in the NAT-traversal port table" . format ( Oo00o )
 oooo00Oo0O = lisp . lisp_span ( "NAT-Traversed xTR Information:" , oO0 )
  ...
  for iIIi11 in Ii1 :
   ...
   if ( dodns ) :
    try :
     ...
     o0OoOo0O00 = "?"
     if 9 - 9: OOooOOo
    output += lisp_table_row ( O0o , II , ooO00o , OOoO000O0OO , o0OoOo0O00 )
   else :
    output += lisp_table_row ( O0o , II , ooO00o , OOoO000O0OO )
...
def lisp_itr_rtr_show_command ( parameter , itr_or_rtr , lisp_threads , dns = False ) :
 ...
 oo0O . input_queue . qsize ( ) ) )
  ...
  i1iiI11I += lisp_table_header ( "LISP-RTR Forwarding Stats:" , * I1IIi1I )
  ...
  i1iiI11I += lisp_table_row ( * I1IIi1I )
 ...
 oO0 = "{} map-resolvers configured" . format ( len ( lisp . lisp_map_resolvers_list ) )
 if 89 - 89: OoooooooOO * Ii1I * I1IiiI . ooOoO0o * Ii1I / iII111i
 oooo00Oo0O = "LISP-{} Configured Map-Resolvers{}" . format ( itr_or_rtr , oOo0O0 )
 oooo00Oo0O = lisp . lisp_span ( oooo00Oo0O , oO0 )
 if 46 - 46: i11iIiiIii
 ...
 for Oo0oOo0O0O0o in lisp . lisp_map_resolvers_list . values ( ) :
  ...
  Oo000o = lisp . lisp_print_elapsed ( Oo0oOo0O0O0o . last_used )
  I11IIiI1IiI1 = lisp . lisp_print_elapsed ( Oo0oOo0O0O0o . last_reply )
  iI11IiiiIII = 0 if Oo0oOo0O0O0o . neg_map_replies_received == 0 else float ( Oo0oOo0O0O0o . total_rtt / Oo0oOo0O0O0o . neg_map_replies_received )
  if 43 - 43: iII111i + i11iIiiIii
  iI11IiiiIII = str ( round ( iI11IiiiIII , 3 ) ) + " ms"
  if 96 - 96: OOooOOo . OoOoOO00 * O0
  i1iiI11I += lisp_table_row ( Ii1I1i , Oo000o , Oo0oOo0O0O0o . map_requests_sent ,
 ...
 i11IiIiiIIIII = '''
    ...
    ''' . format ( o0Oo0oO00Oooo , lisp . lisp_print_sans ( i11IiIiiIIIII ) , o00o0 )
 ...
 oO0 = "{} entries in the map-cache" . format ( lisp . lisp_map_cache . cache_size ( ) )
...
def lisp_itr_rtr_show_rloc_probe_command ( itr_or_rtr ) :
 ...
 for iiiI in lisp . lisp_rloc_probe_list . values ( ) :
  if 77 - 77: II111iiii - i11iIiiIii
  OOOO0oo0 = ""
  for iI1iI , o0o00O0oOOo , O0ooO in iiiI :
   iIOO = lisp . green ( lisp . lisp_print_eid_tuple ( o0o00O0oOOo , O0ooO ) , True )
   OOOO0oo0 += lisp . lisp_print_cour ( iIOO ) + "<br>"
   if 4 - 4: Ii1I % I1ii11iIi11i + I11i - I1ii11iIi11i
  OOOO0oo0 = ", EIDs ({}):<br>" . format ( len ( iiiI ) ) + OOOO0oo0
  if 98 - 98: Ii1I - O0 * oO0o * Ii1I * Ii1I
  iI1iI , o0o00O0oOOo , O0ooO = iiiI [ 0 ]
  if 44 - 44: IiII + I11i
  if 66 - 66: oO0o
 ...
 lisp . bold ( ":" , True ) , iI1iI . translated_port )
  ...
  if ( iI1iI . multicast_rloc_probe_list != { } ) :
   ooo000 += iI1iI . multicast_rloc_probe_list . values ( )
 ...
 OO00oOOO , O0Ooo0o )
   ...
   oOoO = lisp . lisp_print_cour ( oOoO )
   I11IiI1I11i1i = iI1iI . print_rloc_probe_latency ( )
   I11IiI1I11i1i = lisp . lisp_print_cour ( I11IiI1I11i1i )
   iI1iI = iI1iI . print_rloc_probe_rtt ( )
   iI1iI = lisp . lisp_print_cour ( iI1iI )
   II1I11 += ( "Telemetry: rtt: {}, hops: {}, latency: {}<br>" + "recent-rtts: {}, recent-hops: {}, recent-latencies: {}" ) . format ( iI1iI , oOoO , I11IiI1I11i1i , ii111I1i1 , Iii11I1i , oO0OOoOO )
  ...
  i1iiI11I += lisp_table_row ( Ii1iII1ii1 , II1I11 )
...
def lisp_rle_command ( kv_pair ) :
 ...
 for IiII1II11I in kv_pair . keys ( ) :
  ...
  for ii1Iiii1I in i1II111iiii :
   O0OO0O = i1II111iiii . index ( ii1Iiii1I )
   if ( O0OO0O >= len ( oo00oO0O0 ) ) : O0OO0O = len ( oo00oO0O0 ) - 1
   oOOo0oO = oo00oO0O0 [ O0OO0O ]
   if ( IiII1II11I == "level" ) :
    if ( oOOo0oO == "" ) : oOOo0oO = "0"
...
def lisp_get_lookup_string ( input_str ) :
 ...
 if ( I11iiI1i1 ) :
  ...
  if ( len ( OOooO ) == 1 ) :
   ...
   I1i1i1IIi1I . store_prefix ( OOOO0oo0 )
   OO0oO = True
...
def lisp_show_map_cache_lookup ( eid_str ) :
 ...
 Ii = OOooO0o if ( I1i1i1IIi1I . is_null ( ) ) else OO0oO
 if 94 - 94: IiII / I1Ii111 / i1IIi
 OOo0o = lisp . lisp_map_cache . lookup_cache ( II111I1i1 , Ii )
 if ( OOo0o == None ) :
  i1iiI11I += "{} {}" . format ( lisp . lisp_print_sans ( "Lookup not found for" ) ,
 lisp . lisp_print_cour ( eid_str ) )
 else :
  if ( II111I1i1 == I1i1i1IIi1I ) :
   IiiI = OOo0o . lookup_source_cache ( Oo0OOo , OOooO0o )
   if ( IiiI ) : OOo0o = IiiI
   if 79 - 79: OoooooooOO * I1Ii111 - i1IIi * OoooooooOO % O0 % iIii1I11I1II1
   if 82 - 82: OoOoOO00 . Ii1I
  Oo000o = lisp . lisp_print_elapsed ( OOo0o . uptime )
  i1iiI11I += "{} {} {} {} {} {} {}" . format ( lisp . lisp_print_sans ( "Exact" if OOooO0o else "Longest" ) ,
  # I1Ii111 . i11iIiiIii / Ii1I * i11iIiiIii - o0oOOo0O0Ooo
...
def lisp_get_clause_for_api ( command ) :
 ...
 for OOo00OoO in iiIiiIi :
  ...
  if ( lisp_end_clause ( OOo00OoO ) ) :
   IIIIiiI -= 1
   if ( IIIIiiI ) :
    iIi11I11 [ command ] . append ( oo000o )
    oo000o = { }
    continue
    if 83 - 83: i11iIiiIii - I1IiiI * i11iIiiIii
   iIIIII . append ( iIi11I11 )
   iIi11I11 = { command : [ ] }
   ooOo0o = False
   continue
  ...
  if ( len ( oo000o ) == 0 ) :
   ...
   oo000o [ Ii1I1i1IiiI ] [ o0 ] = oo00oO0O0
...
def lisp_put_clause_for_api ( data ) :
 ...
 OO0OO00oo0 = data . keys ( ) [ 0 ]
 if ( OO0OO00oo0 not in lisp_commands . keys ( ) ) :
  return ( [ { OO0OO00oo0 : [ { "?" : "add/replace" } ] } ] )
  if 84 - 84: iII111i / II111iiii
  if 86 - 86: I1IiiI
 oOoOO = ( OO0OO00oo0 in [ "lisp enable" , "lisp debug" , "lisp xtr-parameters" ] )
 ...
 if ( oOoOO == False ) :
  o0o0 = True
  OoOo00oOoo0oO = getoutput ( "egrep '{}' ./lisp.config" . format ( OO0OO00oo0 ) )
  OoOo00oOoo0oO = OoOo00oOoo0oO . split ( "\n" )
  for OOo00OoO in OoOo00oOoo0oO :
   if ( OOo00OoO [ 0 : len ( OO0OO00oo0 ) ] == OO0OO00oo0 ) : o0o0 = False
 ...
 i11oO0OoO = data [ OO0OO00oo0 ]
 i11oO0OoO = lisp_unicode_to_ascii ( i11oO0OoO )
 iIi11I11 = OO0OO00oo0 + " {\n" if o0o0 else ""
 ...
 if 26 - 26: IiII
 if 52 - 52: O0 + ooOoO0o
 for Ii111 in i11oO0OoO :
  if ( type ( i11oO0OoO ) == dict ) :
   oo00oO0O0 = i11oO0OoO [ Ii111 ]
   if ( type ( oo00oO0O0 ) == dict ) : oo00oO0O0 = json_dumps ( oo00oO0O0 )
   iIi11I11 += "    " + Ii111 + " = " + oo00oO0O0 + "\n"
   continue
  ...
  for o0 in Ii111 :
   ...
   if ( type ( oo00oO0O0 ) != dict ) :
    ...
    if 56 - 56: I11i
   iIi11I11 += "    " + O0OOOO0o0O + " {\n"
   for Oo0ooo0ooo in oo00oO0O0 : iIi11I11 += "        " + Oo0ooo0ooo + " = " + oo00oO0O0 [ Oo0ooo0ooo ] + "\n"
   iIi11I11 += "    }\n"
   if 45 - 45: I11i . Oo0Ooo % Ii1I % iII111i
   if 44 - 44: OoooooooOO * OoooooooOO + OoooooooOO . OoO0O00 * O0
 iIi11I11 += "}\n"
 if 16 - 16: OoO0O00
 ...
 if ( lisp_duplicate_command_clause ( OO0OO00oo0 , iIi11I11 ) ) :
  ...
  if 82 - 82: OoooooooOO
 Oo0O = "./lisp.config"
 IIiIiI1i11iiII = Oo0O + ".temp"
 if 64 - 64: Ii1I
 IIiiiIi1ii11I = open ( Oo0O , "r" )
 ii1II11I11i11 = open ( IIiIiI1i11iiII , "w" )
 if 51 - 51: OoooooooOO / o0oOOo0O0Ooo
 IiI1i1iI = False
 iIIi = False
 for OOo00OoO in IIiiiIi1ii11I :
  if ( iIIi ) :
   if ( lisp_end_clause ( OOo00OoO ) == False ) : continue
   iIIi = False
   continue
  ...
  if ( IiI1i1iI == False and lisp_begin_clause ( OOo00OoO ) and
 OOo00OoO [ 0 : len ( OO0OO00oo0 ) ] == OO0OO00oo0 ) :
   if ( oOoOO == False ) :
    ii1II11I11i11 . write ( OOo00OoO )
    for iiIIiIi1i1I1 in iIi11I11 : ii1II11I11i11 . write ( iiIIiIi1i1I1 )
    IiI1i1iI = True
 ...
 ii1II11I11i11 . close ( )
 if 12 - 12: Ii1I
 os . system ( "cp {} {}" . format ( IIiIiI1i11iiII , Oo0O ) )
 os . system ( "rm {}" . format ( IIiIiI1i11iiII ) )
 return ( [ { OO0OO00oo0 : [ { "!" : "add/replace" } ] } ] )
 if 2 - 2: OoooooooOO
...
def lisp_remove_clause_for_api ( data ) :
 ...
 II1I1i1I = [ ]
 o0 = i11oO0OoO . keys ( ) [ 0 ]
 oo00oO0O0 = i11oO0OoO [ o0 ]
 if 21 - 21: OoooooooOO
 if ( type ( oo00oO0O0 ) == dict ) :
  for o0 in oo00oO0O0 . keys ( ) :
...
def lisp_u2a_walk_dict_array ( adata , a_dict ) :
 for o0 in a_dict :
  if ( type ( a_dict [ o0 ] ) == dict ) :
   oOooOO0oOo0O0 = { }
   oo00oO0O0 = a_dict [ o0 ]
   for Oo0ooo0ooo in oo00oO0O0 : oOooOO0oOo0O0 [ Oo0ooo0ooo . encode ( ) ] = oo00oO0O0 [ Oo0ooo0ooo ] . encode ( )
...
def lisp_map_server_command ( kv_pairs ) :
 ...
 for IiII1II11I in kv_pairs . keys ( ) :
 ...
 for Ii1I1i in oOoooOOO0 :
  if ( Ii1I1i == "" ) : continue
  IiiIIiIIii1iI = lisp . lisp_ms ( Ii1I1i , None , o000o00OO00Oo , OOoO00OOo , O000O , IIo00ooo ,
...
def lisp_database_mapping_command ( kv_pair , ephem_port = None , replace = True ) :
 ...
 if ( len ( i1I1I1 ) > 1 ) :
  for o0o0OOo0O in i1I1I1 :
   o0o0OOo0O . rloc_name = O0o + "-" + o0o0OOo0O . interface
   if 9 - 9: IiII . I11i
...
def lisp_show_db_list ( itr_or_etr , output ) :
 oO0 = "{} database-mapping entries" . format ( len ( lisp . lisp_db_list ) )
 ...
 for oo0iI1IIIi11iIII in lisp . lisp_db_list :
  ...
  for o0o0OOo0O in oo0iI1IIIi11iIII . rloc_set :
   ...
   if ( itr_or_etr == "ITR" ) :
    output += lisp_table_row ( o0000o0OOOo , Oo000o , i1 ,
...
def lisp_interface_command ( kv_pair ) :
 ...
 if ( lisp . lisp_myinterfaces . has_key ( oOOOO ) and i1I1IIIII1IIi == None ) :
...
def lisp_show_dynamic_eid_command ( parm ) :
 ...
 if ( oo0iI1IIIi11iIII == None ) : return ( i1iiI11I )
 if 91 - 91: OoOoOO00 + o0oOOo0O0Ooo
 ooooOoO0O = "ITR" if lisp . lisp_i_am_itr else "ETR"
 OOOO0oo0 = oo0iI1IIIi11iIII . print_eid_tuple ( )
 if 23 - 23: i1IIi
 oooo00Oo0O = "LISP-{} Discovered Dynamic EIDs for {}:" . format ( ooooOoO0O , OOOO0oo0 )
 ...
 for IiIIIii1iIII1 in oo0iI1IIIi11iIII . dynamic_eids . values ( ) :
  ...
  if ( ooooOoO0O == "ITR" ) :
   ...
   i1iiI11I += lisp_table_row ( Oo0OOo , IiIIIii1iIII1 . interface , IiIiIIi1 , iI1II1III , IIi1Iii )
  else :
   i1iiI11I += lisp_table_row ( Oo0OOo , IiIIIii1iIII1 . interface , IiIiIIi1 , IIi1Iii )
...
def lisp_show_decap_stats ( output , etr_or_rtr ) :
 ...
 for o0 in lisp . lisp_decap_stats :
  OO0OoO0 = "<a href='/lisp/clear/{}/stats/{}'>{}</a>" . format ( I11IiI1I11i1i , o0 , o0 )
 ...
 I1IIi1I = [ ]
 for OO00 in lisp . lisp_decap_stats . values ( ) :
 ...
 "Key Material" )
   for o0 in lisp . lisp_crypto_keys_by_nonce :
    ...
    for OoooooooOo00O in oo00oO0O0 :
     ...
     i1iiI11I += lisp_table_row ( Ii1iII1ii1 , oo0oo00 , OoooooooOo00O . key_id , ii11ii11II )
     Ii1iII1ii1 = ""
 ...
 "Rekey Count" , "Use Count" , "Key-ID" , "Key Material" )
  for o0 in lisp . lisp_crypto_keys_by_rloc_encap :
   ...
   for OoooooooOo00O in oo00oO0O0 :
    ...
    ii11ii11II = OoooooooOo00O . print_keys ( False )
    i1iiI11I += lisp_table_row ( Ii1iII1ii1 , oo0oo00 , ii1Ii , OoooooooOo00O . rekey_count ,
