...
class api_init ( object ) :
 ...
 do_get = True ) :
  ...
  if ( port < 0 ) :
   port = - port
   I11I11i1I = I11I11i1I . replace ( "s" , "" )
   if 49 - 49: II111iiii % iII111i * O0
  self . url = I11I11i1I + self . host + ":{}/lisp/api/" . format ( str ( port ) )
 ...
 def get_enable ( self , force_query = False ) :
  ...
  Ii11iII1 = self . __get ( "lisp enable" )
  self . enable_status = Ii11iII1
  return ( Ii11iII1 )
 ...
 def get_debug ( self ) :
  ...
  Ii11iII1 = self . __get ( "lisp debug" )
  self . debug_status = Ii11iII1
  return ( Ii11iII1 )
 ...
 def get_xtr_parameters ( self ) :
  ...
  Ii11iII1 = self . __get ( "lisp xtr-parameters" )
  self . xtr_parameters = Ii11iII1
  return ( Ii11iII1 )
 ...
 def enable_itr ( self ) :
  ...
  Ii11iII1 = self . __put ( "lisp enable" , self . enable_status )
  return ( self . __error ( Ii11iII1 ) == False )
 ...
 def enable_core_debug ( self ) :
  ...
  Ii11iII1 = self . __put ( "lisp debug" , self . debug_status )
  return ( self . __error ( Ii11iII1 ) == False )
  if 79 - 79: O0
 ...
 def add_user_account ( self , username , password ) :
  ...
  Ii11iII1 = self . __put ( "lisp user-account" ,
 ...
 def delete_user_account ( self , username ) :
  ...
  Ii11iII1 = self . __delete ( "lisp user-account" , { "username" : username } )
  return ( self . __error ( Ii11iII1 ) == False )
  if 23 - 23: i11iIiiIii
 ...
 def enable_itr_security ( self ) :
  ...
  Ii11iII1 = self . __put ( "lisp xtr-parameters" , self . xtr_parameters )
  if ( self . __error ( Ii11iII1 ) ) : return ( "put error" )
  return ( "good" )
 ...
 def add_mr_ddt_root ( self , address = "" ) :
  ...
  Ii11iII1 = self . __put ( "lisp ddt-root" , { "address" : address } )
  if ( self . __error ( Ii11iII1 ) ) : return ( "put error" )
  return ( "good" )
 ...
 def delete_mr_ddt_root ( self , address = "" ) :
  ...
  Ii11iII1 = self . __delete ( "lisp ddt-root" , { "address" : address } )
  if ( self . __error ( Ii11iII1 ) ) : return ( "delete error" )
  return ( "good" )
 ...
 def add_mr_referral ( self , iid = "0" , prefix = "" , group = "" , referral_set = [ ] ) :
  ...
  Ii11iII1 = self . __build_prefix_tuple ( iid , prefix , group )
  Ii11iII1 = [ Ii11iII1 ]
  for i1 in referral_set :
   Ii11iII1 . append ( { "referral" : { "address" : i1 } } )
   if 51 - 51: OoO0O00 - O0 % oO0o - II111iiii
  Ii11iII1 = self . __put ( "lisp referral-cache" , Ii11iII1 )
 ...
 def delete_mr_referral ( self , iid = "0" , prefix = "" , group = "" ) :
  ...
  Ii11iII1 = self . __build_prefix_tuple ( iid , prefix , group )
  Ii11iII1 = self . __delete ( "lisp referral-cache" , Ii11iII1 )
 ...
 referral_set = [ ] ) :
  ...
  Ii11iII1 = [ Ii11iII1 ]
  for i1 in referral_set :
   Ii11iII1 . append ( { "delegate" : { "address" : i1 } } )
   if 53 - 53: Ii1I % Ii1I * o0oOOo0O0Ooo + OoOoOO00
   if 92 - 92: OoooooooOO + i1IIi / Ii1I * O0
  Ii11iII1 = self . __put ( "lisp delegation" , Ii11iII1 )
 ...
 def delete_ddt_delegation ( self , iid = "0" , prefix = "" , group = "" ) :
  ...
  Ii11iII1 = self . __build_prefix_tuple ( iid , prefix , group )
  Ii11iII1 = self . __delete ( "lisp delegation" , Ii11iII1 )
 ...
 def add_ddt_auth_prefix ( self , iid = "0" , auth_prefix = "" , group = "" ) :
  ...
  Ii11iII1 = self . __build_prefix_tuple ( iid , auth_prefix , group )
  Ii11iII1 = [ Ii11iII1 [ "prefix" ] ]
  Ii11iII1 = self . __put ( "lisp ddt-authoritative-prefix" , Ii11iII1 )
  if 27 - 27: Ii1I
  if ( self . __error ( Ii11iII1 ) ) : return ( "put error" )
  return ( "good" )
  if 67 - 67: I1IiiI
 ...
 def delete_ddt_auth_prefix ( self , iid = "0" , auth_prefix = "" , group = "" ) :
  ...
  Ii11iII1 = self . __build_prefix_tuple ( iid , auth_prefix , group )
  Ii11iII1 = self . __delete ( "lisp ddt-authoritative-prefix" , Ii11iII1 )
  if 90 - 90: iII111i
  if ( self . __error ( Ii11iII1 ) ) : return ( "delete error" )
  return ( "good" )
  if 31 - 31: OOooOOo + O0
 ...
 peer_set = [ ] ) :
  ...
  for OOoOoo0 in peer_set :
   Ii11iII1 . append ( { "peer" : { "address" : OOoOoo0 } } )
   if 17 - 17: Ii1I + oO0o . OoO0O00 - Oo0Ooo * i11iIiiIii
   if 20 - 20: I1IiiI . OoooooooOO % OOooOOo
  Ii11iII1 = self . __put ( "lisp map-server-peer" , Ii11iII1 )
 ...
 def delete_ms_map_server_peer ( self , iid = "0" , prefix = "" , group = "" ) :
  ...
  Ii11iII1 = self . __build_prefix_tuple ( iid , prefix , group )
  Ii11iII1 = self . __delete ( "lisp map-server-peer" , Ii11iII1 )
 ...
 def add_ms_site ( self , site_name , auth_key , prefix_list , description = "" ) :
  ...
  Ii11iII1 = [ ]
  Ii11iII1 . append ( { "site-name" : site_name } )
  Ii11iII1 . append ( { "description" : description } )
  Ii11iII1 . append ( { "authentication-key" : auth_key } )
  Ii11iII1 . append ( prefix_list )
  Ii11iII1 = self . __put ( "lisp site" , Ii11iII1 )
  if 1 - 1: oO0o
  if ( self . __error ( Ii11iII1 ) ) : return ( "put error" )
  return ( "good" )
 ...
 group = "" , ams = False , fpr = False , fnpr = False , pprd = False , pra = "" ) :
  ...
  Ii11iII1 = self . __build_prefix_tuple ( iid , prefix , group ,
 kw = "allowed-prefix" )
  Ii1i1i1111 = Ii11iII1 [ "allowed-prefix" ]
 ...
 def delete_ms_site ( self , site_name ) :
  ...
  Ii11iII1 = self . __delete ( "lisp site" , { "site-name" : site_name } )
  if ( self . __error ( Ii11iII1 ) ) : return ( "delete error" )
  return ( "good" )
 ...
 rloc_set = [ ] ) :
  ...
  for i1 in rloc_set :
   if ( type ( i1 ) == dict ) :
    Ii11iII1 . append ( { "rloc" : i1 } )
    continue
    if 56 - 56: i11iIiiIii . o0oOOo0O0Ooo - I1IiiI * I11i
    if 91 - 91: oO0o + OoooooooOO - i1IIi
   if ( i1 in [ "en0" , "en1" , "eth0" , "eth1" ] ) :
    Ii11iII1 . append ( { "rloc" : { "interface" : i1 } } )
   else :
    if ( self . __is_dist_name ( i1 ) ) :
     Ii11iII1 . append ( { "rloc" : { "rloc-record-name" : i1 } } )
    else :
     Ii11iII1 . append ( { "rloc" : { "address" : i1 } } )
     if 84 - 84: Ii1I / IiII
     if 86 - 86: OoOoOO00 * II111iiii - O0 . OoOoOO00 % iIii1I11I1II1 / OOooOOo
     if 11 - 11: I1IiiI * oO0o + I1ii11iIi11i / I1ii11iIi11i
     if 37 - 37: i11iIiiIii + i1IIi
  Ii11iII1 = self . __put ( "lisp database-mapping" , Ii11iII1 )
 ...
 def delete_etr_database_mapping ( self , iid = "0" , prefix = "" , group = "" ) :
  ...
  if 36 - 36: O0 + Oo0Ooo
  Ii11iII1 = self . __build_prefix_tuple ( iid , prefix , group )
  Ii11iII1 = self . __delete ( "lisp database-mapping" , Ii11iII1 )
 ...
 address_is_name = False ) :
  ...
  if ( self . enable_status == None ) : return
  if 62 - 62: Ii1I
  Ii11iII1 = self . __put ( "lisp map-server" ,
 ...
 def get_etr_map_server ( self , address , address_is_name = False ) :
  ...
  Ii11iII1 = self . __get_data ( "lisp map-server" , { oOooO00o0O : address } )
  return ( Ii11iII1 )
 ...
 def delete_etr_map_server ( self , address , address_is_name = False ) :
  ...
  if ( self . enable_status == None ) : return
  if 83 - 83: I1Ii111
  Ii11iII1 = self . __delete ( "lisp map-server" , { oOooO00o0O : address } )
  if ( self . __error ( Ii11iII1 ) ) : return ( "delete error" )
  return ( "good" )
 ...
 def add_itr_map_resolver ( self , address , address_is_name = False ) :
  ...
  Ii11iII1 = self . __put ( "lisp map-resolver" , { oOooO00o0O : address } )
  if ( self . __error ( Ii11iII1 ) ) : return ( "put error" )
  return ( "good" )
 ...
 def get_itr_map_resolver ( self , address , address_is_name = False ) :
  ...
  Ii11iII1 = self . __get_data ( "lisp map-resolver" , { oOooO00o0O : address } )
  return ( Ii11iII1 )
 ...
 def delete_itr_map_resolver ( self , address , address_is_name = False ) :
  ...
  Ii11iII1 = self . __delete ( "lisp map-resolver" , { oOooO00o0O : address } )
  if ( self . __error ( Ii11iII1 ) ) : return ( "delete error" )
  return ( "good" )
 ...
 def add_itr_map_cache ( self , iid = "0" , prefix = "" , group = "" , rloc_set = [ ] ) :
  ...
  Ii11iII1 = self . __put ( "lisp map-cache" , Ii11iII1 )
 ...
 def delete_itr_map_cache ( self , iid = "0" , prefix = "" , group = "" ) :
  ...
  if 23 - 23: I11i
  Ii11iII1 = self . __build_prefix_tuple ( iid , prefix , group )
  Ii11iII1 = self . __delete ( "lisp map-cache" , Ii11iII1 )
  if ( self . __error ( Ii11iII1 ) ) : return ( "delete error" )
  return ( "good" )
 ...
 def get_system ( self ) :
  ...
  Ii11iII1 = self . __get_data ( "lisp system" , "" )
  return ( Ii11iII1 )
 ...
 def get_map_cache ( self ) :
  ...
  if 93 - 93: i1IIi
  Ii11iII1 = self . __get_data ( "lisp map-cache" , "" )
  return ( Ii11iII1 )
 ...
 def get_map_cache_entry ( self , iid = "" , prefix = "" , group = "" ) :
  ...
  Ii11iII1 = self . __build_prefix_tuple ( iid , prefix , group )
  Ii11iII1 = self . __get_data ( "lisp map-cache" , Ii11iII1 )
  return ( Ii11iII1 )
 ...
 def get_site_cache ( self ) :
  ...
  Ii11iII1 = self . __get_data ( "lisp site-cache" , "" )
  return ( Ii11iII1 )
 ...
 def get_site_cache_entry ( self , iid = "" , prefix = "" , group = "" ) :
  ...
  Ii11iII1 = self . __build_prefix_tuple ( iid , prefix , group )
  Ii11iII1 = self . __get_data ( "lisp site-cache" , Ii11iII1 )
  return ( Ii11iII1 )
 ...
 match_datetime_range != None ) :
  ...
  Ii11iII1 = [ ]
  Ii11iII1 . append ( IIii1 )
  Ii11iII1 . append ( o00Ooo0 )
  if 48 - 48: O0 * Ii1I - O0 / Ii1I + OoOoOO00
  Ii11iII1 = self . __put ( "lisp policy" , Ii11iII1 )
 ...
 def delete_policy ( self , policy_name ) :
  ...
  Ii11iII1 = self . __delete ( "lisp policy" , { "policy-name" : policy_name } )
  if ( self . __error ( Ii11iII1 ) ) : return ( "delete error" )
  return ( "good" )
 ...
 def __unicode_to_ascii ( self , command , rtext ) :
  ...
  Ii11iII1 = json . loads ( str ( rtext ) ) [ 0 ]
  i11i11 = str ( command )
  if ( i11i11 not in Ii11iII1 ) : return ( None )
  if 18 - 18: iIii1I11I1II1 + I11i * I1IiiI - OOooOOo / I1IiiI
  if ( type ( Ii11iII1 ) == dict ) :
   Ii11iII1 = Ii11iII1 [ i11i11 ]
   o00 = { }
   for iI1i1II in Ii11iII1 :
    for i11i11 in iI1i1II :
     o00 [ str ( i11i11 ) ] = str ( iI1i1II [ i11i11 ] )
     if 14 - 14: ooOoO0o - iIii1I11I1II1 / O0 % IiII . OoOoOO00
     if 18 - 18: oO0o * oO0o % oO0o
  else :
   o00 = [ ]
   for Ii1I1I1i11ii in Ii11iII1 :
    OoOo0oO0o = { }
    o0OoOo00ooO = list ( Ii1I1I1i11ii . values ( ) ) [ 0 ]
    for i11i11 in o0OoOo00ooO : OoOo0oO0o [ str ( i11i11 ) ] = str ( o0OoOo00ooO [ i11i11 ] )
    OoOo0oO0o = { str ( list ( Ii1I1I1i11ii . keys ( ) ) [ 0 ] ) : OoOo0oO0o }
 ...
 def __walk_dict_array ( self , udata , u_dict ) :
  for i11i11 in u_dict :
   ...
   if ( type ( u_dict [ i11i11 ] ) == dict ) :
    ...
    for oOoO00 in IiIi1i : Ii1i1 [ str ( oOoO00 ) ] = str ( IiIi1i [ oOoO00 ] )
    IiIi1i = Ii1i1
 ...
 def __ascii_to_unicode ( self , command , ascii_data ) :
  ...
  for Ii1I1I1i11ii in ascii_data :
   ...
   if ( type ( Ii1I1I1i11ii ) == dict ) :
    ...
    oooOO0oOooO00 = { str ( list ( Ii1I1I1i11ii . keys ( ) ) [ 0 ] ) : oooOO0oOooO00 }
    if 17 - 17: I1IiiI
  ...
  Oo0O = { }
  Oo0O [ str ( command ) ] = oooOO0oOooO00 [ 0 ] if OoO0O000 else oooOO0oOooO00
 ...
 def __check_prefix_syntax ( self , prefix ) :
  ...
  if 98 - 98: i1IIi
  OOO0oO = prefix . find ( "/" )
  if ( OOO0oO == - 1 ) : return ( False )
  return ( self . __check_address_syntax ( prefix [ 0 : OOO0oO ] ) )
 ...
 def __check_address_set_syntax ( self , address_set , allow_interfaces ) :
  for oOOOo0o in address_set :
   if ( type ( oOOOo0o ) == str ) :
    iiiii11I1 = oOOOo0o
   else :
    iiiii11I1 = oOOOo0o [ "address" ] if ( "address" in oOOOo0o ) else oOOOo0o [ "interface" ] if ( "interface" in oOOOo0o ) else ""
    if 16 - 16: O0 . Ii1I % i1IIi % OOooOOo
    if 50 - 50: IiII + o0oOOo0O0Ooo
   if ( allow_interfaces and
 iiiii11I1 in [ "en0" , "en1" , "eth0" , "eth1" ] ) : continue
   if ( self . __check_address_syntax ( iiiii11I1 ) ) : continue
   return ( False )
   if 96 - 96: OoO0O00
  return ( True )
 ...
 def __check_address_syntax ( self , address ) :
  ...
  oOOOo0o = address . split ( "." )
  if ( len ( oOOOo0o ) > 1 ) :
   if ( len ( oOOOo0o ) != 4 ) : return ( False )
   for Ooo0oO in range ( 4 ) :
    if ( oOOOo0o [ Ooo0oO ] . isdigit ( ) == False ) : return ( False )
    Ii = int ( oOOOo0o [ Ooo0oO ] )
    if ( Ii < 0 or Ii > 255 ) : return ( False )
 ...
 def __build_prefix_tuple ( self , iid , eid_prefix , group , kw = "prefix" ) :
  Ii11iII1 = { }
  Ii11iII1 [ "instance-id" ] = iid
  Ii11iII1 [ "eid-prefix" ] = eid_prefix
  if ( group != "" ) : Ii11iII1 [ "group-prefix" ] = group
  return ( { kw : Ii11iII1 } )
