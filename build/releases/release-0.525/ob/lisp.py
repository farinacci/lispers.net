...
class lisp_json ( ) :
 ...
 def print_json ( self , html ) :
  i11iii11 = self . json_string
  IiiiIi = "***"
  if ( html ) : IiiiIi = red ( IiiiIi , html )
  oO0oooOo0OOoO0oo0oO = IiiiIi + self . json_string + IiiiIi
  if ( self . valid_json ( ) ) : return ( i11iii11 )
  return ( oO0oooOo0OOoO0oo0oO )
 ...
 def encrypt_json ( self ) :
  ...
  iiI1iiIiiiI1I = "0" * 8
  if 73 - 73: O0 . Oo0Ooo
  IioO0O = json . loads ( self . json_string )
  for Oo000O000 in IioO0O :
   i11II = IioO0O [ Oo000O000 ]
   i11II = chacha . ChaCha ( II11iI11i1 , iiI1iiIiiiI1I ) . encrypt ( i11II )
   IioO0O [ Oo000O000 ] = binascii . hexlify ( i11II )
   if 49 - 49: I1ii11iIi11i / II111iiii - ooOoO0o / I1Ii111 - oO0o
  self . json_string = json . dumps ( IioO0O )
 ...
 def decrypt_json ( self ) :
  ...
  IioO0O = json . loads ( self . json_string )
  for Oo000O000 in IioO0O :
   i11II = binascii . unhexlify ( IioO0O [ Oo000O000 ] )
   IioO0O [ Oo000O000 ] = chacha . ChaCha ( II11iI11i1 , iiI1iiIiiiI1I ) . encrypt ( i11II )
...
class lisp_trace ( ) :
 ...
 def print_trace ( self ) :
  IioO0O = self . packet_json
  lprint ( "LISP-Trace JSON: '{}'" . format ( IioO0O ) )
  if 34 - 34: I1IiiI
  if 56 - 56: Ii1I
 def encode ( self ) :
