...
def iiII1IIii1i1 ( ipc ) :
 ...
 i1iI1IIi1I = False
 if ( iIi11III in O0O00Ooo ) :
  OOo00O = O0O00Ooo [ iIi11III ]
 else :
 ...
 Ooo ]
  ...
  if 92 - 92: oO0o
  if 7 - 7: iII111i
 oOOoOO0O00o = i1i1IiIiIi1Ii . split ( lisp . LISP_TP )
 if ( len ( oOOoOO0O00o ) != 2 ) :
  lisp . lprint ( "Invalid NAT IPC rloc-name {}" . format ( oOOoOO0O00o ) )
  return
  if 38 - 38: i11iIiiIii . iIii1I11I1II1 . OOooOOo / OoO0O00
  if 18 - 18: Oo0Ooo * I1Ii111
 Oo0o0ooO0ooo , O0O0o0oO0O00 = oOOoOO0O00o [ 0 ] , int ( oOOoOO0O00o [ 1 ] )
 if ( lisp . lisp_store_nat_info ( Oo0o0ooO0ooo , OOo00O , O0O0o0oO0O00 ) == False ) :
...
def Oo00oo ( ipc ) :
 ...
 o0ooo , iII1I1IiI11ii , oO = ipc . split ( "%" )
...
def oooooO0oO0ooO ( ipc ) :
 iIII1IiI , o0ooo , IIIIIiI1I1 , oOoO = ipc . split ( "%" )
 oOoO = int ( oOoO , 16 )
 if 57 - 57: Oo0Ooo % OoO0O00
 IIii1IIiiIii = lisp . lisp_get_echo_nonce ( None , IIIIIiI1I1 )
 if ( IIii1IIiiIii == None ) : IIii1IIiiIii = lisp . lisp_echo_nonce ( IIIIIiI1I1 )
 if 75 - 75: O0 % iIii1I11I1II1 / OoOoOO00 % OOooOOo / IiII
 if ( o0ooo == "R" ) :
  IIii1IIiiIii . request_nonce_sent = oOoO
  lisp . lprint ( "Waiting for echo-nonce 0x{} from {}" . format ( lisp . lisp_hex_string ( oOoO ) , lisp . red ( IIii1IIiiIii . rloc_str , False ) ) )
  if 31 - 31: i11iIiiIii * OoOoOO00
 elif ( o0ooo == "E" ) :
  IIii1IIiiIii . echo_nonce_sent = oOoO
  lisp . lprint ( "Sent echo-nonce 0x{} to {}" . format ( lisp . lisp_hex_string ( oOoO ) , lisp . red ( IIii1IIiiIii . rloc_str , False ) ) )
  if 69 - 69: i11iIiiIii
  if 61 - 61: O0
 return
...
if 38 - 38: O0
while ( True ) :
 try : ooO , i1i1i11iI11II , iIII1IiI = select . select ( o00OIIIIIiiI , [ ] , [ ] )
 except : break
 ...
 if 28 - 28: i11iIiiIii
 if ( Oo in ooO ) :
  o0ooo , II1iIi11 , O0O0o0oO0O00 , Ooo0oo = lisp . lisp_receive ( Oo , False )
  ...
  if ( O0O0o0oO0O00 == lisp . LISP_DATA_PORT ) :
   ...
   iio00O0o00oo = lisp . lisp_parse_packet ( o0oOoO00o , Ooo0oo ,
 ...
 oo000OO00Oo , [ o0oOoO00o ] )
    ...
    if 6 - 6: Oo0Ooo
 if ( Ooo in ooO ) :
  o0ooo , II1iIi11 , O0O0o0oO0O00 , Ooo0oo = lisp . lisp_receive ( Ooo , True )
