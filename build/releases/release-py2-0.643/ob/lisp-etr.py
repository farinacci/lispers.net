...
def oo0oO00o0O00o ( ) :
 ...
 if ( lisp . lisp_is_python3 ( ) ) :
  ...
  while ( True ) :
   ...
   try :
    iIIIiIi1i , OoO = I1iI1i11IiI11 . next ( )
   except :
    continue
    if 36 - 36: OoOoOO00
   if ( OoO == None or len ( OoO ) == 0 ) : continue
...
def I111 ( ) :
 ...
 if ( pytun != None ) :
  ...
  try :
   ...
   ii1iIII1ii = i1111 . name
   lisp . lprint ( "Rename tunnel name from '{}' to '{}'" . format ( ii1iIII1ii , i1i1 ) )
   os . system ( "ip link set {} name {} up" . format ( ii1iIII1ii , i1i1 ) )
  except :
   lisp . lprint ( "Cannot create tuntap interface" )
   if 47 - 47: I11i . iII111i * Ii1I - ooOoO0o . I11i - OOooOOo
...
def iiII1IIii1i1 ( ipc ) :
 ...
 IiIi1111ii = ipc [ 1 ]
 i1iiiIIi11II = ipc [ 2 ]
 if ( i1iiiIIi11II == "None" ) : i1iiiIIi11II = None
 if 55 - 55: I11i
 ...
 if ( iIi1II == None and i1iiiIIi11II == None ) :
 ...
 if ( iIi1II and i1iiiIIi11II ) :
  if ( iIi1II . interface == i1iiiIIi11II ) :
   ...
   lisp . lprint ( "Dynamic-EID {} interface change, {} -> {}" . format ( lisp . green ( IiIi1111ii , False ) , iIi1II . interface , i1iiiIIi11II ) )
   if 14 - 14: IiII . IiII % ooOoO0o
   iIi1II . interface = i1iiiIIi11II
 ...
 if ( i1iiiIIi11II ) :
  ...
  iIi1II . interface = i1iiiIIi11II
  iIi1II . get_timeout ( i1iiiIIi11II )
  i1iIi . dynamic_eids [ IiIi1111ii ] = iIi1II
  if 6 - 6: oO0o . I11i
  iIIII1 = lisp . bold ( "Registering" , False )
  IiIi1111ii = lisp . bold ( IiIi1111ii , False )
  lisp . lprint ( "{} dynamic-EID {} on interface {}, timeout {}" . format ( iIIII1 ,
 lisp . green ( IiIi1111ii , False ) , i1iiiIIi11II , iIi1II . timeout ) )
  ...
  if ( lisp . lisp_is_macos ( ) == False ) :
   ...
   i11111 = "ip route add {} dev {}" . format ( IiIi1111ii , i1iiiIIi11II )
   os . system ( i11111 )
   if 60 - 60: OOooOOo
  return
  if 73 - 73: ooOoO0o
 ...
 if ( IiIi1111ii in i1iIi . dynamic_eids ) :
  i1iiiIIi11II = i1iIi . dynamic_eids [ IiIi1111ii ] . interface
  Ii1IIii = lisp . bold ( "Deregistering" , False )
  lisp . lprint ( "{} dynamic-EID {}" . format ( Ii1IIii ,
 lisp . green ( IiIi1111ii , False ) ) )
  ...
  if ( lisp . lisp_is_macos ( ) == False ) :
   IiIi1111ii = oOIIi1iiii1iI . print_prefix_no_iid ( )
   i11111 = "ip route delete {} dev {}" . format ( IiIi1111ii , i1iiiIIi11II )
   os . system ( i11111 )
...
def O0oO0 ( ipc ) :
 ...
 iI = Iiio000o0o00Oo . split ( lisp . LISP_TP )
 if ( len ( iI ) != 2 ) :
  lisp . lprint ( "Invalid NAT IPC rloc-name {}" . format ( iI ) )
  return
  if 66 - 66: iII111i / i11iIiiIii * O0
  if 78 - 78: IiII - I11i % O0 - OOooOOo % OoO0O00
 i11IiIi , i1IiII1i1I = iI [ 0 ] , int ( iI [ 1 ] )
 lisp . lisp_store_nat_info ( i11IiIi , I1i11II , i1IiII1i1I )
...
def iioO ( ipc ) :
 ...
 i111IIIIiI , II1I1I1Ii , IIiI1111i1 = ipc . split ( "%" )
 ...
 if 75 - 75: i1IIi
def OOO0OO ( ipc ) :
 i1iI1IIi , i111IIIIiI , iiI1I , O0oooO00ooO0 = ipc . split ( "%" )
 O0oooO00ooO0 = int ( O0oooO00ooO0 , 16 )
 if 99 - 99: IiII
 OOO0o0 = lisp . lisp_get_echo_nonce ( None , iiI1I )
 if ( OOO0o0 == None ) : OOO0o0 = lisp . lisp_echo_nonce ( iiI1I )
 if 90 - 90: ooOoO0o - I11i . OoO0O00 + OoO0O00
 if ( i111IIIIiI == "R" ) :
  OOO0o0 . request_nonce_sent = O0oooO00ooO0
  lisp . lprint ( "Waiting for echo-nonce 0x{} from {}" . format ( lisp . lisp_hex_string ( O0oooO00ooO0 ) , lisp . red ( OOO0o0 . rloc_str , False ) ) )
  if 45 - 45: OoOoOO00 / OoooooooOO . I1Ii111 % O0 * I1ii11iIi11i * Oo0Ooo
 elif ( i111IIIIiI == "E" ) :
  OOO0o0 . echo_nonce_sent = O0oooO00ooO0
  lisp . lprint ( "Sent echo-nonce 0x{} to {}" . format ( lisp . lisp_hex_string ( O0oooO00ooO0 ) , lisp . red ( OOO0o0 . rloc_str , False ) ) )
...
while ( True ) :
 try : iiI1 , oooOOO0o0O0 , i1iI1IIi = select . select ( oOoo00 , [ ] , [ ] )
 except : break
 if 31 - 31: OoooooooOO - oO0o / I1Ii111
 if 62 - 62: i11iIiiIii - I11i
 if 81 - 81: I11i
 if 92 - 92: OOooOOo - Oo0Ooo - OoooooooOO / IiII - i1IIi
 if ( I1Ii11I1Ii1i in iiI1 ) :
  i111IIIIiI , o0OOOOooo , i1IiII1i1I , OoO = lisp . lisp_receive ( I1Ii11I1Ii1i , False )
  ...
  if ( i1IiII1i1I == lisp . LISP_DATA_PORT ) :
   ...
   Ii11iIiiI = lisp . lisp_parse_packet ( i1 , OoO ,
 ...
 if ( o0oOoO00o in iiI1 ) :
  i111IIIIiI , o0OOOOooo , i1IiII1i1I , OoO = lisp . lisp_receive ( o0oOoO00o , True )
  if 54 - 54: OoOoOO00 . OoooooooOO
  if ( o0OOOOooo == "" ) : break
  if 36 - 36: oO0o / II111iiii * IiII % I1ii11iIi11i
  if ( i111IIIIiI == "command" ) :
   OoO = OoO . decode ( )
   if ( OoO . find ( "learn%" ) != - 1 ) :
    iiII1IIii1i1 ( OoO )
   elif ( OoO . find ( "nat%" ) != - 1 ) :
