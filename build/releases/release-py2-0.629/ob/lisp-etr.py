...
def i1IiiI ( ) :
 ...
 if ( pytun != None ) :
  ...
  try :
   ...
   oO0oOOOooo = i1111 . name
   lisp . lprint ( "Rename tunnel name from '{}' to '{}'" . format ( oO0oOOOooo , O000oO0O ) )
   os . system ( "ip link set {} name {} up" . format ( oO0oOOOooo , O000oO0O ) )
  except :
...
def IIIi11 ( ipc ) :
 ...
 IiIi1111ii = ipc [ 1 ]
 oooOo00O0 = ipc [ 2 ]
 if ( oooOo00O0 == "None" ) : oooOo00O0 = None
 ...
 if 59 - 59: II111iiii
 if ( iIi1II == None and oooOo00O0 == None ) :
 ...
 if ( iIi1II and oooOo00O0 ) :
  if ( iIi1II . interface == oooOo00O0 ) :
   lisp . lprint ( "ITR sent redundant IPC for {}" . format ( lisp . green ( IiIi1111ii , False ) ) )
   if 21 - 21: OoO0O00
  else :
   lisp . lprint ( "Dynamic-EID {} interface change, {} -> {}" . format ( lisp . green ( IiIi1111ii , False ) , iIi1II . interface , oooOo00O0 ) )
   if 63 - 63: I11i . O0 * I11i + iIii1I11I1II1
   iIi1II . interface = oooOo00O0
 ...
 if ( oooOo00O0 ) :
  ...
  iIi1II . interface = oooOo00O0
  iIi1II . get_timeout ( oooOo00O0 )
  i1iIi . dynamic_eids [ IiIi1111ii ] = iIi1II
  if 75 - 75: i11iIiiIii / o0oOOo0O0Ooo . IiII . i1IIi . i1IIi / I11i
  o0OOo0O = lisp . bold ( "Registering" , False )
  IiIi1111ii = lisp . bold ( IiIi1111ii , False )
  lisp . lprint ( "{} dynamic-EID {} on interface {}, timeout {}" . format ( o0OOo0O ,
 lisp . green ( IiIi1111ii , False ) , oooOo00O0 , iIi1II . timeout ) )
  ...
  if ( lisp . lisp_is_macos ( ) == False ) :
   ...
   IIIIIiiI11i1 = "ip route add {} dev {}" . format ( IiIi1111ii , oooOo00O0 )
   os . system ( IIIIIiiI11i1 )
 ...
 if ( IiIi1111ii in i1iIi . dynamic_eids ) :
  oooOo00O0 = i1iIi . dynamic_eids [ IiIi1111ii ] . interface
  I1I11i = lisp . bold ( "Deregistering" , False )
  lisp . lprint ( "{} dynamic-EID {}" . format ( I1I11i ,
 lisp . green ( IiIi1111ii , False ) ) )
  ...
  if ( lisp . lisp_is_macos ( ) == False ) :
   IiIi1111ii = oOIIi1iiii1iI . print_prefix_no_iid ( )
   IIIIIiiI11i1 = "ip route delete {} dev {}" . format ( IiIi1111ii , oooOo00O0 )
   os . system ( IIIIIiiI11i1 )
...
def OoOo00O0o ( ipc ) :
 ...
 I1iii1iIi = False
 if ( III1iiIIIII1 in IiI1I1 ) :
  I1i11II = IiI1I1 [ III1iiIIIII1 ]
 else :
  I1i11II = lisp . lisp_address ( lisp . LISP_AFI_IPV4 , III1iiIIIII1 , 32 , 0 )
  IiI1I1 [ III1iiIIIII1 ] = I1i11II
  I1iii1iIi = True
 ...
 o0oOoO00o ]
  lisp . lprint ( "Trigger NAT-Probe to ETR {}" . format ( III1iiIIIII1 ) )
 ...
 oOiI1I = oO0Oo0OOoo0oo . split ( lisp . LISP_TP )
 if ( len ( oOiI1I ) != 2 ) :
  lisp . lprint ( "Invalid NAT IPC rloc-name {}" . format ( oOiI1I ) )
  return
  if 6 - 6: OoO0O00
  if 99 - 99: o0oOOo0O0Ooo * OOooOOo % oO0o * oO0o + OoooooooOO
 O0OO , iI1IiiiIiI1Ii = oOiI1I [ 0 ] , int ( oOiI1I [ 1 ] )
 lisp . lisp_store_nat_info ( O0OO , I1i11II , iI1IiiiIiI1Ii )
...
def o00OIIIIIiiI ( ipc ) :
 if ( lisp . lisp_register_all_rtrs ) : return
 if 38 - 38: O0
 ooO , II1I1I1Ii , II = ipc . split ( "%" )
...
def OOOo0 ( ipc ) :
 o0Oooo0o0oO0 , ooO , IIIiIiiI1i , I1IiiiI = ipc . split ( "%" )
 I1IiiiI = int ( I1IiiiI , 16 )
 if 6 - 6: I1IiiI - i11iIiiIii
 O00O0O0OO00oo = lisp . lisp_get_echo_nonce ( None , IIIiIiiI1i )
 if ( O00O0O0OO00oo == None ) : O00O0O0OO00oo = lisp . lisp_echo_nonce ( IIIiIiiI1i )
 if 39 - 39: IiII % OoOoOO00 * I1ii11iIi11i - OoooooooOO - Oo0Ooo
 if ( ooO == "R" ) :
  O00O0O0OO00oo . request_nonce_sent = I1IiiiI
  lisp . lprint ( "Waiting for echo-nonce 0x{} from {}" . format ( lisp . lisp_hex_string ( I1IiiiI ) , lisp . red ( O00O0O0OO00oo . rloc_str , False ) ) )
  if 75 - 75: i11iIiiIii . ooOoO0o % i1IIi . I1IiiI - oO0o + Oo0Ooo
 elif ( ooO == "E" ) :
  O00O0O0OO00oo . echo_nonce_sent = I1IiiiI
  lisp . lprint ( "Sent echo-nonce 0x{} to {}" . format ( lisp . lisp_hex_string ( I1IiiiI ) , lisp . red ( O00O0O0OO00oo . rloc_str , False ) ) )
...
if 61 - 61: Ii1I - I1ii11iIi11i - i1IIi + i11iIiiIii % I11i
if 39 - 39: O0 . i1IIi * I1ii11iIi11i - OoO0O00 - iII111i % o0oOOo0O0Ooo
if 6 - 6: OoO0O00 - iII111i / II111iiii
...
OoOO00 = [ I1Ii11I1Ii1i , o0oOoO00o ]
if 91 - 91: I1ii11iIi11i + iIii1I11I1II1 % IiII
while ( True ) :
 try : O0o0OOOO0 , ii1 , o0Oooo0o0oO0 = select . select ( OoOO00 , [ ] , [ ] )
 except : break
 ...
 if ( I1Ii11I1Ii1i in O0o0OOOO0 ) :
  ooO , o0OOOOooo , iI1IiiiIiI1Ii , OoO = lisp . lisp_receive ( I1Ii11I1Ii1i , False )
  ...
  if ( iI1IiiiIiI1Ii == lisp . LISP_DATA_PORT ) :
   ...
   Oo00O = lisp . lisp_parse_packet ( i1 , OoO ,
 o0OOOOooo , iI1IiiiIiI1Ii )
   if 44 - 44: ooOoO0o * I11i
 ...
 if ( o0oOoO00o in O0o0OOOO0 ) :
  ooO , o0OOOOooo , iI1IiiiIiI1Ii , OoO = lisp . lisp_receive ( o0oOoO00o , True )
