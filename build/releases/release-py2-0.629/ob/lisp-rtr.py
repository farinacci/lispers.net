...
def O0oooo00o0Oo ( lisp_packet , thread_name ) :
 ...
 lisp_socket = O00OOooo0Ooo ) == False ) : return
  ...
  if ( len ( O0iIi1IiII . packet ) <= 1500 ) :
   OO0 = oO0O00OoOO0 . rloc_next_hop [ 0 ] if ( oO0O00OoOO0 . rloc_next_hop != None ) else "?"
   Ooo0 = "Send {}" . format ( OO0 )
   O0iIi1IiII . print_packet ( Ooo0 , True )
  ...
  o0O0 = Ii1IIii11 if I1Iii1iI1 == 6 else OOo
  O0iIi1IiII . send_packet ( o0O0 , O0iIi1IiII . outer_dest )
  ...
  Oo = len ( O0iIi1IiII . packet )
  for iIIIiIi1I1i in O0oOOo0o . rle_forwarding_list :
   if ( iIIIiIi1I1i . rloc . up_state ( ) == False ) : continue
   if 78 - 78: iIii1I11I1II1 % OoOoOO00 + I1ii11iIi11i / i1IIi % II111iiii + OOooOOo
   O0iIi1IiII . outer_dest . copy_address ( iIIIiIi1I1i . rloc . rloc )
   O0iIi1IiII . encap_port = lisp . LISP_DATA_PORT if iIIIiIi1I1i . rloc . translated_port == 0 else iIIIiIi1I1i . rloc . translated_port
   ...
   iIIIiIi1I1i . rloc . stats . increment ( len ( O0iIi1IiII . packet ) )
   if 3 - 3: iII111i . ooOoO0o % I1IiiI + I1ii11iIi11i
   O0iIi1IiII . print_packet ( "Replicate-to-L{}" . format ( iIIIiIi1I1i . level ) , True )
   O0iIi1IiII . send_packet ( o0O0 , O0iIi1IiII . outer_dest )
   if 64 - 64: i1IIi
   ...
   I1III111i = len ( O0iIi1IiII . packet ) - Oo
...
def o0oO0Oo ( parms , not_used , packet ) :
 ...
 OO0 = parms [ 0 ]
 o0O0OO0o = parms [ 1 ]
 OO = o0O0OO0o . number_of_worker_threads
 if 77 - 77: i11iIiiIii / OoooooooOO + IiII % oO0o
 o0O0OO0o . input_stats . increment ( len ( packet ) )
 if 36 - 36: oO0o
 if 74 - 74: OoooooooOO
 ...
 I1ii = 4 if OO0 == "lo0" else ( 14 if lisp . lisp_is_macos ( ) else 16 )
 packet = packet [ I1ii : : ]
 ...
 if 13 - 13: OoO0O00
 if ( OO ) :
  O0oo0O0 = o0O0OO0o . input_stats . packet_count % OO
  O0oo0O0 = O0oo0O0 + ( len ( I11 ) - OO )
  iiII111iIII1Ii = I11 [ O0oo0O0 ]
  iiII111iIII1Ii . input_queue . put ( packet )
 else :
  o0O0OO0o . lisp_packet . packet = packet
  O0oooo00o0Oo ( o0O0OO0o . lisp_packet , o0O0OO0o . thread_name )
...
def oo0O0o ( lisp_thread ) :
 ...
 OOO = OOO [ 0 : - 4 ]
 I11i11i1 += ( " or (not (src host {}) and " + "((udp src port 4342) or (udp dst port 4342)))" ) . format ( OOO )
 ...
 if ( lisp . lisp_is_python2 ( ) ) :
  import pcappy
  iii1IIiI = pcappy . open_live ( OO0 , 9000 , 0 , 100 )
  iii1IIiI . filter = I11i11i1
  iii1IIiI . loop ( - 1 , o0oO0Oo , [ OO0 , lisp_thread ] )
  if 33 - 33: I11i
 if ( lisp . lisp_is_python3 ( ) ) :
  import pcapy
  iii1IIiI = pcapy . open_live ( OO0 , 9000 , 0 , 100 )
  iii1IIiI . setfilter ( I11i11i1 )
  while ( True ) :
   Ii1Iii111IiI1 , O0iIi1IiII = iii1IIiI . next ( )
   if ( len ( O0iIi1IiII ) == 0 ) : continue
   o0oO0Oo ( [ OO0 , lisp_thread ] , None , O0iIi1IiII )
...
def Iiii11I ( lisp_raw_socket , eid , geid , igmp ) :
 global iIiiI1
 ...
 i11I1I = eid . print_address_no_iid ( )
 for iiIIiiIi1Ii11 in OoOo . rloc_set [ 0 ] . rle . rle_nodes :
  if ( iiIIiiIi1Ii11 . rloc . rloc_name == i11I1I ) :
 ...
 IIi1 = lisp . lisp_myrlocs [ 0 ]
 if ( iIiiI1 ) : IIi1 = iIiiI1
 O0iIi1IiII . outer_source . copy_address ( IIi1 )
 ...
 I1iiI1II = lisp . bold ( "IGMP Query" , False )
 if 44 - 44: Oo0Ooo / i1IIi + iIii1I11I1II1 / iIii1I11I1II1 * iIii1I11I1II1 . Ii1I
 lisp . lprint ( "Data encapsulate {} to gleaned EID {}, RLOC {}" . format ( I1iiI1II , OO0oOoOO0oOO0 , i1oO ) )
...
def O000oOo0O ( lisp_raw_socket ) :
 ...
 for Oo0O in lisp . lisp_gleaned_groups :
  ...
  for i111i1I1ii1i in lisp . lisp_gleaned_groups [ Oo0O ] :
   ...
   II1i , Ii1IIIIi1ii1I , O0O = lisp . lisp_allow_gleaning ( i1i , Oo0oOOo , None )
   if ( O0O == False ) : continue
   Iiii11I ( lisp_raw_socket , i1i , Oo0oOOo , OoOOoooO000 + oO0 )
...
def iIi1i11 ( ) :
 ...
 for iiI in range ( IiI ) :
  ...
  I11 . append ( O0OO0o0O00oO )
  threading . Thread ( target = I1I1I11Ii , args = [ O0OO0o0O00oO ] ) . start ( )
