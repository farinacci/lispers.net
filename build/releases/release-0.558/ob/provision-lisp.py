...
def O0OoOoo00o ( device ) :
 iiiI11 = commands . getoutput ( 'ip route | egrep "link src "' . format ( device ) )
 if ( iiiI11 == "" ) :
  iiiI11 = commands . getoutput ( 'ip route | egrep "link  src "' . format ( device ) )
...
if ( iIii11I ( ) ) :
 ...
 os . system ( "sudo ifconfig lo0 inet6 {}/128 alias" . format ( oOOoo00O0O ) )
 os . system ( "sudo route delete -inet6 fe00::/16 > /dev/null" )
 os . system ( "sudo route add -inet6 fe00::/16 {} > /dev/null" . format ( oOOoo00O0O ) )
