...
def i1II11Iii1I ( parms , not_used , packet ) :
 ...
 if ( packet . lisp_header . get_instance_id ( ) == 0xffffff ) :
  ...
  I11Iii1 = - 1
  if ( lisp . lisp_is_rloc_probe_request ( oOo00Ooo0o0 [ 0 ] ) ) :
   I11Iii1 = struct . unpack ( "B" , iiIiII11i1 [ 8 ] ) [ 0 ] - 1
   if 33 - 33: I11i
...
def i11ii ( ) :
 ...
 while ( True ) :
  OoooOo0 = commands . getoutput ( "ls join-*" ) . replace ( "join-" , "" )
...
def i1I1i1i1I1 ( ipc ) :
 ...
 Ii1Ii1 , o0OOOooo0OOo , i1i1 = ipc . split ( "%" )
