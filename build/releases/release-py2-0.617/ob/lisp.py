...
def lisp_timeout_igmp_database ( ) :
 ...
 for oooO00OO00 in list ( lisp_db_for_lookups . cache . values ( ) ) :
...
def lisp_glean_map_cache ( seid , rloc , encap_port , igmp ) :
 ...
 if ( Ii111 and len ( Ii111 . rloc_set ) != 0 ) :
  ...
  if 26 - 26: oO0o + i1IIi . IiII
  oOo0OoO0oo0Oo = Ii111 . rloc_set [ 0 ]
  o0OiI1i1I11Ii1Ii = oOo0OoO0oo0Oo . rloc
  iIII1Iii = oOo0OoO0oo0Oo . translated_port
  O0o0OooOO0o = ( o0OiI1i1I11Ii1Ii . is_exact_match ( rloc ) == False or
 iIII1Iii != encap_port )
  ...
  if ( O0o0OooOO0o ) :
   ...
   oOo0OoO0oo0Oo . delete_from_rloc_probe_list ( Ii111 . eid , Ii111 . group )
