...
def Oo000o ( jd ) :
 for I11IiI1I11i1i in jd :
  ...
  for iI1ii1Ii in I11IiI1I11i1i [ "paths" ] :
   if ( iI1ii1Ii . has_key ( "encap-ts" ) ) :
    oooo000 = iI1ii1Ii [ "encap-ts" ]
    iIIIi1 = "encap"
    if 20 - 20: i1IIi + I1ii11iIi11i - ooOoO0o
   if ( iI1ii1Ii . has_key ( "decap-ts" ) ) :
    oooo000 = iI1ii1Ii [ "decap-ts" ]
    iIIIi1 = "decap"
    if 30 - 30: II111iiii - OOooOOo - i11iIiiIii % OoOoOO00 - II111iiii * Ii1I
   oO00O0O0O = iI1ii1Ii [ "hn" ]
   ...
   if ( iI1ii1Ii . has_key ( "rtts" ) and iI1ii1Ii . has_key ( "hops" ) ) :
    O0oOoOO = iI1ii1Ii [ "rtts" ]
    oO00o0 = json . dumps ( iI1ii1Ii [ "hops" ] )
