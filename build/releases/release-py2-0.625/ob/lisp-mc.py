 ...
 for IIooooo in oOOo0oOo0 :
  ...
  if ( "nh-node" not in IIooooo ) :
   ...
   if ( "upriority" in IIooooo and "uweight" in IIooooo ) :
    oO00OOoO00 += ", p{}/w{}" . format ( IIooooo [ "upriority" ] , IIooooo [ "uweight" ] )
  ...
  O00 = o000o0o00o0Oo ( IIooooo [ "nh-interface" ] [ 0 ] ) + ": " if ( "nh-interface" in IIooooo ) else ""
  if ( "is-active" in IIooooo and IIooooo [ "is-active" ] == True ) : O00 = "*" + O00
  if 29 - 29: oO0o0ooO0 / OoO0O00 . i1IIi * I1IiiI + i11iIiiIii
  print ( "    {}{}" . format ( O00 , OO ( IIooooo ) ) )
  i1iiIII111ii , I1Ii , O0oo00o0O = i11IiIiiIIIII ( IIooooo )
  print ( "    rtts {}, hops {}, lats {}" . format ( i1iiIII111ii , I1Ii , O0oo00o0O ) )
  if 1 - 1: II111iiii
 print ( )
...
if ( o00oOO0 and i1i == False ) :
 ...
 if 51 - 51: Oo0Ooo - OOooOOo + II111iiii * OoOO0ooOOoo0O . OoOO + OOooOOo
 if 78 - 78: i11iIiiIii / o0000oOoOoO0o - OoOO0ooOOoo0O / ii11ii1ii + OOooOOo
exit ( 0 )
if 82 - 82: OoOO0ooOOoo0O
