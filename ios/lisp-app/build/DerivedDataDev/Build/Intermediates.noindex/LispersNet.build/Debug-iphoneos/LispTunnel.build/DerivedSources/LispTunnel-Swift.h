...
#ifndef LISPTUNNEL_SWIFT_H
#define LISPTUNNEL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="LispTunnel",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10LispTunnel11NetworkName")
...
@interface NetworkName (SWIFT_EXTENSION(LispTunnel)) <CLLocationManagerDelegate>
- (void)locationManagerDidChangeAuthorization:(CLLocationManager * _Nonnull)m;
@end

@class NSString;
SWIFT_CLASS("_TtC10LispTunnel20PacketTunnelProvider")
